...
**  VERSION   : 7.0.0                                                         **
**                                                                            **
**  DATE, TIME: 2024-11-05, 15:19:05        !!!IGNORE-LINE!!!                 **
**                                                                            **
...
#define DSADC_SW_MAJOR_VERSION  (10U)
#define DSADC_SW_MINOR_VERSION  (40U)
#define DSADC_SW_PATCH_VERSION  (1U)

#define DSADC_NUM_OF_CHANNELS              (0x6U)
...
#define DSADC_SAFETY_ENABLE                 (STD_OFF)
...
#define DSADC_GTMTRIGGER_USED               (STD_ON)
...
#define DSADC_ALL_CH_RESULT_HANDLING_DMA    (STD_ON)
...
in generated code to be in sync with  Autosar Naming constraints.
No side effects foreseen by violating this MISRA rule.*/
#ifndef DsadcChannel_DsadcChannelConfiguration_3
/* MISRA2012_RULE_5_1_JUSTIFICATION: External identifiers going beyond 32 chars.
in generated code to be in sync with  Autosar Naming constraints.
No side effects foreseen by violating this MISRA rule.*/
/* MISRA2012_RULE_5_2_JUSTIFICATION: External identifiers going beyond 32 chars.
...
#define DsadcChannel_DsadcChannelConfiguration_3     ((Dsadc_ChannelType)0x1U)
#endif

/* Number of DSADC channels configured */
#define DSADC_MAX_CHANNELS_CONFIGURED                ((Dsadc_ChannelType)2U)
