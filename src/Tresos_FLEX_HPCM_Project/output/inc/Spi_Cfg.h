...
#define SPI_JOB_STATUS_ARRAY_INDEX            (5U)
/* Array size to store the 2-bit status of all the Sequence */
#define SPI_SEQUENCE_STATUS_ARRAY_INDEX       (5U)
...
/* Job Queue Length for QSPI1 */
#define SPI_JOB_QUEUE_LENGTH_QSPI1            (50U)
/* Job Queue Length for QSPI2 */
#define SPI_JOB_QUEUE_LENGTH_QSPI2            (50U)
/* Job Queue Length for QSPI3 */
#define SPI_JOB_QUEUE_LENGTH_QSPI3            (100U)
/* Job Queue Length for QSPI4 */
#define SPI_JOB_QUEUE_LENGTH_QSPI4            (100U)
/* QSPI Channel Index */
...
/*kernel 1*/
#define SPI_NUM_EB_CHANNELS_QSPI1            (3U)
/*Kernel 2*/
#define SPI_NUM_EB_CHANNELS_QSPI2            (1U)
/*Kernel 3*/
#define SPI_NUM_EB_CHANNELS_QSPI3            (33U)
/*Kernel 4*/
#define SPI_NUM_EB_CHANNELS_QSPI4            (33U)
...
#define SPI_NUM_SYNC_QSPI_MASTER              (4U)
