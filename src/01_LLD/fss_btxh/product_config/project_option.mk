...
#@mv outputs/Output/*.elf 01_LLD/outputs
...
SOFTWARE_VERSION := "dz110B1CBM130_0"
...
CPPFLAGS += $(CPPFLAGS_dev) -DBRS_TIMEBASE_CLOCK=300 -DBRS_EVA_BOARD_CUSTOMER_HARDWARE -DBRS_COMP_GCCHIGHTEC -DAUTOSAR_IS_PRESENT -DNO_BOOT_IS_PRESENT -DDemoBm \
...
hightec_main.ld:  btxh_appl_src/vLinkGen_Template_DemoBm.ld product_config/project_option.mk
	$(CC) -E -P -C -xc $(CPPFLAGS) btxh_appl_src/vLinkGen_Template_DemoBm.ld -o product_config/hightec_main.ld -I gendata
