 ...
 *  03.02.00  2008-07-16  Jk                    BUSTRCV_E_OK added (specification inconsistency ComStackTypes <->
 *                                              FrTrcv)
 ...
 *  04.00.00  2012-07-19  visht   ESCAN00058421 support ASR 4.0 R3 (support TPParameterType as enum, include generated
 *                                              ComStack_Cfg.h)
 *  04.00.01  2012-08-31  visht                 version define corrected - replace PATCH by REVISION -
 *                                              (COMSTACKTYPE_AR_RELEASE_REVISION_VERSION,
 *                                              COMSTACKTYPE_AR_RELEASE_REVISION_VERSION)
 *            2012-10-23  visseu                Add COMSTACKTYPE_MODULE_ID as specified in
 ...
 *  04.02.00  2023-04-12  visbwa  HALBE-7488    Removed outdated fragments of ASR3.x/ASR4.0.1 and file filtering,
 *                                              fixed copyright header, removed author identity, codestyle review
 **********************************************************************************************************************/
...
# define COMMONASR__COMMON_IMPL_COMSTACKTYPES_VERSION 0x0402
...
# define COMSTACKTYPE_SW_MINOR_VERSION       (2u)
