 ...
 *  08.02.00  2021-03-11  visgaz  CAN-2553      [CAN-IF] Support ASR4.4.0 CAN driver
 *                                CAN-2631      [CAN-IF] Perform Finite Execution Time Analysis (FETA)
 *            2021-04-16          ESCAN00109109 Compiler warning: Undefined CPU_TYPE_64
 *                                ESCAN00109110 Compiler warning: Type qualifier is meaningless on cast type
 *  08.03.00  2021-05-05  visgaz  CAN-2592      [CAN-IF] Remove configuration variant Link-Time
 *                                CAN-2588      [CAN-IF] Make MemMap-Description available again
 *  08.04.00  2022-02-23  visgaz  CANCORE-463   [CAN-IF] Implementation of multi-partition support (Part1)
 *  08.05.00  2022-08-15  visgaz  CANCORE-1372  [CAN-IF] [Beta] Support CAN driver combination 3rd party AR version 4.4.0 with CMSR
 *            2022-09-26  visgaz  CANCORE-242   [CAN-IF] Finalize Finite Execution Time Analysis (FETA)
 *  08.05.01  2023-02-01  visgaz  ESCAN00113771 FETA ID "FETA_CANIF_14" has no justification
 *********************************************************************************************************************/
 #if !defined (CANIF_H)
 # define CANIF_H
...
# define CANIF_SW_MINOR_VERSION                    0x05u
# define CANIF_SW_PATCH_VERSION                    0x01u
