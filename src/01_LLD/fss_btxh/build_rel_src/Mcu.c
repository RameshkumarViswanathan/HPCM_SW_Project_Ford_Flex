...
LOCAL_INLINE void Mcu_lGtmToutSelInit(void)
{
  ...
  */
  ...
  {
    //MODULE_GTM.TOUTSEL[ToutSelRegIndex].U &= (~(Mcu_ConfigPtr->McuGtmConfigPtr  /* TODO: TECHM: Commented out for debug*/
...
LOCAL_INLINE void Mcu_lGtmTimInselInit(void)
{
  ...
  */
  ...
  {
    //MODULE_GTM.TIMINSEL[TimInSelRegIndex].U |= Mcu_ConfigPtr->McuGtmConfigPtr   /* TODO: TECHM: Commented out for debug*/
...
** Parameters (out): None                                                     **
**                                                                            **
** Return value    : E_OK     : CCUCON0 is locked and can't be updated        **
**                   E_NOT_OK : CCUCON0 is unlocked and can be updated        **
**                                                                            **
*******************************************************************************/
LOCAL_INLINE Std_ReturnType Mcu_lCcuconLckChk(const uint8 ApiId)
{
...
**                                                                            **
** Description     :  This function calls the appropriate DEM handlers.       **
**                                                                            **
** Sync/Async      :  Synchronous                                             **
**                                                                            **
** Reentrancy      :  Reentrant                                               **
