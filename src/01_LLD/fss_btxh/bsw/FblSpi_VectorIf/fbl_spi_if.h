 ...
 *  01.01.00   2018-06-20  Rie     ESCAN00099736    Added NULL pointer definition for unused polling function
 **********************************************************************************************************************/
...
#define FBLDRVSPI_VECTORIF_VERSION           0x0101u
#define FBLDRVSPI_VECTORIF_RELEASE_VERSION   0x00u
...
#define FBLDRVSPI_VECTORIF_API_VERSION_MINOR       0x01u
...
/** NULL pointer definition for unused polling function */
#define FBL_SPI_POLLING_FCT_NULL          ((tFblSpiPollingFct)0)
...
typedef struct
{
   ...
   /** The polling function (called by FblSpi<...>TransferSync() once the driver blocks waiting for transfer completion).
     * Use FBL_SPI_NULL_PTR_POLLING_FCT in case no polling function should be called. */
