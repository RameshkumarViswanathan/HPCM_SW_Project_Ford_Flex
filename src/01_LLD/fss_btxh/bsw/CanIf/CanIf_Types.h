 ...
 * 06.17.00   2019-01-21  visgaz  STORYC-7275   Support of AUTOSAR Bus Mirroring in CanIf
 *                                STORYC-4900   Support of 64bit Plattforms - If_AsrIfCan
 * 06.18.00   2019-02-22  visgaz  ESCAN00094121 [Only if not Vector CanDrv is used] CanIf does not fullfill the requirements: CANIF720, CANIF678 in relation to CanDrv
 *                                STORYC-7599   Support CanIfTxPduTruncation
 * 06.19.00   2019-09-02  visgaz  CAN-32        [CAN-IF] ASIL for J1939
 * 06.20.00   2020-08-04  visgaz  CAN-1570      [CAN-IF] IdsM: Support reporting of security events by CAN stack modules
 * 06.21.00   2020-08-31  visgaz  CAN-1904      [CAN-IF] Improve robustness of CanIf_TxQueueTransmit()
                          visgaz  CAN-1628      [CAN-IF] Improvements for CREQ-992/CREQ-918/CREQ-952
 * 06.22.00   2020-11-23  visgaz  CAN-1989      [CAN-IF] Support reporting of security events according to AR20-11
 * 06.23.00   2021-01-18  visgaz  CAN-36        [CAN-IF] Improve Tx-Buffer runtime
 * 06.24.00   2021-03-11  visgaz  CAN-2553      [CAN-IF] Support ASR4.4.0 CAN driver
 *            2021-04-16          ESCAN00109109 Compiler warning: Undefined CPU_TYPE_64
 * 06.25.00   2021-05-05  visgaz  CAN-2592      [CAN-IF] Remove configuration variant Link-Time
 * 06.26.00   2022-08-15  visgaz  CANCORE-1372  [CAN-IF] [Beta] Support CAN driver combination 3rd party AR version 4.4.0 with CMSR
 *********************************************************************************************************************/
...
# define CANIF_TYPES_MINOR_VERSION             0x26u
...
# if (CANIF_SUPPORT_CANDRV_AR_VERSIONS == STD_ON)
typedef enum CanIf_CanDrvArVersionType_Tag
{
  CAN_DRV_AR_403,
  CAN_DRV_AR_431
} CanIf_CanDrvArVersionType;
# endif
