# 1 "../../../../CBD2300515_D00/BSW/PduR/PduR_RmTp.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/PduR/PduR_RmTp.c"
# 43 "../../../../CBD2300515_D00/BSW/PduR/PduR_RmTp.c"
...
# 44 "../../../../CBD2300515_D00/BSW/PduR/PduR_RmTp.c" 2
...
# 45 "../../../../CBD2300515_D00/BSW/PduR/PduR_RmTp.c" 2
...
# 46 "../../../../CBD2300515_D00/BSW/PduR/PduR_RmTp.c" 2
...
# 47 "../../../../CBD2300515_D00/BSW/PduR/PduR_RmTp.c" 2
...
# 48 "../../../../CBD2300515_D00/BSW/PduR/PduR_RmTp.c" 2
...
# 49 "../../../../CBD2300515_D00/BSW/PduR/PduR_RmTp.c" 2
# 80 "../../../../CBD2300515_D00/BSW/PduR/PduR_RmTp.c"
# 1 "GenData/PduR_MemMap.h" 1
# 473 "GenData/PduR_MemMap.h"
#pragma section ".RamCodeCoreSection" ax
# 81 "../../../../CBD2300515_D00/BSW/PduR/PduR_RmTp.c" 2
# 125 "../../../../CBD2300515_D00/BSW/PduR/PduR_RmTp.c"
static __inline__ Std_ReturnType PduR_RmTp_MultipleSourceHandler_Transmit(PduR_RmDestRomIterType rmDestRomIdx, const PduInfoType * info);
# 805 "../../../../CBD2300515_D00/BSW/PduR/PduR_RmTp.c"
static __inline__ Std_ReturnType PduR_RmTp_MultipleSourceHandler_Transmit(PduR_RmDestRomIterType rmDestRomIdx, const PduInfoType * info)
{
...
# 833 "../../../../CBD2300515_D00/BSW/PduR/PduR_RmTp.c"
    {
      retVal = (PduR_MmRom[((PduR_RmGDestRom[(rmGDestRomIdx)].MmRomIdxOfRmGDestRom))].LoTpTransmitFctPtrOfMmRom) ((PduR_RmGDestRom[(rmGDestRomIdx)].DestHndOfRmGDestRom), info);
    }
  }
...
# 855 "../../../../CBD2300515_D00/BSW/PduR/PduR_RmTp.c"
void PduR_RmTp_MultipleSourceHandler_TpTxConfirmation(PduR_RmGDestRomIdxOfTxTp2SrcType rmGDestRomIdx, Std_ReturnType result)
{
  PduR_Lock_LockRoutingPathByGDestPdu(rmGDestRomIdx);
  {
    ...
    if(PduR_Rm_GetSrcDestPdu(rmGDestRomIdx, &rmDestRomIdx) == 0u)
    {




      switch ((PduR_RmDestRom[(rmDestRomIdx)].RoutingTypeOfRmDestRom))
      {
        ...
        case 0x06u:
        {
          ...
          (PduR_MmRom[((PduR_RmSrcRom[(rmSrcRomIdx)].MmRomIdxOfRmSrcRom))].UpTpTpTxConfirmationFctPtrOfMmRom) ((PduR_RmSrcRom[(rmSrcRomIdx)].SrcHndOfRmSrcRom), result);
        }
          break;
    ...
    {
      (void)Det_ReportError(51u, 0U, (((uint8)0xA9u)), (((uint8)0xA1u)));
    }
  }
  PduR_Lock_UnlockRoutingPathByGDestPdu(rmGDestRomIdx);
}
# 907 "../../../../CBD2300515_D00/BSW/PduR/PduR_RmTp.c"
BufReq_ReturnType PduR_RmTp_MultipleSourceHandler_CopyTxData(PduR_RmGDestRomIdxOfTxTp2SrcType rmGDestRomIdx, PduInfoType * info,
                                                                              RetryInfoType * retry, PduLengthType * availableDataPtr)
{
  ...
  PduR_Lock_LockRoutingPathByGDestPdu(rmGDestRomIdx);
  {
    ...
    if(PduR_Rm_GetSrcDestPdu(rmGDestRomIdx, &rmDestRomIdx) == 0u)
    {
...

      {
        switch ((PduR_RmDestRom[(rmDestRomIdx)].RoutingTypeOfRmDestRom))
        {
# 932 "../../../../CBD2300515_D00/BSW/PduR/PduR_RmTp.c"
          case 0x06u:
          {
            PduR_RmSrcRomIdxOfRmDestRomType rmSrcRomIdx = (PduR_RmDestRom[(rmDestRomIdx)].RmSrcRomIdxOfRmDestRom);
            retVal = (PduR_MmRom[((PduR_RmSrcRom[(rmSrcRomIdx)].MmRomIdxOfRmSrcRom))].UpTpCopyTxDataFctPtrOfMmRom) ((PduR_RmSrcRom[(rmSrcRomIdx)].SrcHndOfRmSrcRom), info, retry, availableDataPtr);
          }
            break;
    ...
    {
      (void)Det_ReportError(51u, 0U, (((uint8)0xABu)), (((uint8)0xA1u)));
    }
  }
  PduR_Lock_UnlockRoutingPathByGDestPdu(rmGDestRomIdx);
  return retVal;
}
# 1014 "../../../../CBD2300515_D00/BSW/PduR/PduR_RmTp.c"
Std_ReturnType PduR_RmTp_Transmit_MultiDest(PduR_RmSrcRomIterType rmSrcIdx, const PduInfoType * info)
{
  Std_ReturnType retVal = 1u;
  PduR_RmDestRomIterType rmDestIdx;

  for(rmDestIdx = (PduR_RmSrcRom[(rmSrcIdx)].RmDestRomStartIdxOfRmSrcRom); rmDestIdx < ((PduR_RmDestRomEndIdxOfRmSrcRomType)(((PduR_RmSrcRom[(rmSrcIdx)].RmDestRomStartIdxOfRmSrcRom) + 1u))); rmDestIdx++)
  {
    PduR_RmGDestRomIterType rmGDestRomIdx = (PduR_RmDestRom[(rmDestIdx)].RmGDestRomIdxOfRmDestRom);
    if((PduR_RmGDestRom[(rmGDestRomIdx)].DirectionOfRmGDestRom) == 0x01u)
    {
...
# 2526 "../../../../CBD2300515_D00/BSW/PduR/PduR_RmTp.c"
# 1 "GenData/PduR_MemMap.h" 1
# 489 "GenData/PduR_MemMap.h"
#pragma section
# 2527 "../../../../CBD2300515_D00/BSW/PduR/PduR_RmTp.c" 2
