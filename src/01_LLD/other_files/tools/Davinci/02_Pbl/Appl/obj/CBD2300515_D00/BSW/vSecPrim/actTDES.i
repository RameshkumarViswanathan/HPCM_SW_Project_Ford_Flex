# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actTDES.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actTDES.c"
# 25 "../../../../CBD2300515_D00/BSW/vSecPrim/actTDES.c"
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actTDES.h" 1
# 27 "../../../../CBD2300515_D00/BSW/vSecPrim/actTDES.h"
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actDES.h" 1
# 27 "../../../../CBD2300515_D00/BSW/vSecPrim/actDES.h"
...
# 28 "../../../../CBD2300515_D00/BSW/vSecPrim/actDES.h" 2
# 37 "../../../../CBD2300515_D00/BSW/vSecPrim/actDES.h"
typedef struct
{
   actU32 n_keys[32];
   actU8 mode;
...
typedef void ( * actDESTransformFctType)(
   actDESSTRUCT * info, const actU8 * in,
   actU8 * out_buffer, actLengthType blocks,
   void ( * watchdog)(void));
# 67 "../../../../CBD2300515_D00/BSW/vSecPrim/actDES.h"
# 1 "GenData/vSecPrim_MemMap.h" 1
# 68 "../../../../CBD2300515_D00/BSW/vSecPrim/actDES.h" 2
# 93 "../../../../CBD2300515_D00/BSW/vSecPrim/actDES.h"
actRETURNCODE actDESInit(
   actDESSTRUCT * info, const actU8 * key,
   actU8 crypt_mode, const actU8 * iv, actU8 block_mode,
   void ( * watchdog)(void));
# 115 "../../../../CBD2300515_D00/BSW/vSecPrim/actDES.h"
actRETURNCODE actDESKeySetup(
   actDESSTRUCT * info, const actU8 * key,
   actU8 crypt_mode, void ( * watchdog)(void));
# 140 "../../../../CBD2300515_D00/BSW/vSecPrim/actDES.h"
actRETURNCODE actDESInitEncrypt(
   actDESSTRUCT * info, const actU8 * key,
   const actU8 * iv, actU8 mode,
   void ( * watchdog)(void));
# 177 "../../../../CBD2300515_D00/BSW/vSecPrim/actDES.h"
actRETURNCODE actDESEncrypt(
  actDESSTRUCT * info,
  const actU8 * in, actLengthType in_length,
  actU8 * out_buffer, actLengthType * out_length,
  boolean final, void ( * watchdog)(void));
# 204 "../../../../CBD2300515_D00/BSW/vSecPrim/actDES.h"
actRETURNCODE actDESInitDecrypt(
   actDESSTRUCT * info, const actU8 * key,
   const actU8 * iv, actU8 mode,
   void ( * watchdog)(void));
# 242 "../../../../CBD2300515_D00/BSW/vSecPrim/actDES.h"
actRETURNCODE actDESDecrypt(
  actDESSTRUCT * info,
  const actU8 * in, actLengthType in_length,
  actU8 * out_buffer, actLengthType * out_length,
  boolean final, void ( * watchdog)(void));
# 264 "../../../../CBD2300515_D00/BSW/vSecPrim/actDES.h"
actRETURNCODE actDESInitEncryptBlock(
   actDESSTRUCT * info, const actU8 * key,
   void ( * watchdog)(void));
# 284 "../../../../CBD2300515_D00/BSW/vSecPrim/actDES.h"
actRETURNCODE actDESInitDecryptBlock(
   actDESSTRUCT * info, const actU8 * key,
   void ( * watchdog)(void));
# 304 "../../../../CBD2300515_D00/BSW/vSecPrim/actDES.h"
void actDESCryptBlock(
   actDESSTRUCT * info,
   const actU8 * in_block, actU8 * out_block,
   void ( * watchdog)(void));
# 326 "../../../../CBD2300515_D00/BSW/vSecPrim/actDES.h"
void actDESEncryptMultipleBlocks(
  actDESSTRUCT * info,
  const actU8 * in, actU8 * out_buffer,
  actLengthType blocks, void ( * watchdog)(void));
# 348 "../../../../CBD2300515_D00/BSW/vSecPrim/actDES.h"
void actDESDecryptMultipleBlocks(
  actDESSTRUCT * info,
  const actU8 * in, actU8 * out_buffer,
  actLengthType blocks, void ( * watchdog)(void));
# 374 "../../../../CBD2300515_D00/BSW/vSecPrim/actDES.h"
void actDESTransform(
  actDESSTRUCT * info,
  const actU8 * in, actLengthType in_length,
  actU8 * out_buffer, actDESTransformFctType transform,
  void ( * watchdog)(void));


# 1 "GenData/vSecPrim_MemMap.h" 1
# 382 "../../../../CBD2300515_D00/BSW/vSecPrim/actDES.h" 2
# 28 "../../../../CBD2300515_D00/BSW/vSecPrim/actTDES.h" 2
# 36 "../../../../CBD2300515_D00/BSW/vSecPrim/actTDES.h"
typedef struct
{
   actDESSTRUCT k1;
   actDESSTRUCT k2;
...
typedef void ( * actTDESTransformFctType)(
   actTDESSTRUCT * info,
   const actU8 * in, actU8 * out_buffer,
   actLengthType blocks, void ( * watchdog)(void));
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 62 "../../../../CBD2300515_D00/BSW/vSecPrim/actTDES.h" 2
# 86 "../../../../CBD2300515_D00/BSW/vSecPrim/actTDES.h"
actRETURNCODE actTDESInit(
   actTDESSTRUCT * info,
   const actU8 * key, actU8 key_len,
   actU8 crypt_mode, const actU8 * iv,
   actU8 block_mode, void ( * watchdog)(void));
# 110 "../../../../CBD2300515_D00/BSW/vSecPrim/actTDES.h"
actRETURNCODE actTDESKeySetup(
   actTDESSTRUCT * info,
   const actU8 * key, actU8 key_len,
   actU8 crypt_mode, void ( * watchdog)(void));
# 137 "../../../../CBD2300515_D00/BSW/vSecPrim/actTDES.h"
actRETURNCODE actTDESInitEncrypt(
   actTDESSTRUCT * info,
   const actU8 * key, actU8 key_len,
   const actU8 * iv, actU8 mode,
   void ( * watchdog)(void));
# 176 "../../../../CBD2300515_D00/BSW/vSecPrim/actTDES.h"
actRETURNCODE actTDESEncrypt(
   actTDESSTRUCT * info,
   const actU8 * in, actLengthType in_length,
   actU8 * out_buffer, actLengthType * out_length,
   boolean final, void ( * watchdog)(void));
# 204 "../../../../CBD2300515_D00/BSW/vSecPrim/actTDES.h"
actRETURNCODE actTDESInitDecrypt(
   actTDESSTRUCT * info,
   const actU8 * key, actU8 key_len,
   const actU8 * iv, actU8 mode,
   void ( * watchdog)(void));
# 244 "../../../../CBD2300515_D00/BSW/vSecPrim/actTDES.h"
actRETURNCODE actTDESDecrypt(
   actTDESSTRUCT * info,
   const actU8 * in, actLengthType in_length,
   actU8 * out_buffer, actLengthType * out_length,
   boolean final, void ( * watchdog)(void));
# 267 "../../../../CBD2300515_D00/BSW/vSecPrim/actTDES.h"
actRETURNCODE actTDESInitEncryptBlock(
   actTDESSTRUCT * info,
   const actU8 * key, actU8 key_len,
   void ( * watchdog)(void));
# 289 "../../../../CBD2300515_D00/BSW/vSecPrim/actTDES.h"
actRETURNCODE actTDESInitDecryptBlock(
   actTDESSTRUCT * info,
   const actU8 * key, actU8 key_len,
   void ( * watchdog)(void));
# 310 "../../../../CBD2300515_D00/BSW/vSecPrim/actTDES.h"
void actTDESCryptBlock (
   actTDESSTRUCT * info,
   const actU8 * in_block, actU8 * out_block,
   void ( * watchdog)(void));
# 332 "../../../../CBD2300515_D00/BSW/vSecPrim/actTDES.h"
void actTDESEncryptMultipleBlocks(
   actTDESSTRUCT * info,
   const actU8 * in, actU8 * out_buffer,
   actLengthType blocks, void ( * watchdog)(void));
# 354 "../../../../CBD2300515_D00/BSW/vSecPrim/actTDES.h"
void actTDESDecryptMultipleBlocks(
   actTDESSTRUCT * info,
   const actU8 * in, actU8 * out_buffer,
   actLengthType blocks, void ( * watchdog)(void));
# 381 "../../../../CBD2300515_D00/BSW/vSecPrim/actTDES.h"
void actTDESTransform(
   actTDESSTRUCT * info,
   const actU8 * in, actLengthType in_length,
   actU8 * out_buffer, actTDESTransformFctType transform,
   void ( * watchdog)(void));


# 1 "GenData/vSecPrim_MemMap.h" 1
# 389 "../../../../CBD2300515_D00/BSW/vSecPrim/actTDES.h" 2
# 26 "../../../../CBD2300515_D00/BSW/vSecPrim/actTDES.c" 2
...
# 27 "../../../../CBD2300515_D00/BSW/vSecPrim/actTDES.c" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actWatchdog.h" 1
# 28 "../../../../CBD2300515_D00/BSW/vSecPrim/actTDES.c" 2
