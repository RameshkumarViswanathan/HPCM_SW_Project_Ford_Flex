# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actSHA.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actSHA.c"
# 39 "../../../../CBD2300515_D00/BSW/vSecPrim/actSHA.c"
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actISHA.h" 1
# 41 "../../../../CBD2300515_D00/BSW/vSecPrim/actISHA.h"
...
# 42 "../../../../CBD2300515_D00/BSW/vSecPrim/actISHA.h" 2
...
# 40 "../../../../CBD2300515_D00/BSW/vSecPrim/actSHA.c" 2
...
# 41 "../../../../CBD2300515_D00/BSW/vSecPrim/actSHA.c" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actWatchdog.h" 1
# 42 "../../../../CBD2300515_D00/BSW/vSecPrim/actSHA.c" 2
# 93 "../../../../CBD2300515_D00/BSW/vSecPrim/actSHA.c"
# 1 "GenData/vSecPrim_MemMap.h" 1
# 94 "../../../../CBD2300515_D00/BSW/vSecPrim/actSHA.c" 2
# 108 "../../../../CBD2300515_D00/BSW/vSecPrim/actSHA.c"
static void actSHATransform(
  const actU8 * in, actU32 * H,
  void ( * watchdog)(void));
# 126 "../../../../CBD2300515_D00/BSW/vSecPrim/actSHA.c"
static actU32 blk1(const actU32 * W, actU32 i);
# 174 "../../../../CBD2300515_D00/BSW/vSecPrim/actSHA.c"
static void actSHATransform(
  const actU8 * in,
  actU32 * H,
  void ( * watchdog)(void))
...
# 236 "../../../../CBD2300515_D00/BSW/vSecPrim/actSHA.c"
  for (i = 0u; i < 16u; ++i)
  {
    ((Eval) += (((Dval))^(((Bval))&(((Cval))^((Dval))))) + ((W)[((i))]) + 0x5A827999uL + ((((((Aval))) << ((actU32)(5))) | ((((Aval))) >> (32uL - (actU32)(5))))));
    t = Eval;
    Eval = Dval;
    Dval = Cval;
    Cval = (((((Bval)) << ((actU32)(30))) | (((Bval)) >> (32uL - (actU32)(30)))));
    Bval = Aval;
    Aval = t;
    actWatchdogTriggerFunction(watchdog);
  }
  for (; i < 20u; ++i)
  {
    ((W)[(i)&15u]) = blk1(W, (i)); ((Eval) += (((Dval))^(((Bval))&(((Cval))^((Dval))))) + ((W)[(i)&15u]) + 0x5A827999uL + ((((((Aval))) << ((actU32)(5))) | ((((Aval))) >> (32uL - (actU32)(5))))));
    t = Eval;
    Eval = Dval;
    Dval = Cval;
    Cval = (((((Bval)) << ((actU32)(30))) | (((Bval)) >> (32uL - (actU32)(30)))));
  ...
  for (; i < 40u; ++i)
  {
    ((W)[(i)&15u]) = blk1(W, (i)); ((Eval) += (((Bval))^((Cval))^((Dval))) + ((W)[(i)&15u]) + 0x6ED9EBA1uL + ((((((Aval))) << ((actU32)(5))) | ((((Aval))) >> (32uL - (actU32)(5))))));
    t = Eval;
    Eval = Dval;
    Dval = Cval;
    Cval = (((((Bval)) << ((actU32)(30))) | (((Bval)) >> (32uL - (actU32)(30)))));
  ...
  for (; i < 60u; ++i)
  {
    ((W)[(i)&15u]) = blk1(W, (i)); ((Eval) += ((((Bval))&((Cval)))|(((Dval))&(((Bval))|((Cval))))) + ((W)[(i)&15u]) + 0x8F1BBCDCuL + ((((((Aval))) << ((actU32)(5))) | ((((Aval))) >> (32uL - (actU32)(5))))));
    t = Eval;
    Eval = Dval;
    Dval = Cval;
    Cval = (((((Bval)) << ((actU32)(30))) | (((Bval)) >> (32uL - (actU32)(30)))));
  ...
  for (; i < 80u; ++i)
  {
    ((W)[(i)&15u]) = blk1(W, (i)); ((Eval) += (((Bval))^((Cval))^((Dval))) + ((W)[(i)&15u]) + 0xCA62C1D6uL + ((((((Aval))) << ((actU32)(5))) | ((((Aval))) >> (32uL - (actU32)(5))))));
    t = Eval;
    Eval = Dval;
    Dval = Cval;
    Cval = (((((Bval)) << ((actU32)(30))) | (((Bval)) >> (32uL - (actU32)(30)))));
...
# 321 "../../../../CBD2300515_D00/BSW/vSecPrim/actSHA.c"
static actU32 blk1(const actU32 * W, actU32 i)
{
...
# 376 "../../../../CBD2300515_D00/BSW/vSecPrim/actSHA.c"
actRETURNCODE actSHAInit(actSHASTRUCT * info)
{
...
# 403 "../../../../CBD2300515_D00/BSW/vSecPrim/actSHA.c"
actRETURNCODE actSHAUpdate(
  actSHASTRUCT * info,
  const actU8 * dataIN,
  ...
  void ( * watchdog)(void))
{
  ...
  if (retVal == (0x00u))
  {
    ...
    if (info->buffer_used > 0u)
    {
      ...
      (VStdLib_MemCpy((&buffer[info->buffer_used]), (dataIN), (diff)));
    ...
    if (finished == 0u)
    {
      ...
      (VStdLib_MemCpy((buffer), (&dataIN[lastBlockEnd]), ((actLengthType)(info->buffer_used))));
...
# 483 "../../../../CBD2300515_D00/BSW/vSecPrim/actSHA.c"
actRETURNCODE actSHAFinalize(
  actSHASTRUCT * info, actU8 * hash,
   void ( * watchdog)(void))
{
  ...
  if (len > pad_len)
  {
    actSHATransform((const actU8 * )tempBuffer, digest, watchdog);
  ...
  actCpyU32toBE (hash, digest, (20u) /(4u));


  (VStdLib_MemSet((tempBuffer), (0u), ((64u))));

  actWatchdogTriggerFunction(watchdog);

  return (0x00u);
}
# 534 "../../../../CBD2300515_D00/BSW/vSecPrim/actSHA.c"
void actSHAGetDigest(
  const actSHASTRUCT * info,
  actU8 * hash,
  void ( * watchdog)(void))
{
  ...
  actCpyU32toBE(hash, info->H, (20u) /(4u));
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 548 "../../../../CBD2300515_D00/BSW/vSecPrim/actSHA.c" 2
