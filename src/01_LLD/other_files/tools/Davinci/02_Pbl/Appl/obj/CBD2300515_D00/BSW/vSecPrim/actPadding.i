# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actPadding.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actPadding.c"
# 39 "../../../../CBD2300515_D00/BSW/vSecPrim/actPadding.c"
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actPadding.h" 1
# 40 "../../../../CBD2300515_D00/BSW/vSecPrim/actPadding.h"
...
# 41 "../../../../CBD2300515_D00/BSW/vSecPrim/actPadding.h" 2
...
# 40 "../../../../CBD2300515_D00/BSW/vSecPrim/actPadding.c" 2
...
# 41 "../../../../CBD2300515_D00/BSW/vSecPrim/actPadding.c" 2
# 49 "../../../../CBD2300515_D00/BSW/vSecPrim/actPadding.c"
# 1 "GenData/vSecPrim_MemMap.h" 1
# 50 "../../../../CBD2300515_D00/BSW/vSecPrim/actPadding.c" 2
# 59 "../../../../CBD2300515_D00/BSW/vSecPrim/actPadding.c"
actRETURNCODE actPaddingInit(actU8 mode)
{
...
# 93 "../../../../CBD2300515_D00/BSW/vSecPrim/actPadding.c"
actRETURNCODE actPaddingPad(
   actU8 mode, actLengthType buffer_size, actLengthType * buffer_used,
   actU8 * buffer)
{
  actRETURNCODE result;
  actLengthType pad;
  ...
  else
  {
    ...
    switch (mode)
    {
      ...
      case (0x10u):
      {
        (VStdLib_MemSet((&buffer[used]), (0x00u), (pad)));
        buffer[used] = 0x80u;
      ...
      case (0x20u):
      {
        (VStdLib_MemSet((&buffer[used]), ((actU8) (pad & 0xFFu)), (pad)));
...
# 161 "../../../../CBD2300515_D00/BSW/vSecPrim/actPadding.c"
actRETURNCODE actPaddingUnpad(
   actU8 mode, actLengthType buffer_size, actLengthType * buffer_used,
   const actU8 * buffer)
{
  actRETURNCODE result;
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 245 "../../../../CBD2300515_D00/BSW/vSecPrim/actPadding.c" 2
