# 1 "../../../../CBD2300515_D00/BSW/Cmpr/cmpr.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/Cmpr/cmpr.c"
# 56 "../../../../CBD2300515_D00/BSW/Cmpr/cmpr.c"
...
# 57 "../../../../CBD2300515_D00/BSW/Cmpr/cmpr.c" 2
# 1 "../../../../CBD2300515_D00/BSW/Cmpr/cmpr.h" 1
# 58 "../../../../CBD2300515_D00/BSW/Cmpr/cmpr.c" 2
# 145 "../../../../CBD2300515_D00/BSW/Cmpr/cmpr.c"
 static vuint8 window[ (vuint16)( 1 << (vuint8)10 ) ];


 static vuint8 unprocessed[ (vuint8)((vuint8)(2 + (((vuint8)10 - 2) / 8)) + (vuint8)(1 + (((vuint8)10 - 2) / 8))) ];

 static vuint8 unprocessedCount;


 static vuint8 state;

 static vuint8 matchLen;

 static vuint16 matchPos;

 static vuint16 winPos;

 static vuint8 eosFlag;

 static vuint8 overflow;

 static vuint32 maxOutLen;


 static vuint8 const inputMask[] = { 0xFFu, 0x7Fu, 0x3Fu, 0x1Fu, 0x0Fu, 0x07u, 0x03u, 0x01u, 0x00u };
# 178 "../../../../CBD2300515_D00/BSW/Cmpr/cmpr.c"
...
# 190 "../../../../CBD2300515_D00/BSW/Cmpr/cmpr.c"
void LZSS_Init( void )
{
   state = 0;
   matchLen = 0;
...
# 209 "../../../../CBD2300515_D00/BSW/Cmpr/cmpr.c"
void LZSS_ExpandData(LZSS_InputBuffer_T *inBuf, LZSS_OutputBuffer_T *outBuf)
{
   ...
   if (unprocessedCount > 0)
   {
      ...
      if (!((unprocessedCount <= (vuint8)(2 + (((vuint8)10 - 2) / 8))))) ApplFblFatalError((0xA1u));


      if (inBuf->length < (vuint8)(1 + (((vuint8)10 - 2) / 8)))
      {
         addCount = (vuint8)(inBuf->length & 0xFFu);
      }
      else
      {
         addCount = (vuint8)(1 + (((vuint8)10 - 2) / 8));
      }
   ...
   if (overflow == 1)
   {
      ...
      if (!(((unprocessedCount + inBuf->length) <= (vuint8)(2 + (((vuint8)10 - 2) / 8))))) ApplFblFatalError((0xA1u));
...
# 301 "../../../../CBD2300515_D00/BSW/Cmpr/cmpr.c"
static void LZSS_Decompress(LZSS_InputBuffer_T *inBuf, LZSS_OutputBuffer_T *outBuf)
{
   ...
   while ( (inBuf->length > 0) && (!(eosFlag == 1)) && (overflow == 0) )
   {
      ...
      switch ( state )
      {
         ...
         case 0:
         {
            ...
            else
            {
               ...
               if (!((inBuf->bitLength == (inBuf->length * 8) - inBuf->bitPos))) ApplFblFatalError((0xE0u));
            }
            break;
         }
         ...
         case 1:
         {
            ...
            else
            {
               ...
               else
               {
                  ...
                  ((*((outBuf->buffer)++)) = outByte);
                  (outBuf->length)++;

                  window[ winPos ] = outByte;

                  winPos = (vuint16)( ( winPos + 1 ) & ( (vuint16)( 1 << (vuint8)10 ) - 1 ) );
         ...
         case 2:
         {
            ...
            else
            {
               ...
               matchPos = (vuint16) InputBits( inBuf, (vuint8)10 );


               if (!((inBuf->bitLength == (inBuf->length * 8) - inBuf->bitPos))) ApplFblFatalError((0xE0u));


               if (matchPos == (vuint8)0 )
               {

                  if (!((inBuf->length <= 1))) ApplFblFatalError((0xE0u));
         ...
         case 3:
         {
            ...
            else
            {
               ...
               matchLen = (vuint8) InputBits( inBuf, (vuint8)4 );


               if (!((inBuf->bitLength == (inBuf->length * 8) - inBuf->bitPos))) ApplFblFatalError((0xE0u));

               if (!((matchLen < (1 << (vuint8)4)))) ApplFblFatalError((0xE1u));




               matchLen = matchLen + ((vuint8)( ( 1 + (vuint8)10 + (vuint8)4 ) / 9 ) + 1);
         ...
         case 4:
         {
            ...
            else
            {
               ...
               for ( i = 0 ; i < matchLen ; i++ )
               {
                  ...
                  outByte = window[ (vuint16)( ( matchPos + i ) & ( (vuint16)( 1 << (vuint8)10 ) - 1 ) ) ];
         ...
         default:
         {
            ...
            if (!(0)) ApplFblFatalError((0xA2u));
            break;
         }
      }


      if (!((winPos < (vuint16)( 1 << (vuint8)10 )))) ApplFblFatalError((0xE0u));
   }
}
# 502 "../../../../CBD2300515_D00/BSW/Cmpr/cmpr.c"
static vuint16 InputBits(LZSS_InputBuffer_T *pInBuf, vuint8 numBits)
{
   vuint32 rval;
   vuint8 byteCount;
   ...
   if (!((pInBuf->bitPos < 8))) ApplFblFatalError((0xA1u));

   if (!(((pInBuf->bitPos + numBits) <= 32))) ApplFblFatalError((0xA1u));
   ...
   if (!((byteCount < 4))) ApplFblFatalError((0xA1u));


   while (byteCount > 0)
   {

      if (!((pInBuf->length > 0))) ApplFblFatalError((0xA1u));
...
# 562 "../../../../CBD2300515_D00/BSW/Cmpr/cmpr.c"
