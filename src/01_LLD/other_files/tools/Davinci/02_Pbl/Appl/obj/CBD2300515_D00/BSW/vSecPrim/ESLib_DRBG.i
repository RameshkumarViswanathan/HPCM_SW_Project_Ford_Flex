# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_DRBG.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_DRBG.c"
# 32 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_DRBG.c"
...
# 33 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_DRBG.c" 2
...
# 34 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_DRBG.c" 2

# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actIDRBG.h" 1
# 59 "../../../../CBD2300515_D00/BSW/vSecPrim/actIDRBG.h"
typedef struct
{
  const actU8 * dataPtr;
...
{
  actU8 elements;
  actAesCtrDrbgSeedInputElementType input[(4u)];
} actDrbgSeedInputType;
# 83 "../../../../CBD2300515_D00/BSW/vSecPrim/actIDRBG.h"
# 1 "GenData/vSecPrim_MemMap.h" 1
# 84 "../../../../CBD2300515_D00/BSW/vSecPrim/actIDRBG.h" 2
# 105 "../../../../CBD2300515_D00/BSW/vSecPrim/actIDRBG.h"
actRETURNCODE actAesCtrDrbgInstantiation(
  actCTRDRBGSTRUCT * workSpace,
  const actDrbgSeedInputType * dataInput,
  boolean reseedFlag,
  void ( * watchdog)(void));
# 134 "../../../../CBD2300515_D00/BSW/vSecPrim/actIDRBG.h"
actRETURNCODE actAesCtrDrbgGenerate(
  actCTRDRBGSTRUCT * workSpace,
  actLengthType requestedLength,
  actU8 * outputBuffer,
  const actU8 * additionalInputPtr,
  actLengthType additionalInputLength,
  void ( * watchdog)(void));


# 1 "GenData/vSecPrim_MemMap.h" 1
# 144 "../../../../CBD2300515_D00/BSW/vSecPrim/actIDRBG.h" 2
# 36 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_DRBG.c" 2
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 42 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_DRBG.c" 2
# 59 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_DRBG.c"
static eslt_ErrorCode esl_CTRDRBG_checkMode(
  eslt_DRBGMode modeDRBG);
# 77 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_DRBG.c"
static eslt_ErrorCode esl_seedCTRDRBG_checkEntropySize(
  const eslt_WorkSpaceCTRDRBG * workSpace,
  eslt_Length entropyLength);
# 99 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_DRBG.c"
static eslt_ErrorCode esl_CTRDRBG_checkInputLengthNoDF(
  eslt_DRBGMode modeDRBG,
  eslt_Length inputLength);
# 119 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_DRBG.c"
static eslt_ErrorCode esl_seedCTRDRBG_checkInput(
  const eslt_WorkSpaceCTRDRBG * workSpace,
  eslt_Length entropyLength);
# 142 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_DRBG.c"
static eslt_ErrorCode esl_getBytesCTRDRBG_checkInput(
  eslt_DRBGMode modeDRBG,
  eslt_Length requestedLength,
  eslt_Length maxRequestLength,
  eslt_Length additionalInputLength);
# 175 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_DRBG.c"
static eslt_ErrorCode esl_initialSeed_CTRDRBG(
  eslt_WorkSpaceCTRDRBG * workSpace,
  const eslt_Byte * entropyPtr,
  eslt_Length entropyLength,
  const eslt_Byte * noncePtr,
  ...
  const eslt_Byte * personalizationStringPtr,
  eslt_Length personalizationStringLength);
# 206 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_DRBG.c"
static eslt_ErrorCode esl_reseed_CTRDRBG(
  eslt_WorkSpaceCTRDRBG * workSpace,
  const eslt_Byte * entropyPtr,
  eslt_Length entropyLength,
  const eslt_Byte * additionalInputPtr,
  eslt_Length additionalInputLength);
# 339 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_DRBG.c"
static eslt_ErrorCode esl_CTRDRBG_checkMode(
  eslt_DRBGMode modeDRBG)
{
  eslt_ErrorCode retVal = (0x0000u);


  if ( (((0x0Fu) & modeDRBG) != (0x01u)) &&
    (((0x0Fu) & modeDRBG) != (0x03u)))
  {
    retVal = (0x2000u + 0x0004u);
  }
  else
  {

    if ((((0xF0u) & modeDRBG) != (0x10u)) &&
      (((0xF0u) & modeDRBG) != (0x00u)))
    {
      retVal = (0x2000u + 0x0004u);
    }
  }
...
# 372 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_DRBG.c"
static eslt_ErrorCode esl_CTRDRBG_checkInputLengthNoDF(
  eslt_DRBGMode modeDRBG,
  eslt_Length inputLength)
{
  ...
  if (((0xF0u) & modeDRBG) == (0x00u))
  {


    if ((modeDRBG == (0x01u)) && (inputLength > 32u))
    {
      retVal = (0x2000u + 0x0032u);
    }
    else if ((modeDRBG == (0x03u)) && (inputLength > 48u))
    {
      retVal = (0x2000u + 0x0032u);
    }
    else
...
# 412 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_DRBG.c"
static eslt_ErrorCode esl_seedCTRDRBG_checkEntropySize(
  const eslt_WorkSpaceCTRDRBG * workSpace,
  eslt_Length entropyLength)
{
  ...
  if (((0x0Fu) & workSpace->wsDRBG.mode) == (0x01u))
  {
    requiredEntropyLengthDF = ((128u) >> 3u);
    requiredEntropyLengthNoDF = 32u;
  }
  else
  {
    requiredEntropyLengthDF = ((256u) >> 3u);
    requiredEntropyLengthNoDF = 48u;
  }



  if (((0xF0u) & workSpace->wsDRBG.mode) == (0x10u))
  {
    if (entropyLength < requiredEntropyLengthDF)
    {
      retVal = (0x2000u + 0x000Au);
    }
  }
  else
  {
...
# 460 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_DRBG.c"
static eslt_ErrorCode esl_seedCTRDRBG_checkInput(
  const eslt_WorkSpaceCTRDRBG * workSpace,
  eslt_Length entropyLength)
{
...
# 490 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_DRBG.c"
static eslt_ErrorCode esl_getBytesCTRDRBG_checkInput(
  eslt_DRBGMode modeDRBG,
  eslt_Length requestedLength,
  eslt_Length maxRequestLength,
...
# 526 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_DRBG.c"
static eslt_ErrorCode esl_reseed_CTRDRBG(
  eslt_WorkSpaceCTRDRBG * workSpace,
  const eslt_Byte * entropyPtr,
  eslt_Length entropyLength,
  ...
  eslt_Length additionalInputLength)
{
  ...
  dataInput.input[(0u)].dataPtr = entropyPtr;
  dataInput.input[(0u)].length = (actLengthType)entropyLength;
  dataInput.elements = 1u;


  if (additionalInputPtr != ((void *)0))
  {
    ...
    if (retVal == (0x0000u))
    {
      ...
      dataInput.input[(1u)].dataPtr = additionalInputPtr;
      dataInput.input[(1u)].length = (actLengthType)additionalInputLength;
      dataInput.elements++;
    }
  }
  ...
  if (retVal == (0x0000u))
  {
    ...
    actRetVal = actAesCtrDrbgInstantiation(&(workSpace->wsDRBG), &dataInput, 1u, workSpace->header.watchdog);
    ...
    {
      workSpace->wsDRBG.seedState = ((0x01u));
...
# 592 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_DRBG.c"
static eslt_ErrorCode esl_initialSeed_CTRDRBG(
  eslt_WorkSpaceCTRDRBG * workSpace,
  const eslt_Byte * entropyPtr,
  eslt_Length entropyLength,
  ...
  eslt_Length personalizationStringLength)
{
  ...
  if (((0xF0u) & workSpace->wsDRBG.mode) == (0x10u))
  {
    ...
    if (noncePtr != ((void *)0))
    {
      dataInput.input[(1u)].dataPtr = noncePtr;
      dataInput.input[(1u)].length = (actLengthType)nonceLength;
      dataInput.elements++;
    }
    else
    {
      retVal = (0x2000u + 0x0003u);
    }
  }

  if (retVal == (0x0000u))
  {
    if (personalizationStringPtr != ((void *)0))
    {
  ...
  if (retVal == (0x0000u))
  {
    ...
    actRetVal = actAesCtrDrbgInstantiation(&(workSpace->wsDRBG), &dataInput, 0u, workSpace->header.watchdog);
...
# 870 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_DRBG.c"
eslt_ErrorCode esl_initCTRDRBG(
  eslt_WorkSpaceCTRDRBG * workSpace,
  eslt_DRBGMode modeDRBG)
{
  ...
  else if ((retVal = esl_CheckWorkSpaceHeader(&workSpace->header, (sizeof(eslt_WorkSpaceCTRDRBG)))) != (0x0000u))
  {

  }
  else
  {
    workSpace->wsDRBG.seedState = ((0x00u));
    ...
    esl_SetWorkspaceStatus(&workSpace->header, (0x0180u));

  }

  return retVal;
}
# 930 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_DRBG.c"
eslt_ErrorCode esl_seedCTRDRBG(
  eslt_WorkSpaceCTRDRBG * workSpace,
  const eslt_Byte * entropyPtr,
  eslt_Length entropyLength,
  ...
  eslt_Length additionalInputLength)
{
  ...
  if ((workSpace == ((void *)0)) || (entropyPtr == ((void *)0)))
  {
    retVal = (0x2000u + 0x0003u);
  }
  else if ((retVal = esl_CheckWorkSpaceHeaderAndState(&workSpace->header, (sizeof(eslt_WorkSpaceCTRDRBG)), (0x0180u))) != (0x0000u))
  {

  }

  else if ((retVal = esl_seedCTRDRBG_checkInput(workSpace, entropyLength)) != (0x0000u))
  {
  ...
  else
  {
    ...
    if (workSpace->wsDRBG.seedState == ((0x00u)))
    {
...
# 992 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_DRBG.c"
eslt_ErrorCode esl_getBytesCTRDRBG(
  eslt_WorkSpaceCTRDRBG * workSpace,
  eslt_Length requestedLength,
  eslt_Byte * outputBuffer,
  ...
  eslt_Length additionalInputLength)
{
  ...
  if ((workSpace == ((void *)0)) || (outputBuffer == ((void *)0)))
  {
    retVal = (0x2000u + 0x0003u);
  }
  else if ((retVal = esl_CheckWorkSpaceHeaderAndState(&workSpace->header, (sizeof(eslt_WorkSpaceCTRDRBG)), (0x0180u))) != (0x0000u))
  ...
  else if ((retVal = esl_getBytesCTRDRBG_checkInput(workSpace->wsDRBG.mode, requestedLength, (1024u), additionalInputLength)) != (0x0000u))
  {

  }
  else if (workSpace->wsDRBG.seedState != ((0x01u)))
  {
    retVal = (0x2000u + 0x0031u);
  }
  else
  {
...
# 1064 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_DRBG.c"
eslt_ErrorCode esl_getStateCTRDRBG(
  const eslt_WorkSpaceCTRDRBG * workSpace,
  eslt_Byte * internalStateBuffer,
  eslt_Length * internalStateBufferLength,
  ...
  eslt_DRBGMode * modeDRBG)
{
  ...
  if ((workSpace == ((void *)0)) || (internalStateBuffer == ((void *)0)) || (internalStateBufferLength == ((void *)0)) ||
      (reseedCounter == ((void *)0)) || (seedStatus == ((void *)0)) || (modeDRBG == ((void *)0)))
  {
    retVal = (0x2000u + 0x0003u);
  }
  else
  {
    if ((workSpace->wsDRBG.mode & (0x0Fu)) == (0x01u))
    {
      localSeedLength = 32u;
      localKeyLength = 16u;
    }
    ...
    else
    {
      ...
      if (workSpace->wsDRBG.seedState == ((0x00u)))
      {
        (VStdLib_MemSet(((internalStateBuffer)), 0, ((localSeedLength))));
        *reseedCounter = 0u;
      }
      else
      {
        (VStdLib_MemCpy((internalStateBuffer), (workSpace->wsDRBG.key), (localKeyLength)));
        (VStdLib_MemCpy((&internalStateBuffer[localKeyLength]), (workSpace->wsDRBG.variable), (16u)));
...
# 1137 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_DRBG.c"
eslt_ErrorCode esl_restoreStateCTRDRBG(
  eslt_WorkSpaceCTRDRBG * workSpace,
  const eslt_Byte * internalStateBuffer,
  eslt_Length internalStateBufferLength,
  ...
  eslt_DRBGMode modeDRBG)
{
  ...
  if ((workSpace == ((void *)0)) || (internalStateBuffer == ((void *)0)))
  {
    retVal = (0x2000u + 0x0003u);
  }
  else
  {
    ...
    else
    {
      ...
      (VStdLib_MemCpy((workSpace->wsDRBG.key), (internalStateBuffer), (localKeyLength)));
      (VStdLib_MemCpy((workSpace->wsDRBG.variable), (&internalStateBuffer[localKeyLength]), (16u)));
...
# 1483 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_DRBG.c"
# 1 "GenData/vSecPrim_MemMap.h" 1
# 1484 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_DRBG.c" 2
