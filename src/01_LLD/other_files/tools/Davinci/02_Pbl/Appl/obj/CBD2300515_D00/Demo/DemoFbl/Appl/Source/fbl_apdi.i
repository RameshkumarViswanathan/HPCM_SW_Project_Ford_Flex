# 1 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/fbl_apdi.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/fbl_apdi.c"
# 108 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/fbl_apdi.c"
...
# 109 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/fbl_apdi.c" 2
# 138 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/fbl_apdi.c"
 tFblDidTable const fblDidTable[] =
{
   {

      ((vuint16) 0xF111u), 24u, fblCommonData.EcuCoreAssemblyNumber
   },
   {

      ((vuint16) 0xF113u), 24u, fblCommonData.EcuDeliveryAssemblyNumber
   },
   {

      ((vuint16) 0xF18Cu), 16u, fblCommonData.EcuSerialNumber
   },
   {

      ((vuint16) 0xF180u), 25u, 0
   },
   {

      ((vuint16) 0xF17Cu), 11u, 0
   },
   {

      ((vuint16) 0xF17Fu), 8u, fblCommonData.FordElectronicSerialNumber
   }

   ,{

      ((vuint16) 0xD070u), 2u, 0
   }

   ,{

      ((vuint16) 0xD071u), 2134u, 0
   }

   ,{

       ((vuint16) 0xD028u), 1u, 0
    }
   ,{

       ((vuint16) 0xD03Fu), 32u, 0
    }

};

 vuint8 const kNrOfDids = sizeof(fblDidTable) / sizeof(fblDidTable[0]);
 ...
 static vuint8 const kFblDerKeyPart1[0x21u] = {
 ...
 static vuint8 const kFblDerKeyPart2[0x02u] = {
   0x02u, 0x03u
};
# 213 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/fbl_apdi.c"
 static SecM_EntropyPoolType secEntropyPool;
 static vuint8 secEntropyInput[2];
 static SecM_SeedKeyContextType secSeedContext;
 static SecM_SeedStorageType secSeedData;


 static SecM_SeedType seed;
# 232 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/fbl_apdi.c"
static SecM_SizeType ApplFblReadBootloaderROM( SecM_AddrType address, SecM_RamDataType buffer, SecM_SizeType length);
# 469 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/fbl_apdi.c"
vuint8 ApplFblReadDataByIdentifier( vuint8 * pbDiagData, tTpDataType diagReqDataLen )
{
   vuint16 reqDid, dataIdx;
   vuint8 returnCode;
# 483 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/fbl_apdi.c"
   returnCode = 0x00u;

   {
      ...
      switch (reqDid)
      {
         ...
         case ((vuint16) 0xD070u):
         {
            if (SecM_GenerateSeed(&seed) == 0x00u)
            {

               (void)FblOwnMemcpy( (void *)(&pbDiagData[2u]), (const void *)(seed.data), (unsigned int)(2u));
            }
            else
            {
               returnCode = 0x01u;
         ...
         case ((vuint16) 0xD071u):
         {

            (void)FblOwnMemcpy( (void *)(&pbDiagData[2u]), (const void *)(tokenBuffer), (unsigned int)(1899u));


            for (dataIdx = 1899u; dataIdx < diagReqDataLen; dataIdx++)
            {
         ...
         case ((vuint16) 0xD028u):
         {

            pbDiagData[2] = (applSignValidState);
            break;
         }

         case ((vuint16) 0xD03Fu):
         {
            ...
            pubKey.shared.size = sizeof(SecM_RsaDevelopmentMod);
            pubKey.individual.size = sizeof(SecM_RsaDevelopmentExp);

            if (ApplFblReadVerificationKey(&pubKey) != 0x00u)
            {
            ...
            else
            {
               ...
               verifySegmentInfo[0u].targetAddress = (SecM_AddrType)kFblDerKeyPart1;
               ...
               verifySegmentInfo[1u].targetAddress = (SecM_AddrType)pubKey.shared.data;
               verifySegmentInfo[1u].transferredAddress = verifySegmentInfo[1u].targetAddress;
               verifySegmentInfo[1u].length = pubKey.shared.size;
               verifySegmentInfo[2u].targetAddress = (SecM_AddrType)kFblDerKeyPart2;
               ...
               verifySegmentInfo[3u].targetAddress = (SecM_AddrType)&pubKey.individual.data[pubKey.individual.size - 3u];
               ...
               secStatus = SecM_VerificationClassDDD_Sha256(&verifyParam);
...
# 629 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/fbl_apdi.c"
vuint8 ApplFblWriteDataByIdentifier( vuint8 * pbDiagData, tTpDataType diagReqDataLen )
{
   vuint16 reqDid;
   vuint8 returnCode;
# 643 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/fbl_apdi.c"
   reqDid = (vuint16)(((vuint16)pbDiagData[0u] << 8u) | (pbDiagData[1u]));

   switch (reqDid)
   {

      case ((vuint16) 0xF18Cu):
      {
         if (diagReqDataLen != 18u)
         {
         ...
         {
            if (((vuint8) 0x01u) != diagCurrentSecLvl)
            {
               (diagErrorCode = (((vuint8) 0x33u)));
               returnCode = 0x01u;
            }
            else
            {
...
# 702 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/fbl_apdi.c"
tFblMemStatus ApplFblMemConditionCheck( void )
{
...
vuint8 ApplFblSecurityInit( void )
{
   ...
   secEntropyPool.context = &secSeedContext;
   secSeedContext.wdTriggerFct = (FL_WDTriggerFctType)FblRealTimeSupport;
   secSeedContext.workspace.data = ((SecM_WorkspacePtrType)0);
   secSeedContext.workspace.size = 0u;
# 761 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/fbl_apdi.c"
   return 0x00u;
}
...
# 2905 "Include/MemMap.h"
#pragma section ".RamCodeCoreSection" ax
# 766 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/fbl_apdi.c" 2
...
# 793 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/fbl_apdi.c"
   return 0x00u;
}
...
# 2914 "Include/MemMap.h"
#pragma section
# 797 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/fbl_apdi.c" 2
# 805 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/fbl_apdi.c"
vuint8 ApplFblSecuritySeed( void )
{
   vuint8 retVal;
   vuint8 seedLength;
# 817 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/fbl_apdi.c"
   retVal = 0x00u;



   seedLength = (0x00000010u);
   ...
   {
# 838 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/fbl_apdi.c"
      {



         while (secEntropyPool.fillLevel < 0x00000020u)
         {
         ...
         if (0x00u != SecM_GenerateSeed(&seed))
         {
            retVal = 0x01u;
         }
      }
   ...
   if (0x00u == retVal)
   {
...

      {
         ...
         (void)FblOwnMemcpy( (void *)(&DiagBuffer[((tCwDataLengthType) (((tCwDataLengthType) (((tCwDataLengthType) 0x00u)+0x01u))+0x01u))]), (const void *)((const void *)secSeedData), (unsigned int)(seedLength));
...
# 891 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/fbl_apdi.c"
   return retVal;
}
...
{
   vuint8 result;
# 913 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/fbl_apdi.c"
   SecM_KeyType securityKey;
   SecM_ComputeKeySymParamType seedKeyContext;
   vuint8 securityBytes[(0x0000000Cu)];
   const vuint8 securityBytesZero[(0x0000000Cu)] = { 0u };
   ...
   result = 0x01u;
# 941 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/fbl_apdi.c"
   {


      ApplFblReadSecurityBytes(securityBytes, (0x0000000Cu));


      seedKeyContext.secretKey.data = securityBytes;
      seedKeyContext.secretKey.size = (0x0000000Cu);
      seedKeyContext.common.workspace.size = 0u;
      seedKeyContext.common.wdTriggerFct = (FL_WDTriggerFctType)FblRealTimeSupport;


      securityKey.data = &DiagBuffer[((tCwDataLengthType) (((tCwDataLengthType) (((tCwDataLengthType) 0x00u)+0x01u))+0x01u))];
      securityKey.context = &seedKeyContext;


      if (SecM_CompareKey(securityKey, seed) == 0x00u)
      {

         result = 0x00u;
      }

      (void)FblOwnMemcpy( (void *)(securityBytes), (const void *)(securityBytesZero), (unsigned int)(sizeof(securityBytes)));
# 973 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/fbl_apdi.c"
   }

   return result;
}
# 989 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/fbl_apdi.c"
static SecM_SizeType ApplFblReadBootloaderROM( SecM_AddrType address, SecM_RamDataType buffer, SecM_SizeType length )
{
   SecM_SizeType validReadLength = 0;

   if(0x00u == FlashDriver_RReadSync(buffer, length, address))
   {
...
# 1009 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/fbl_apdi.c"
void ApplFblTokenRevertKey( const vuint8 * tokenBuf, vuint16 tokenLength )
{
...
# 1024 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/fbl_apdi.c"
void ApplFblTokenUseDevPermKey( const vuint8 * tokenBuf, vuint16 tokenLength )
{
...
# 1039 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/fbl_apdi.c"
void ApplFblTokenUseDevTempKey( const vuint8 * tokenBuf, vuint16 tokenLength )
{
...
# 1055 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/fbl_apdi.c"
tTokenHdlResult ApplFblTokenUseDevDateKey( const vuint8 * tokenBuf, vuint16 tokenLength )
{
...
# 1072 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/fbl_apdi.c"
tTokenHdlResult ApplFblTokenUseDevIgniKey( const vuint8 * tokenBuf, vuint16 tokenLength )
{
...
# 1088 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/fbl_apdi.c"
void ApplFblTokenProgKey( const vuint8 * tokenBuf, vuint16 tokenLength )
{
...
# 1120 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/fbl_apdi.c"
void ApplFblInitErrStatus( void )
{
