# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actGCM.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actGCM.c"
# 38 "../../../../CBD2300515_D00/BSW/vSecPrim/actGCM.c"
...
# 39 "../../../../CBD2300515_D00/BSW/vSecPrim/actGCM.c" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actIGCM.h" 1
# 41 "../../../../CBD2300515_D00/BSW/vSecPrim/actIGCM.h"
...
# 42 "../../../../CBD2300515_D00/BSW/vSecPrim/actIGCM.h" 2
...
# 43 "../../../../CBD2300515_D00/BSW/vSecPrim/actIGCM.h" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actIGHash.h" 1
# 60 "../../../../CBD2300515_D00/BSW/vSecPrim/actIGHash.h"
# 1 "GenData/vSecPrim_MemMap.h" 1
# 61 "../../../../CBD2300515_D00/BSW/vSecPrim/actIGHash.h" 2
# 81 "../../../../CBD2300515_D00/BSW/vSecPrim/actIGHash.h"
  actRETURNCODE actGHashReset(actGHASHSTRUCT * info);
# 98 "../../../../CBD2300515_D00/BSW/vSecPrim/actIGHash.h"
actRETURNCODE actGHashInit (
   actGHASHSTRUCT * info,
   const actU8 * H,
   void ( * watchdog)(void));
# 123 "../../../../CBD2300515_D00/BSW/vSecPrim/actIGHash.h"
actRETURNCODE actGHashUpdate (
   actGHASHSTRUCT * info,
   const actU8 * X,
   actLengthType X_len,
   void ( * watchdog)(void));
# 145 "../../../../CBD2300515_D00/BSW/vSecPrim/actIGHash.h"
actRETURNCODE actGHashZeroPad (
   actGHASHSTRUCT * info,
   void ( * watchdog)(void));
# 167 "../../../../CBD2300515_D00/BSW/vSecPrim/actIGHash.h"
actRETURNCODE actGHashFinalize (
   actGHASHSTRUCT * info,
   actU8 hash[(16u)],
   void ( * watchdog)(void));
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 178 "../../../../CBD2300515_D00/BSW/vSecPrim/actIGHash.h" 2
# 44 "../../../../CBD2300515_D00/BSW/vSecPrim/actIGCM.h" 2
# 68 "../../../../CBD2300515_D00/BSW/vSecPrim/actIGCM.h"
# 1 "GenData/vSecPrim_MemMap.h" 1
# 69 "../../../../CBD2300515_D00/BSW/vSecPrim/actIGCM.h" 2
# 94 "../../../../CBD2300515_D00/BSW/vSecPrim/actIGCM.h"
actRETURNCODE actGCMInit (
   actGCMSTRUCT * info,
   const actU8 * key,
   ...
   void ( * watchdog)(void));
# 127 "../../../../CBD2300515_D00/BSW/vSecPrim/actIGCM.h"
actRETURNCODE actGCMTransform (
   actGCMSTRUCT * info,
   const actU8 * input,
   ...
   void ( * watchdog)(void));
# 158 "../../../../CBD2300515_D00/BSW/vSecPrim/actIGCM.h"
actRETURNCODE actGCMEncryptUpdate (
   actGCMSTRUCT * info,
   const actU8 * X,
   ...
   actLengthType * bytes_out,
   void ( * watchdog)(void));
# 188 "../../../../CBD2300515_D00/BSW/vSecPrim/actIGCM.h"
actRETURNCODE actGCMDecryptUpdate (
   actGCMSTRUCT * info,
   const actU8 * X,
   const actLengthType X_len,
   actU8 * output,
   actLengthType * bytes_out,
   void ( * watchdog)(void));
# 214 "../../../../CBD2300515_D00/BSW/vSecPrim/actIGCM.h"
actRETURNCODE actGCMTriggerState (
   actGCMSTRUCT * info,
   void ( * watchdog)(void));
# 235 "../../../../CBD2300515_D00/BSW/vSecPrim/actIGCM.h"
actRETURNCODE actGMACFinalize (
   actGCMSTRUCT * info,
   actU8 * tag,
   void ( * watchdog)(void));
# 260 "../../../../CBD2300515_D00/BSW/vSecPrim/actIGCM.h"
actRETURNCODE actGCMEncryptFinalize (
   actGCMSTRUCT * info,
   actU8 * output,
   actLengthType * bytes_out,
   actU8 * tag,
   void ( * watchdog)(void));
# 287 "../../../../CBD2300515_D00/BSW/vSecPrim/actIGCM.h"
actRETURNCODE actGCMDecryptFinalize (
   actGCMSTRUCT * info,
   actU8 * output,
   actLengthType * bytes_out,
   actU8 * tag,
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 300 "../../../../CBD2300515_D00/BSW/vSecPrim/actIGCM.h" 2
# 40 "../../../../CBD2300515_D00/BSW/vSecPrim/actGCM.c" 2
...
# 43 "../../../../CBD2300515_D00/BSW/vSecPrim/actGCM.c" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actWatchdog.h" 1
# 44 "../../../../CBD2300515_D00/BSW/vSecPrim/actGCM.c" 2
