# 1 "../../../../CBD2300515_D00/BSW/Fbl/fbl_wd.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/Fbl/fbl_wd.c"
# 39 "../../../../CBD2300515_D00/BSW/Fbl/fbl_wd.c"
...
# 40 "../../../../CBD2300515_D00/BSW/Fbl/fbl_wd.c" 2
# 86 "../../../../CBD2300515_D00/BSW/Fbl/fbl_wd.c"
# 1 "Include/MemMap.h" 1
# 87 "../../../../CBD2300515_D00/BSW/Fbl/fbl_wd.c" 2
 ...
 tWdTime WDTimer;
# 108 "../../../../CBD2300515_D00/BSW/Fbl/fbl_wd.c"
# 1 "Include/MemMap.h" 1
# 109 "../../../../CBD2300515_D00/BSW/Fbl/fbl_wd.c" 2
...
# 1 "Include/MemMap.h" 1
# 116 "../../../../CBD2300515_D00/BSW/Fbl/fbl_wd.c" 2
...
# 1 "Include/MemMap.h" 1
# 135 "../../../../CBD2300515_D00/BSW/Fbl/fbl_wd.c" 2


# 1 "Include/MemMap.h" 1
# 4026 "Include/MemMap.h"
#pragma section ".RamCodeCoreSection" ax
# 138 "../../../../CBD2300515_D00/BSW/Fbl/fbl_wd.c" 2
# 148 "../../../../CBD2300515_D00/BSW/Fbl/fbl_wd.c"
void FblLookForWatchdogVoid( void )
{
...
# 4033 "Include/MemMap.h"
#pragma section
# 154 "../../../../CBD2300515_D00/BSW/Fbl/fbl_wd.c" 2


# 1 "Include/MemMap.h" 1
# 4026 "Include/MemMap.h"
#pragma section ".RamCodeCoreSection" ax
# 157 "../../../../CBD2300515_D00/BSW/Fbl/fbl_wd.c" 2
# 167 "../../../../CBD2300515_D00/BSW/Fbl/fbl_wd.c"
vuint8 FblLookForWatchdog( void )
{
   vuint8 retValue = 0x00u;

   if ((WDInitFlag == 0x01u))
   {
      if (((vuint8)(((*((volatile vuint32 *)((0xF0001000u) + (0x3Cu + ((0u) * 0x100u))))) & 0x00000002u) & 0xFFu)) != 0x00u)
      {
         { fblCurrentTimer = (*((volatile vuint32 *)((0xF0001000u) + (0x10u + ((0u) * 0x100u) + ((0) * 0x04u))))); fblCurrentCmpValue = (*((volatile vuint32 *)((0xF0001000u) + (0x30u + ((0u) * 0x100u) + ((0) * 0x04u))))); if ( ((fblCurrentTimer > fblCurrentCmpValue) && (fblCurrentTimer <= (fblCurrentCmpValue + (99999 - 50u)))) || ((fblCurrentCmpValue > (0xFFFFFFFFu - (99999 + 50u))) && (fblCurrentTimer > fblCurrentCmpValue)) || ((fblCurrentCmpValue > (0xFFFFFFFFu - (99999 + 50u))) && (fblCurrentTimer <= (fblCurrentCmpValue + (99999 - 50u)))) ) { (*((volatile vuint32 *)((0xF0001000u) + (0x30u + ((0u) * 0x100u) + ((0) * 0x04u))))) += 99999; } else { (*((volatile vuint32 *)((0xF0001000u) + (0x30u + ((0u) * 0x100u) + ((0) * 0x04u))))) = (*((volatile vuint32 *)((0xF0001000u) + (0x10u + ((0u) * 0x100u) + ((0) * 0x04u))))) + 99999; } (*((volatile vuint32 *)((0xF0001000u) + (0x40u + ((0u) * 0x100u))))) |= 0x00000001u; };
         retValue |= 0x02u;

         if (P2Timer > 0x00u)
         {
            P2Timer--;
            if (P2Timer < ((5000u / 1u)/2u))
            {
               { if ((((fblStates)[((((((((((((((((((0u) + 1u) + 1u) + 1u) + 1u) + 1u) + 1u) + 1u) + 1u) + 1u) + 1u) + 1u) + 1u) + 1u) + 1u))) / 32u)] & ((tStateBitmap)(1uL << ((((((((((((((((((0u) + 1u) + 1u) + 1u) + 1u) + 1u) + 1u) + 1u) + 1u) + 1u) + 1u) + 1u) + 1u) + 1u) + 1u))) % 32u)))) == ((tStateBitmap)(1uL << ((((((((((((((((((0u) + 1u) + 1u) + 1u) + 1u) + 1u) + 1u) + 1u) + 1u) + 1u) + 1u) + 1u) + 1u) + 1u) + 1u))) % 32u))))) { FblCwRetransmitRP(); (P2Timer = ((5000u / 1u))); } };
            }
         }
...
# 215 "../../../../CBD2300515_D00/BSW/Fbl/fbl_wd.c"
      }
   }
...
# 233 "../../../../CBD2300515_D00/BSW/Fbl/fbl_wd.c"
   return retValue;
}
...
# 4033 "Include/MemMap.h"
#pragma section
# 237 "../../../../CBD2300515_D00/BSW/Fbl/fbl_wd.c" 2
