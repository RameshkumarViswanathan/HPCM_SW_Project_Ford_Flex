# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS.c"
# 38 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS.c"
...
# 39 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS.c" 2
...
# 40 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS.c" 2
...
# 41 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS.c" 2
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 47 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS.c" 2
# 62 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS.c"
eslt_ErrorCode esl_calcSaltedHashRSASHA1_PSS(
eslt_WorkSpaceSHA1 * wsHash,
eslt_Length saltSize,
const eslt_Byte * salt,
const eslt_Byte * messageDigest,
eslt_Byte * saltedHash)
{
  ...
  if ((wsHash == ((void *)0)) || (saltedHash == ((void *)0)))
  {
  ...
  else
  {
    ...
    returnValue = esl_calcSaltedHashRSA_PSS(&wsHashUnion, saltSize,
      salt, messageDigest, 20u, saltedHash, (0x00u));
...
# 109 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS.c"
eslt_ErrorCode esl_calcSaltedHashRSASHA256_PSS(
  eslt_WorkSpaceSHA256 * wsHash,
  eslt_Length saltSize,
  const eslt_Byte * salt,
  const eslt_Byte * messageDigest,
  eslt_Byte * saltedHash)
{
  ...
  if ((wsHash == ((void *)0)) || (salt == ((void *)0)) || (messageDigest == ((void *)0)) || (saltedHash == ((void *)0)))
  {
    returnValue = (0x2000u + 0x0003u);
  }
  ...
  else
  {
    ...
    returnValue = esl_calcSaltedHashRSA_PSS(&wsHashUnion, saltSize,
      salt, messageDigest, 32u, saltedHash, (0x02u));
...
# 194 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS.c"
# 1 "GenData/vSecPrim_MemMap.h" 1
# 195 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS.c" 2
