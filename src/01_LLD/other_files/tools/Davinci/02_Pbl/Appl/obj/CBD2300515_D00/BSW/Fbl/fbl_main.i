# 1 "../../../../CBD2300515_D00/BSW/Fbl/fbl_main.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/Fbl/fbl_main.c"
# 48 "../../../../CBD2300515_D00/BSW/Fbl/fbl_main.c"
...
# 49 "../../../../CBD2300515_D00/BSW/Fbl/fbl_main.c" 2
...
# 51 "../../../../CBD2300515_D00/BSW/Fbl/fbl_main.c" 2
# 118 "../../../../CBD2300515_D00/BSW/Fbl/fbl_main.c"
# 1 "Include/MemMap.h" 1
# 3662 "Include/MemMap.h"
#pragma section ".FblHeaderSection" a
# 119 "../../../../CBD2300515_D00/BSW/Fbl/fbl_main.c" 2

 tFblHeader const FblHeader =
{
   0x58462918u
...
# 3669 "Include/MemMap.h"
#pragma section
# 139 "../../../../CBD2300515_D00/BSW/Fbl/fbl_main.c" 2


# 1 "Include/MemMap.h" 1
# 142 "../../../../CBD2300515_D00/BSW/Fbl/fbl_main.c" 2





 static vuint16 startMessageDelay;


 tFblStateBitmap fblMainStates[((8u - 1u) / 32u) + 1u];


# 1 "Include/MemMap.h" 1
# 154 "../../../../CBD2300515_D00/BSW/Fbl/fbl_main.c" 2
...
# 1 "Include/MemMap.h" 1
# 161 "../../../../CBD2300515_D00/BSW/Fbl/fbl_main.c" 2

static void FblCheckProgrammingRequest(void);

static void FblPostProcessStartMsg( vuint32 startMsgResult );
...
# 185 "../../../../CBD2300515_D00/BSW/Fbl/fbl_main.c"
static void FblCheckProgrammingRequest(void)
{
   ...
   switch (ApplFblExtProgRequest())
   {
      case 0x00u:
      {
         ((fblMainStates)[((1u) / 32u)] |= ((tFblStateBitmap)(1ul << ((1u) % 32u))));
         break;
      }
      ...
      case 0x10u:
      {
         ...
         { ((fblMainStates)[((5u) / 32u)] |= ((tFblStateBitmap)(1ul << ((5u) % 32u)))); startMessageDelay = 20u + 1u; };
         break;
      }
# 211 "../../../../CBD2300515_D00/BSW/Fbl/fbl_main.c"
      case 0xFFu:
      default:
      {

         ((fblMainStates)[((0u) / 32u)] |= ((tFblStateBitmap)(1ul << ((0u) % 32u))));
         break;
      }
   }
}
# 230 "../../../../CBD2300515_D00/BSW/Fbl/fbl_main.c"
static void FblPostProcessStartMsg(vuint32 startMsgResult)
{
   switch (startMsgResult)
   {
      case 0u:
      {
         ((fblMainStates)[((6u) / 32u)] |= ((tFblStateBitmap)(1ul << ((6u) % 32u))));
         break;
      }
      case 1u:
      {
         ...
         while (!(((fblMainStates)[(((7u)) / 32u)] & ((tFblStateBitmap)(1ul << (((7u)) % 32u)))) == ((tFblStateBitmap)(1ul << (((7u)) % 32u)))))
         {
            FblLookForWatchdogVoid();
         }

         FblDeinit();
         ((( tFblBmHeader const *)(0xA001FFE0u))->pApplStartFct)();
...
# 271 "../../../../CBD2300515_D00/BSW/Fbl/fbl_main.c"
static void FblInitPowerOn(void)
{
   vuint32 i;
# 284 "../../../../CBD2300515_D00/BSW/Fbl/fbl_main.c"
   if (!((( tFblHeader const *)(&FblHeader)) == (( tFblHeader const *)(0xA0020000u)))) ApplFblFatalError((0x50u));
   ...
   FblLbtInitPowerOn();
# 314 "../../../../CBD2300515_D00/BSW/Fbl/fbl_main.c"
}
...
static void FblInit( vuint8 initposition )
{
   ...
   ApplFblStartup(0x00u | initposition);
   ...
   ApplFblStartup(0x80u | initposition);
}
...
# 403 "../../../../CBD2300515_D00/BSW/Fbl/fbl_main.c"
static void FblRepeatCheckForStartMsg( void )
{

   (fblCwStateStartMsg |= 0x01u);
   while ((((fblMainStates)[(((5u)) / 32u)] & ((tFblStateBitmap)(1ul << (((5u)) % 32u)))) == ((tFblStateBitmap)(1ul << (((5u)) % 32u)))))
   {

      if ((FblLookForWatchdog() & 0x02u) == 0x02u)
      {
         ...
         if (startMessageDelay == 0u)
         {
            ...
            ((fblMainStates)[((5u) / 32u)] &= ((vuint32)((((tFblStateBitmap)(1ul << ((5u) % 32u)))) ^ ((vuint32)0xFFFFFFFFul))));
            FblPostProcessStartMsg(1u);
         }
      }

      if (FblCwCheckStartMessage() == 0x00u)
      {

         ((fblMainStates)[((5u) / 32u)] &= ((vuint32)((((tFblStateBitmap)(1ul << ((5u) % 32u)))) ^ ((vuint32)0xFFFFFFFFul))));
         FblPostProcessStartMsg(0u);
      }
   }

   (fblCwStateStartMsg &= ((vuint8) ((0x01u) ^ ((vuint8)0xFFu))));
}
# 443 "../../../../CBD2300515_D00/BSW/Fbl/fbl_main.c"
static void FblRepeat( void )
{
...
# 488 "../../../../CBD2300515_D00/BSW/Fbl/fbl_main.c"
void FblMain( void )
{
  FblMainInternal();
}
# 500 "../../../../CBD2300515_D00/BSW/Fbl/fbl_main.c"
void FblMainInternal( void )
{
...
# 1 "Include/MemMap.h" 1
# 532 "../../../../CBD2300515_D00/BSW/Fbl/fbl_main.c" 2
