# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actUtilities.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actUtilities.c"
# 35 "../../../../CBD2300515_D00/BSW/vSecPrim/actUtilities.c"
...
# 36 "../../../../CBD2300515_D00/BSW/vSecPrim/actUtilities.c" 2




# 1 "GenData/vSecPrim_MemMap.h" 1
# 41 "../../../../CBD2300515_D00/BSW/vSecPrim/actUtilities.c" 2
# 54 "../../../../CBD2300515_D00/BSW/vSecPrim/actUtilities.c"
 void actMemSet(void * dest, actU8 fill, actLengthType count)
{
  actU8 * dest_tmp = (actU8 * )dest;
...
# 73 "../../../../CBD2300515_D00/BSW/vSecPrim/actUtilities.c"
 void actMemcpy(void * dest, const void * src, actU32 count)
{
  actU8 * dest_tmp = (actU8 * )dest;
  const actU8 * src_tmp = (const actU8 * )src;
  actU32 i = count;
  while (i > 0u)
  {
    --i;
...
# 93 "../../../../CBD2300515_D00/BSW/vSecPrim/actUtilities.c"
 void actMemcpy_ROM(void * dest, const void * src, actLengthType count)
{
  actU8 * dest_tmp = (actU8 * )dest;
  const actU8 * src_tmp = (const actU8 * )src;
...
# 113 "../../../../CBD2300515_D00/BSW/vSecPrim/actUtilities.c"
 void actMemcpy_ROMRAM(void * dest, const actU8 * src, actLengthType count)
{
  actU8 * dest_tmp = (actU8 * )dest;
  actLengthType i = count;
...
# 132 "../../../../CBD2300515_D00/BSW/vSecPrim/actUtilities.c"
void actWatchdogTriggerFunction( void ( * watchdog)(void))
{
  if (watchdog != ((void *)0))
  {
...
# 149 "../../../../CBD2300515_D00/BSW/vSecPrim/actUtilities.c"
 actU8 actMemcmp(const void * buf1, const void * buf2, actLengthType count)
{
  const actU8 * buf1_tmp = (const actU8 * )buf1;
  const actU8 * buf2_tmp = (const actU8 * )buf2;
  actLengthType i;
  boolean isEqual = 1u;

  for (i = 0; i < count; ++i)
  {
    isEqual &= (buf1_tmp[i] == buf2_tmp[i]) ? (1u) : (0u);
  }

  return isEqual;
}
# 173 "../../../../CBD2300515_D00/BSW/vSecPrim/actUtilities.c"
 actU8 actMemcmp_ROM(const actU8 * buf1, const actU8 * buf2, actLengthType count)
{
  actLengthType i;
  boolean isEqual = 1u;
  ...
  for (i = 0; i < count; ++i)
  {
    isEqual &= (((*(&buf1[i])) == (*(&buf2[i])))) ? (1u) : (0u);
  }

  return isEqual;
}
# 195 "../../../../CBD2300515_D00/BSW/vSecPrim/actUtilities.c"
 actU8 actMemcmp_ROMRAM(const void * buf1, const actU8 * buf2, actLengthType count)
{
  const actU8 * buf1_tmp = (const actU8 * )buf1;
  actLengthType i;
  ...
  for (i = 0; i < count; ++i)
  {
    isEqual &= (buf1_tmp[i] == (*(&buf2[i]))) ? (1u) : (0u);
  }

  return isEqual;
}
# 217 "../../../../CBD2300515_D00/BSW/vSecPrim/actUtilities.c"
 void actXOR(void * buf1, const void * buf2, actU32 count)
{
  actU8 * buf1_tmp = (actU8 * )buf1;
  const actU8 * buf2_tmp = (const actU8 * )buf2;
  actU32 i = count;
  while (i > 0u)
  {
...
# 239 "../../../../CBD2300515_D00/BSW/vSecPrim/actUtilities.c"
 actU8 actAddBE(actU8 * tgt, const actU8 * src, const actU32 length, const actU8 carry)
{
  actU8 cy = carry;
  actU16 tmp;
...
# 268 "../../../../CBD2300515_D00/BSW/vSecPrim/actUtilities.c"
 actU8 actLEtoU8(const actU8 * src)
{
  return (*src);
}
# 281 "../../../../CBD2300515_D00/BSW/vSecPrim/actUtilities.c"
 void actU8toLE(actU8 * tgt, const actU8 in)
{
  *tgt = (actU8)(in);
}
# 294 "../../../../CBD2300515_D00/BSW/vSecPrim/actUtilities.c"
 actU16 actLEtoU16(const actU8 * src)
{
  register actU16 u16;
...
# 312 "../../../../CBD2300515_D00/BSW/vSecPrim/actUtilities.c"
 void actU16toLE(
  actU8 * tgt,
  const actU16 src)
{
...
# 328 "../../../../CBD2300515_D00/BSW/vSecPrim/actUtilities.c"
 void actCpyLEtoU16(
  actU16 * tgt,
  const actU8 * src,
  const actU32 length)
...
# 349 "../../../../CBD2300515_D00/BSW/vSecPrim/actUtilities.c"
 void actCpyU16toLE(
  actU8 * tgt,
  const actU16 * src,
  const actU32 length)
...
# 370 "../../../../CBD2300515_D00/BSW/vSecPrim/actUtilities.c"
 actU32 actBEtoU32(const actU8 * src)
{
  register actU32 u32;
...
# 390 "../../../../CBD2300515_D00/BSW/vSecPrim/actUtilities.c"
 actU32 actLEtoU32(const actU8 * src)
{
  register actU32 u32;
...
# 410 "../../../../CBD2300515_D00/BSW/vSecPrim/actUtilities.c"
 void actU32toBE(actU8 * tgt, const actU32 src)
{
  tgt[0] = (actU8)(src >> 24);
  tgt[1] = (actU8)(src >> 16);
...
# 427 "../../../../CBD2300515_D00/BSW/vSecPrim/actUtilities.c"
 void actU32toLE(
  actU8 * tgt,
  const actU32 src)
{
...
# 445 "../../../../CBD2300515_D00/BSW/vSecPrim/actUtilities.c"
 void actCpyBEtoU32(
  actU32 * tgt,
  const actU8 * src,
  const actU32 length)
...
# 467 "../../../../CBD2300515_D00/BSW/vSecPrim/actUtilities.c"
 void actCpyLEtoU32(
  actU32 * tgt,
  const actU8 * src,
  const actU32 length)
...
# 488 "../../../../CBD2300515_D00/BSW/vSecPrim/actUtilities.c"
 void actCpyU32toBE(
  actU8 * tgt,
  const actU32 * src,
  const actU32 length)
...
# 509 "../../../../CBD2300515_D00/BSW/vSecPrim/actUtilities.c"
 void actCpyU32toLE(
  actU8 * tgt,
  const actU32 * src,
  const actU32 length)
...
# 531 "../../../../CBD2300515_D00/BSW/vSecPrim/actUtilities.c"
 actU64 actBEtoU64(const actU8 * src)
{
  register actU64 u64;
...
# 555 "../../../../CBD2300515_D00/BSW/vSecPrim/actUtilities.c"
 void actU64toBE(
  actU8 * tgt,
  const actU64 src)
{
...
# 577 "../../../../CBD2300515_D00/BSW/vSecPrim/actUtilities.c"
 void actCpyBEtoU64(
  actU64 * tgt,
  const actU8 * src,
  const actU32 length)
...
# 598 "../../../../CBD2300515_D00/BSW/vSecPrim/actUtilities.c"
 void actCpyU64toBE(
  actU8 * tgt,
  const actU64 * src,
  const actU32 length)
...
# 619 "../../../../CBD2300515_D00/BSW/vSecPrim/actUtilities.c"
 actU64 actLEtoU64(const actU8 * src)
{
  register actU64 u64;
...
# 643 "../../../../CBD2300515_D00/BSW/vSecPrim/actUtilities.c"
 void actU64toLE(
  actU8 * tgt,
  const actU64 src)
{
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 661 "../../../../CBD2300515_D00/BSW/vSecPrim/actUtilities.c" 2
