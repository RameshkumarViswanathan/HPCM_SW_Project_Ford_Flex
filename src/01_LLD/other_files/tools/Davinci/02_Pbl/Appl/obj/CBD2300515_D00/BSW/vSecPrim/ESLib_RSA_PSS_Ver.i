# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
# 40 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
...
# 41 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c" 2
...
# 42 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c" 2
...
# 43 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c" 2
...
# 44 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c" 2
# 66 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
...
# 68 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c" 2
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 74 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c" 2
# 94 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
static eslt_ErrorCode esl_checkSaltSizeVer(
  eslt_Length * saltSize,
  eslt_Length dbLength,
  eslt_Length estimatedPSLength);
# 118 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
static eslt_ErrorCode esl_checkStandardConditionsEncodedMessage(
  const eslt_WorkSpaceRSAver_prim * workSpace,
  eslt_Length signatureSize,
  eslt_Length keyPairModuleSize,
  const eslt_Byte * encodedMessage,
  eslt_Size32 * emBits,
  eslt_Length * emLength);
# 149 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
static eslt_ErrorCode esl_initVerifyRSA_PSS(
   eslt_WorkSpaceRSAPSSver * workSpace,
   eslt_Length keyPairModuleSize,
   const eslt_Byte * keyPairModule,
   eslt_Length publicKeyExponentSize,
   const eslt_Byte * publicKeyExponent,
  eslt_HashAlgorithm hashID);
# 176 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
static eslt_ErrorCode esl_updateVerifyRSA_PSS(
   eslt_WorkSpaceRSAPSSver * workSpace,
   eslt_Length inputSize,
   const eslt_Byte * input,
  eslt_HashAlgorithm hashID);
# 199 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
static void esl_finalizeHashVerifyRSA_PSS(
   eslt_WorkSpaceRSAPSSver * workSpace,
   eslt_Byte * messageDigest,
  eslt_HashAlgorithm hashID);
# 235 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
static eslt_ErrorCode esl_verifySigVerifyRSA_PSS(
  eslt_WorkSpaceRSAPSSver * workSpace,
  const eslt_Byte * messageDigest,
   eslt_Length hashDigestSize,
   eslt_Length saltSize,
   ...
   const eslt_Byte * signature,
  eslt_HashAlgorithm hashID);
# 259 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
static eslt_ErrorCode esl_checkSaltSizeVer(
  eslt_Length * saltSize,
  eslt_Length dbLength,
  eslt_Length estimatedPSLength)
...
# 293 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
static eslt_ErrorCode esl_checkStandardConditionsEncodedMessage(
  const eslt_WorkSpaceRSAver_prim * workSpace,
  eslt_Length signatureSize,
  eslt_Length keyPairModuleSize,
  ...
  eslt_Length * emLength)
{
  ...
  if ((signatureSize != keyPairModuleSize) || ((0xBCu) != encodedMessage[keyPairModuleSize - 1u]))
  {
    returnValue = (0x2000u + 0x001Du);
  }
  else
  {
...
# 335 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
static eslt_ErrorCode esl_initVerifyRSA_PSS(
  eslt_WorkSpaceRSAPSSver * workSpace,
  eslt_Length keyPairModuleSize,
  const eslt_Byte * keyPairModule,
  ...
  eslt_HashAlgorithm hashID)
{
  ...
  if ((keyPairModule == ((void *)0)) || (publicKeyExponent == ((void *)0)))
  {
    returnValue = (0x2000u + 0x0003u);
  }
  else
  {
    ...
    {
      workSpace->wsRSAVerPrim.header.size = (eslt_Length)((sizeof(actRSAPRIMSTRUCT)));
...
# 386 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
static eslt_ErrorCode esl_updateVerifyRSA_PSS(
  eslt_WorkSpaceRSAPSSver * workSpace,
  eslt_Length inputSize,
  const eslt_Byte * input,
...
# 422 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
static void esl_finalizeHashVerifyRSA_PSS(
  eslt_WorkSpaceRSAPSSver * workSpace,
  eslt_Byte * messageDigest,
  eslt_HashAlgorithm hashID)
...
# 454 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
static eslt_ErrorCode esl_verifySigVerifyRSA_PSS(
  eslt_WorkSpaceRSAPSSver * workSpace,
  const eslt_Byte * messageDigest,
  eslt_Length hashDigestSize,
...
# 477 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
  const eslt_Byte * saltedHash;
  eslt_Byte * db;
  const eslt_Byte * dbSalt;
  eslt_Byte * tempHash;
  ...
  if (returnValue == (0x0000u))
  {
# 513 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
    ...
    else
    {
      ...
      if (returnValue == (0x0000u))
      {
        ...
        if (actMemcmp(saltedHash, tempHash, hashDigestSize) != 1u)
        {
          returnValue = (0x2000u + 0x001Du);
        }
      }
...
# 600 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
eslt_ErrorCode esl_initVerifyRSASHA1_PSS(
eslt_WorkSpaceRSAPSSver * workSpace,
eslt_Length keyPairModuleSize,
const eslt_Byte * keyPairModule,
eslt_Length publicKeyExponentSize,
const eslt_Byte * publicKeyExponent)
{
  ...
  else if ((returnValue = esl_CheckWorkSpaceHeader(&(workSpace->header), (sizeof(eslt_WorkSpaceRSAPSSver) - sizeof(eslt_WorkSpaceHeader)))) != (0x0000u))
  {
  ...
  else
  {
    ...
    returnValue = esl_initVerifyRSA_PSS(workSpace, keyPairModuleSize, keyPairModule,
                                        publicKeyExponentSize, publicKeyExponent, (0x00u));
  }
  return returnValue;
}
# 636 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
eslt_ErrorCode esl_updateVerifyRSASHA1_PSS(
eslt_WorkSpaceRSAPSSver * workSpace,
eslt_Length inputSize,
const eslt_Byte * input)
{
  ...
  {
    returnValue = esl_CheckWorkSpaceHeaderAndState(&(workSpace->header), (sizeof(eslt_WorkSpaceRSAPSSver) - sizeof(eslt_WorkSpaceHeader)), (0x0700u));
  }

  if (returnValue == (0x0000u))
  {
    returnValue = esl_updateVerifyRSA_PSS(workSpace, inputSize, input, (0x00u));
...
# 672 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
eslt_ErrorCode esl_finalizeHashVerifyRSASHA1_PSS(
eslt_WorkSpaceRSAPSSver * workSpace,
eslt_Byte * messageDigest)
{
  eslt_ErrorCode returnValue = (0x0000u);
  ...
  if (returnValue == (0x0000u))
  {
    esl_finalizeHashVerifyRSA_PSS(workSpace, messageDigest, (0x00u));
  }

  return returnValue;
}
# 704 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
eslt_ErrorCode esl_verifySigVerifyRSASHA1_PSS(
eslt_WorkSpaceRSAPSSver * workSpace,
const eslt_Byte * messageDigest,
eslt_Length saltSize,
eslt_Length signatureSize,
const eslt_Byte * signature)
{
  ...
  if ((workSpace == ((void *)0)) || (messageDigest == ((void *)0)) || (signature == ((void *)0)))
  {
    returnValue = (0x2000u + 0x0003u);
  }
  else
  ...
  if (returnValue == (0x0000u))
  {
    returnValue = esl_verifySigVerifyRSA_PSS(workSpace, messageDigest, 20u, saltSize,
                                             signatureSize, signature, (0x00u));
  }
  return returnValue;
}
# 739 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
eslt_ErrorCode esl_verifySigVerifyRSASHA1_PSS_AutoSalt(
eslt_WorkSpaceRSAPSSver * workSpace,
const eslt_Byte * messageDigest,
eslt_Length signatureSize,
const eslt_Byte * signature)
...
# 758 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
eslt_ErrorCode esl_verifySigVerifyRSASHA1_PSS_NoSalt(
eslt_WorkSpaceRSAPSSver * workSpace,
const eslt_Byte * messageDigest,
eslt_Length signatureSize,
const eslt_Byte * signature)
...
# 778 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
eslt_ErrorCode esl_verifySigVerifyRSASHA1_PSS_DigestLengthSalt(
eslt_WorkSpaceRSAPSSver * workSpace,
const eslt_Byte * messageDigest,
eslt_Length signatureSize,
const eslt_Byte * signature)
{
  eslt_ErrorCode returnValue = (0x2000u);
  returnValue = esl_verifySigVerifyRSASHA1_PSS(workSpace, messageDigest, 20u,
                                               signatureSize, signature);
  return returnValue;
}
# 801 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
eslt_ErrorCode esl_finalizeVerifyRSASHA1_PSS(
eslt_WorkSpaceRSAPSSver * workSpace,
eslt_Length saltSize,
eslt_Length signatureSize,
const eslt_Byte * signature)
...
# 839 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
eslt_ErrorCode esl_finalizeVerifyRSASHA1_PSS_AutoSalt(
eslt_WorkSpaceRSAPSSver * workSpace,
eslt_Length signatureSize,
const eslt_Byte * signature)
{
...
# 857 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
eslt_ErrorCode esl_finalizeVerifyRSASHA1_PSS_NoSalt(
eslt_WorkSpaceRSAPSSver * workSpace,
eslt_Length signatureSize,
const eslt_Byte * signature)
{
...
# 876 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
eslt_ErrorCode esl_finalizeVerifyRSASHA1_PSS_DigestLengthSalt(
eslt_WorkSpaceRSAPSSver * workSpace,
eslt_Length signatureSize,
const eslt_Byte * signature)
{
  eslt_ErrorCode returnValue = (0x2000u);
  returnValue = esl_finalizeVerifyRSASHA1_PSS(workSpace, 20u, signatureSize, signature);
  return returnValue;
}
# 897 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
eslt_ErrorCode esl_initVerifyRSASHA256_PSS(
  eslt_WorkSpaceRSAPSSver * workSpace,
  eslt_Length keyPairModuleSize,
  const eslt_Byte * keyPairModule,
  eslt_Length publicKeyExponentSize,
  const eslt_Byte * publicKeyExponent)
{
  ...
  else
  {
    ...
    returnValue = esl_initVerifyRSA_PSS(workSpace, keyPairModuleSize, keyPairModule,
                                        publicKeyExponentSize, publicKeyExponent, (0x02u));
  }
  return returnValue;
}
# 933 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
eslt_ErrorCode esl_updateVerifyRSASHA256_PSS(
  eslt_WorkSpaceRSAPSSver * workSpace,
  eslt_Length inputSize,
  const eslt_Byte * input)
{
  ...
  if (returnValue == (0x0000u))
  {
    returnValue = esl_updateVerifyRSA_PSS(workSpace, inputSize, input, (0x02u));
    if (returnValue == (0x2000u + 0x002Cu))
    {
      returnValue = ((0x2000u + 0x002Cu));
    }
...
# 969 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
eslt_ErrorCode esl_finalizeHashVerifyRSASHA256_PSS(
  eslt_WorkSpaceRSAPSSver * workSpace,
  eslt_Byte * messageDigest)
{
  eslt_ErrorCode returnValue = (0x0000u);
  ...
  if (returnValue == (0x0000u))
  {
    esl_finalizeHashVerifyRSA_PSS(workSpace, messageDigest, (0x02u));
  }
  return returnValue;
}
# 999 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
eslt_ErrorCode esl_verifySigVerifyRSASHA256_PSS(
  eslt_WorkSpaceRSAPSSver * workSpace,
  const eslt_Byte * messageDigest,
  eslt_Length saltSize,
  eslt_Length signatureSize,
  const eslt_Byte * signature)
{
  ...
  if (returnValue == (0x0000u))
  {
    returnValue = esl_verifySigVerifyRSA_PSS(workSpace, messageDigest, 32u,
                                             saltSize, signatureSize, signature, (0x02u));
  }
  return returnValue;
}
# 1033 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
eslt_ErrorCode esl_verifySigVerifyRSASHA256_PSS_AutoSalt(
  eslt_WorkSpaceRSAPSSver * workSpace,
  const eslt_Byte * messageDigest,
  eslt_Length signatureSize,
  const eslt_Byte * signature)
...
# 1052 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
eslt_ErrorCode esl_verifySigVerifyRSASHA256_PSS_NoSalt(
  eslt_WorkSpaceRSAPSSver * workSpace,
  const eslt_Byte * messageDigest,
  eslt_Length signatureSize,
  const eslt_Byte * signature)
...
# 1072 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
eslt_ErrorCode esl_verifySigVerifyRSASHA256_PSS_DigestLengthSalt(
  eslt_WorkSpaceRSAPSSver * workSpace,
  const eslt_Byte * messageDigest,
  eslt_Length signatureSize,
  const eslt_Byte * signature)
{
  eslt_ErrorCode returnValue = (0x2000u);
  returnValue = esl_verifySigVerifyRSASHA256_PSS(workSpace, messageDigest, 32u,
                                                 signatureSize, signature);
  return returnValue;
}
# 1098 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
eslt_ErrorCode esl_finalizeVerifyRSASHA256_PSS(
  eslt_WorkSpaceRSAPSSver * workSpace,
  eslt_Length saltSize,
  eslt_Length signatureSize,
  const eslt_Byte * signature)
...
# 1137 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
eslt_ErrorCode esl_finalizeVerifyRSASHA256_PSS_AutoSalt(
  eslt_WorkSpaceRSAPSSver * workSpace,
  eslt_Length signatureSize,
  const eslt_Byte * signature)
{
...
# 1155 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
eslt_ErrorCode esl_finalizeVerifyRSASHA256_PSS_NoSalt(
  eslt_WorkSpaceRSAPSSver * workSpace,
  eslt_Length signatureSize,
  const eslt_Byte * signature)
{
...
# 1174 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
eslt_ErrorCode esl_finalizeVerifyRSASHA256_PSS_DigestLengthSalt(
  eslt_WorkSpaceRSAPSSver * workSpace,
  eslt_Length signatureSize,
  const eslt_Byte * signature)
{
  eslt_ErrorCode returnValue = (0x2000u);
  returnValue = esl_finalizeVerifyRSASHA256_PSS(workSpace, 32u, signatureSize, signature);
  return returnValue;
}
# 1485 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c"
# 1 "GenData/vSecPrim_MemMap.h" 1
# 1486 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Ver.c" 2
