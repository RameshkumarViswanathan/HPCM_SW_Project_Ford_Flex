# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actRC2.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actRC2.c"
# 54 "../../../../CBD2300515_D00/BSW/vSecPrim/actRC2.c"
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actRC2.h" 1
# 26 "../../../../CBD2300515_D00/BSW/vSecPrim/actRC2.h"
...
# 27 "../../../../CBD2300515_D00/BSW/vSecPrim/actRC2.h" 2
# 40 "../../../../CBD2300515_D00/BSW/vSecPrim/actRC2.h"
typedef struct
{
   actU16 e_key[128u/2u];
   ...
   actLengthType buffer_used;
   actU8 buffer[8u];
   actU8 copyInputData[8u];
} actRC2STRUCT;


typedef void ( * actRC2TransformFctType)(
   actRC2STRUCT * info, const actU8 * in, actU8 * out_buffer,
   actLengthType blocks, void ( * watchdog)(void));
# 69 "../../../../CBD2300515_D00/BSW/vSecPrim/actRC2.h"
# 1 "GenData/vSecPrim_MemMap.h" 1
# 70 "../../../../CBD2300515_D00/BSW/vSecPrim/actRC2.h" 2
# 89 "../../../../CBD2300515_D00/BSW/vSecPrim/actRC2.h"
actRETURNCODE actRC2KeySetup(
  actRC2STRUCT * info,
  const actU8 * key, actLengthType key_len,
  void ( * watchdog)(void));
# 120 "../../../../CBD2300515_D00/BSW/vSecPrim/actRC2.h"
actRETURNCODE actRC2Init(
  actRC2STRUCT * info,
  const actU8 * key, actLengthType key_len, actLengthType eff_key_len,
  const actU8 * iv, actU8 mode,
  void ( * watchdog)(void));
# 159 "../../../../CBD2300515_D00/BSW/vSecPrim/actRC2.h"
...
# 199 "../../../../CBD2300515_D00/BSW/vSecPrim/actRC2.h"
actRETURNCODE actRC2Decrypt(
  actRC2STRUCT * info,
  const actU8 * in, actLengthType in_length,
  actU8 * out_buffer, actLengthType * out_length,
  boolean final, void ( * watchdog)(void));
# 224 "../../../../CBD2300515_D00/BSW/vSecPrim/actRC2.h"
actRETURNCODE actRC2InitCryptBlock(
  actRC2STRUCT * info,
  const actU8 * key, actLengthType key_len, actLengthType eff_key_len,
  void ( * watchdog)(void));
# 246 "../../../../CBD2300515_D00/BSW/vSecPrim/actRC2.h"
void actRC2EncryptBlock(
   const actRC2STRUCT * info,
   const actU8 * in_block, actU8 * out_block,
   void ( * watchdog)(void));
# 268 "../../../../CBD2300515_D00/BSW/vSecPrim/actRC2.h"
void actRC2DecryptBlock(
   const actRC2STRUCT * info,
   const actU8 * in_block, actU8 * out_block,
   void ( * watchdog)(void));
# 291 "../../../../CBD2300515_D00/BSW/vSecPrim/actRC2.h"
void actRC2EncryptMultipleBlocks(
  actRC2STRUCT * info,
  const actU8 * in, actU8 * out_buffer,
  actLengthType blocks, void ( * watchdog)(void));
# 314 "../../../../CBD2300515_D00/BSW/vSecPrim/actRC2.h"
void actRC2DecryptMultipleBlocks(
  actRC2STRUCT * info,
  const actU8 * in, actU8 * out_buffer,
  actLengthType blocks, void ( * watchdog)(void));
# 342 "../../../../CBD2300515_D00/BSW/vSecPrim/actRC2.h"
void actRC2Transform(
   actRC2STRUCT * info,
   const actU8 * in, actLengthType in_length,
   actU8 * out_buffer, actRC2TransformFctType transform,
   void ( * watchdog)(void));


# 1 "GenData/vSecPrim_MemMap.h" 1
# 350 "../../../../CBD2300515_D00/BSW/vSecPrim/actRC2.h" 2
# 55 "../../../../CBD2300515_D00/BSW/vSecPrim/actRC2.c" 2
...
# 56 "../../../../CBD2300515_D00/BSW/vSecPrim/actRC2.c" 2

# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actWatchdog.h" 1
# 58 "../../../../CBD2300515_D00/BSW/vSecPrim/actRC2.c" 2
