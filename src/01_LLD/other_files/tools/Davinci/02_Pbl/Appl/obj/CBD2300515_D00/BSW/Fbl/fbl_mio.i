# 1 "../../../../CBD2300515_D00/BSW/Fbl/fbl_mio.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/Fbl/fbl_mio.c"
# 41 "../../../../CBD2300515_D00/BSW/Fbl/fbl_mio.c"
...
# 42 "../../../../CBD2300515_D00/BSW/Fbl/fbl_mio.c" 2
# 71 "../../../../CBD2300515_D00/BSW/Fbl/fbl_mio.c"
# 1 "Include/MemMap.h" 1
# 72 "../../../../CBD2300515_D00/BSW/Fbl/fbl_mio.c" 2
...
# 1 "Include/MemMap.h" 1
# 96 "../../../../CBD2300515_D00/BSW/Fbl/fbl_mio.c" 2


# 1 "Include/MemMap.h" 1
# 3858 "Include/MemMap.h"
#pragma section ".RamCodeCoreSection" ax
# 99 "../../../../CBD2300515_D00/BSW/Fbl/fbl_mio.c" 2
# 109 "../../../../CBD2300515_D00/BSW/Fbl/fbl_mio.c"
void MemDriver_InitPowerOn( void )
{
...
# 133 "../../../../CBD2300515_D00/BSW/Fbl/fbl_mio.c"
vsint16 FblMemSegmentNrGet( tFblAddress address )
{
   vsint16 segment;
...
# 243 "../../../../CBD2300515_D00/BSW/Fbl/fbl_mio.c"
   return segment;
}
# 256 "../../../../CBD2300515_D00/BSW/Fbl/fbl_mio.c"
tFblResult FblMemGetDeviceByAddr(tFblAddress address, vuint8 * device)
{
   tFblResult result;
...
# 285 "../../../../CBD2300515_D00/BSW/Fbl/fbl_mio.c"
tFblResult FblMemGetDeviceByRange(tFblAddress address, tFblLength length, vuint8 * device)
{
   tFblResult result;
   vuint8 localDevice;
...
# 344 "../../../../CBD2300515_D00/BSW/Fbl/fbl_mio.c"
tFblLength FblReadProm(tFblAddress address, vuint8 * buffer, tFblLength length)
{
   tFblLength actualReadCount;
...
# 367 "../../../../CBD2300515_D00/BSW/Fbl/fbl_mio.c"
IO_ErrorType FblReadPromExt(tFblAddress address, vuint8 * buffer, tFblLength length,
   tFblLength * actualReadCount)
{
   IO_ErrorType result;
...
# 494 "../../../../CBD2300515_D00/BSW/Fbl/fbl_mio.c"
void MemDriver_Begin(vuint8 device, vuint8 function, boolean hookEnabled)
{
# 504 "../../../../CBD2300515_D00/BSW/Fbl/fbl_mio.c"
...
void MemDriver_End(boolean hookEnabled)
{
# 534 "../../../../CBD2300515_D00/BSW/Fbl/fbl_mio.c"
   if (hookEnabled == 1u)
   {
...
# 552 "../../../../CBD2300515_D00/BSW/Fbl/fbl_mio.c"
IO_ErrorType MemDriver_InitSync( void * address )
{
   vuint8 i;
...
# 584 "../../../../CBD2300515_D00/BSW/Fbl/fbl_mio.c"
IO_ErrorType MemDriver_DeinitSync( void * address )
{
   vuint8 i;
   IO_ErrorType result = 0x00u;
...
# 613 "../../../../CBD2300515_D00/BSW/Fbl/fbl_mio.c"
IO_ErrorType MemDriver_RReadSync(IO_MemPtrType buf, IO_SizeType len, IO_PositionType addr)
{
   IO_ErrorType result;
...
# 641 "../../../../CBD2300515_D00/BSW/Fbl/fbl_mio.c"
IO_ErrorType MemDriver_RWriteSync(IO_MemPtrType buf, IO_SizeType len, IO_PositionType addr)
{
   IO_ErrorType result;
...
# 669 "../../../../CBD2300515_D00/BSW/Fbl/fbl_mio.c"
IO_ErrorType MemDriver_REraseSync(IO_SizeType len, IO_PositionType addr)
{
   IO_ErrorType result;
...
# 3865 "Include/MemMap.h"
#pragma section
# 688 "../../../../CBD2300515_D00/BSW/Fbl/fbl_mio.c" 2
