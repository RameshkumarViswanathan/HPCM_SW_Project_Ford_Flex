...
.LFB18:
	.file 1 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/BrsHw.c"
	.loc 1 449 0
	sub.a	%SP, 16
.LCFI0:
.LVL0:
...
#APP
	# 789 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/BrsHw.c" 1
	nop
	# 0 "" 2
#NO_APP
	loop	%a15, .L12
...
.LFB26:
	.loc 1 1191 0
	.loc 1 1227 0
	movh.a	%a2, hi:BRSHW_PORT_CAN1_TX
	lea	%a15, [%a2] lo:BRSHW_PORT_CAN1_TX
	ld.hu	%d15, [%a2] lo:BRSHW_PORT_CAN1_TX
	ld.hu	%d4, [%a15] 2
	sh	%d4, %d4, 16
	or	%d9, %d4, %d15
	mov	%d4, %d9
...
.LVL78:
	.loc 1 1228 0
	movh.a	%a2, hi:BRSHW_PORT_CAN1_RX
	lea	%a15, [%a2] lo:BRSHW_PORT_CAN1_RX
	ld.hu	%d15, [%a2] lo:BRSHW_PORT_CAN1_RX
	ld.hu	%d2, [%a15] 2
	sh	%d2, %d2, 16
	or	%d15, %d2
	mov	%d4, %d15
	call	BrsHwInitPortInput
.LVL79:
	.loc 1 1229 0
	movh.a	%a15, hi:BRSHW_PORT_CONF_CAN
	ld.bu	%d8, [%a15] lo:BRSHW_PORT_CONF_CAN
	mov	%d4, %d9
	mov	%d5, %d8
	call	BrsHwInitPortConfig
.LVL80:
	.loc 1 1230 0
	mov	%d4, %d15
	mov	%d5, %d8
...
.LFB30:
	...
	.loc 1 1691 0
#APP
	# 1691 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/BrsHw.c" 1
	nop
	# 0 "" 2
	# 1691 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/BrsHw.c" 1
	nop
	...
	# 0 "" 2
	.loc 1 1692 0
	# 1692 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/BrsHw.c" 1
	nop
	# 0 "" 2
	# 1692 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/BrsHw.c" 1
	nop
	...
	# 0 "" 2
	.loc 1 1693 0
	# 1693 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/BrsHw.c" 1
	nop
	# 0 "" 2
	# 1693 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/BrsHw.c" 1
	nop
	...
	# 0 "" 2
	.loc 1 1694 0
	# 1694 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/BrsHw.c" 1
	nop
	# 0 "" 2
	# 1694 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/BrsHw.c" 1
	nop
	...
	# 0 "" 2
	.loc 1 1695 0
	# 1695 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/BrsHw.c" 1
	nop
	# 0 "" 2
	# 1695 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/BrsHw.c" 1
	nop
	...
	# 0 "" 2
	.loc 1 1697 0
	# 1697 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/BrsHw.c" 1
	nop
	# 0 "" 2
	# 1697 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/BrsHw.c" 1
	nop
	...
	# 0 "" 2
	.loc 1 1698 0
	# 1698 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/BrsHw.c" 1
	nop
	# 0 "" 2
	# 1698 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/BrsHw.c" 1
	nop
	...
	# 0 "" 2
	.loc 1 1699 0
	# 1699 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/BrsHw.c" 1
	nop
	# 0 "" 2
	# 1699 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/BrsHw.c" 1
	nop
	...
	# 0 "" 2
	.loc 1 1700 0
	# 1700 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/BrsHw.c" 1
	nop
	# 0 "" 2
	# 1700 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/BrsHw.c" 1
	nop
	...
	# 0 "" 2
	.loc 1 1701 0
	# 1701 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/BrsHw.c" 1
	nop
	# 0 "" 2
	# 1701 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/BrsHw.c" 1
	nop
...
.section .text.RamCodeSection,"ax",@progbits
	.align 1
	.global	Appl_UnlockInit
	.type	Appl_UnlockInit, @function
Appl_UnlockInit:
.LFB36:
	.loc 1 1861 0
	sub.a	%SP, 8
...
.LBB919:
	...
	jeq	%d15, -1, .L101
	.loc 3 357 0
	movh.a	%a15, hi:kBrsWdtCon0Addresses_RAM
	lea	%a15, [%a15] lo:kBrsWdtCon0Addresses_RAM
	addsc.a	%a15, %a15, %d15, 3
	ld.a	%a15, [%a15]0
.L101:
.LBE919:
...
.LBE916:
.LFE36:
	.size	Appl_UnlockInit, .-Appl_UnlockInit
	.align 1
	.global	Appl_UnlockEndinit
	.type	Appl_UnlockEndinit, @function
Appl_UnlockEndinit:
.LFB37:
	.loc 1 1866 0
	sub.a	%SP, 8
...
.LBE928:
.LFE37:
	.size	Appl_UnlockEndinit, .-Appl_UnlockEndinit
	.align 1
	.global	Appl_LockInit
	.type	Appl_LockInit, @function
Appl_LockInit:
.LFB38:
	.loc 1 1871 0
	sub.a	%SP, 8
...
.LBE940:
.LFE38:
	.size	Appl_LockInit, .-Appl_LockInit
	.align 1
	.global	Appl_LockEndinit
	.type	Appl_LockEndinit, @function
Appl_LockEndinit:
.LFB39:
	.loc 1 1876 0
	sub.a	%SP, 8
...
.LBE952:
.LFE39:
	.size	Appl_LockEndinit, .-Appl_LockEndinit
.section .text.ApplCanWaitSetMCR,"ax",@progbits
	.align 1
	.global	ApplCanWaitSetMCR
	.type	ApplCanWaitSetMCR, @function
ApplCanWaitSetMCR:
.LFB40:
	.loc 1 1888 0
.LVL129:
...
#APP
	# 1892 "../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/BrsHw.c" 1
	nop
	# 0 "" 2
#NO_APP
	loop	%a15, .L113
	...
	ret
.LFE40:
	.size	ApplCanWaitSetMCR, .-ApplCanWaitSetMCR
...
kBrsHwMainVersion:
	.byte	3
	.global	BRSHW_PORT_CAN1_RX
	.align 1
	.type	BRSHW_PORT_CAN1_RX, @object
	.size	BRSHW_PORT_CAN1_RX, 4
BRSHW_PORT_CAN1_RX:
	.byte	23
	.byte	0
	.byte	0
	.zero	1
	.global	BRSHW_PORT_CAN1_TX
	.align 1
	.type	BRSHW_PORT_CAN1_TX, @object
	.size	BRSHW_PORT_CAN1_TX, 4
BRSHW_PORT_CAN1_TX:
	.byte	23
	.byte	1
	.byte	5
...
.Ldebug_info0:
	...
	.byte	0x1
	.string	"../../../../CBD2300515_D00/Demo/DemoFbl/Appl/Source/BrsHw.c"
	...
	.byte	0x5
	.byte	0x3
	.uaword	BRSHW_PORT_CAN1_TX
	.uleb128 0x4
	.uaword	0xa7d
	.uleb128 0x35
	.string	"BRSHW_PORT_CAN1_RX"
	.byte	0x5
	.uahalf	0x134
	.uaword	0x2cb5
	.byte	0x1
