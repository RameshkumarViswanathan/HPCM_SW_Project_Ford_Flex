# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNModExp.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNModExp.c"
# 39 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNModExp.c"
...
# 40 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNModExp.c" 2
...
# 41 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNModExp.c" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actWatchdog.h" 1
# 42 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNModExp.c" 2
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 50 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNModExp.c" 2
# 73 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNModExp.c"
void actBNModExp(
   const actBNDIGIT * gR, const actBNDIGIT * e,
   actBNDIGIT * AR, const actBNRING * Ring,
   actBNDIGIT * t[], void ( * watchdog)(void))
{
  ...
  while((( ((((e)[(i)/((32u))]) & ((actBNDIGIT)(1u)<<(((i)%((32u)))))) != (actBNDIGIT)0u) ? 1u:0u)) == 0u)
  {
    if ((i & 0x07u) == 0x00u)
    {
      actWatchdogTriggerFunction(watchdog);
  ...
  for (; i > 0u; i--)
  {
    ...
    if ((( ((((e)[((i - 1u))/((32u))]) & ((actBNDIGIT)(1u)<<((((i - 1u))%((32u)))))) != (actBNDIGIT)0u) ? 1u:0u)) == 1u)
    {
      actWatchdogTriggerFunction(watchdog);
...
# 522 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNModExp.c"
  actWatchdogTriggerFunction(watchdog);
}


# 1 "GenData/vSecPrim_MemMap.h" 1
# 527 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNModExp.c" 2
