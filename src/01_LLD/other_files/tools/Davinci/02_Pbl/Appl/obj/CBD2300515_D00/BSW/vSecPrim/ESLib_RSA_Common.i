# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_Common.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_Common.c"
# 39 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_Common.c"
...
# 40 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_Common.c" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_Common.h" 1
# 37 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_Common.h"
...
# 38 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_Common.h" 2
...
# 41 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_Common.c" 2
# 58 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_Common.c"
...
# 60 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_Common.c" 2
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 66 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_Common.c" 2
# 77 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_Common.c"
eslt_ErrorCode esl_calcSaltedHashRSA_PSS(
  eslt_WorkSpaceUnionHashFunctions_RSA * wsuHash,
  eslt_Length saltSize,
  const eslt_Byte * salt,
  ...
  eslt_HashAlgorithm hashID)
{
  ...
  if (actReturnValue == (0x00u))
  {
    ...
    (VStdLib_MemSet(((padding)), 0, ((sizeof(padding)))));
  ...
  {
    returnValue = (0x2000u + 0x0008u);
  }

  return returnValue;
}
# 149 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_Common.c"
eslt_ErrorCode esl_generateMaskMGF1(
  eslt_HashAlgorithm hashAlgorithm,
  eslt_WorkSpaceUnionHashFunctions_RSA * wsHash,
  eslt_Byte * tempHash,
  ...
  eslt_Byte * mask)
{
  ...
  actRETURNCODE actReturnValue = (0x01u);
  eslt_Size32 counter;
  ...
  else
  {
    ...
    for (i = 0; i < digestNumber; i++)
    {
      ...
      if (actReturnValue == (0x00u))
      {
        ...
        (VStdLib_MemCpy((&mask[offset]), (tempHash), (passLength)));
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 242 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_Common.c" 2
