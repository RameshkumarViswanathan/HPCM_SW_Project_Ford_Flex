# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actIAES.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actIAES.c"
# 40 "../../../../CBD2300515_D00/BSW/vSecPrim/actIAES.c"
...
# 41 "../../../../CBD2300515_D00/BSW/vSecPrim/actIAES.c" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actAES.h" 1
# 47 "../../../../CBD2300515_D00/BSW/vSecPrim/actAES.h"
...
# 42 "../../../../CBD2300515_D00/BSW/vSecPrim/actIAES.c" 2
...
# 43 "../../../../CBD2300515_D00/BSW/vSecPrim/actIAES.c" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actWatchdog.h" 1
# 44 "../../../../CBD2300515_D00/BSW/vSecPrim/actIAES.c" 2
# 60 "../../../../CBD2300515_D00/BSW/vSecPrim/actIAES.c"
# 1 "GenData/vSecPrim_MemMap.h" 1
# 61 "../../../../CBD2300515_D00/BSW/vSecPrim/actIAES.c" 2
# 70 "../../../../CBD2300515_D00/BSW/vSecPrim/actIAES.c"
actRETURNCODE actAESInitEncryptBlock(
  actAESSTRUCT * info,
  const actU8 * key, actLengthType key_len,
  void ( * watchdog)(void))
...
# 89 "../../../../CBD2300515_D00/BSW/vSecPrim/actIAES.c"
void actAESEncryptBlock(
   const actAESSTRUCT * info,
   const actU8 * in_block, actU8 * out_block,
   void ( * watchdog)(void))
{
  const actU32 * k_ptr = info->e_key;
  actU32 b0[4], b1[4];
  ...
  actCpyU32toLE (out_block, b0, (16u) /(4u));

  actWatchdogTriggerFunction(watchdog);
}
# 136 "../../../../CBD2300515_D00/BSW/vSecPrim/actIAES.c"
actRETURNCODE actAESInitDecryptBlock(
   actAESSTRUCT * info,
   const actU8 * key, actLengthType key_len,
   void ( * watchdog)(void))
...
# 162 "../../../../CBD2300515_D00/BSW/vSecPrim/actIAES.c"
void actAESDecryptBlock(
   const actAESSTRUCT * info,
   const actU8 * in_block, actU8 * out_block,
   void ( * watchdog)(void))
{
  const actU32 * k_ptr = &info->e_key[((4u * info->key_dword_len) + 20u)];
  actU32 b0[4], b1[4];
  actLengthType i, iterations = 4u + ((info->key_dword_len - 4u) / 2u);
...
# 212 "../../../../CBD2300515_D00/BSW/vSecPrim/actIAES.c"
actRETURNCODE actAESInitEncrypt(
   actAESSTRUCT * info,
   const actU8 * key, actLengthType key_len, const actU8 * iv,
   actU8 mode, void ( * watchdog)(void))
{
  ...
  result = actPaddingInit(mode & (0xF0u));
...
# 244 "../../../../CBD2300515_D00/BSW/vSecPrim/actIAES.c"
actRETURNCODE actAESEncrypt(
  actAESSTRUCT * info,
  const actU8 * in, actLengthType in_length,
  actU8 * out_buffer, actLengthType * out_length,
  actBoolean final, void ( * watchdog)(void))
{
  ...
  actLengthType out_size = ((in_length + info->buffer_used) / (16u)) * (16u);


  if (in_length > (0xFFFFFFFFuL - (16u)))
  {
    result = (0xF8u);
  }
  else if ((final == 1u) && ((info->mode & (0x0Fu)) == (0x04u)) && ((info->mode & (0xF0u)) == (0x00u)))
  {
  ...
  else if ((final == 0u) || ((info->mode & (0xF0u)) == (0x00u)))
  {
  ...
  {
    if (*out_length < (actLengthType) (out_size + (16u)))
    {
      result = (0xF8u);
    }
    else
    {
      *out_length = out_size + (16u);
    }
  }
  ...
  if (result == (0x00u))
  {
    ...
    if (final == 1u)
    {
      ...
      if (((info->mode & (0x0Fu)) != (0x04u)) || ((info->mode & (0xF0u)) != (0x00u)))
      {
        result = actPaddingPad(info->mode & (0xF0u), (16u), &(info->buffer_used), info->buffer);
      }

      if ((result == (0x00u)) && (info->buffer_used > 0u))
      {
...
# 338 "../../../../CBD2300515_D00/BSW/vSecPrim/actIAES.c"
actRETURNCODE actAESInitDecrypt(
   actAESSTRUCT * info,
   const actU8 * key, actLengthType key_len, const actU8 * iv,
   actU8 mode, void ( * watchdog)(void))
...
# 376 "../../../../CBD2300515_D00/BSW/vSecPrim/actIAES.c"
actRETURNCODE actAESDecrypt(
  actAESSTRUCT * info,
  const actU8 * in, actLengthType in_length,
  actU8 * out_buffer, actLengthType * out_length,
  actBoolean final, void ( * watchdog)(void))
{
  ...
  if (final == 1u)
  {
     if (((info->mode & (0x0Fu)) != (0x04u)) || ((info->mode & (0xF0u)) != (0x00u)))
     {
       ...
       if ((total_bytes == 0u) || ((total_bytes % (16u)) != 0u))
       {
         result = (0xF5u);
       }
     }
  ...
  if (result == (0x00u))
  {
    if (total_bytes > 0u)
    {
      ...
      out_size = ((total_bytes - 1u) / (16u)) * (16u);
    }
    else
    {
    ...
    if (result == (0x00u))
    {
      ...
      if (in_length > 0u)
      {
        if (total_bytes <= (16u))
        {
          (VStdLib_MemCpy((&info->buffer[info->buffer_used]), (in), ((actU32)in_length)));
          info->buffer_used += in_length;
        }
        else
        {
          if ((total_bytes % (16u)) == 0u)
          {
            actAESTransform(info, in, (actLengthType)(in_length - (16u)), out_buffer, actAESDecryptMultipleBlocks, watchdog);
            (VStdLib_MemCpy((info->buffer), (&in[(in_length - (16u))]), ((16u))));
            info->buffer_used = (16u);
          }
          else
          {
      ...
      if (final == 1u)
      {
        ...
        if (((info->mode & (0x0Fu)) != (0x04u)) || ((info->mode & (0xF0u)) != (0x00u)))
        {
          result = actPaddingUnpad(info->mode & (0xF0u), (16u), &(info->buffer_used), info->buffer);
        }
        ...
        if (result == (0x00u))
        {
          ...
          {
            (VStdLib_MemCpy((&out_buffer[out_size]), (info->buffer), (info->buffer_used)));
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 482 "../../../../CBD2300515_D00/BSW/vSecPrim/actIAES.c" 2
