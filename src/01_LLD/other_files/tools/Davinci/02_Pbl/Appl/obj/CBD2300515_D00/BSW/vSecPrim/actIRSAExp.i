# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actIRSAExp.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actIRSAExp.c"
# 38 "../../../../CBD2300515_D00/BSW/vSecPrim/actIRSAExp.c"
...
# 39 "../../../../CBD2300515_D00/BSW/vSecPrim/actIRSAExp.c" 2
...
# 40 "../../../../CBD2300515_D00/BSW/vSecPrim/actIRSAExp.c" 2
...
# 41 "../../../../CBD2300515_D00/BSW/vSecPrim/actIRSAExp.c" 2
...
# 42 "../../../../CBD2300515_D00/BSW/vSecPrim/actIRSAExp.c" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actWatchdog.h" 1
# 43 "../../../../CBD2300515_D00/BSW/vSecPrim/actIRSAExp.c" 2
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 51 "../../../../CBD2300515_D00/BSW/vSecPrim/actIRSAExp.c" 2
# 70 "../../../../CBD2300515_D00/BSW/vSecPrim/actIRSAExp.c"
static actRETURNCODE actRSAInitExpCheckInputParameters(
  actLengthType modulus_len,
  actLengthType exponent_len,
  actLengthType n_length,
  actU16 key_flag);
# 93 "../../../../CBD2300515_D00/BSW/vSecPrim/actIRSAExp.c"
static actRETURNCODE actRSAInitExpCheckExponent(
  actU16 key_flag,
  const actBNDIGIT * e,
  const actBNDIGIT * modulus,
  actLengthType n_length,
  void ( * watchdog)(void));
# 117 "../../../../CBD2300515_D00/BSW/vSecPrim/actIRSAExp.c"
static actRETURNCODE actRSAExpInputCheck(
  const actU8 * message,
  const actLengthType * message_len,
  actLengthType cipher_len,
  actLengthType modulusLengthBytes);
# 137 "../../../../CBD2300515_D00/BSW/vSecPrim/actIRSAExp.c"
static actRETURNCODE actRSAInitExpCheckInputParameters(
  actLengthType modulus_len,
  actLengthType exponent_len,
  actLengthType n_length,
  actU16 key_flag)
{
  actRETURNCODE returnValue = (0x00u);
  actU32 key_out_of_range = ((key_flag == (2u)) ? (0xF9u) : (0xFBu));
...
# 178 "../../../../CBD2300515_D00/BSW/vSecPrim/actIRSAExp.c"
static actRETURNCODE actRSAInitExpCheckExponent(
  actU16 key_flag,
  const actBNDIGIT * e,
  const actBNDIGIT * modulus,
  ...
  void ( * watchdog)(void))
{
  ...
  if (key_flag != (1u))
  {
    ...
    else
    {
      ...
      if (e[0] <= 1u)
      {
        if (actBNIsZero(&e[1], n_length - 1u) == 1u)
        {
          returnValue = key_out_of_range;
        }
      }
      else if ((( ((e[0] & (actBNDIGIT)1u) != ((actBNDIGIT)1u)) ? 1u:0u)))
      {
        returnValue = key_out_of_range;
      }
      else
    ...
    if (returnValue == (0x00u))
    {
      if (actBNCompare(e, modulus, n_length) >= (0x11u))
      {
        returnValue = key_out_of_range;
      }
    }
...
# 245 "../../../../CBD2300515_D00/BSW/vSecPrim/actIRSAExp.c"
static actRETURNCODE actRSAExpInputCheck(
  const actU8 * message,
  const actLengthType * message_len,
  actLengthType cipher_len,
  actLengthType modulusLengthBytes)
{
  ...
  if ((message != ((void *)0)) && (*message_len < modulusLengthBytes))
  {
    returnValue = (0xF4u);
  }
...
# 281 "../../../../CBD2300515_D00/BSW/vSecPrim/actIRSAExp.c"
actRETURNCODE actRSAInitExponentiation(
  const actU8 * modulus,
  actLengthType modulus_len,
  const actU8 * exponent,
  actLengthType exponent_len,
  ...
  void ( * watchdog)(void))
{
  ...
  actBNRING * n_ring = &(wksp->wsRSARing);
...
# 320 "../../../../CBD2300515_D00/BSW/vSecPrim/actIRSAExp.c"
    actWatchdogTriggerFunction(watchdog);
    ...
    actBNSet ((tmp), (tmp_len), ((actBNDIGIT) 0));
    tmp[tmp_len - 1u] = 1u;
...
# 380 "../../../../CBD2300515_D00/BSW/vSecPrim/actIRSAExp.c"
actRETURNCODE actRSAExponentiation(
  const actU8 * cipher,
  actLengthType cipher_len,
  actU8 * message,
  actLengthType * message_len,
...
{
  actRETURNCODE returnValue = (0x00u);
  const actBNRING * n_ring = &(wksp->wsRSARing);
  ...
  if (returnValue == (0x00u))
  {
    ...
    if (actBNCompare(c, n_ring->m, n_length) >= (0x11u))
    {
      returnValue = (0x90u);
    }
    ...
    if (returnValue == (0x00u))
    {
...

      {
        ...
        actBNDIGIT * one = e;
        actBNSet ((one), (n_length), ((actBNDIGIT) 0));
        one[0] = (actBNDIGIT)1;
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 473 "../../../../CBD2300515_D00/BSW/vSecPrim/actIRSAExp.c" 2
