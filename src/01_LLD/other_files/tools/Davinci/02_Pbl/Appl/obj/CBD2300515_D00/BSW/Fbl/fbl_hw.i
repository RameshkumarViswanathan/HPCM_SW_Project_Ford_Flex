# 1 "../../../../CBD2300515_D00/BSW/Fbl/fbl_hw.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/Fbl/fbl_hw.c"
# 105 "../../../../CBD2300515_D00/BSW/Fbl/fbl_hw.c"
...
# 106 "../../../../CBD2300515_D00/BSW/Fbl/fbl_hw.c" 2
# 138 "../../../../CBD2300515_D00/BSW/Fbl/fbl_hw.c"
typedef struct
{
   volatile vuint32 * con0;
   volatile vuint32 * sr;
} tFblWdtRegisters;
...
# 1 "Include/MemMap.h" 1
# 149 "../../../../CBD2300515_D00/BSW/Fbl/fbl_hw.c" 2



# 1 "Include/MemMap.h" 1
# 153 "../../../../CBD2300515_D00/BSW/Fbl/fbl_hw.c" 2



# 1 "Include/MemMap.h" 1
# 157 "../../../../CBD2300515_D00/BSW/Fbl/fbl_hw.c" 2


 static tFblWdtRegisters const fblWdtRegisters[7] =
{
   { &(*((volatile vuint32 *)((0xF0036000u) + (0x2A8u + ((0u) * 0x04u))))), &(*((volatile vuint32 *)((0xF0036000u) + (0x2B0u)))) },
   { &(*((volatile vuint32 *)((0xF0036000u) + (0x24Cu + ((0u) * 0x0Cu) + ((0u) * 0x04u))))), &(*((volatile vuint32 *)((0xF0036000u) + (0x254u + ((0u) * 0x0Cu))))) },
   { &(*((volatile vuint32 *)((0xF0036000u) + (0x24Cu + ((1u) * 0x0Cu) + ((0u) * 0x04u))))), &(*((volatile vuint32 *)((0xF0036000u) + (0x254u + ((1u) * 0x0Cu))))) },
   { &(*((volatile vuint32 *)((0xF0036000u) + (0x24Cu + ((2u) * 0x0Cu) + ((0u) * 0x04u))))), &(*((volatile vuint32 *)((0xF0036000u) + (0x254u + ((2u) * 0x0Cu))))) },
   { &(*((volatile vuint32 *)((0xF0036000u) + (0x24Cu + ((3u) * 0x0Cu) + ((0u) * 0x04u))))), &(*((volatile vuint32 *)((0xF0036000u) + (0x254u + ((3u) * 0x0Cu))))) },
   { &(*((volatile vuint32 *)((0xF0036000u) + (0x24Cu + ((4u) * 0x0Cu) + ((0u) * 0x04u))))), &(*((volatile vuint32 *)((0xF0036000u) + (0x254u + ((4u) * 0x0Cu))))) },
   { &(*((volatile vuint32 *)((0xF0036000u) + (0x24Cu + ((5u) * 0x0Cu) + ((0u) * 0x04u))))), &(*((volatile vuint32 *)((0xF0036000u) + (0x254u + ((5u) * 0x0Cu))))) }
};


# 1 "Include/MemMap.h" 1
# 172 "../../../../CBD2300515_D00/BSW/Fbl/fbl_hw.c" 2
# 182 "../../../../CBD2300515_D00/BSW/Fbl/fbl_hw.c"
# 1 "Include/MemMap.h" 1
# 183 "../../../../CBD2300515_D00/BSW/Fbl/fbl_hw.c" 2

 vuint32 fblCurrentTimer;

 vuint32 fblCurrentCmpValue;

# 1 "Include/MemMap.h" 1
# 189 "../../../../CBD2300515_D00/BSW/Fbl/fbl_hw.c" 2
...
# 3693 "Include/MemMap.h"
#pragma section ".RamCodeCoreSection" x
# 195 "../../../../CBD2300515_D00/BSW/Fbl/fbl_hw.c" 2
...
# 210 "../../../../CBD2300515_D00/BSW/Fbl/fbl_hw.c"
void FblTimerInit( void )
{
   (*((volatile vuint32 *)((0xF0001000u) + (0x30u + ((0u) * 0x100u) + ((0u) * 0x04u))))) = (*((volatile vuint32 *)((0xF0001000u) + (0x10u + ((0u) * 0x100u) + ((0u) * 0x04u))))) + 99999;
   (*((volatile vuint32 *)((0xF0001000u) + (0x38u + ((0u) * 0x100u))))) = 31uL;
   (*((volatile vuint32 *)((0xF0001000u) + (0x3Cu + ((0u) * 0x100u))))) = 0x00000000uL;
}

# 1 "Include/MemMap.h" 1
# 3699 "Include/MemMap.h"
#pragma section
# 218 "../../../../CBD2300515_D00/BSW/Fbl/fbl_hw.c" 2


# 1 "Include/MemMap.h" 1
# 3678 "Include/MemMap.h"
#pragma section ".RamCodeCoreSection" ax
# 221 "../../../../CBD2300515_D00/BSW/Fbl/fbl_hw.c" 2
...
vuint16 FblGetTimerValue(void)
{
   ...
   tempCount = (*((volatile vuint32 *)((0xF0001000u) + (0x10u + ((0u) * 0x100u) + ((0u) * 0x04u)))));

   return (vuint16)(tempCount & 0x0000FFFFuL);
}
# 247 "../../../../CBD2300515_D00/BSW/Fbl/fbl_hw.c"
static vuint32 FblHwRegisterGetIndex( tFblWdtType wdtType )
{
   vuint32 regIndex;


   regIndex = (sizeof(fblWdtRegisters) / sizeof(fblWdtRegisters[0]));
   ...
   switch (wdtType)
   {
      ...
      case FBL_WDT_CPU:
      {
         ...
         regIndex = (_mfcr(0xFE1Cu) & 0x07uL) + 1u;
   ...
   if (!((regIndex < (sizeof(fblWdtRegisters) / sizeof(fblWdtRegisters[0]))))) ApplFblFatalError((0x50u));

   return regIndex;
}
# 291 "../../../../CBD2300515_D00/BSW/Fbl/fbl_hw.c"
static vuint32 FblHwRegisterPasswordAccess( vuint32 regIndex )
{
   vuint32 wdtcon0;
   vuint32 wdtsr;
   ...
   prevPass = (wdtcon0 & (0x3FFFuL << 2u)) ^ (0x003FuL << 2u);


   if (0u == (wdtsr & (0x1uL << 7u)))
   {
   ...
   else
   {
      ...
      currentPass = (prevPass << 1u) & (0x3FFFuL << 2u);
      currentPass |= ((prevPass >> 13u) ^ (prevPass >> 12u) ^ (prevPass >> 11u) ^ (prevPass >> 1u)) & (0x1uL << 2u);
   }



   wdtcon0 &= (((0x3FFFuL << 2u) ^ 0xFFFFFFFFuL) & (((0x1uL << 1u) | (0x1uL << 0u)) ^ 0xFFFFFFFFuL));
   wdtcon0 |= (currentPass | (0x0uL << 1u) | (0x1uL << 0u));


   wdtcon0Value = wdtcon0;


   if (0u != (wdtsr & (0x1uL << 8u)))
   {
      ...
      wdtcon0 &= ((0xFFFFuL << 16u) ^ 0xFFFFFFFFuL);
      wdtcon0 |= (wdtsr ^ (0xFFFFuL << 16u)) & (0xFFFFuL << 16u);
   }
...
# 357 "../../../../CBD2300515_D00/BSW/Fbl/fbl_hw.c"
static void FblHwRegisterModifyAccess( vuint32 regIndex, vuint32 regValue, vuint32 lockBit )
{
   tFblWdtRegisters wdtRegisters;
   vuint32 wdtcon0;
   ...
   wdtcon0 = (regValue & (((0x1uL << 1u) | (0x1uL << 0u)) ^ 0xFFFFFFFFuL)) | lockBitTmp | (0x1uL << 1u);


   *(wdtRegisters.con0) = wdtcon0;


   while (lockBitTmp != (*(wdtRegisters.con0) & (0x1uL << 0u)))
   {
      ;
   }
}
# 392 "../../../../CBD2300515_D00/BSW/Fbl/fbl_hw.c"
void FblHwRegisterUnlock( tFblWdtType wdtType )
{
   ...
   FblHwRegisterModifyAccess(regIndex, wdtcon0, (0x0uL << 0u));
}
# 414 "../../../../CBD2300515_D00/BSW/Fbl/fbl_hw.c"
void FblHwRegisterLock( tFblWdtType wdtType )
{
   ...
   FblHwRegisterModifyAccess(regIndex, wdtcon0, (0x1uL << 0u));
}
# 438 "../../../../CBD2300515_D00/BSW/Fbl/fbl_hw.c"
void FblHwRegisterModify( tFblWdtType wdtType, vuint16 password, vuint16 reload )
{
   ...
   wdtcon0 &= ((0x3FFFuL << 2u) ^ 0xFFFFFFFFuL) & ((0xFFFFuL << 16u) ^ 0xFFFFFFFFuL);
   wdtcon0 |= (((vuint32)password << 2u) & (0x3FFFuL << 2u)) | ((vuint32)reload << 16u);
...
# 3685 "Include/MemMap.h"
#pragma section
# 458 "../../../../CBD2300515_D00/BSW/Fbl/fbl_hw.c" 2
# 467 "../../../../CBD2300515_D00/BSW/Fbl/fbl_hw.c"
# 1 "Include/MemMap.h" 1
# 6396 "Include/MemMap.h"
#pragma section ".RamCodeCoreSection" ax
# 468 "../../../../CBD2300515_D00/BSW/Fbl/fbl_hw.c" 2
# 481 "../../../../CBD2300515_D00/BSW/Fbl/fbl_hw.c"
void *FblOwnMemcpy(void* dest, const void* source, unsigned int count)
{
   vuint32 i;
   vuint32 j;
   unsigned int countTmp;
   const vuint8* localSource = (const vuint8*)source;
   ...
   countTmp = count;
   localDest = (vuint16 *)((vuint32)dest & 0xFFFFFFFEu);


   if (0u != countTmp)
   {

      if (((vuint32)dest & 0x01u) != 0x00u)
      {
...
# 6403 "Include/MemMap.h"
#pragma section
# 545 "../../../../CBD2300515_D00/BSW/Fbl/fbl_hw.c" 2


# 1 "Include/MemMap.h" 1
# 3693 "Include/MemMap.h"
#pragma section ".RamCodeCoreSection" x
# 548 "../../../../CBD2300515_D00/BSW/Fbl/fbl_hw.c" 2
...
{
   return *( vuint8 const *)address;
}
# 569 "../../../../CBD2300515_D00/BSW/Fbl/fbl_hw.c"
tFblLength FblReadBlock( tFblAddress address, vuint8 *buffer, tFblLength length )
{
   (void)FblOwnMemcpy( (void *)(buffer), (const void *)(address), (unsigned int)(length));
   return length;
}
...
# 3699 "Include/MemMap.h"
#pragma section
# 576 "../../../../CBD2300515_D00/BSW/Fbl/fbl_hw.c" 2
