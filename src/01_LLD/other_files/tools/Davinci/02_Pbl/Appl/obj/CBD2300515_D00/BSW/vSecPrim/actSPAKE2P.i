# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actSPAKE2P.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actSPAKE2P.c"
# 35 "../../../../CBD2300515_D00/BSW/vSecPrim/actSPAKE2P.c"
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actISPAKE2P.h" 1
# 33 "../../../../CBD2300515_D00/BSW/vSecPrim/actISPAKE2P.h"
...
# 34 "../../../../CBD2300515_D00/BSW/vSecPrim/actISPAKE2P.h" 2
...
# 40 "../../../../CBD2300515_D00/BSW/vSecPrim/actISPAKE2P.h" 2
# 71 "../../../../CBD2300515_D00/BSW/vSecPrim/actISPAKE2P.h"
actRETURNCODE actSPAKE2PPreambleInit(
  actSPAKE2PPreambleStruct * wksp,
  const actU8 * domain,
  const actU8 * domain_ext,
  actLengthType wksp_len);
# 119 "../../../../CBD2300515_D00/BSW/vSecPrim/actISPAKE2P.h"
actRETURNCODE actSPAKE2PPreambleCalc(
  actSPAKE2PPreambleStruct * wksp,
  const actU8 * pbkdfOutput,
  const actLengthType pbkdfOutputLength,
  actU8 * w0OutputBuffer,
  actLengthType * w0BufferLength,
  actU8 * w1OutputBuffer,
  actLengthType * w1BufferLength,
  actU8 * pointL,
  actLengthType * pointLBufferLength,
  void ( * watchdog)(void));
# 161 "../../../../CBD2300515_D00/BSW/vSecPrim/actISPAKE2P.h"
actRETURNCODE actSPAKE2PInit(
  actSPAKE2PSTRUCT * wksp,
  const actU8 * domain,
  const actU8 * domain_ext,
  const actU8 * pointM,
  ...
  actLengthType wksp_len);
# 198 "../../../../CBD2300515_D00/BSW/vSecPrim/actISPAKE2P.h"
 actRETURNCODE actSPAKE2PSetPreambleData(
   actSPAKE2PSTRUCT * wsSpake,
   const actU8 * w0,
...
# 237 "../../../../CBD2300515_D00/BSW/vSecPrim/actISPAKE2P.h"
actRETURNCODE actSPAKE2PCalcPubVal(
  actSPAKE2PSTRUCT * wsSpake,
  actU8 * pubValXCoordinate,
  actU8 * pubValYCoordinate,
  actLengthType * pubValCoordinateLength,
  void ( * watchdog)(void));
# 272 "../../../../CBD2300515_D00/BSW/vSecPrim/actISPAKE2P.h"
actRETURNCODE actSPAKE2PSetAdditionalInformation(
  actSPAKE2PSTRUCT * wsSpake,
  actSHA256STRUCT * wsHash,
  const actU8 * infoA,
  ...
  void ( * watchdog)(void));
# 321 "../../../../CBD2300515_D00/BSW/vSecPrim/actISPAKE2P.h"
actRETURNCODE actSPAKE2PCalcSharedSecret(
  actSPAKE2PSTRUCT * wsSpake,
  actSHA256STRUCT * wsHash,
  actHKDFSTRUCT * wsHKDF,
  actCMACAESSTRUCT * wsCMAC,
  const actU8 * pubValXCoordinate,
  const actU8 * pubValYCoordinate,
  const actLengthType pubValCoordinateLength,
  actU8 * sharedSecret,
  actU8 * confirmationMAC,
  void ( * watchdog)(void));
# 355 "../../../../CBD2300515_D00/BSW/vSecPrim/actISPAKE2P.h"
actRETURNCODE actSPAKE2PConfirmKey(
  actSPAKE2PSTRUCT * wsSpake,
  actCMACAESSTRUCT * wsCMAC,
  const actU8 * mac,
  actU8 * recomputedMAC,
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 368 "../../../../CBD2300515_D00/BSW/vSecPrim/actISPAKE2P.h" 2
# 36 "../../../../CBD2300515_D00/BSW/vSecPrim/actSPAKE2P.c" 2
...
# 37 "../../../../CBD2300515_D00/BSW/vSecPrim/actSPAKE2P.c" 2
...
# 38 "../../../../CBD2300515_D00/BSW/vSecPrim/actSPAKE2P.c" 2
...
# 39 "../../../../CBD2300515_D00/BSW/vSecPrim/actSPAKE2P.c" 2
...
# 40 "../../../../CBD2300515_D00/BSW/vSecPrim/actSPAKE2P.c" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actIHKDF_HMAC.h" 1
# 50 "../../../../CBD2300515_D00/BSW/vSecPrim/actIHKDF_HMAC.h"
# 1 "GenData/vSecPrim_MemMap.h" 1
# 51 "../../../../CBD2300515_D00/BSW/vSecPrim/actIHKDF_HMAC.h" 2
# 72 "../../../../CBD2300515_D00/BSW/vSecPrim/actIHKDF_HMAC.h"
void actHKDF_HMAC_Extract(
  actHKDFSTRUCT * info,
  const actU8 * secret,
  ...
  actU8 hashMACidx,
  void ( * watchdog)(void));
# 109 "../../../../CBD2300515_D00/BSW/vSecPrim/actIHKDF_HMAC.h"
actRETURNCODE actHKDF_HMAC_Expand(
  actHKDFSTRUCT * info,
  const actU8 * addInput,
  actLengthType addInputLength,
  actU8 * derivedKey,
  const actLengthType derivedKeyLength,
  actU8 hashMACidx,
  void ( * watchdog)(void));
# 147 "../../../../CBD2300515_D00/BSW/vSecPrim/actIHKDF_HMAC.h"
actRETURNCODE actHKDF_HMAC_OneStepDerive(
  actHKDFSTRUCT * info,
  const actU8 * secret,
  actLengthType secretLength,
  const actU8 * salt,
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 162 "../../../../CBD2300515_D00/BSW/vSecPrim/actIHKDF_HMAC.h" 2
# 41 "../../../../CBD2300515_D00/BSW/vSecPrim/actSPAKE2P.c" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actICMACAES.h" 1
# 39 "../../../../CBD2300515_D00/BSW/vSecPrim/actICMACAES.h"
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actAES.h" 1
# 40 "../../../../CBD2300515_D00/BSW/vSecPrim/actAES.h"
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actIAES.h" 1
# 42 "../../../../CBD2300515_D00/BSW/vSecPrim/actIAES.h"
...
# 40 "../../../../CBD2300515_D00/BSW/vSecPrim/actICMACAES.h" 2
# 48 "../../../../CBD2300515_D00/BSW/vSecPrim/actICMACAES.h"
# 1 "GenData/vSecPrim_MemMap.h" 1
# 49 "../../../../CBD2300515_D00/BSW/vSecPrim/actICMACAES.h" 2
# 67 "../../../../CBD2300515_D00/BSW/vSecPrim/actICMACAES.h"
actRETURNCODE actCMACAESInit(
   actCMACAESSTRUCT * info,
   const actU8 * key, actLengthType key_length,
   void ( * watchdog)(void));
# 88 "../../../../CBD2300515_D00/BSW/vSecPrim/actICMACAES.h"
actRETURNCODE actCMACAESUpdate(
   actCMACAESSTRUCT * info,
   const actU8 * dataIN, actLengthType length,
   void ( * watchdog)(void));
# 110 "../../../../CBD2300515_D00/BSW/vSecPrim/actICMACAES.h"
actRETURNCODE actCMACAESFinalize(
   actCMACAESSTRUCT * info, actU8 * mac,
   void ( * watchdog)(void));


# 1 "GenData/vSecPrim_MemMap.h" 1
# 116 "../../../../CBD2300515_D00/BSW/vSecPrim/actICMACAES.h" 2
# 42 "../../../../CBD2300515_D00/BSW/vSecPrim/actSPAKE2P.c" 2
