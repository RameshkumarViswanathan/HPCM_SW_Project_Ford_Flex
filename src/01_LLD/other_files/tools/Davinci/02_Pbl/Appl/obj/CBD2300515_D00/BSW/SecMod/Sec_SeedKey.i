# 1 "../../../../CBD2300515_D00/BSW/SecMod/Sec_SeedKey.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/SecMod/Sec_SeedKey.c"
# 39 "../../../../CBD2300515_D00/BSW/SecMod/Sec_SeedKey.c"
...
# 40 "../../../../CBD2300515_D00/BSW/SecMod/Sec_SeedKey.c" 2
# 48 "../../../../CBD2300515_D00/BSW/SecMod/Sec_SeedKey.c"
...
# 49 "../../../../CBD2300515_D00/BSW/SecMod/Sec_SeedKey.c" 2
...
# 51 "../../../../CBD2300515_D00/BSW/SecMod/Sec_SeedKey.c" 2
# 148 "../../../../CBD2300515_D00/BSW/SecMod/Sec_SeedKey.c"
...
# 1 "Include/MemMap.h" 1
# 157 "../../../../CBD2300515_D00/BSW/SecMod/Sec_SeedKey.c" 2

static SecM_StatusType SecM_GenerateRandom( SecM_ByteType * pRandom, SecM_WordType length );
...
static SecM_StatusType SecM_ConsumeEntropy( SecM_EntropyPoolType * pEntropyPool,
...
# 1 "Include/MemMap.h" 1
# 176 "../../../../CBD2300515_D00/BSW/SecMod/Sec_SeedKey.c" 2
# 194 "../../../../CBD2300515_D00/BSW/SecMod/Sec_SeedKey.c"
# 1 "Include/MemMap.h" 1
# 195 "../../../../CBD2300515_D00/BSW/SecMod/Sec_SeedKey.c" 2



# 1 "Include/MemMap.h" 1
# 199 "../../../../CBD2300515_D00/BSW/SecMod/Sec_SeedKey.c" 2
...
# 1 "Include/MemMap.h" 1
# 206 "../../../../CBD2300515_D00/BSW/SecMod/Sec_SeedKey.c" 2
# 217 "../../../../CBD2300515_D00/BSW/SecMod/Sec_SeedKey.c"
static SecM_StatusType SecM_GenerateRandom( SecM_ByteType * pRandom, SecM_WordType length )
{
   ...
   if (SecM_RandomGenerateJob(0x00000001u, (pRandom), (pLength)) == 0x00u)
   {
...
# 329 "../../../../CBD2300515_D00/BSW/SecMod/Sec_SeedKey.c"
static SecM_StatusType SecM_ConsumeEntropy( SecM_EntropyPoolType * pEntropyPool,
   SecM_LengthType consumed )
{
   ...
   SecM_LengthType offset;
   SecM_ByteType * pSource;
   SecM_ByteType * pTarget;
   ...
   else
   {
      ...
      if (consumed > 0u)
      {
         ...
         for (index = 0u; index < (0x00000020u - (SecM_ShortFastType)consumed); index++)
         {
...
# 389 "../../../../CBD2300515_D00/BSW/SecMod/Sec_SeedKey.c"
void SecM_InitEntropy( SecM_EntropyPoolType * pEntropyPool )
...

{
   ...
   for (index = 0u; index < 0x00000020u; index++)
   {
      pPool[index] = 0x00u;
   }
}
...
# 1 "Include/MemMap.h" 1
# 413 "../../../../CBD2300515_D00/BSW/SecMod/Sec_SeedKey.c" 2
...
# 7030 "Include/MemMap.h"
#pragma section ".RamCodeCoreSection" ax
# 417 "../../../../CBD2300515_D00/BSW/SecMod/Sec_SeedKey.c" 2
# 427 "../../../../CBD2300515_D00/BSW/SecMod/Sec_SeedKey.c"
void SecM_ProvideEntropy( SecM_EntropyPoolType * pEntropyPool,
   SecM_ByteType * entropy, SecM_LengthType length )
...
# 7037 "Include/MemMap.h"
#pragma section
# 470 "../../../../CBD2300515_D00/BSW/SecMod/Sec_SeedKey.c" 2



# 1 "Include/MemMap.h" 1
# 474 "../../../../CBD2300515_D00/BSW/SecMod/Sec_SeedKey.c" 2
# 490 "../../../../CBD2300515_D00/BSW/SecMod/Sec_SeedKey.c"
SecM_StatusType SecM_GenerateSeed( SecM_SeedType * seed )
{
   SecM_StatusType result;
   SecM_SeedBaseType * pBaseSeed;
   SecM_ByteType * pRandom;
# 504 "../../../../CBD2300515_D00/BSW/SecMod/Sec_SeedKey.c"
   SecM_EntropyPoolType * pPool;
# 514 "../../../../CBD2300515_D00/BSW/SecMod/Sec_SeedKey.c"
   pBaseSeed = seed->data;
   ...
   pRandom = pBaseSeed;
# 543 "../../../../CBD2300515_D00/BSW/SecMod/Sec_SeedKey.c"
   pPool = seed->entropyPool;
# 555 "../../../../CBD2300515_D00/BSW/SecMod/Sec_SeedKey.c"
   result = 0x00u;
   ...
   if (SEC_RNG_UNINTIALIZED == pPool->state)
   {
      ...
      else
      {
         ...
         pPool->fillLevel = (SecM_LengthType)0x00000020u;
         result = SecM_RandomSeedJob(0x00000000u, (pPool)->data, (pPool)->fillLevel);


         if (SecM_ConsumeEntropy(pPool, pPool->fillLevel) != 0x00u)
         {
            result = 0xFFu;
         }
   ...
   else
   {
      ...
      if (pPool->fillLevel >= (SecM_LengthType)0x00000020u)
      {
         result = SecM_RandomSeedJob(0x00000000u, (pPool)->data, (pPool)->fillLevel);
...

   {
      ...
      result = SecM_GenerateRandom(pRandom, 0x00000010u);
# 637 "../../../../CBD2300515_D00/BSW/SecMod/Sec_SeedKey.c"
      if (result == 0x00u)
      {
...
# 687 "../../../../CBD2300515_D00/BSW/SecMod/Sec_SeedKey.c"
...
# 712 "../../../../CBD2300515_D00/BSW/SecMod/Sec_SeedKey.c"
SecM_StatusType SecM_CompareKey( SecM_KeyType key, SecM_SeedType lastSeed )
{
   ...
   for (index = 0u; index < 0x00000012u; index++)
   {
      computeVal[index] = 0u;
   }
   ...
   if ((secTimer) > 0u)
   {
      ...
      keyConstant.constant = 0x00000000u;


      keyConstant.context = key.context;
# 760 "../../../../CBD2300515_D00/BSW/SecMod/Sec_SeedKey.c"
      result = SecM_ComputeKey(((lastSeed).data), keyConstant, (SecM_CompareType*)&computeVal);
      ...
      for (index = 0u; index < 0x00000012u; index++)
      {
         ...
         if (computeVal[index] != key.data[index])
         {

            result = 0xFFu;
         }
      }
# 785 "../../../../CBD2300515_D00/BSW/SecMod/Sec_SeedKey.c"
      (secTimer = 0u);
   }
...
# 1 "Include/MemMap.h" 1
# 806 "../../../../CBD2300515_D00/BSW/SecMod/Sec_SeedKey.c" 2
