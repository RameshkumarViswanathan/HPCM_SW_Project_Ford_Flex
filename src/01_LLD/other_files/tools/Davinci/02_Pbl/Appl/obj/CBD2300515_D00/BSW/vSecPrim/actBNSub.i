# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNSub.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNSub.c"
# 39 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNSub.c"
...
# 40 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNSub.c" 2
...
# 41 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNSub.c" 2




# 1 "GenData/vSecPrim_MemMap.h" 1
# 46 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNSub.c" 2
# 69 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNSub.c"
void actBNSub(
  const actBNDIGIT * a,
  const actBNDIGIT * b,
  actBNDIGIT * c,
...
{
  actLengthType i;
  actBNDDIGIT tmp = ((actBNDDIGIT)(1) << ((32u)));

  for (i = 0; i < length; ++i)
  {

     tmp = (actBNDDIGIT)(((actBNDDIGIT)(1) << ((32u))) | a[i]) - b[i] - (1u - (actBNDDIGIT)((actBNDIGIT)((tmp) >> ((32u)))));
    c[i] = ((actBNDIGIT)(tmp));
  }
}
# 97 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNSub.c"
void actBNSubDigit(
  const actBNDIGIT * a,
  const actBNDIGIT b,
  actBNDIGIT * c,
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 125 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNSub.c" 2
