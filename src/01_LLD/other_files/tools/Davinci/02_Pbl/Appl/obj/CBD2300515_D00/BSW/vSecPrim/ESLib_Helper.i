# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_Helper.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_Helper.c"
# 39 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_Helper.c"
...
# 40 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_Helper.c" 2
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 47 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_Helper.c" 2
# 64 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_Helper.c"
void esl_ResetAndClearWorkspace(eslt_WorkSpaceHeader * workSpaceHeader, void * workSpaceBuffer)
{

  workSpaceHeader->status = (0x007Fu);
...
# 84 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_Helper.c"
void esl_SetWorkspaceStatus(eslt_WorkSpaceHeader * workSpaceHeader, eslt_WSStatus algo)
{

    workSpaceHeader->status = (algo | (0x4000u) | (0x8000u));
}
# 98 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_Helper.c"
eslt_ErrorCode esl_CheckWorkSpaceHeader(const eslt_WorkSpaceHeader * workSpaceHeader, eslt_Length minSize)
{
  ...
  {
    retVal = (0x2000u + 0x0002u);
  }

  return retVal;
}
# 119 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_Helper.c"
eslt_ErrorCode esl_CheckWorkSpaceState(
  const eslt_WorkSpaceHeader * workSpaceHeader,
  eslt_WSStatus algo)
{
  ...
  if (((workSpaceHeader->status & (0x1F80u)) != algo) || ((workSpaceHeader->status & (0x4000u)) == 0u))
  {
...
# 142 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_Helper.c"
eslt_ErrorCode esl_CheckWorkSpaceHeaderAndState(
  const eslt_WorkSpaceHeader * workSpaceHeader,
...
# 170 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_Helper.c"
eslt_ErrorCode esl_checkLengthRef(eslt_LengthConstRef lenRef, eslt_Length lengthValue)
{
  eslt_ErrorCode retVal = (0x0000u);
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 192 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_Helper.c" 2
