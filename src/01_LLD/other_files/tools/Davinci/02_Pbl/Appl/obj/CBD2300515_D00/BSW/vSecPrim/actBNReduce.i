# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNReduce.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNReduce.c"
# 39 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNReduce.c"
...
# 40 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNReduce.c" 2
...
# 41 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNReduce.c" 2
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 49 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNReduce.c" 2
# 68 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNReduce.c"
static actBNDIGIT actBNMulDigit(
  const actBNDIGIT * a,
  const actLengthType a_length,
  const actBNDIGIT b,
  actBNDIGIT * c);
# 99 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNReduce.c"
static void actBNNormalize(
  actBNDIGIT * a,
  actLengthType * a_length,
  actBNDIGIT * b,
  actLengthType b_length,
  actLengthType shift);
# 126 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNReduce.c"
static void actBNReNormalize(
  actBNDIGIT * r,
  actBNDIGIT * b,
  actLengthType b_length,
  actLengthType shift);
# 154 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNReduce.c"
actRETURNCODE actBNReduceLengthCheck(
  const actBNDIGIT * a,
  actLengthType * a_length,
  const actBNDIGIT * b,
  actLengthType * b_length,
  actBNDIGIT * r);
# 181 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNReduce.c"
void actBNReduceInitialize(
  actBNDIGIT * a,
  actLengthType * a_length,
  actBNDIGIT * b,
  const actLengthType * b_length,
  actLengthType * shift);
# 207 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNReduce.c"
void actBNReduceComputeQuotientEstimate(
  const actBNDIGIT * a,
  const actBNDIGIT * b,
  actLengthType idx,
  actLengthType b_length,
  actBNDIGIT * qDig);
# 237 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNReduce.c"
void actBNReduceRefineQuotientEstimate(
  const actBNDIGIT * a,
  actLengthType idx,
  const actBNDIGIT * b,
  actLengthType b_length,
  actBNDIGIT * qDig,
  void ( * watchdog)(void));
# 270 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNReduce.c"
void actBNReduceUpdateCurrentProduct(
  const actBNDIGIT * a,
  const actBNDIGIT * b,
  actLengthType idx,
  actLengthType b_length,
  ...
  actBNDIGIT * r,
  void ( * watchdog)(void));
# 293 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNReduce.c"
  static actBNDIGIT actBNMulDigit(
    const actBNDIGIT * a,
    const actLengthType a_length,
    const actBNDIGIT b,
    actBNDIGIT * c)
{
  ...
  for (i = 0u; i < a_length; ++i)
  {
    ...
    tmp = ((actBNDDIGIT) a[i] * b) + ((actBNDIGIT)((tmp) >> ((32u))));
    c[i] = ((actBNDIGIT)(tmp));
  }
  return ((actBNDIGIT)((tmp) >> ((32u))));
}
# 325 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNReduce.c"
static void actBNNormalize(
   actBNDIGIT * a,
  actLengthType * a_length,
   actBNDIGIT * b,
...
# 360 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNReduce.c"
static void actBNReNormalize(
   actBNDIGIT * r,
   actBNDIGIT * b,
  actLengthType b_length,
  actLengthType shift)
{
  ...
  actBNDIGIT tmp = (actBNDIGIT)(((actBNDIGIT)1u) << (((32u)) - shift));
...
# 393 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNReduce.c"
actRETURNCODE actBNReduceLengthCheck(
  const actBNDIGIT * a,
  actLengthType * a_length,
  const actBNDIGIT * b,
  ...
  actBNDIGIT * r)
{
  ...
  else
  {
    ...
    {
      if (actBNCompare(a, b, *a_length) == (0x10u))
      {
...
# 451 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNReduce.c"
void actBNReduceInitialize(
  actBNDIGIT * a,
  actLengthType * a_length,
  actBNDIGIT * b,
  ...
  actLengthType * shift)
{
  ...
  while (tmp < ((actBNDDIGIT)(1u) << (((32u))-1u)))
  {
    tmp <<= 1;
    *shift = *shift + 1u;
  }
  ...
  if (actBNCompare(&a[*a_length - *b_length], b, *b_length) >= (0x11u))
  {
    actBNSub(&a[*a_length - *b_length], b, &a[*a_length - *b_length], *b_length);
  }
}
# 498 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNReduce.c"
void actBNReduceComputeQuotientEstimate(
  const actBNDIGIT * a,
  const actBNDIGIT * b,
  actLengthType idx,
  ...
  actBNDIGIT * qDig)
{
  ...
  {
    tmp = ((((actBNDDIGIT)a[idx]) << ((32u))) + a[idx - 1u]) / b[b_length - 1u];

    qDig[0] = (actBNDIGIT)(((actBNDIGIT)tmp) + 1u);
  }
}
# 534 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNReduce.c"
void actBNReduceRefineQuotientEstimate(
  const actBNDIGIT * a,
  actLengthType idx,
  const actBNDIGIT * b,
  ...
  void ( * watchdog)(void))
{
  ...
  do
  {
    ...
    digits[0] = ((actBNDIGIT)(tmp));
    tmp = (((actBNDDIGIT)(*qDig)) * b[b_length - 1u]) + ((actBNDIGIT)((tmp) >> ((32u))));
    digits[1] = ((actBNDIGIT)(tmp));
    digits[2] = ((actBNDIGIT)((tmp) >> ((32u))));

    actWatchdogTriggerFunction(watchdog);
  } while (actBNCompare(&a[idx - 2u], digits, 3) == (0x10u));
}
# 569 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNReduce.c"
void actBNReduceUpdateCurrentProduct(
  const actBNDIGIT * a,
  const actBNDIGIT * b,
  ...
  void ( * watchdog)(void))
{
  ...
  if (actBNCompare(&a[idx - b_length], r, b_length + 1u) == (0x10u))
  {
    --(*qDig);
    r[b_length] = actBNMulDigit(b, b_length, *qDig, r);
  }
...
# 621 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNReduce.c"
actRETURNCODE actBNReduce(
   actBNDIGIT * a,
  actLengthType a_length,
   actBNDIGIT * b,
  actLengthType b_length,
   actBNDIGIT * r, void ( * watchdog)(void))
{
  actRETURNCODE retVal = (0x01u);
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 696 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNReduce.c" 2
