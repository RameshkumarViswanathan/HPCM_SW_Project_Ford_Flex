# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSAprim_sign.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSAprim_sign.c"
# 39 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSAprim_sign.c"
...
# 40 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSAprim_sign.c" 2
...
# 41 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSAprim_sign.c" 2
...
# 42 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSAprim_sign.c" 2
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 49 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSAprim_sign.c" 2
# 62 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSAprim_sign.c"
eslt_ErrorCode esl_initSignRSA_prim(
  eslt_WorkSpaceRSAsig_prim * workSpace,
  eslt_Length keyPairModuleSize,
  const eslt_Byte * keyPairModule,
  eslt_Length privateKeyExponentSize,
  const eslt_Byte * privateKeyExponent)
{
  ...
  if ((workSpace == ((void *)0)) || (keyPairModule == ((void *)0)) || (privateKeyExponent == ((void *)0)))
  {
    returnValue = (0x2000u + 0x0003u);
  }
  else if ((returnValue = esl_CheckWorkSpaceHeader(&workSpace->header, (sizeof(actRSAPRIMSTRUCT)))) != (0x0000u))
  {
  ...
  else
  {
    ...
    {
      if (actReturnValue == (0xF4u))
      {
        returnValue = (0x2000u + 0x0002u);
      }
      else if (actReturnValue == (0x90u))
      {
        returnValue = (0x2000u + 0x0003u);
      }
      else
...
# 127 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSAprim_sign.c"
eslt_ErrorCode esl_signRSA_prim(
  eslt_WorkSpaceRSAsig_prim * workSpace,
  eslt_Length messageSize,
  const eslt_Byte * message,
  eslt_Length * signatureSize,
  eslt_Byte * signature)
{
  ...
  if ((workSpace == ((void *)0)) || (signatureSize == ((void *)0)) || (signature == ((void *)0)) || (message == ((void *)0)))
  {
    returnValue = (0x2000u + 0x0003u);
  }
  else if ((returnValue = esl_CheckWorkSpaceHeaderAndState(&(workSpace->header), (sizeof(actRSAPRIMSTRUCT)), (0x0700u))) != (0x0000u))
  {
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 174 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSAprim_sign.c" 2
