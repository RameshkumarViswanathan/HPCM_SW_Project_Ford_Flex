# 1 "../../../../CBD2300515_D00/BSW/Fbl/fbl_valstruct.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/Fbl/fbl_valstruct.c"
# 58 "../../../../CBD2300515_D00/BSW/Fbl/fbl_valstruct.c"
...
# 59 "../../../../CBD2300515_D00/BSW/Fbl/fbl_valstruct.c" 2
# 1 "../../../../CBD2300515_D00/BSW/Fbl/fbl_valstruct.h" 1
# 65 "../../../../CBD2300515_D00/BSW/Fbl/fbl_valstruct.h"
# 1 "../../../../CBD2300515_D00/BSW/Fbl/fbl_valstruct_oem.h" 1
# 66 "../../../../CBD2300515_D00/BSW/Fbl/fbl_valstruct.h" 2
# 85 "../../../../CBD2300515_D00/BSW/Fbl/fbl_valstruct.h"
...
# 1 "Include/MemMap.h" 1
# 96 "../../../../CBD2300515_D00/BSW/Fbl/fbl_valstruct.h" 2
...
# 1 "Include/MemMap.h" 1
# 101 "../../../../CBD2300515_D00/BSW/Fbl/fbl_valstruct.h" 2
# 60 "../../../../CBD2300515_D00/BSW/Fbl/fbl_valstruct.c" 2
# 173 "../../../../CBD2300515_D00/BSW/Fbl/fbl_valstruct.c"
typedef struct
{
   vuint32 alignDummy;
   vuint8 data[((0x00u + 0x02u + 0x02u + 0x00u) + ((16u - 2u) * (0x04u + 0x04u + 0x20u)) + (0x00u + 0x00u))];
} tAlignedReadBuffer;
...
# 198 "../../../../CBD2300515_D00/BSW/Fbl/fbl_valstruct.c"
# 1 "Include/MemMap.h" 1
# 199 "../../../../CBD2300515_D00/BSW/Fbl/fbl_valstruct.c" 2
 static tAlignedReadBuffer readBuffer;




# 1 "Include/MemMap.h" 1
# 205 "../../../../CBD2300515_D00/BSW/Fbl/fbl_valstruct.c" 2
# 213 "../../../../CBD2300515_D00/BSW/Fbl/fbl_valstruct.c"
# 1 "Include/MemMap.h" 1
# 214 "../../../../CBD2300515_D00/BSW/Fbl/fbl_valstruct.c" 2
...
static tFblValStructResult FblValStructCompareSegmentChecksum( const tVsSegInfo * vsSegInfo,
                                                               const tDiagSegmentList * blockSegInfo );
# 250 "../../../../CBD2300515_D00/BSW/Fbl/fbl_valstruct.c"
# 1 "Include/MemMap.h" 1
# 251 "../../../../CBD2300515_D00/BSW/Fbl/fbl_valstruct.c" 2
# 259 "../../../../CBD2300515_D00/BSW/Fbl/fbl_valstruct.c"
# 1 "Include/MemMap.h" 1
# 260 "../../../../CBD2300515_D00/BSW/Fbl/fbl_valstruct.c" 2
# 300 "../../../../CBD2300515_D00/BSW/Fbl/fbl_valstruct.c"
static tFblValStructResult FblValStructGetSegmentInfo( tVsInfo * vsInfo )
{
   ...
   if (FblReadProm(vsInfo->address, readBuffer.data, (0x00u + 0x02u + 0x02u + 0x00u)) != (0x00u + 0x02u + 0x02u + 0x00u))
   {

      result = 5u;
   }
# 335 "../../../../CBD2300515_D00/BSW/Fbl/fbl_valstruct.c"
   if (0u == result)
   {

      if (((0x0000u == (((vuint16)(FblMemGetInteger(sizeof(vuint16), (&(readBuffer.data)[((0x00u) + 0x00u)])) & 0xFFFFu)))) ? 0u : 1u) != 0u)
      {
   ...
   if (0u == result)
   {
      ...
      vsSegCount = ((vuint16)(FblMemGetInteger(sizeof(vuint16), (&(readBuffer.data)[(((0x00u) + 0x00u) + 0x02u)])) & 0xFFFFu));
      if (vsSegCount <= (16u - 2u))
      {
...
# 373 "../../../../CBD2300515_D00/BSW/Fbl/fbl_valstruct.c"
   if (0u == result)
   {

      vsTotalSize = ((0x00u + 0x02u + 0x02u + 0x00u) + (((vuint32) vsInfo->segInfo.nrOfSegments) * (0x04u + 0x04u + 0x20u)) + (0x00u + 0x00u));


      if (FblReadProm((vsInfo->address + (0x00u + 0x02u + 0x02u + 0x00u)),
                     &(readBuffer.data[(0x00u + 0x02u + 0x02u + 0x00u)]),
                      (vsTotalSize - (0x00u + 0x02u + 0x02u + 0x00u))) != (vsTotalSize - (0x00u + 0x02u + 0x02u + 0x00u)))
      {

         result = 5u;
      }
   }
# 413 "../../../../CBD2300515_D00/BSW/Fbl/fbl_valstruct.c"
   if (0u == result)
   {
      ...
      {
         vsInfo->segInfo.segmentInfo[segIndex].targetAddress = FblMemGetInteger(sizeof(vuint32), (&(readBuffer.data)[(((((0x00u) + 0x00u) + 0x02u) + 0x02u) + 0x00u + ((segIndex) * (0x04u + 0x04u + 0x20u)))]));
         vsInfo->segInfo.segmentInfo[segIndex].length = FblMemGetInteger(sizeof(vuint32), (&(readBuffer.data)[((((((0x00u) + 0x00u) + 0x02u) + 0x02u) + 0x00u + ((segIndex) * (0x04u + 0x04u + 0x20u))) + 0x04u)]));

         (void)FblOwnMemcpy( (void *)(vsInfo->segInfo.segmentInfo[segIndex].checksum), (const void *)(&(readBuffer.data)[(((((((0x00u) + 0x00u) + 0x02u) + 0x02u) + 0x00u + ((segIndex) * (0x04u + 0x04u + 0x20u))) + 0x04u) + 0x04u)]), (unsigned int)(0x20u));
      }
   }
...
# 442 "../../../../CBD2300515_D00/BSW/Fbl/fbl_valstruct.c"
static void FblValStructRemoveStructSegment( const tVsInfo * vsInfo, tDiagSegmentList * blockSegInfo )
{
   vuint8 segIdx;
...
# 466 "../../../../CBD2300515_D00/BSW/Fbl/fbl_valstruct.c"
...
# 504 "../../../../CBD2300515_D00/BSW/Fbl/fbl_valstruct.c"
   verifyParam.key = ((SecM_VerifyKeyType)0);


   if (0u == result)
   {

      secStatus = SecM_VerificationClassCCC_Rsa2048PssSha256(&verifyParam);
      if (0x00u != secStatus)
      {
...
# 644 "../../../../CBD2300515_D00/BSW/Fbl/fbl_valstruct.c"
static tFblValStructResult FblValStructChecksumExternal( const tBlockDescriptor * blockDescriptor,
                                                         tVsInfo * vsInfo,
                                                         tDiagSegmentList * blockSegInfo )
{
   ...
   (void)FblDiagGetSegmentList(blockDescriptor->blockNr, blockSegInfo);
...
# 682 "../../../../CBD2300515_D00/BSW/Fbl/fbl_valstruct.c"
static tFblValStructResult FblValStructCompareSegmentLocation( tVsInfo * vsInfo,
                                                               const tDiagSegmentList * blockSegInfo)
{
   tFblValStructResult result;
...
# 738 "../../../../CBD2300515_D00/BSW/Fbl/fbl_valstruct.c"
...
# 1013 "../../../../CBD2300515_D00/BSW/Fbl/fbl_valstruct.c"
tFblValStructResult FblValStructValidateBlockExtended( const tBlockDescriptor * blockDescriptor,
                                                       const tFblValStructOption option )
{
   ...
   if (!(! (((option) & 0x01u) == 0x01u))) ApplFblFatalError((0x50u));



   if (!(! (((option) & 0x02u) == 0x02u))) ApplFblFatalError((0x50u));



   if (!(! (((option) & 0x04u) == 0x04u))) ApplFblFatalError((0x50u));


   vsInfo.address = ((blockDescriptor)->headerAddress);
   ...
   if (0u == result)
   {
      ...
      result = (tFblValStructResult)((256u == FblReadProm(((blockDescriptor)->headerAddress - 256u), (readBuffer.data), 256u)) ? 0u : 5u);
      if (0u == result)
      {
   ...
   if (0u == result)
   {
      ...
      vsInfo.address = ((blockDescriptor)->headerAddress - 256u);
      vsInfo.length = (256u + (vsInfo.length));
# 1072 "../../../../CBD2300515_D00/BSW/Fbl/fbl_valstruct.c"
      {

         result = FblValStructChecksumExternal(blockDescriptor, &vsInfo, &blockSegInfo);
      }
   }
# 1090 "../../../../CBD2300515_D00/BSW/Fbl/fbl_valstruct.c"
   if (0u == result)
   {
...
# 1111 "../../../../CBD2300515_D00/BSW/Fbl/fbl_valstruct.c"
tFblValStructResult FblValStructValidateBlock( const tBlockDescriptor * blockDescriptor )
{
   return FblValStructValidateBlockExtended(blockDescriptor, ((0x00u)));
}

# 1 "Include/MemMap.h" 1
# 1117 "../../../../CBD2300515_D00/BSW/Fbl/fbl_valstruct.c" 2
