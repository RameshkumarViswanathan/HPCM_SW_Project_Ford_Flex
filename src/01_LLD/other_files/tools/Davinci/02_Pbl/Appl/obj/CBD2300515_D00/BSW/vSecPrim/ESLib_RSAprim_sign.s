...
.Ltext0:
.section .text.esl_initSignRSA_prim,"ax",@progbits
	.align 1
	.global	esl_initSignRSA_prim
	.type	esl_initSignRSA_prim, @function
esl_initSignRSA_prim:
.LFB15:
	.file 1 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSAprim_sign.c"
	.loc 1 68 0
.LVL0:
	mov.d	%d2, %a5
	mov.d	%d3, %a6
...
.LBB2:
	...
	lea	%a6, [%a15] 16
	ld.a	%a7, [%a15] 8
	call	actRSAInitPrivateKeyOperation
.LVL4:
	.loc 1 87 0
	jz	%d2, .L3
	.loc 1 89 0
...
.LBE2:
	...
	ret
.LFE15:
	.size	esl_initSignRSA_prim, .-esl_initSignRSA_prim
.section .text.esl_signRSA_prim,"ax",@progbits
	.align 1
	.global	esl_signRSA_prim
	.type	esl_signRSA_prim, @function
esl_signRSA_prim:
.LFB16:
	.loc 1 133 0
.LVL9:
...
.LVL14:
	...
	mov.aa	%a5, %a14
	lea	%a7, [%a15] 16
	call	actRSAPrivateKeyOperation
.LVL15:
	.loc 1 151 0
	jz	%d2, .L9
	.loc 1 153 0
...
.LBE3:
	...
	ret
.LFE16:
	.size	esl_signRSA_prim, .-esl_signRSA_prim
...
.Ldebug_info0:
	...
	.byte	0x1
	.string	"../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSAprim_sign.c"
...
.LASF0:
	.string	"workSpace"
	.extern	actRSAPrivateKeyOperation,STT_FUNC,0
	.extern	esl_CheckWorkSpaceHeaderAndState,STT_FUNC,0
	.extern	esl_SetWorkspaceStatus,STT_FUNC,0
	.extern	actRSAInitPrivateKeyOperation,STT_FUNC,0
