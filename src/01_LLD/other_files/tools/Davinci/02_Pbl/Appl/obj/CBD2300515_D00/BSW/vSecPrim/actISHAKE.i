# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actISHAKE.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actISHAKE.c"
# 39 "../../../../CBD2300515_D00/BSW/vSecPrim/actISHAKE.c"
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actISHAKE.h" 1
# 40 "../../../../CBD2300515_D00/BSW/vSecPrim/actISHAKE.h"
...
# 41 "../../../../CBD2300515_D00/BSW/vSecPrim/actISHAKE.h" 2
...
# 47 "../../../../CBD2300515_D00/BSW/vSecPrim/actISHAKE.h" 2
# 68 "../../../../CBD2300515_D00/BSW/vSecPrim/actISHAKE.h"
actRETURNCODE actSHAKEInit(
  actKECCAKcSTRUCT * info,
  const actU32 strength);
# 93 "../../../../CBD2300515_D00/BSW/vSecPrim/actISHAKE.h"
actRETURNCODE actSHAKEUpdate(
  actKECCAKcSTRUCT * info,
  const actU8 * data,
  const actLengthType dataLength,
  void ( * watchdog)(void));
# 120 "../../../../CBD2300515_D00/BSW/vSecPrim/actISHAKE.h"
actRETURNCODE actSHAKEGetXOFDigest(
  actKECCAKcSTRUCT * info,
  actU8 * digest,
  const actLengthType digestSize,
  void ( * watchdog)(void));
# 144 "../../../../CBD2300515_D00/BSW/vSecPrim/actISHAKE.h"
actRETURNCODE actSHAKEFinalize(
  actKECCAKcSTRUCT * info,
  actU8 * digest,
  void ( * watchdog)(void));
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 155 "../../../../CBD2300515_D00/BSW/vSecPrim/actISHAKE.h" 2
# 40 "../../../../CBD2300515_D00/BSW/vSecPrim/actISHAKE.c" 2

# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actKECCAKc.h" 1
# 55 "../../../../CBD2300515_D00/BSW/vSecPrim/actKECCAKc.h"
# 1 "GenData/vSecPrim_MemMap.h" 1
# 56 "../../../../CBD2300515_D00/BSW/vSecPrim/actKECCAKc.h" 2
# 79 "../../../../CBD2300515_D00/BSW/vSecPrim/actKECCAKc.h"
actRETURNCODE actKECCAKcInit(
  actKECCAKcSTRUCT * info,
  const actU32 strength,
  const actU8 pad1);
# 103 "../../../../CBD2300515_D00/BSW/vSecPrim/actKECCAKc.h"
actRETURNCODE actKECCAKcAbsorb(
  actKECCAKcSTRUCT * info,
  const actU8 * data,
  const actLengthType dataLength,
  void ( * watchdog)(void));
# 131 "../../../../CBD2300515_D00/BSW/vSecPrim/actKECCAKc.h"
actRETURNCODE actKECCAKcSqueeze(
  actKECCAKcSTRUCT * info,
  actU8 * digest,
  const actLengthType digestSize,
  void ( * watchdog)(void));
# 152 "../../../../CBD2300515_D00/BSW/vSecPrim/actKECCAKc.h"
actRETURNCODE actKECCAKcZEROPadToRate(
  actKECCAKcSTRUCT * info,
  void ( * watchdog)(void));
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 162 "../../../../CBD2300515_D00/BSW/vSecPrim/actKECCAKc.h" 2
# 42 "../../../../CBD2300515_D00/BSW/vSecPrim/actISHAKE.c" 2
