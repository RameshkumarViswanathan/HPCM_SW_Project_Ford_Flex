# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSAprim_ver.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSAprim_ver.c"
# 39 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSAprim_ver.c"
...
# 40 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSAprim_ver.c" 2
...
# 41 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSAprim_ver.c" 2
...
# 42 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSAprim_ver.c" 2
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 50 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSAprim_ver.c" 2
# 63 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSAprim_ver.c"
eslt_ErrorCode esl_initVerifyRSA_prim(
  eslt_WorkSpaceRSAver_prim * workSpace,
  eslt_Length keyPairModuleSize,
  const eslt_Byte * keyPairModule,
  eslt_Length publicKeyExponentSize,
  const eslt_Byte * publicKeyExponent)
{
  ...
  if ((workSpace == ((void *)0)) || (keyPairModule == ((void *)0)) || (publicKeyExponent == ((void *)0)))
  {
...
# 126 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSAprim_ver.c"
eslt_ErrorCode esl_verifyRSA_prim(
  eslt_WorkSpaceRSAver_prim * workSpace,
  eslt_Length signatureSize,
  const eslt_Byte * signature,
  eslt_Length * messageSize,
  eslt_Byte * message)
{
  ...
  if ((workSpace == ((void *)0)) || (messageSize == ((void *)0)) || (message == ((void *)0)) || (signature == ((void *)0)))
  {
    returnValue = (0x2000u + 0x0003u);
  }
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 174 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSAprim_ver.c" 2
