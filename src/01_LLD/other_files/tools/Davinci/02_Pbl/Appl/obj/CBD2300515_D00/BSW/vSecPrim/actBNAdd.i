# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNAdd.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNAdd.c"
# 39 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNAdd.c"
...
# 40 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNAdd.c" 2
...
# 41 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNAdd.c" 2




# 1 "GenData/vSecPrim_MemMap.h" 1
# 46 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNAdd.c" 2
# 60 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNAdd.c"
actU8 actBNAdd(
  const actBNDIGIT * a,
  const actBNDIGIT * b,
  actBNDIGIT * c,
  const actLengthType length)
{
  ...
  for (i = 0u; i < length; ++i)
  {
    ...
    tmp = ((actBNDDIGIT) a[i]) + b[i] + ((actBNDIGIT)((tmp) >> ((32u))));
    c[i] = ((actBNDIGIT)(tmp));
  }


  return (actU8)((actBNDIGIT)((tmp) >> ((32u))));
}


# 1 "GenData/vSecPrim_MemMap.h" 1
# 82 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNAdd.c" 2
