# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c"
# 40 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c"
...
# 41 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c" 2
...
# 42 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_Common.h" 1
# 45 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_Common.h"
# 1 "GenData/vSecPrim_MemMap.h" 1
# 99 "GenData/vSecPrim_MemMap.h"
#pragma section ".rodata.MSR_CONST" a
# 46 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_Common.h" 2

extern const eslt_Byte esl_RSAPSSEncodingMask[8];


# 1 "GenData/vSecPrim_MemMap.h" 1
# 115 "GenData/vSecPrim_MemMap.h"
#pragma section
# 51 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_Common.h" 2
# 60 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_Common.h"
# 1 "GenData/vSecPrim_MemMap.h" 1
# 61 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_Common.h" 2
# 89 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_Common.h"
eslt_ErrorCode esl_calcSaltedHashRSA_PSS(
  eslt_WorkSpaceUnionHashFunctions_RSA * wsuHash,
  eslt_Length saltSize,
  const eslt_Byte * salt,
  const eslt_Byte * messageDigest,
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 100 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_Common.h" 2
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 107 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_Common.h" 2
# 135 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_Common.h"
eslt_ErrorCode esl_generateMaskMGF1(
  eslt_HashAlgorithm hashAlgorithm,
  eslt_WorkSpaceUnionHashFunctions_RSA * wsHash,
  eslt_Byte * tempHash,
  eslt_Length hashDigestSize,
  eslt_Length seedLength,
  const eslt_Byte * seed,
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 147 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_Common.h" 2
# 43 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c" 2
...
# 45 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c" 2
...
# 46 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c" 2
# 68 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c"
typedef eslt_WorkSpaceUnionHashFunctions_RSA eslt_WorkSpaceUnionHashFunctions;
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actHashFctWrappers_Implementation.h" 1
# 36 "../../../../CBD2300515_D00/BSW/vSecPrim/actHashFctWrappers_Implementation.h"
...
# 37 "../../../../CBD2300515_D00/BSW/vSecPrim/actHashFctWrappers_Implementation.h" 2


# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actISHA2_32.h" 1
# 43 "../../../../CBD2300515_D00/BSW/vSecPrim/actISHA2_32.h"
# 1 "GenData/vSecPrim_MemMap.h" 1
# 44 "../../../../CBD2300515_D00/BSW/vSecPrim/actISHA2_32.h" 2
# 62 "../../../../CBD2300515_D00/BSW/vSecPrim/actISHA2_32.h"
actRETURNCODE actSHA224Init(actSHA224STRUCT * info);
# 76 "../../../../CBD2300515_D00/BSW/vSecPrim/actISHA2_32.h"
actRETURNCODE actSHA256Init(actSHA256STRUCT * info);
# 98 "../../../../CBD2300515_D00/BSW/vSecPrim/actISHA2_32.h"
actRETURNCODE actSHA224Update(
  actSHA224STRUCT * info,
  const actU8 * dataIN,
  actLengthType length,
  void ( * watchdog)(void));
# 124 "../../../../CBD2300515_D00/BSW/vSecPrim/actISHA2_32.h"
actRETURNCODE actSHA256Update(
  actSHA256STRUCT * info,
  const actU8 * dataIN,
  actLengthType length,
  void ( * watchdog)(void));
# 145 "../../../../CBD2300515_D00/BSW/vSecPrim/actISHA2_32.h"
actRETURNCODE actSHA224Finalize(
  actSHA224STRUCT * info,
  actU8 * hash,
  void ( * watchdog)(void));
# 165 "../../../../CBD2300515_D00/BSW/vSecPrim/actISHA2_32.h"
actRETURNCODE actSHA256Finalize(
  actSHA256STRUCT * info,
  actU8 * hash,
  void ( * watchdog)(void));
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 176 "../../../../CBD2300515_D00/BSW/vSecPrim/actISHA2_32.h" 2
# 40 "../../../../CBD2300515_D00/BSW/vSecPrim/actHashFctWrappers_Implementation.h" 2
# 67 "../../../../CBD2300515_D00/BSW/vSecPrim/actHashFctWrappers_Implementation.h"
# 1 "GenData/vSecPrim_MemMap.h" 1
# 68 "../../../../CBD2300515_D00/BSW/vSecPrim/actHashFctWrappers_Implementation.h" 2
# 87 "../../../../CBD2300515_D00/BSW/vSecPrim/actHashFctWrappers_Implementation.h"
static actRETURNCODE actHashInit(
  eslt_WorkSpaceUnionHashFunctions * hashWSU,
  eslt_HashAlgorithm hashID);
# 111 "../../../../CBD2300515_D00/BSW/vSecPrim/actHashFctWrappers_Implementation.h"
static actRETURNCODE actHashUpdate(
eslt_WorkSpaceUnionHashFunctions * hashWSU,
const actU8 * dataIN,
actLengthType length,
eslt_HashAlgorithm hashID);
# 136 "../../../../CBD2300515_D00/BSW/vSecPrim/actHashFctWrappers_Implementation.h"
static actRETURNCODE actHashFinalize(
eslt_WorkSpaceUnionHashFunctions * hashWSU,
actU8 * hash,
eslt_HashAlgorithm hashID);
# 157 "../../../../CBD2300515_D00/BSW/vSecPrim/actHashFctWrappers_Implementation.h"
static actRETURNCODE actHashInit(
eslt_WorkSpaceUnionHashFunctions * hashWSU,
eslt_HashAlgorithm hashID)
{
  ...
  switch(hashID)
  {
    ...
    case (0x00u):
      returnValue = actSHAInit((&(hashWSU->SHA1ws.wsSHA1)));
      break;
    ...
    case (0x02u):
      returnValue = actSHA256Init((&(hashWSU->SHA256ws.wsSHA256)));
      break;
# 204 "../../../../CBD2300515_D00/BSW/vSecPrim/actHashFctWrappers_Implementation.h"
    default:
      returnValue = (0xF7u);
      break;
  }
...
# 224 "../../../../CBD2300515_D00/BSW/vSecPrim/actHashFctWrappers_Implementation.h"
static actRETURNCODE actHashUpdate(
eslt_WorkSpaceUnionHashFunctions * hashWSU,
const actU8 * dataIN,
actLengthType length,
eslt_HashAlgorithm hashID)
{
  ...
  switch(hashID)
  {
    ...
    case (0x00u):
      returnValue = actSHAUpdate((&(hashWSU->SHA1ws.wsSHA1)), dataIN, length, (hashWSU->SHA1ws.header.watchdog));
      break;
    ...
    case (0x02u):
      returnValue = actSHA256Update((&(hashWSU->SHA256ws.wsSHA256)), dataIN, length, (hashWSU->SHA256ws.header.watchdog));
      break;
# 273 "../../../../CBD2300515_D00/BSW/vSecPrim/actHashFctWrappers_Implementation.h"
    default:
      returnValue = (0xF7u);
      break;
  }
...
# 293 "../../../../CBD2300515_D00/BSW/vSecPrim/actHashFctWrappers_Implementation.h"
static actRETURNCODE actHashFinalize(
eslt_WorkSpaceUnionHashFunctions * hashWSU,
actU8 * hash,
eslt_HashAlgorithm hashID)
{
  ...
  case (0x00u):
      returnValue = actSHAFinalize((&(hashWSU->SHA1ws.wsSHA1)), hash, (hashWSU->SHA1ws.header.watchdog));
      break;
    ...
    case (0x02u):
      returnValue = actSHA256Finalize((&(hashWSU->SHA256ws.wsSHA256)), hash, (hashWSU->SHA256ws.header.watchdog));
      break;
# 341 "../../../../CBD2300515_D00/BSW/vSecPrim/actHashFctWrappers_Implementation.h"
    default:
      returnValue = (0xF7u);
      break;
  }
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 350 "../../../../CBD2300515_D00/BSW/vSecPrim/actHashFctWrappers_Implementation.h" 2
# 70 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c" 2
...
# 99 "GenData/vSecPrim_MemMap.h"
#pragma section ".rodata.MSR_CONST" a
# 76 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c" 2

 const eslt_Byte esl_RSAPSSEncodingMask[8] =
{
...
# 115 "GenData/vSecPrim_MemMap.h"
#pragma section
# 84 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c" 2
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 90 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c" 2
# 105 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c"
static eslt_ErrorCode esl_checkSaltSizeSig(
  eslt_Length saltSize,
  eslt_Length dbLength);
# 123 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c"
static eslt_ErrorCode esl_checkSignatureSize(
  eslt_Length * signatureSize,
  eslt_Length emLength);
# 148 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c"
static eslt_ErrorCode esl_FillDataBlock(
  eslt_Byte * db,
  eslt_Byte * dbSalt,
  eslt_Length saltSize,
  const eslt_Byte * salt,
  eslt_Length psLength);
# 178 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c"
static eslt_ErrorCode esl_initSignRSA_PSS(
   eslt_WorkSpaceRSAPSSsig * workSpace,
   eslt_Length keyPairModuleSize,
  const eslt_Byte * keyPairModule,
   eslt_Length privateKeyExponentSize,
  const eslt_Byte * privateKeyExponent,
   eslt_HashAlgorithm hashID);
# 205 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c"
static eslt_ErrorCode esl_updateSignRSA_PSS(
   eslt_WorkSpaceRSAPSSsig * workSpace,
   eslt_Length inputSize,
  const eslt_Byte * input,
   eslt_HashAlgorithm hashID);
# 227 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c"
static void esl_finalizeHashSignRSA_PSS(
   eslt_WorkSpaceRSAPSSsig * workSpace,
   eslt_Byte * messageDigest,
   eslt_HashAlgorithm hashID);
# 264 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c"
static eslt_ErrorCode esl_finalizeSigSignRSA_PSS(
   eslt_WorkSpaceRSAPSSsig * workSpace,
   const eslt_Byte * messageDigest,
   eslt_Length hashDigestSize,
   eslt_Length saltSize,
  const eslt_Byte * salt,
   ...
   eslt_Byte * signature,
   eslt_HashAlgorithm hashID);
# 290 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c"
static eslt_ErrorCode esl_checkSaltSizeSig(
  eslt_Length saltSize,
  eslt_Length dbLength)
{
  eslt_ErrorCode returnValue = (0x0000u);


  if ((saltSize + 1u) > dbLength)
  {
    returnValue = (0x2000u + 0x0003u);
  }

  return returnValue;
}
# 314 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c"
static eslt_ErrorCode esl_checkSignatureSize(
  eslt_Length * signatureSize,
  eslt_Length emLength)
{
...
# 342 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c"
static eslt_ErrorCode esl_FillDataBlock(
  eslt_Byte * db,
  eslt_Byte * dbSalt,
  eslt_Length saltSize,
  ...
  eslt_Length psLength)
{
  ...
  if (saltSize > 0u)
  {
    ...
    else
    {
      ...
      (VStdLib_MemCpy((dbSalt), (salt), (saltSize)));
    }
  }

  return returnValue;
}
# 387 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c"
static eslt_ErrorCode esl_initSignRSA_PSS(
  eslt_WorkSpaceRSAPSSsig * workSpace,
  eslt_Length keyPairModuleSize,
  const eslt_Byte * keyPairModule,
  ...
  eslt_HashAlgorithm hashID)
{
  eslt_ErrorCode returnValue = (0x2000u);

  if ((keyPairModule == ((void *)0)) || (privateKeyExponent == ((void *)0)))
  {
    returnValue = (0x2000u + 0x0003u);
  }
  else
  {
    ...
    workSpace->wsRSASigPrim.header.size = (eslt_Length)((sizeof(actRSAPRIMSTRUCT)));
    ...
    if (returnValue == (0x0000u))
    {
      esl_SetWorkspaceStatus(&workSpace->header, (0x0700u));
...
# 437 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c"
static eslt_ErrorCode esl_updateSignRSA_PSS(
  eslt_WorkSpaceRSAPSSsig * workSpace,
  eslt_Length inputSize,
  const eslt_Byte * input,
  eslt_HashAlgorithm hashID)
{
  ...
  else
  {
    ...
    if (actReturnValue != (0x00u))
    {
      returnValue = (0x2000u + 0x002Cu);
    }
  }

  return returnValue;
}
# 472 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c"
static void esl_finalizeHashSignRSA_PSS(
  eslt_WorkSpaceRSAPSSsig * workSpace,
  eslt_Byte * messageDigest,
  eslt_HashAlgorithm hashID)
...
# 496 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c"
static eslt_ErrorCode esl_finalizeSigSignRSA_PSS(
  eslt_WorkSpaceRSAPSSsig * workSpace,
  const eslt_Byte * messageDigest,
  eslt_Length hashDigestSize,
  ...
  eslt_HashAlgorithm hashID)
{
  ...
  emLength = ((((eslt_Length)((emBits + 7u) / 8u))<(((2048u) >> 3)))? ((eslt_Length)((emBits + 7u) / 8u)):(((2048u) >> 3)));
  returnValue = esl_checkSignatureSize(signatureSize, emLength);


  if (returnValue == (0x0000u))
  {
# 542 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c"
    if (emLength < (hashDigestSize + 1u))
    {
      returnValue = (0x2000u + 0x001Eu);
    }
    else
    {
  ...
  if (returnValue == (0x0000u))
  {
    ...
    (workSpace->encodedMessageBuffer.encodedMessage)[emLength - 1u] = (0xBCu);
...
# 619 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c"
eslt_ErrorCode esl_initSignRSASHA1_PSS(
  eslt_WorkSpaceRSAPSSsig * workSpace,
  eslt_Length keyPairModuleSize,
  const eslt_Byte * keyPairModule,
  eslt_Length privateKeyExponentSize,
  const eslt_Byte * privateKeyExponent)
{
  ...
  else if ((returnValue = esl_CheckWorkSpaceHeader(&workSpace->header, (sizeof(eslt_WorkSpaceRSAPSSsig) - sizeof(eslt_WorkSpaceHeader)))) != (0x0000u))
  {

  }
  else
  {
    workSpace->wsHashUnion.SHA1ws.header.size = (sizeof(actSHASTRUCT));
    ...
    returnValue = esl_initSignRSA_PSS(workSpace, keyPairModuleSize, keyPairModule,
                                      privateKeyExponentSize, privateKeyExponent, (0x00u));
  }
  return returnValue;
}
# 655 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c"
eslt_ErrorCode esl_updateSignRSASHA1_PSS(
eslt_WorkSpaceRSAPSSsig * workSpace,
eslt_Length inputSize,
const eslt_Byte * input)
{
  ...
  {
    returnValue = esl_CheckWorkSpaceHeaderAndState(&(workSpace->header), (sizeof(eslt_WorkSpaceRSAPSSsig) - sizeof(eslt_WorkSpaceHeader)), (0x0700u));
  }

  if (returnValue == (0x0000u))
  {
    returnValue = esl_updateSignRSA_PSS(workSpace, inputSize, input, (0x00u));
    if (returnValue == (0x2000u + 0x002Cu))
    {
      returnValue = (0x2000u + 0x000Du);
    }
  }
  return returnValue;
}
# 691 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c"
eslt_ErrorCode esl_finalizeHashSignRSASHA1_PSS(
eslt_WorkSpaceRSAPSSsig * workSpace,
eslt_Byte * messageDigest)
{
  eslt_ErrorCode returnValue = (0x0000u);

  if ((workSpace == ((void *)0)) || (messageDigest == ((void *)0)))
  {
    returnValue = (0x2000u + 0x0003u);
  }
  else
  ...
  if (returnValue == (0x0000u))
  {
    esl_finalizeHashSignRSA_PSS(workSpace, messageDigest, (0x00u));
  }

  return returnValue;
}
# 723 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c"
eslt_ErrorCode esl_finalizeSigSignRSASHA1_PSS(
eslt_WorkSpaceRSAPSSsig * workSpace,
const eslt_Byte * messageDigest,
eslt_Length saltSize,
const eslt_Byte * salt,
...
{
  eslt_ErrorCode returnValue = (0x2000u);
  if ((workSpace == ((void *)0)) || (signatureSize == ((void *)0)) || (signature == ((void *)0)) || (messageDigest == ((void *)0)))
  {
    returnValue = (0x2000u + 0x0003u);
  }
  else
  ...
  if (returnValue == (0x0000u))
  {
    returnValue = esl_finalizeSigSignRSA_PSS(workSpace, messageDigest, 20u, saltSize,
                                             salt, signatureSize, signature, (0x00u));
  }
  return returnValue;
}
# 757 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c"
eslt_ErrorCode esl_finalizeSigSignRSASHA1_PSS_NoSalt(
eslt_WorkSpaceRSAPSSsig * workSpace,
const eslt_Byte * messageDigest,
eslt_Length * signatureSize,
eslt_Byte * signature)
{
  eslt_ErrorCode returnValue = (0x2000u);
  returnValue = esl_finalizeSigSignRSASHA1_PSS(workSpace, messageDigest, 0u, ((void *)0), signatureSize, signature);
  return returnValue;
}
# 778 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c"
eslt_ErrorCode esl_finalizeSigSignRSASHA1_PSS_DigestLengthSalt(
eslt_WorkSpaceRSAPSSsig * workSpace,
const eslt_Byte * messageDigest,
eslt_Length * signatureSize,
eslt_Byte * signature)
{
  eslt_ErrorCode returnValue = (0x2000u);
  returnValue = esl_finalizeSigSignRSASHA1_PSS(workSpace, messageDigest, 20u, ((void *)0),
                                               signatureSize, signature);
  return returnValue;
}
# 801 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c"
eslt_ErrorCode esl_finalizeSignRSASHA1_PSS(eslt_WorkSpaceRSAPSSsig *
                           workSpace,
  eslt_Length saltSize,
  const eslt_Byte * salt,
  eslt_Length * signatureSize,
  eslt_Byte * signature)
{
  ...
  (VStdLib_MemSet(((hash)), 0, ((20u))));

  if ((workSpace == ((void *)0)) || (signatureSize == ((void *)0)) || (signature == ((void *)0)))
  {
    returnValue = (0x2000u + 0x0003u);
  }
  else
...
# 839 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c"
eslt_ErrorCode esl_finalizeSignRSASHA1_PSS_NoSalt(eslt_WorkSpaceRSAPSSsig * workSpace,
                                                                 eslt_Length * signatureSize,
                                                                 eslt_Byte * signature)
{
  eslt_ErrorCode returnValue = (0x2000u);
  returnValue = esl_finalizeSignRSASHA1_PSS(workSpace, 0u, ((void *)0), signatureSize, signature);
  return returnValue;
}
# 858 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c"
eslt_ErrorCode esl_finalizeSignRSASHA1_PSS_DigestLengthSalt(
eslt_WorkSpaceRSAPSSsig * workSpace,
eslt_Length * signatureSize,
eslt_Byte * signature)
{
  eslt_ErrorCode returnValue = (0x2000u);
  returnValue = esl_finalizeSignRSASHA1_PSS(workSpace, 20u, ((void *)0), signatureSize, signature);
  return returnValue;
}
# 879 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c"
eslt_ErrorCode esl_initSignRSASHA256_PSS(
  eslt_WorkSpaceRSAPSSsig * workSpace,
  eslt_Length keyPairModuleSize,
  const eslt_Byte * keyPairModule,
  eslt_Length privateKeyExponentSize,
  const eslt_Byte * privateKeyExponent)
{
  ...
  {
    workSpace->wsHashUnion.SHA256ws.header.size = (sizeof(actSHA256STRUCT));
    workSpace->wsHashUnion.SHA256ws.header.watchdog = workSpace->header.watchdog;
    returnValue = esl_initSignRSA_PSS(workSpace, keyPairModuleSize, keyPairModule,
                                      privateKeyExponentSize, privateKeyExponent, (0x02u));
  }
  return returnValue;
}
# 915 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c"
eslt_ErrorCode esl_updateSignRSASHA256_PSS(
  eslt_WorkSpaceRSAPSSsig * workSpace,
  eslt_Length inputSize,
  const eslt_Byte * input)
{
  ...
  if (returnValue == (0x0000u))
  {
    returnValue = esl_updateSignRSA_PSS(workSpace, inputSize, input, (0x02u));
    if (returnValue == (0x2000u + 0x002Cu))
    {
      returnValue = ((0x2000u + 0x002Cu));
    }
...
# 950 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c"
eslt_ErrorCode esl_finalizeHashSignRSASHA256_PSS(
  eslt_WorkSpaceRSAPSSsig * workSpace,
  eslt_Byte * messageDigest)
{
  eslt_ErrorCode returnValue = (0x0000u);
  ...
  if (returnValue == (0x0000u))
  {
    esl_finalizeHashSignRSA_PSS(workSpace, messageDigest, (0x02u));
  }
  return returnValue;
}
# 980 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c"
eslt_ErrorCode esl_finalizeSigSignRSASHA256_PSS(
  eslt_WorkSpaceRSAPSSsig * workSpace,
  const eslt_Byte * messageDigest,
  eslt_Length saltSize,
  const eslt_Byte * salt,
  ...
  eslt_Byte * signature)
{
  ...
  if (returnValue == (0x0000u))
  {
    returnValue = esl_finalizeSigSignRSA_PSS(workSpace, messageDigest, 32u, saltSize,
                                             salt, signatureSize, signature, (0x02u));
  }
  return returnValue;
}
# 1014 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c"
eslt_ErrorCode esl_finalizeSigSignRSASHA256_PSS_NoSalt(
  eslt_WorkSpaceRSAPSSsig * workSpace,
  const eslt_Byte * messageDigest,
  eslt_Length * signatureSize,
  eslt_Byte * signature)
{
  eslt_ErrorCode returnValue = (0x2000u);
  returnValue = esl_finalizeSigSignRSASHA256_PSS(workSpace, messageDigest, 0u, ((void *)0), signatureSize, signature);
  return returnValue;
}
# 1035 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c"
eslt_ErrorCode esl_finalizeSigSignRSASHA256_PSS_DigestLengthSalt(
  eslt_WorkSpaceRSAPSSsig * workSpace,
  const eslt_Byte * messageDigest,
  eslt_Length * signatureSize,
  eslt_Byte * signature)
{
  eslt_ErrorCode returnValue = (0x2000u);
  returnValue = esl_finalizeSigSignRSASHA256_PSS(workSpace, messageDigest, 32u,
                                                 ((void *)0), signatureSize, signature);
  return returnValue;
}
# 1058 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c"
eslt_ErrorCode esl_finalizeSignRSASHA256_PSS(
  eslt_WorkSpaceRSAPSSsig * workSpace,
  eslt_Length saltSize,
  const eslt_Byte * salt,
  eslt_Length * signatureSize,
...
# 1097 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c"
eslt_ErrorCode esl_finalizeSignRSASHA256_PSS_NoSalt(
  eslt_WorkSpaceRSAPSSsig * workSpace,
  eslt_Length * signatureSize,
  eslt_Byte * signature)
{
  eslt_ErrorCode returnValue = (0x2000u);
  returnValue = esl_finalizeSignRSASHA256_PSS(workSpace, 0u, ((void *)0), signatureSize, signature);
  return returnValue;
}
# 1117 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c"
eslt_ErrorCode esl_finalizeSignRSASHA256_PSS_DigestLengthSalt(
  eslt_WorkSpaceRSAPSSsig * workSpace,
  eslt_Length * signatureSize,
  eslt_Byte * signature)
{
  eslt_ErrorCode returnValue = (0x2000u);
  returnValue = esl_finalizeSignRSASHA256_PSS(workSpace, 32u, ((void *)0), signatureSize, signature);
  return returnValue;
}
# 1392 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c"
# 1 "GenData/vSecPrim_MemMap.h" 1
# 1393 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_PSS_Sig.c" 2
