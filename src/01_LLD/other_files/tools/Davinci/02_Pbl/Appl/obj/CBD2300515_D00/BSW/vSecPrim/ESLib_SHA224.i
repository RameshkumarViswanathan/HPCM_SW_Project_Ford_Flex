# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_SHA224.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_SHA224.c"
# 40 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_SHA224.c"
...
# 41 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_SHA224.c" 2
...
# 42 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_SHA224.c" 2
...
# 44 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_SHA224.c" 2




# 1 "GenData/vSecPrim_MemMap.h" 1
# 49 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_SHA224.c" 2
# 63 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_SHA224.c"
eslt_ErrorCode esl_initSHA224(eslt_WorkSpaceSHA224 * workSpace)
{
  ...
  else if ((retVal = esl_CheckWorkSpaceHeader(&workSpace->header, (sizeof(actSHA224STRUCT)))) != (0x0000u))
  {
  ...
  else
  {
    ...
    esl_SetWorkspaceStatus(&workSpace->header, ((0x0800u)));
  }

  return retVal;
}
# 94 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_SHA224.c"
eslt_ErrorCode esl_updateSHA224(
  eslt_WorkSpaceSHA224 * workSpace,
  const eslt_Length inputSize,
  const eslt_Byte * input)
{
  ...
  else if ((retVal = esl_CheckWorkSpaceHeaderAndState(&workSpace->header, (sizeof(actSHA224STRUCT)), ((0x0800u)))) != (0x0000u))
  {
...
# 134 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_SHA224.c"
eslt_ErrorCode esl_finalizeSHA224(eslt_WorkSpaceSHA224 * workSpace, eslt_Byte * messageDigest)
{
  eslt_ErrorCode retVal;
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 161 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_SHA224.c" 2
