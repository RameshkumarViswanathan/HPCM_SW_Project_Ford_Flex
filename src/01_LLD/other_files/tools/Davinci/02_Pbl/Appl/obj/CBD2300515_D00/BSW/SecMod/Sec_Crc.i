# 1 "../../../../CBD2300515_D00/BSW/SecMod/Sec_Crc.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/SecMod/Sec_Crc.c"
# 39 "../../../../CBD2300515_D00/BSW/SecMod/Sec_Crc.c"
...
# 40 "../../../../CBD2300515_D00/BSW/SecMod/Sec_Crc.c" 2
...
# 46 "../../../../CBD2300515_D00/BSW/SecMod/Sec_Crc.c" 2
# 236 "../../../../CBD2300515_D00/BSW/SecMod/Sec_Crc.c"
# 1 "Include/MemMap.h" 1
# 237 "../../../../CBD2300515_D00/BSW/SecMod/Sec_Crc.c" 2



static void SecM_GenerateLookupCrc16(FL_WDTriggerFctType pWatchdog);
# 255 "../../../../CBD2300515_D00/BSW/SecMod/Sec_Crc.c"
static void SecM_UpdateCrc16( SecM_CRC16ParamType * pCrcParam);
# 265 "../../../../CBD2300515_D00/BSW/SecMod/Sec_Crc.c"
# 1 "Include/MemMap.h" 1
# 266 "../../../../CBD2300515_D00/BSW/SecMod/Sec_Crc.c" 2
# 286 "../../../../CBD2300515_D00/BSW/SecMod/Sec_Crc.c"
# 1 "Include/MemMap.h" 1
# 287 "../../../../CBD2300515_D00/BSW/SecMod/Sec_Crc.c" 2

 static SecM_Crc16Type lookupCrc16[256u + 1u];

# 1 "Include/MemMap.h" 1
# 291 "../../../../CBD2300515_D00/BSW/SecMod/Sec_Crc.c" 2
# 347 "../../../../CBD2300515_D00/BSW/SecMod/Sec_Crc.c"
# 1 "Include/MemMap.h" 1
# 348 "../../../../CBD2300515_D00/BSW/SecMod/Sec_Crc.c" 2


 static SecM_Crc16Type const initialValueCrc16 = 0xFFFFu;

 static SecM_Crc16Type const finalValueCrc16 = 0x0000u;
# 367 "../../../../CBD2300515_D00/BSW/SecMod/Sec_Crc.c"
# 1 "Include/MemMap.h" 1
# 368 "../../../../CBD2300515_D00/BSW/SecMod/Sec_Crc.c" 2
...
# 1 "Include/MemMap.h" 1
# 376 "../../../../CBD2300515_D00/BSW/SecMod/Sec_Crc.c" 2
...
# 1 "Include/MemMap.h" 1
# 382 "../../../../CBD2300515_D00/BSW/SecMod/Sec_Crc.c" 2
...
# 1 "Include/MemMap.h" 1
# 389 "../../../../CBD2300515_D00/BSW/SecMod/Sec_Crc.c" 2
# 398 "../../../../CBD2300515_D00/BSW/SecMod/Sec_Crc.c"
static void SecM_GenerateLookupCrc16( FL_WDTriggerFctType pWatchdog )
{
   ...
   for (tableIndex = 0u; tableIndex < 256u; tableIndex++)
   {

      if (((tableIndex) & (0x00000020u - 1u)) == 0x00u) { if ((((FL_WDTriggerFctType)0u)) != (pWatchdog)) { (pWatchdog)(); }; };




      crc = (SecM_Crc16Type)(tableIndex << (16u - 8u));
...
# 446 "../../../../CBD2300515_D00/BSW/SecMod/Sec_Crc.c"
      }
   ...
   lookupCrc16[256u] = 0xC2C7u;
}
# 621 "../../../../CBD2300515_D00/BSW/SecMod/Sec_Crc.c"
static void SecM_UpdateCrc16( SecM_CRC16ParamType * pCrcParam)
{
   SecM_ShortFastType tableIndex;
   ...
   for (sourceIndex = 0u; sourceIndex < byteCount; sourceIndex++)
   {
      ...
      if (((sourceIndex) & (0x00000020u - 1u)) == 0x00u) { if ((((FL_WDTriggerFctType)0u)) != (pWatchdog)) { (pWatchdog)(); }; };


      currentData = pCrcParam->crcSourceBuffer[sourceIndex];
# 653 "../../../../CBD2300515_D00/BSW/SecMod/Sec_Crc.c"
      tableIndex = (SecM_ShortFastType)(((SecM_Crc16Type)currentData ^ (tmpCrc >> (SecM_Crc16Type)(16u - 8u))) & 0xFFu);
      tmpCrc = (SecM_Crc16Type)((tmpCrc << 8u) ^ lookupCrc16[tableIndex]);
# 667 "../../../../CBD2300515_D00/BSW/SecMod/Sec_Crc.c"
   }


   pCrcParam->currentCRC = tmpCrc;
}
# 807 "../../../../CBD2300515_D00/BSW/SecMod/Sec_Crc.c"
void SecM_InitPowerOnCRC( void )
{
# 821 "../../../../CBD2300515_D00/BSW/SecMod/Sec_Crc.c"
   lookupCrc16[256u] = 0xA5A5u;
# 834 "../../../../CBD2300515_D00/BSW/SecMod/Sec_Crc.c"
}
# 845 "../../../../CBD2300515_D00/BSW/SecMod/Sec_Crc.c"
SecM_StatusType SecM_ComputeCRC( SecM_CRCParamType * crcParam )
{
...
# 868 "../../../../CBD2300515_D00/BSW/SecMod/Sec_Crc.c"
SecM_StatusType SecM_ComputeCrc16( SecM_CRC16ParamType * crcParam)
{
   ...
   switch (crcParam->crcState)
   {
      ...
      case 0x04u:
      {
         if (crcParam->crcByteCount == 2u)
         {

            crcTransferred = (SecM_Crc16Type)SecM_GetInteger(2u, crcParam->crcSourceBuffer);
      ...
      case 0x05u:
      {
         if (crcParam->crcByteCount >= 2u)
         {
            SecM_SetInteger(2u, crcParam->currentCRC, crcParam->crcOutputBuffer);

            crcParam->crcByteCount = 2u;
...
# 1198 "../../../../CBD2300515_D00/BSW/SecMod/Sec_Crc.c"
# 1 "Include/MemMap.h" 1
# 1199 "../../../../CBD2300515_D00/BSW/SecMod/Sec_Crc.c" 2
