# 1 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c"
# 90 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c"
...
# 91 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c" 2

# 1 "../../../BSW/Flash/flash_sfr.h" 1
# 93 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c" 2
# 214 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c"
typedef struct
{

   vuint32 logicalSectorCount;

   vuint32 const * logicalSectors;
} tPhysSector;
...
typedef struct
{
   ...
   volatile vuint32 * xfECC;

   vuint32 maskECC;

   vuint32 maskBLANK;

   volatile vuint32 * flashControl;
...
typedef struct
{
   ...
   tPhysSector const * physicalSectors;

   tflashRegs const * flashRegs;

   vuint32 maxNumLogSectorsForErase;
} tFlashStructure;
# 296 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c"
typedef struct
{
   vuint16 uc;
   vuint32 protMask;
...
# 3542 "Include/MemMap.h"
#pragma section ".FblFlashDrvSection" awB
# 307 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c" 2
 vuint8 flashCode[3072];

# 1 "Include/MemMap.h" 1
# 3549 "Include/MemMap.h"
#pragma section
# 310 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c" 2
...
# 1 "Include/MemMap.h" 1
# 317 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c" 2

 static tFlashParam flashParam;

 static vuint32 tempFlashData[0x01u];


# 1 "Include/MemMap.h" 1
# 324 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c" 2


# 1 "Include/MemMap.h" 1
# 327 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c" 2



static vuint32 const physSector[] =
{
...
# 350 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c"
static vuint32 const physSector_D0[] =
{
...
# 427 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c"
static tPhysSector const pmuStructure0[] =
{
   { (sizeof(physSector) / sizeof((physSector)[0u])), physSector }
...
static tflashRegs const flashReg0[] =
{

   { &(*((volatile vuint32 *)((0xA8080000u) + (0x20u + ((0u) * 0x300000u))))), ( 0x00010000uL | 0x00020000uL | 0x00080000uL ), ( 0x00200000uL | 0x00000020uL ), &(*((volatile vuint32 *)((0xF8800000u) + ((0x1100u + ((0x00000000u) + ((2u) * 0x04u))))))), 0x00030000uL, 0x00010000uL }
};



static tPhysSector const pmuStructure1[] =
{
   { (sizeof(physSector) / sizeof((physSector)[0u])), physSector }
...
static tflashRegs const flashReg1[] =
{

   { &(*((volatile vuint32 *)((0xA8080000u) + (0x20u + ((1u) * 0x300000u))))), ( 0x00010000uL | 0x00020000uL | 0x00080000uL ), ( 0x00200000uL | 0x00000020uL ), &(*((volatile vuint32 *)((0xF8800000u) + ((0x1100u + ((0x00020000u) + ((2u) * 0x04u))))))), 0x00030000uL, 0x00010000uL }
};
# 564 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c"
static tPhysSector const df0Structure[] =
{
    { (sizeof(physSector_D0) / sizeof((physSector_D0)[0u])), physSector_D0 }
};



static tflashRegs const flashRegDF[] =
{

   { &(*((volatile vuint32 *)((0xF8040000u) + (0x44u + ((0u) * 0x200000u))))), ( 0x00010000uL | 0x00020000uL | 0x00040000uL | 0x00080000uL ), ( 0x01000000uL | 0x02000000uL | 0x00000100uL | 0x00000200uL ), &(*((volatile vuint32 *)((0xF8040000u) + (0x48u + ((0u) * 0x200000u))))), 0x00000003uL, 0x00000003uL }
};
# 602 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c"
static tFlashStructure const flashStructure[] =
{
   { 0xA0000000uL, ((0xA0000000uL + (3072 * 1024uL)) - 1u), (sizeof(pmuStructure0) / sizeof((pmuStructure0)[0u])), pmuStructure0, flashReg0, 0x20u }

   , { 0xA0300000uL, ((0xA0300000uL + (3072 * 1024uL)) - 1u), (sizeof(pmuStructure1) / sizeof((pmuStructure1)[0u])), pmuStructure1, flashReg1, 0x20u }
# 620 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c"
   ,
   { 0xAF000000uL, 0xAF0FFFFFuL, (sizeof(df0Structure) / sizeof((df0Structure)[0u])), df0Structure, flashRegDF, 0x20u }
};
# 650 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c"
static tFlashProtectionMaskLookUpTbl const flashProtMaskLookUpTbl[] =
{
   {0x0010u, 0x00000001uL},
   {0x0011u, 0x00000002uL},
   {0x0012u, 0x00000004uL},
   {0x0016u, 0x00000008uL},
   {0x0000u, 0x00000010uL},
   {0x0017u, 0x00000020uL},
   {0x0020u, 0x00000100uL},
   {0x0021u, 0x00000200uL},
   {0x0022u, 0x00000400uL},
   {0x0023u, 0x00000800uL},
   {0x0024u, 0x00001000uL},
   {0x0025u, 0x00002000uL},
   {0x000Fu, 0x01000000uL}
};


# 1 "Include/MemMap.h" 1
# 669 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c" 2
...
# 3590 "Include/MemMap.h"
#pragma section ".RamCodeCoreSection" x
# 676 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c" 2
...
# 3597 "Include/MemMap.h"
#pragma section
# 686 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c" 2

# 1 "Include/MemMap.h" 1
# 3574 "Include/MemMap.h"
#pragma section ".RamCodeCoreSection" ax
# 688 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c" 2
...
# 1 "Include/MemMap.h" 1
# 3581 "Include/MemMap.h"
#pragma section
# 691 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c" 2

# 1 "Include/MemMap.h" 1
# 3590 "Include/MemMap.h"
#pragma section ".RamCodeCoreSection" x
# 693 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c" 2
# 707 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c"
# 1 "Include/MemMap.h" 1
# 3597 "Include/MemMap.h"
#pragma section
# 708 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c" 2

# 1 "Include/MemMap.h" 1
# 3574 "Include/MemMap.h"
#pragma section ".RamCodeCoreSection" ax
# 710 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c" 2
static IO_ErrorType FlashDriver_VerifyErasedPage(vuint32 address);

# 1 "Include/MemMap.h" 1
# 3581 "Include/MemMap.h"
#pragma section
# 713 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c" 2

# 1 "Include/MemMap.h" 1
# 3590 "Include/MemMap.h"
#pragma section ".RamCodeCoreSection" x
# 715 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c" 2
static IO_ErrorType FlashDriver_VerifyErased(vuint32 address, vuint32 length);
# 739 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c"
static IO_ErrorType FlashDriver_WriteToFlash ( IO_MemPtrType writeBuffer, IO_SizeType writeLength, IO_PositionType writeAddress, vuint16 programmingType)
{
   ...
   uncachedWriteAddress = writeAddress | 0xA0000000uL;


   if ((uncachedWriteAddress & 0xAF000000uL) == 0xAF000000uL)
   {

      if ((uncachedWriteAddress & (0x08u - 1uL)) != 0x00uL)
      {
         returnValue = (0x60u | 0x04u);
      }
      else if ((writeLength & (0x08u - 1uL)) != 0x00uL)
      {
         returnValue = (0x60u | 0x05u);
      }
      else
      {
   ...
   else
   {
      ...
      if ((uncachedWriteAddress & (0x20u - 1uL)) != 0x00uL)
      {
         returnValue = (0x60u | 0x04u);
      }
      else if ((writeLength & (0x20u - 1uL)) != 0x00uL)
      {
         returnValue = (0x60u | 0x05u);
      }
      else
   ...
   if (returnValue == 0x00u)
   {
      ...
      do
      {
         ...
         if (((sizeof(flashStructure) / sizeof((flashStructure)[0u])) - 1u) >= sectorIndex)
         {
            ...
            if (!((((vuint32)&(writeBuffer[writePos]) & (sizeof(tFlashData)-1u)) == 0u))) ApplFblFatalError((0x50u));


            flashParam.address = (tFlashAddress)uncachedWriteAddress;
            flashParam.writeLength = (tFlashLength)deltaWriteLength;
            flashParam.data = (tFlashData *)&(writeBuffer[writePos]);
            flashParam.programmingType = programmingType;
# 835 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c"
            flashParam.verificationAddress = flashParam.address;
            flashParam.pflashEccStatReg = ((flashStructure[sectorIndex]).flashRegs)->xfECC;
            flashParam.flashEccStatMask = ((flashStructure[sectorIndex]).flashRegs)->maskECC;


            flashParam.pflashEccControlReg = ((flashStructure[sectorIndex]).flashRegs)->flashControl;
            flashParam.flashEccControlMask = ((flashStructure[sectorIndex]).flashRegs)->maskFC;
            flashParam.flashEccControlValue = ((flashStructure[sectorIndex]).flashRegs)->valFC;

            ((tFlashFct)(*(tFlashUint32 *)&(flashCode)[(0x04u + 0x0Cu)]))(&flashParam);
      ...
      } while ((writeLengthRemaining > 0uL) && (0x00u == returnValue));
   }

   return returnValue;
}
# 868 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c"
static vuint32 FlashDriver_GetPmuIndex( IO_PositionType address, vuint32 startIndex )
{
   vuint32 returnValue;
   ...
   uncachedAddress = address | 0xA0000000uL;

   index = startIndex;

   while ((index < (sizeof(flashStructure) / sizeof((flashStructure)[0u]))) && (0xFFFFFFFFuL == returnValue))
   {
...
# 947 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c"
# 1 "Include/MemMap.h" 1
# 3597 "Include/MemMap.h"
#pragma section
# 948 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c" 2

# 1 "Include/MemMap.h" 1
# 3574 "Include/MemMap.h"
#pragma section ".RamCodeCoreSection" ax
# 950 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c" 2
# 961 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c"
static IO_ErrorType FlashDriver_VerifyErasedPage(vuint32 address)
{
   IO_ErrorType returnValue;
   vuint32 errsr;
   ...
   (*((volatile tFlashUint32 *)((0xF8040000uL)+(0x0038uL)))) = (0x00000010uL | 0x00000002uL | 0x00000004uL);

   _dsync();
   *((volatile tFlashAddress *)(0xAF000000uL | (0xAA50u))) = ((tFlashAddress) (address));
   _dsync();
   *((volatile tFlashAddress *)(0xAF000000uL | (0xAA58u))) = ((tFlashAddress) (0x00u));
   _dsync();
   *((volatile tFlashAddress *)(0xAF000000uL | (0xAAA8u))) = ((tFlashAddress) (0x80u));
   _dsync();
   *((volatile tFlashAddress *)(0xAF000000uL | (0xAAA8u))) = ((tFlashAddress) (0x56u));
   _dsync();



   while((((*((volatile tFlashUint32 *)((0xF8040000uL)+(0x0010uL)))) & 0x000000FFu) == 0u))
   {
   }
   ...
   errsr = (*((volatile tFlashUint32 *)((0xF8040000uL)+(0x0034uL))));
# 1002 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c"
   if ((errsr & 0x00000002uL) == 0x00000002uL)
   {

      returnValue = 0x01u;
   }
   else if ((errsr & 0x00000010uL) == 0x00000010uL)
   {
   ...
   else if ((errsr & 0x00000004uL) == 0x00000004uL)
   {
...
# 3581 "Include/MemMap.h"
#pragma section
# 1035 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c" 2

# 1 "Include/MemMap.h" 1
# 3590 "Include/MemMap.h"
#pragma section ".RamCodeCoreSection" x
# 1037 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c" 2
# 1048 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c"
static IO_ErrorType FlashDriver_VerifyErased(vuint32 address, vuint32 length)
{
   IO_ErrorType returnValue = 0x00u;
   IO_ErrorType firstResult = 0x00u;
   ...
   if ((address & 0xAF000000uL) == 0xAF000000uL)
   {
      segmentSize = 0x08u;
   }
   else
   ...
   if (0x00u == returnValue)
   {

      alignedAddress = address & ((vuint32)((segmentSize - 1u) ^ ((vuint32)0xFFFFFFFFul)));

      alignedEndAddress = (address + length + segmentSize - 1u) & ((vuint32)((segmentSize - 1u) ^ ((vuint32)0xFFFFFFFFul)));
   ...
   if ((0x00u == returnValue) || (0xE5u == returnValue))
   {
...
# 3597 "Include/MemMap.h"
#pragma section
# 1106 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c" 2

# 1 "Include/MemMap.h" 1
# 3574 "Include/MemMap.h"
#pragma section ".RamCodeCoreSection" ax
# 1108 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c" 2
# 1124 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c"
static IO_ErrorType FlashDriver_ReadInternal(IO_MemPtrType readBuffer, const tflashRegs * regs, vuint32 startAddress, vuint32 length)
{
   IO_ErrorType returnValue;
   ...
   uncachedAddress = startAddress | 0xA0000000uL;
   localRegs = *regs;




   if ((uncachedAddress & 0xAF000000uL) == 0xAF000000uL)
   {
# 1158 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c"
      returnValue = 0x00u;
   }
   else
...

   {
      ...
      returnValue = 0x00u;
# 1196 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c"
      {
         ...
         (*ecccReg) = ((*ecccReg) & ((vuint32)((ecccMask) ^ ((vuint32)0xFFFFFFFFul)))) | (ecccValue & ecccMask);

         FblHwRegisterLock(FBL_WDT_CPU);

         {

            (void)FblOwnMemcpy( (void *)((void *) readBuffer), (const void *)((void *) uncachedAddress), (unsigned int)(length));
...
# 3581 "Include/MemMap.h"
#pragma section
# 1237 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c" 2

# 1 "Include/MemMap.h" 1
# 3590 "Include/MemMap.h"
#pragma section ".RamCodeCoreSection" x
# 1239 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c" 2
# 1616 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c"
IO_ErrorType FlashDriver_InitSync ( void * address )
{
   IO_ErrorType returnValue;
   ...
   flashParam.programmingType = 0x00u;
   flashParam.errorCode = 0x00u;

   flashParam.majorVersion = (tFlashUint8)(0x0209u >> 8u);
   flashParam.minorVersion = (tFlashUint8)(0x0209u & 0xFFu);
   flashParam.patchLevel = (tFlashUint8)(0x01u);

   flashParam.tempData = tempFlashData;

   {

      if ( (((flashCode)[3u]) != 0xA3u)
           || (((flashCode)[2u]) != 0x01u)
           || (((flashCode)[0u]) != (0x00u | 0x04u))
         )
      {

         returnValue = (0x00u | 0x09u);
      }
      else
      {

         ((tFlashFct)(*(tFlashUint32 *)&(flashCode)[(0x04u + 0x00u)]))(&flashParam);
         returnValue = flashParam.errorCode;
      }
   }
# 1672 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c"
   return returnValue;
}
# 1685 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c"
IO_ErrorType FlashDriver_DeinitSync ( void * address )
{
   vuint32 i;
   ...
   ((tFlashFct)(*(tFlashUint32 *)&(flashCode)[(0x04u + 0x04u)]))(&flashParam);
...
# 1730 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c"
IO_ErrorType FlashDriver_RWriteSync ( IO_MemPtrType writeBuffer, IO_SizeType writeLength, IO_PositionType writeAddress )
{
   return FlashDriver_WriteToFlash(writeBuffer, writeLength, writeAddress, 0x00u);
}
# 1748 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c"
IO_ErrorType FlashDriver_REraseSync ( IO_SizeType eraseLength, IO_PositionType eraseAddress )
{
   ...
   tPhysSector const * currentPhysicalSector;
   ...
   uncachedEraseAddress = eraseAddress | 0xA0000000uL;


   if ((uncachedEraseAddress & 0xAF000000uL) == 0xAF000000uL)
   {

      pmuPosition = 2u;
      pmuLimit = ((2u - 1u) + (1u + 0u));
   }
   else
   {
   ...
   if ((0xFFFFFFFFuL - eraseLength) < uncachedEraseAddress)
   {
      ...
      pmuPosition = ((2u - 1u) + (1u + 0u)) + 1u;
      pmuLimit = ((2u - 1u) + (1u + 0u));
   }


   while ((returnValue == 0x01u) && (pmuPosition <= pmuLimit))
   {
      physBlockPosition = 0uL;
      actualErasePosition = flashStructure[pmuPosition].startAddress;


      while ((returnValue == 0x01u) && (physBlockPosition < flashStructure[pmuPosition].physicalSectorCount))
      {
         logBlockPosition = 0uL;


         currentPhysicalSector = &flashStructure[pmuPosition].physicalSectors[physBlockPosition];
         while ((returnValue == 0x01u) && (logBlockPosition < currentPhysicalSector->logicalSectorCount))
         {
   ...
   if (returnValue == 0x00u)
   {
      ...
      while ((eraseCounter != 0uL) && (returnValue == 0x00u))
      {
         ...
         while ((eraseRange > 0u) && (0x00u == returnValue))
         {
            ...
            ((tFlashFct)(*(tFlashUint32 *)&(flashCode)[(0x04u + 0x08u)]))(&flashParam);
   ...
   else
   {
      if (addressAligned == 0x00uL)
      {
         ...
         returnValue = (0x40u | 0x04u);
      }
      else
      {

         returnValue = (0x40u | 0x05u);
      }
   }

   return returnValue;
}
# 1966 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c"
IO_ErrorType FlashDriver_RReadSync ( IO_MemPtrType readBuffer, IO_SizeType readLength, IO_PositionType readAddress )
{
   IO_ErrorType returnValue;
   ...
   uncachedAddress = readAddress | 0xA0000000uL;
   ...
   if (remainingLength > 0uL)
   {
      ...
      do
      {
         ...
         else
         {
            ...
            internalResult = FlashDriver_ReadInternal(&readBuffer[pos], ((flashStructure[pmu]).flashRegs), uncachedAddress, length);

            if ((0xE5u == returnValue) && (0x00u == internalResult))
            {
            ...
            if (0xE5u == internalResult)
            {

               for (i = 0uL; i < length; i++)
               {
                  readBuffer[pos + i] = 0x00u;
               }
            }
      ...
      while ((remainingLength > 0u) && (0x01u != returnValue));
   }

   return returnValue;
}
# 2055 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c"
IO_U32 FlashDriver_GetVersionOfDriver( void )
{
   IO_U32 returnValue;
      ...
      )
   {
      ...
      returnValue = (IO_U32)(((IO_U32)(tFlashUint8)(0x0209u >> 8u) << 16u) |
                             ((IO_U32)(tFlashUint8)(0x0209u & 0xFFu) << 8u) |
                             ((IO_U32)(tFlashUint8)(0x01u)));
   }
   else
   {
...
# 2347 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c"
void FlashDriver_ResumeProtection( void )
{
   *((volatile tFlashAddress *)(0xAF000000uL | (0x5554u))) = ((tFlashAddress) (0x00F5u));
   _dsync();
}
# 2362 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c"
IO_ErrorType FlashDriver_DisableProtection(vuint16 uc, const vuint32 password[8u])
{
   IO_ErrorType result;
   vuint32 i;
   ...
   if (0x00u == result)
   {
      ...
      if(((*((volatile tFlashUint32 *)((0xF8040000uL)+(0x001CuL)))) & protectRegisterMask) == protectRegisterMask)
      {
      ...
      else
      {
         ...
         (*((volatile tFlashUint32 *)((0xF8040000uL)+(0x0038uL)))) |= 0x00000004uL;

         *((volatile tFlashAddress *)(0xAF000000uL | (0x553Cu))) = ((tFlashAddress) (uc));
         _dsync();
         *((volatile tFlashAddress *)(0xAF000000uL | (0x553Cu))) = ((tFlashAddress) (password[0u]));
         _dsync();
         *((volatile tFlashAddress *)(0xAF000000uL | (0x553Cu))) = ((tFlashAddress) (password[1u]));
         _dsync();
         *((volatile tFlashAddress *)(0xAF000000uL | (0x553Cu))) = ((tFlashAddress) (password[2u]));
         _dsync();
         *((volatile tFlashAddress *)(0xAF000000uL | (0x553Cu))) = ((tFlashAddress) (password[3u]));
         _dsync();
         *((volatile tFlashAddress *)(0xAF000000uL | (0x553Cu))) = ((tFlashAddress) (password[4u]));
         _dsync();
         *((volatile tFlashAddress *)(0xAF000000uL | (0x553Cu))) = ((tFlashAddress) (password[5u]));
         _dsync();
         *((volatile tFlashAddress *)(0xAF000000uL | (0x553Cu))) = ((tFlashAddress) (password[6u]));
         _dsync();
         *((volatile tFlashAddress *)(0xAF000000uL | (0x553Cu))) = ((tFlashAddress) (password[7u]));
         _dsync();



         if ( (((*((volatile tFlashUint32 *)((0xF8040000uL)+(0x001CuL)))) & protectRegisterMask) == protectRegisterMask) && (((*((volatile tFlashUint32 *)((0xF8040000uL)+(0x0034uL)))) & 0x00000004uL) == 0u))
         {
...
# 2755 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c"
# 1 "Include/MemMap.h" 1
# 3597 "Include/MemMap.h"
#pragma section
# 2756 "../../../../CBD2300515_D00/BSW/Fbl/fbl_flio.c" 2
