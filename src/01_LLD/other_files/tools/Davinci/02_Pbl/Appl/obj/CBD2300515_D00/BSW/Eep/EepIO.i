# 1 "../../../../CBD2300515_D00/BSW/Eep/EepIO.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/Eep/EepIO.c"
# 45 "../../../../CBD2300515_D00/BSW/Eep/EepIO.c"
# 1 "../../../../CBD2300515_D00/BSW/Eep/EepInc.h" 1
# 42 "../../../../CBD2300515_D00/BSW/Eep/EepInc.h"
...
# 43 "../../../../CBD2300515_D00/BSW/Eep/EepInc.h" 2
# 1 "../../../../CBD2300515_D00/BSW/Eep/EepIO.h" 1
# 74 "../../../../CBD2300515_D00/BSW/Eep/EepIO.h"
# 1 "Include/MemMap.h" 1
# 75 "../../../../CBD2300515_D00/BSW/Eep/EepIO.h" 2
...
# 1 "Include/MemMap.h" 1
# 86 "../../../../CBD2300515_D00/BSW/Eep/EepIO.h" 2
# 44 "../../../../CBD2300515_D00/BSW/Eep/EepInc.h" 2
# 46 "../../../../CBD2300515_D00/BSW/Eep/EepIO.c" 2
# 85 "../../../../CBD2300515_D00/BSW/Eep/EepIO.c"
# 1 "Include/MemMap.h" 1
# 86 "../../../../CBD2300515_D00/BSW/Eep/EepIO.c" 2
 static IO_U8 eepData[((((((((0x70001C00u) + 0x08u) + 0x01u - 1u) - 0x70001C00u + 1u) + 0x01u) + ((4u) - 1u)) / (4u)) * (4u))];

# 1 "Include/MemMap.h" 1
# 89 "../../../../CBD2300515_D00/BSW/Eep/EepIO.c" 2
...
# 1 "Include/MemMap.h" 1
# 96 "../../../../CBD2300515_D00/BSW/Eep/EepIO.c" 2

static IO_ErrorType EepromDriver_CheckRangeContained( IO_SizeType length, IO_PositionType address );
# 114 "../../../../CBD2300515_D00/BSW/Eep/EepIO.c"
static IO_ErrorType EepromDriver_CheckRangeContained( IO_SizeType length, IO_PositionType address )
{
   IO_ErrorType result;

   if ( (address >= ((vuint32)eepData))
       && ((address - ((vuint32)eepData)) < (((((((((0x70001C00u) + 0x08u) + 0x01u - 1u) - 0x70001C00u + 1u) + 0x01u) + ((4u) - 1u)) / (4u)) * (4u)) - 0x01u))
       && (length <= (((((((((0x70001C00u) + 0x08u) + 0x01u - 1u) - 0x70001C00u + 1u) + 0x01u) + ((4u) - 1u)) / (4u)) * (4u)) - 0x01u))
       && ((address - ((vuint32)eepData)) <= ((((((((((0x70001C00u) + 0x08u) + 0x01u - 1u) - 0x70001C00u + 1u) + 0x01u) + ((4u) - 1u)) / (4u)) * (4u)) - 0x01u) - length)))
   {
      result = 0x00u;
   }
   else
...
# 146 "../../../../CBD2300515_D00/BSW/Eep/EepIO.c"
IO_ErrorType EepromDriver_InitSync( void * address )
{
   IO_SizeType i;
   ...
   if (0x55u != eepData[(((((((((0x70001C00u) + 0x08u) + 0x01u - 1u) - 0x70001C00u + 1u) + 0x01u) + ((4u) - 1u)) / (4u)) * (4u)) - 0x01u)])
   {

      for (i = 0u; i < (((((((((0x70001C00u) + 0x08u) + 0x01u - 1u) - 0x70001C00u + 1u) + 0x01u) + ((4u) - 1u)) / (4u)) * (4u)) - 0x01u); i++)
      {
         eepData[i] = 0xFFu;
      }


      eepData[(((((((((0x70001C00u) + 0x08u) + 0x01u - 1u) - 0x70001C00u + 1u) + 0x01u) + ((4u) - 1u)) / (4u)) * (4u)) - 0x01u)] = 0x55u;
   }

   return 0x00u;
}
# 177 "../../../../CBD2300515_D00/BSW/Eep/EepIO.c"
IO_ErrorType EepromDriver_DeinitSync( void * address )
{
...
# 197 "../../../../CBD2300515_D00/BSW/Eep/EepIO.c"
IO_ErrorType EepromDriver_RWriteSync( IO_MemPtrType writeBuffer, IO_SizeType writeLength, IO_PositionType writeAddress )
{
   IO_ErrorType result;
   ...
   if (0x00u == result)
   {
      ...
      (void)FblOwnMemcpy( (void *)((IO_MemPtrType)writeAddress), (const void *)(writeBuffer), (unsigned int)(writeLength));
   }

   return result;
}
# 221 "../../../../CBD2300515_D00/BSW/Eep/EepIO.c"
IO_ErrorType EepromDriver_REraseSync( IO_SizeType eraseLength, IO_PositionType eraseAddress )
{
   IO_ErrorType result;
...
# 245 "../../../../CBD2300515_D00/BSW/Eep/EepIO.c"
IO_ErrorType EepromDriver_RReadSync( IO_MemPtrType readBuffer, IO_SizeType readLength, IO_PositionType readAddress )
{
   IO_ErrorType result;
   ...
   if (0x00u == result)
   {
      (void)FblOwnMemcpy( (void *)(readBuffer), (const void *)((IO_MemPtrType)readAddress), (unsigned int)(readLength));
   }

   return result;
}
# 267 "../../../../CBD2300515_D00/BSW/Eep/EepIO.c"
IO_ErrorType EepromDriver_VerifySync( void * address )
{
...
# 1 "Include/MemMap.h" 1
# 278 "../../../../CBD2300515_D00/BSW/Eep/EepIO.c" 2
