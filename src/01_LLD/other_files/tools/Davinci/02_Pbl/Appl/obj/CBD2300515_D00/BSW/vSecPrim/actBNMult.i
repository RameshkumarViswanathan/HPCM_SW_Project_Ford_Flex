# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNMult.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNMult.c"
# 39 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNMult.c"
...
# 40 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNMult.c" 2
...
# 41 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNMult.c" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actWatchdog.h" 1
# 42 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNMult.c" 2




# 1 "GenData/vSecPrim_MemMap.h" 1
# 47 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNMult.c" 2
# 63 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNMult.c"
void actBNMult(
  const actBNDIGIT * a,
  const actLengthType a_length,
  const actBNDIGIT * b,
  ...
  void ( * watchdog)(void))
{
  ...
  actBNSet ((c), (c_length), ((actBNDIGIT) 0));
  ...
  for (i = 0u; i < b_length; ++i)
  {
    ...
    for (j = 0u; j < a_length; ++j)
    {
      ...
      c[(i + j)] = ((actBNDIGIT)(tmp));
      carry = ((actBNDIGIT)((tmp) >> ((32u))));
    }
    c[(i + a_length)] = carry;
  }
}
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 95 "../../../../CBD2300515_D00/BSW/vSecPrim/actBNMult.c" 2
