# 1 "../../../../CBD2300515_D00/BSW/Crypto_30_LibCv/Crypto_30_LibCv_Hash.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/Crypto_30_LibCv/Crypto_30_LibCv_Hash.c"
# 31 "../../../../CBD2300515_D00/BSW/Crypto_30_LibCv/Crypto_30_LibCv_Hash.c"
...
# 32 "../../../../CBD2300515_D00/BSW/Crypto_30_LibCv/Crypto_30_LibCv_Hash.c" 2
...
# 33 "../../../../CBD2300515_D00/BSW/Crypto_30_LibCv/Crypto_30_LibCv_Hash.c" 2
...
# 34 "../../../../CBD2300515_D00/BSW/Crypto_30_LibCv/Crypto_30_LibCv_Hash.c" 2
# 49 "../../../../CBD2300515_D00/BSW/Crypto_30_LibCv/Crypto_30_LibCv_Hash.c"
# 1 "GenData/Crypto_30_LibCv_MemMap.h" 1
# 50 "../../../../CBD2300515_D00/BSW/Crypto_30_LibCv/Crypto_30_LibCv_Hash.c" 2
# 67 "../../../../CBD2300515_D00/BSW/Crypto_30_LibCv/Crypto_30_LibCv_Hash.c"
Std_ReturnType Crypto_30_LibCv_Dispatch_Hash_ModeStart(
  vSecPrimType_WorkSpaceHash * workSpace,
  Crypto_AlgorithmFamilyType hashAlgoFam)
{
  ...
  vSecPrimType_HashAlgorithm esLibHashAlgoIdentifier = (0xFFu);
# 83 "../../../../CBD2300515_D00/BSW/Crypto_30_LibCv/Crypto_30_LibCv_Hash.c"
  if (hashAlgoFam < 4u)
  {
    esLibHashAlgoIdentifier = (Crypto_30_LibCv_FamilyToHashMapping[(hashAlgoFam)]);
  }
  else
  {
  ...
  retValCv = esl_initWorkSpaceHeader(&(workSpace->header), (sizeof(vSecPrimType_WorkSpaceHash) - sizeof(eslt_WorkSpaceHeader)), FblLookForWatchdogVoid);

  if (retValCv == (0x0000u))
  {
    retValCv = vSecPrim_initHash(workSpace, esLibHashAlgoIdentifier, (0x04u));
  }
...
# 116 "../../../../CBD2300515_D00/BSW/Crypto_30_LibCv/Crypto_30_LibCv_Hash.c"
Std_ReturnType Crypto_30_LibCv_Dispatch_Hash_ModeUpdate(
  vSecPrimType_WorkSpaceHash * workSpace,
  uint32 inputLength,
  const uint8 * inputPtr)
{
  ...
  retValCv = vSecPrim_updateHash(workSpace,
    (eslt_Length)inputLength,
    (const eslt_Byte * )inputPtr);
...
# 146 "../../../../CBD2300515_D00/BSW/Crypto_30_LibCv/Crypto_30_LibCv_Hash.c"
Std_ReturnType Crypto_30_LibCv_Dispatch_Hash_ModeFinish(
  vSecPrimType_WorkSpaceHash * workSpace,
  uint32 * outputLengthPtr,
  uint8 * outputPtr)
{
  ...
  retValCv = vSecPrim_finalizeHash(workSpace, &outputLength, outputPtr);

  if (retValCv == (0x0000u))
  {
    *outputLengthPtr = outputLength;
    retVal = 0u;
  }

  return retVal;
}
# 185 "../../../../CBD2300515_D00/BSW/Crypto_30_LibCv/Crypto_30_LibCv_Hash.c"
Std_ReturnType Crypto_30_LibCv_Dispatch_Hash(
  uint32 objectId,
  Crypto_JobType * job,
  Crypto_OperationModeType mode)
{
  ...
  vSecPrimType_WorkSpaceHash * workSpaceHash = (Crypto_30_LibCv_Hash[((Crypto_30_LibCv_ObjectInfo[(objectId)].HashIdxOfObjectInfo))].WorkspaceOfHash);
  ;
  ...
  switch (mode)
  {
    ...
    case 1u:
    {
      retVal = Crypto_30_LibCv_Dispatch_Hash_ModeStart(workSpaceHash, job->jobPrimitiveInfo->primitiveInfo->algorithm.family);
      break;
    }

    case 2u:
    {
      retVal = Crypto_30_LibCv_Dispatch_Hash_ModeUpdate(workSpaceHash, job->jobPrimitiveInputOutput.inputLength,
    ...
    case 4u:
    {
      retVal = Crypto_30_LibCv_Dispatch_Hash_ModeFinish(workSpaceHash, job->jobPrimitiveInputOutput.outputLengthPtr,
...
# 1 "GenData/Crypto_30_LibCv_MemMap.h" 1
# 232 "../../../../CBD2300515_D00/BSW/Crypto_30_LibCv/Crypto_30_LibCv_Hash.c" 2
