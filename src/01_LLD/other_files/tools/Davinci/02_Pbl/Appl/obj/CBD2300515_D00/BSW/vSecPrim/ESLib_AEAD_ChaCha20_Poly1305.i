# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_AEAD_ChaCha20_Poly1305.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_AEAD_ChaCha20_Poly1305.c"
# 55 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_AEAD_ChaCha20_Poly1305.c"
...
# 56 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_AEAD_ChaCha20_Poly1305.c" 2


# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actIAEAD7539.h" 1
# 62 "../../../../CBD2300515_D00/BSW/vSecPrim/actIAEAD7539.h"
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actIChaCha20.h" 1
# 66 "../../../../CBD2300515_D00/BSW/vSecPrim/actIChaCha20.h"
typedef struct
{
  actU32 iState[16];
  actU8 cipher[64];
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 79 "../../../../CBD2300515_D00/BSW/vSecPrim/actIChaCha20.h" 2
# 101 "../../../../CBD2300515_D00/BSW/vSecPrim/actIChaCha20.h"
extern void actChaCha20Init(actChaCha20Context * ctx,
  const actU8 * key,
  const actU8 * nonce,
  const actU32 bCount,
  void ( * watchdog)(void));
# 125 "../../../../CBD2300515_D00/BSW/vSecPrim/actIChaCha20.h"
extern void actChaCha20Cipher(actChaCha20Context * ctx,
  const actU8 * in,
  const actLengthType iLen,
  actU8 * out,
  void ( * watchdog)(void));
# 145 "../../../../CBD2300515_D00/BSW/vSecPrim/actIChaCha20.h"
void actChaCha20NextBlock(actChaCha20Context * ctx,
  void ( * watchdog)(void));
# 162 "../../../../CBD2300515_D00/BSW/vSecPrim/actIChaCha20.h"
void actChaCha20EatBlock(actChaCha20Context * ctx);
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 170 "../../../../CBD2300515_D00/BSW/vSecPrim/actIChaCha20.h" 2
# 63 "../../../../CBD2300515_D00/BSW/vSecPrim/actIAEAD7539.h" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actIPoly1305.h" 1
# 60 "../../../../CBD2300515_D00/BSW/vSecPrim/actIPoly1305.h"
...
# 61 "../../../../CBD2300515_D00/BSW/vSecPrim/actIPoly1305.h" 2
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 84 "../../../../CBD2300515_D00/BSW/vSecPrim/actIPoly1305.h" 2
# 103 "../../../../CBD2300515_D00/BSW/vSecPrim/actIPoly1305.h"
extern void actPoly1305Init(actPoly1305Context * ctx,
  const actU8 * key);
# 122 "../../../../CBD2300515_D00/BSW/vSecPrim/actIPoly1305.h"
extern void actPoly1305Update(actPoly1305Context * ctx,
  const actU8 * data,
  const actLengthType dLen,
  void ( * watchdog)(void));
# 142 "../../../../CBD2300515_D00/BSW/vSecPrim/actIPoly1305.h"
extern void actPoly1305HandleRemains(actPoly1305Context * ctx,
  const actU8 fillUp,
  void ( * watchdog)(void));
# 164 "../../../../CBD2300515_D00/BSW/vSecPrim/actIPoly1305.h"
extern void actPoly1305Finalize(actPoly1305Context * ctx,
  actU8 * tag,
  void ( * watchdog)(void));
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 174 "../../../../CBD2300515_D00/BSW/vSecPrim/actIPoly1305.h" 2
# 64 "../../../../CBD2300515_D00/BSW/vSecPrim/actIAEAD7539.h" 2
# 79 "../../../../CBD2300515_D00/BSW/vSecPrim/actIAEAD7539.h"
typedef struct
{
  actU32 mode;
  actU8 data[16];
...
# 96 "../../../../CBD2300515_D00/BSW/vSecPrim/actIAEAD7539.h"
# 1 "GenData/vSecPrim_MemMap.h" 1
# 97 "../../../../CBD2300515_D00/BSW/vSecPrim/actIAEAD7539.h" 2
# 121 "../../../../CBD2300515_D00/BSW/vSecPrim/actIAEAD7539.h"
extern void actAEAD7539Init(actAEAD7539Context * ctx,
  const actU8 * key,
  const actU8 * nonce,
  const actU32 mode,
  void ( * watchdog)(void));
# 159 "../../../../CBD2300515_D00/BSW/vSecPrim/actIAEAD7539.h"
extern actRETURNCODE actAEAD7539Update(actAEAD7539Context * ctx,
  const actU8 * in,
  const actLengthType iLen,
  actU8 * out,
  void ( * watchdog)(void));
# 181 "../../../../CBD2300515_D00/BSW/vSecPrim/actIAEAD7539.h"
void actAEAD7539SwitchToData(actAEAD7539Context * ctx);
# 200 "../../../../CBD2300515_D00/BSW/vSecPrim/actIAEAD7539.h"
void actAEAD7539Finalize(actAEAD7539Context * ctx,
  actU8 * tag,
  void ( * watchdog)(void));
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 211 "../../../../CBD2300515_D00/BSW/vSecPrim/actIAEAD7539.h" 2
# 59 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_AEAD_ChaCha20_Poly1305.c" 2
