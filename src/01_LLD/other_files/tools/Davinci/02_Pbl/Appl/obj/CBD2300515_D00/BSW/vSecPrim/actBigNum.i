# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actBigNum.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actBigNum.c"
# 40 "../../../../CBD2300515_D00/BSW/vSecPrim/actBigNum.c"
...
# 41 "../../../../CBD2300515_D00/BSW/vSecPrim/actBigNum.c" 2
...
# 42 "../../../../CBD2300515_D00/BSW/vSecPrim/actBigNum.c" 2




# 1 "GenData/vSecPrim_MemMap.h" 1
# 47 "../../../../CBD2300515_D00/BSW/vSecPrim/actBigNum.c" 2
# 60 "../../../../CBD2300515_D00/BSW/vSecPrim/actBigNum.c"
void actBNLoadLE(
  actBNDIGIT * bigNum,
  const actU8 * bytes,
  const actU32 byteLength)
{
  ...
  for (b = (byteLength / ((((32u)))>>3)); b > 0u; b--)
  {
    ...
    offset += 4u;
# 90 "../../../../CBD2300515_D00/BSW/vSecPrim/actBigNum.c"
    bigNum[(byteLength / ((((32u)))>>3)) - b] = tmp;
  }
}
# 102 "../../../../CBD2300515_D00/BSW/vSecPrim/actBigNum.c"
void actBNStoreLE(
  actU8 * bytes,
  const actBNDIGIT * bigNum,
  const actLengthType bnLength)
{
  register actU32 b;
  actU8 * bytesPtr = bytes;

  for (b = bnLength; b > 0u; b--)
  {
    register actBNDIGIT tmp = *(&bigNum[(bnLength - b)]);
    ...
    bytesPtr = &bytesPtr[4];
# 129 "../../../../CBD2300515_D00/BSW/vSecPrim/actBigNum.c"
  }
}
# 140 "../../../../CBD2300515_D00/BSW/vSecPrim/actBigNum.c"
void actBNCopy(actBNDIGIT * a, const actBNDIGIT * b, const actLengthType length)
{
  actLengthType i;
...
# 158 "../../../../CBD2300515_D00/BSW/vSecPrim/actBigNum.c"
actLengthType actBNGetBitLength(
  const actBNDIGIT * a,
  const actLengthType length)
{
...
# 192 "../../../../CBD2300515_D00/BSW/vSecPrim/actBigNum.c"
actRETURNCODE actBNSetBit(
  actBNDIGIT * a,
  const actLengthType length,
  const actLengthType bit_pos)
{
  ...
  if (bit_pos >= (actLengthType)(length * ((32u))))
  {

  }
  else
  {
    a[bit_pos / ((32u))] |= (((actBNDIGIT) 1) << (bit_pos % ((32u))));
    retVal = (0x00u);
  }

  return retVal;
}
# 220 "../../../../CBD2300515_D00/BSW/vSecPrim/actBigNum.c"
void actBNSet(
  actBNDIGIT * a,
  const actLengthType length,
  const actBNDIGIT value)
...
# 244 "../../../../CBD2300515_D00/BSW/vSecPrim/actBigNum.c"
actU8 actBNIsZero(
  const actBNDIGIT * a,
  const actLengthType length)
{
...
# 270 "../../../../CBD2300515_D00/BSW/vSecPrim/actBigNum.c"
actRETURNCODE actBNCompare(
  const actBNDIGIT * a,
  const actBNDIGIT * b,
  const actLengthType length)
{
  actRETURNCODE retVal = (0x11u);
  actLengthType i;
...
# 307 "../../../../CBD2300515_D00/BSW/vSecPrim/actBigNum.c"
void actBNSetOctetString(
  actBNDIGIT * a,
  actLengthType length,
  const actU8 * in,
  const actLengthType in_len)
{
  actLengthType i, digits = in_len / ((((32u)))>>3);
  actLengthType offset = in_len - 1u;

  actBNSet ((a), (length), ((actBNDIGIT) 0));
  digits = ((((actLengthType)length)<(digits))? ((actLengthType)length):(digits));
  ...
  if (in_len <= ((actLengthType)length * ((((32u)))>>3)))
  {
    for(i = in_len % ((((32u)))>>3); i > 0u; --i)
    {
      a[digits] <<= 8;
...
# 356 "../../../../CBD2300515_D00/BSW/vSecPrim/actBigNum.c"
void actBNSetOctetStringROM(
   actBNDIGIT * a, actLengthType length,
   const actU8 * in, const actLengthType in_len)
{
  actLengthType i, digits = in_len / ((((32u)))>>3);
  actLengthType offset = in_len - 1u;
...
# 404 "../../../../CBD2300515_D00/BSW/vSecPrim/actBigNum.c"
void actBNOctetString(
   actU8 * out, actLengthType out_len,
   const actBNDIGIT * a, const actLengthType length)
{
  actLengthType i, digits = out_len / ((((32u)))>>3);

  actBNDIGIT tmp;

  actLengthType offset = out_len;

  (VStdLib_MemSet((out), (0u), (out_len)));
  digits = ((((actLengthType)length)<(digits))? ((actLengthType)length):(digits));


  for (i = 0; i < digits; ++i)
  {
# 431 "../../../../CBD2300515_D00/BSW/vSecPrim/actBigNum.c"
    tmp = a[i];
    offset--;
  ...
  if (out_len <= (actLengthType)(length * ((((32u)))>>3)))
  {
    if ((out_len % ((((32u)))>>3)) > 0u)
    {
      tmp = a[i];

      for(i = out_len % ((((32u)))>>3); i > 0u; --i)
      {
        offset--;
        out[offset] = ((actU8) tmp);
        tmp >>= 8;
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 469 "../../../../CBD2300515_D00/BSW/vSecPrim/actBigNum.c" 2
