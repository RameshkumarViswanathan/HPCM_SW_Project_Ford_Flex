# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_MGF1.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_MGF1.c"
# 39 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_MGF1.c"
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_Common.h" 1
# 36 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_Common.h"
...
# 37 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_Common.h" 2
...
# 40 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_MGF1.c" 2
...
# 41 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_MGF1.c" 2
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 49 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_MGF1.c" 2
# 60 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_MGF1.c"
eslt_ErrorCode esl_generateMaskMGF1RSASHA1_PSS(
  eslt_WorkSpaceSHA1 * wsHash,
  eslt_Byte * tempHash,
  eslt_Length seedLength,
  const eslt_Byte * seed,
  ...
  eslt_Byte * mask)
{
  ...
  if ((wsHash == ((void *)0)) || (tempHash == ((void *)0)) || (seed == ((void *)0)) || (mask == ((void *)0)))
  {
    returnValue = (0x2000u + 0x0003u);
  }
  else if ((returnValue = esl_CheckWorkSpaceHeader(&wsHash->header, (sizeof(actSHASTRUCT)))) != (0x0000u))
  {
  ...
  else
  {
    ...
    returnValue = esl_generateMaskMGF1((0x00u), &wsHashUnion,
      tempHash, 20u, seedLength, seed, maskLength, mask);
  }

  return returnValue;
}
# 101 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_MGF1.c"
eslt_ErrorCode esl_generateMaskMGF1RSASHA256_PSS(
  eslt_WorkSpaceSHA256 * wsHash,
  eslt_Byte * tempHash,
  eslt_Length seedLength,
  const eslt_Byte * seed,
  ...
  eslt_Byte * mask)
{
  ...
  else if ((returnValue = esl_CheckWorkSpaceHeader(&wsHash->header, (sizeof(actSHA256STRUCT)))) != (0x0000u))
  {
  ...
  else
  {
    ...
    returnValue = esl_generateMaskMGF1((0x02u), &wsHashUnion,
      tempHash, 32u, seedLength, seed, maskLength, mask);
  }

  return returnValue;
}
# 174 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_MGF1.c"
# 1 "GenData/vSecPrim_MemMap.h" 1
# 175 "../../../../CBD2300515_D00/BSW/vSecPrim/ESLib_RSA_MGF1.c" 2
