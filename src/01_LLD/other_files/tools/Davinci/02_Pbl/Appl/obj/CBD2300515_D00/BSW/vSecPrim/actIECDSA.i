# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actIECDSA.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actIECDSA.c"
# 39 "../../../../CBD2300515_D00/BSW/vSecPrim/actIECDSA.c"
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actIECDSA.h" 1
# 39 "../../../../CBD2300515_D00/BSW/vSecPrim/actIECDSA.h"
...
# 40 "../../../../CBD2300515_D00/BSW/vSecPrim/actIECDSA.h" 2
# 53 "../../../../CBD2300515_D00/BSW/vSecPrim/actIECDSA.h"
# 1 "GenData/vSecPrim_MemMap.h" 1
# 54 "../../../../CBD2300515_D00/BSW/vSecPrim/actIECDSA.h" 2
# 72 "../../../../CBD2300515_D00/BSW/vSecPrim/actIECDSA.h"
actLengthType actECDSAGetSignatureCompLength(const actU8 * domain);
# 97 "../../../../CBD2300515_D00/BSW/vSecPrim/actIECDSA.h"
actRETURNCODE actECDSAInitVerify(
  const actU8 * domain,
  const actU8 * domain_ext,
  actECPSTRUCT * wksp,
  actLengthType wksp_len);
# 140 "../../../../CBD2300515_D00/BSW/vSecPrim/actIECDSA.h"
actRETURNCODE actECDSAVerify(
  const actU8 * message,
  actLengthType message_len,
  const actU8 * signature_r,
  actLengthType signature_r_len,
  const actU8 * signature_s,
  actLengthType signature_s_len,
  const actU8 * publickey_x,
  const actU8 * publickey_y,
  actECPSTRUCT * wksp,
  void ( * watchdog)(void));
# 177 "../../../../CBD2300515_D00/BSW/vSecPrim/actIECDSA.h"
actRETURNCODE actECDSAInitSign(
  const actU8 * domain,
  const actU8 * domain_ext,
  const actU8 * speedup_ext,
  actECPSTRUCT * wksp,
  actLengthType wksp_len);
# 222 "../../../../CBD2300515_D00/BSW/vSecPrim/actIECDSA.h"
actRETURNCODE actECDSASign(
  const actU8 * message,
  actLengthType message_len,
  const actU8 * privatekey,
  actU8 * signature_r,
  actLengthType * signature_r_len,
  actU8 * signature_s,
  actLengthType * signature_s_len,
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 239 "../../../../CBD2300515_D00/BSW/vSecPrim/actIECDSA.h" 2
# 40 "../../../../CBD2300515_D00/BSW/vSecPrim/actIECDSA.c" 2
...
# 41 "../../../../CBD2300515_D00/BSW/vSecPrim/actIECDSA.c" 2
...
# 42 "../../../../CBD2300515_D00/BSW/vSecPrim/actIECDSA.c" 2
# 1 "../../../../CBD2300515_D00/BSW/vSecPrim/actECDSA.h" 1
# 40 "../../../../CBD2300515_D00/BSW/vSecPrim/actECDSA.h"
...
# 41 "../../../../CBD2300515_D00/BSW/vSecPrim/actECDSA.h" 2
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 48 "../../../../CBD2300515_D00/BSW/vSecPrim/actECDSA.h" 2
# 85 "../../../../CBD2300515_D00/BSW/vSecPrim/actECDSA.h"
actRETURNCODE actECDSAvp(
  const actBNDIGIT * e,
  const actBNDIGIT * r,
  const actBNDIGIT * s,
  const actECPOINT * Q,
  actECPSTRUCT * wksp_ptr,
  void ( * watchdog)(void));
# 121 "../../../../CBD2300515_D00/BSW/vSecPrim/actECDSA.h"
actRETURNCODE actECDSAsp(
  const actBNDIGIT * e,
  const actBNDIGIT * d,
  actBNDIGIT * r,
  actBNDIGIT * s,
...
# 1 "GenData/vSecPrim_MemMap.h" 1
# 135 "../../../../CBD2300515_D00/BSW/vSecPrim/actECDSA.h" 2
# 43 "../../../../CBD2300515_D00/BSW/vSecPrim/actIECDSA.c" 2
...
# 45 "../../../../CBD2300515_D00/BSW/vSecPrim/actIECDSA.c" 2
