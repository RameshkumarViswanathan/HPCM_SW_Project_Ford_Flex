...
# if defined( FBL_ENABLE_FBL_START )
   ...
   if (FblBmChkFblStartMagicFlag())
   {
      ...
      FblBmClrMagicFlag(); /* PRQA S 3109 */ /* MD_MSR_14.3 */
...
tApplStatus ApplFblIsValidApp( void )
{
   ...
   /*
    * This function is called in the context of RoutineControl CheckMemory if all mandatory blocks are present
    */
...
# else
      /* User specific: check if application validity is set (e.g. in EEPROM) */
