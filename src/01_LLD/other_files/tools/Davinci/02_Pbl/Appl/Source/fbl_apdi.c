...
{
   {
      ...
      kDiagDataIdEcuCoreAssemblyNumber, kDiagFmtDataIdEcuCoreAssemblyNumberSize, fblCommonData.EcuCoreAssemblyNumber
   },
   {
      /* ECU Delivery Assembly Number */
      kDiagDataIdEcuDeliveryAssemblyNumber, kDiagFmtDataIdEcuDeliveryAssemblyNumberSize, fblCommonData.EcuDeliveryAssemblyNumber
   },
   {
      /* ECU Serial Number */
      kDiagDataIdEcuSerialNumber, kDiagFmtDataIdEcuSerialNumberSize, fblCommonData.EcuSerialNumber
   },
   {
   ...
   },
   {
      ...
      kDiagDataIdFordElectronicSerialNumber, kDiagFmtDataIdFordElectronicSerialNumberSize, fblCommonData.FordElectronicSerialNumber
   }
# if ( SEC_SECURITY_CLASS_VERIFY == SEC_CLASS_CCC )
   ,{
