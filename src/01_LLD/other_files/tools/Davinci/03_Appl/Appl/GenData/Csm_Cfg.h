...
#define CSM_USE_DUMMY_STATEMENT STD_OFF /* /MICROSAR/vSet/vSetGeneral/vSetDummyStatementKind */
#endif
#ifndef CSM_DUMMY_STATEMENT
#define CSM_DUMMY_STATEMENT(v)  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */  /* /MICROSAR/vSet/vSetGeneral/vSetDummyStatementKind */
#endif
#ifndef CSM_DUMMY_STATEMENT_CONST
#define CSM_DUMMY_STATEMENT_CONST(v)  /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */  /* /MICROSAR/vSet/vSetGeneral/vSetDummyStatementKind */
#endif
...
#endif
#ifndef CSM_PROCESSOR_TC377T
#define CSM_PROCESSOR_TC377T
#endif
#ifndef CSM_COMP_GCCHIGHTEC
#define CSM_COMP_GCCHIGHTEC
#endif
...
#define CsmConf_CsmJob_CsmJob_HashSha256                                                            0u 
#define CsmConf_CsmJob_CsmJob_RandomGenerate                                                        1u 
#define CsmConf_CsmJob_CsmJob_SigAsymVer_RsaPssSha256                                               2u 
#define CsmConf_CsmKey_CsmKey_SmhKeyRSA                                                             0u 
#define CsmConf_CsmKey_CsmKey_Smh_HashSha256                                                        1u 
#define CsmConf_CsmKey_CsmKey_Smh_Nist_800_90A                                                      2u 
...
#define CSM_EXIST_MACVERIFY                                                                         STD_OFF
...
#define Csm_GetSizeOfJobInfoOfPCConfig()                                                            3u  /**< the number of accomplishable value elements in Csm_JobInfo */
#define Csm_GetSizeOfJobOfPCConfig()                                                                1u  /**< the number of accomplishable value elements in Csm_Job */
#define Csm_GetSizeOfJobPrimitiveInfoOfPCConfig()                                                   3u  /**< the number of accomplishable value elements in Csm_JobPrimitiveInfo */
#define Csm_GetSizeOfJobTableOfPCConfig()                                                           3u  /**< the number of accomplishable value elements in Csm_JobTable */
#define Csm_GetSizeOfKeyOfPCConfig()                                                                3u  /**< the number of accomplishable value elements in Csm_Key */
#define Csm_GetSizeOfPrimitiveInfoOfPCConfig()                                                      3u  /**< the number of accomplishable value elements in Csm_PrimitiveInfo */
#define Csm_GetSizeOfQueueInfoOfPCConfig()                                                          1u  /**< the number of accomplishable value elements in Csm_QueueInfo */
#define Csm_GetSizeOfQueueOfPCConfig()                                                              1u  /**< the number of accomplishable value elements in Csm_Queue */
...
#define Csm_GetQueueRefIdxOfJobTable(Index)                                                         Csm_GetPriorityOfJobTable(Index)  /**< the index of the 1:1 relation pointing to one of Csm_QueueInfo */
#define Csm_GetMainFunctionPeriodOfGeneral()                                                        Csm_GetMainFunctionPeriodOfGeneralOfPCConfig()
#define Csm_GetJobObjSynchronousIdxOfQueueInfo(Index)                                               ((Csm_JobObjSynchronousIdxOfQueueInfoType)((Index)))  /**< the index of the 0:1 relation pointing to Csm_Job */
...
#define Csm_GetJobPoolEndIdxOfQueueInfo(Index)                                                      ((Csm_JobPoolEndIdxOfQueueInfoType)((((Csm_JobPoolEndIdxOfQueueInfoType)(Index)) + 1u)))  /**< the end index of the 0:n relation pointing to Csm_Job */
#define Csm_GetJobPoolStartIdxOfQueueInfo(Index)                                                    ((Csm_JobPoolStartIdxOfQueueInfoType)((Index)))  /**< the start index of the 0:n relation pointing to Csm_Job */
...
#define Csm_GetMaskedBitsOfQueueInfo(Index)                                                         ((Csm_MaskedBitsOfQueueInfoType)((((Csm_MaskedBitsOfQueueInfoType)(Index)) + 0x07u)))  /**< contains bitcoded the boolean data of Csm_JobObjSynchronousUsedOfQueueInfo, Csm_JobPoolUsedOfQueueInfo, Csm_JobSharingOfQueueInfo */
#define Csm_GetQueueEndIdxOfQueueInfo(Index)                                                        ((Csm_QueueEndIdxOfQueueInfoType)((((Csm_QueueEndIdxOfQueueInfoType)(Index)) + 1u)))  /**< the end index of the 1:n relation pointing to Csm_Queue */
#define Csm_GetQueueStartIdxOfQueueInfo(Index)                                                      ((Csm_QueueStartIdxOfQueueInfoType)((Index)))  /**< the start index of the 1:n relation pointing to Csm_Queue */
...
/*lint -restore */
extern CONST(Crypto_JobInfoType, CSM_CONST) Csm_JobInfo[3];
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(Crypto_JobPrimitiveInfoType, CSM_CONST) Csm_JobPrimitiveInfo[3];
#define CSM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(Csm_JobTableType, CSM_CONST) Csm_JobTable[3];
#define CSM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(Csm_KeyType, CSM_CONST) Csm_Key[3];
#define CSM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(Crypto_PrimitiveInfoType, CSM_CONST) Csm_PrimitiveInfo[3];
#define CSM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(Csm_QueueInfoType, CSM_CONST) Csm_QueueInfo[1];
#define CSM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern VAR(Crypto_JobType, CSM_VAR_NOINIT) Csm_Job[1];
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern VAR(Csm_JobStateType, CSM_VAR_NOINIT) Csm_JobState[3];
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern VAR(Csm_SizeOfJobType, CSM_VAR_NOINIT) Csm_JobToObjMap[3];
#define CSM_STOP_SEC_VAR_NOINIT_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern VAR(Csm_QueueStateType, CSM_VAR_NOINIT) Csm_QueueState[1];
#define CSM_STOP_SEC_VAR_NOINIT_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
