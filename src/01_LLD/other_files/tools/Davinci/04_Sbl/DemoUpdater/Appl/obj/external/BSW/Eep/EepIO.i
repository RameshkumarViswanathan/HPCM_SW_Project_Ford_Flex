...
# 1 "<command-line>" 2
# 1 "../../../../external/BSW/Eep/EepIO.c"
# 45 "../../../../external/BSW/Eep/EepIO.c"
# 1 "../../../../external/BSW/Eep/EepInc.h" 1
# 42 "../../../../external/BSW/Eep/EepInc.h"
...
# 43 "../../../../external/BSW/Eep/EepInc.h" 2
# 1 "../../../../external/BSW/Eep/EepIO.h" 1
# 74 "../../../../external/BSW/Eep/EepIO.h"
# 1 "Include/MemMap.h" 1
# 75 "../../../../external/BSW/Eep/EepIO.h" 2
...
# 1 "Include/MemMap.h" 1
# 86 "../../../../external/BSW/Eep/EepIO.h" 2
# 44 "../../../../external/BSW/Eep/EepInc.h" 2
# 46 "../../../../external/BSW/Eep/EepIO.c" 2
# 85 "../../../../external/BSW/Eep/EepIO.c"
# 1 "Include/MemMap.h" 1
# 86 "../../../../external/BSW/Eep/EepIO.c" 2
 static IO_U8 eepData[0x100u];

# 1 "Include/MemMap.h" 1
# 89 "../../../../external/BSW/Eep/EepIO.c" 2
...
# 1 "Include/MemMap.h" 1
# 96 "../../../../external/BSW/Eep/EepIO.c" 2

static IO_ErrorType EepromDriver_CheckRangeContained( IO_SizeType length, IO_PositionType address );
# 114 "../../../../external/BSW/Eep/EepIO.c"
static IO_ErrorType EepromDriver_CheckRangeContained( IO_SizeType length, IO_PositionType address )
{
   IO_ErrorType result;

   if ( (address >= ((vuint32)eepData))
       && ((address - ((vuint32)eepData)) < (0x100u - 0x01u))
       && (length <= (0x100u - 0x01u))
       && ((address - ((vuint32)eepData)) <= ((0x100u - 0x01u) - length)))
   {
      result = 0x00u;
   }
   else
...
IO_ErrorType EepromDriver_InitSync( void * address )
{
   ...
   if (0x55u != eepData[(0x100u - 0x01u)])
   {

      for (i = 0u; i < (0x100u - 0x01u); i++)
      {
         eepData[i] = 0xFFu;
      }


      eepData[(0x100u - 0x01u)] = 0x55u;
   }

   return 0x00u;
}
# 177 "../../../../external/BSW/Eep/EepIO.c"
...
# 1 "Include/MemMap.h" 1
# 278 "../../../../external/BSW/Eep/EepIO.c" 2
