# 1 "../../../../external/BSW/FblUpd/upd_main.c"
...
# 1 "<command-line>" 2
# 1 "../../../../external/BSW/FblUpd/upd_main.c"
# 41 "../../../../external/BSW/FblUpd/upd_main.c"
...
# 42 "../../../../external/BSW/FblUpd/upd_main.c" 2


# 1 "../../../../external/BSW/FblUpd/upd_main.h" 1
# 45 "../../../../external/BSW/FblUpd/upd_main.c" 2
# 1 "Include/upd_ap.h" 1
# 46 "../../../../external/BSW/FblUpd/upd_main.c" 2
...
# 48 "../../../../external/BSW/FblUpd/upd_main.c" 2
# 242 "../../../../external/BSW/FblUpd/upd_main.c"
...
# 267 "../../../../external/BSW/FblUpd/upd_main.c"
# 1 "Include/MemMap.h" 1
# 268 "../../../../external/BSW/FblUpd/upd_main.c" 2
# 280 "../../../../external/BSW/FblUpd/upd_main.c"
# 1 "Include/MemMap.h" 1
# 281 "../../../../external/BSW/FblUpd/upd_main.c" 2
...
# 1 "Include/MemMap.h" 1
# 288 "../../../../external/BSW/FblUpd/upd_main.c" 2
...
static tFblLength FblUpdPadBuffer( tFblAddress address, tFblLength length,
   vuint8 * data );
# 304 "../../../../external/BSW/FblUpd/upd_main.c"
static tFblResult FblUpdReset( void );



static tFblResult FblUpdGetSegment( vuint32 index, tFblUpdSegmentInfo * pSegment );


static tFblResult FblUpdAdjustSegmentDummy( tFblUpdSegmentInfo * pSegmentList,
   vuint32 * pSegmentCount );
# 322 "../../../../external/BSW/FblUpd/upd_main.c"
...
static tFblResult FblUpdIterateData( tFblUpSegmentOp pOperation, vuint32 subIndex, tFblLength loopSize);
...
# 1 "Include/MemMap.h" 1
# 343 "../../../../external/BSW/FblUpd/upd_main.c" 2
# 351 "../../../../external/BSW/FblUpd/upd_main.c"
# 1 "Include/MemMap.h" 1
# 352 "../../../../external/BSW/FblUpd/upd_main.c" 2


 static tFblUpdBufferAligned fblUpdBuffer;


# 1 "Include/MemMap.h" 1
# 358 "../../../../external/BSW/FblUpd/upd_main.c" 2


# 1 "Include/MemMap.h" 1
# 361 "../../../../external/BSW/FblUpd/upd_main.c" 2


 static vuint8 * const fblUpdCompareBuffer = &fblUpdBuffer.data[(4096u / 2u)];

 static tFblUpdSegmentInfo fblUpdSegmentList[2u];


# 1 "Include/MemMap.h" 1
# 369 "../../../../external/BSW/FblUpd/upd_main.c" 2


# 1 "Include/MemMap.h" 1
# 372 "../../../../external/BSW/FblUpd/upd_main.c" 2


 static tFblUpdFunc const fblUpdFunctionWalk[] =
{
   (tFblUpdFunc)0,
   (tFblUpdFunc)0,
   FblUpdMioInit,
...
# 1 "Include/MemMap.h" 1
# 398 "../../../../external/BSW/FblUpd/upd_main.c" 2
...
# 1 "Include/MemMap.h" 1
# 405 "../../../../external/BSW/FblUpd/upd_main.c" 2
# 419 "../../../../external/BSW/FblUpd/upd_main.c"
static tFblResult FblUpdCheckAddressRange( tFblAddress address, tFblAddress rangeStart, tFblLength rangeLength )
{
   tFblResult result;
...
# 445 "../../../../external/BSW/FblUpd/upd_main.c"
static tFblLength FblUpdPadLength( tFblAddress address, tFblLength length )
{
   ...
   mask = (tFblAddress)((memDrvLst[FlashBlock[memSegment].device].segmentSize) - 1u);
...
# 494 "../../../../external/BSW/FblUpd/upd_main.c"
static tFblLength FblUpdPadBuffer( tFblAddress address, tFblLength length,
   vuint8 * data )
{
   vuint8 * padBuffer;
...
# 535 "../../../../external/BSW/FblUpd/upd_main.c"
static tFblResult FblUpdGetSegment( vuint32 index, tFblUpdSegmentInfo * pSegment )
{
   tFblResult result;
   ...
   if (index < 1)
   {
      ...
      pSegment->source = (tFblAddress)FblUpdateBlkInfo[index].blockSource;
...
# 570 "../../../../external/BSW/FblUpd/upd_main.c"
static tFblResult FblUpdAdjustSegmentDummy( tFblUpdSegmentInfo * pSegmentList,
   vuint32 * pSegmentCount )
{
...
# 767 "../../../../external/BSW/FblUpd/upd_main.c"
static tFblResult FblUpdSegmentOpProgram( tFblAddress targetAddress, tFblLength length )
{
   tFblResult result;
   tFblLength localLength;
   ...
   if ((localLength + padLen) <= 4096u)
   {
      ...
      if (0x00u == MemDriver_RWriteSync(fblUpdBuffer.data, localLength, targetAddress))
      {
         result = 0x00u;
      }
   }
...
# 812 "../../../../external/BSW/FblUpd/upd_main.c"
static tFblResult FblUpdSegmentOpCompare( tFblAddress targetAddress, tFblLength length )
{
   tFblResult result;
   vuint32 compareIndex;

   result = 0x00u;


   if (0x00u == MemDriver_RReadSync(fblUpdCompareBuffer, length, targetAddress))
   {

      for (compareIndex = 0u; compareIndex < length; compareIndex++)
      {
         { if (((compareIndex) & (0x20u - 1u)) == 0x00u) { (void)FblLookForWatchdog(); } };
...
# 857 "../../../../external/BSW/FblUpd/upd_main.c"
static tFblResult FblUpdIterateData( tFblUpSegmentOp pOperation, vuint32 subIndex, tFblLength loopSize )
{
   tFblResult result;
   ...
   while (remainderLength > 0u)
   {
      ...
      else if (0u != (targetAddress & ((tFblAddress)(memDrvLst[FlashBlock[memSegment].device].segmentSize) - 1u)))
      {
...
# 923 "../../../../external/BSW/FblUpd/upd_main.c"
                       if (0x00u != (((operationLength) == FblReadBlock((sourceAddress), (fblUpdBuffer.data), (operationLength))) ? 0x00u : 0x01u))
            {
...
# 969 "../../../../external/BSW/FblUpd/upd_main.c"
static tFblResult FblUpdIterateSegments( tFblUpSegmentOp pOperation, tFblUpAdjustSegment pAdjustSegment, tFblLength loopSize )
{
   tFblResult result;
   ...
   while (0x00u == FblUpdGetSegment(segmentIndex, fblUpdSegmentList))
   {

      segmentIndex++;

      subSegments = (sizeof(fblUpdSegmentList) / sizeof((fblUpdSegmentList)[0u]));


      if (0x00u == pAdjustSegment(fblUpdSegmentList, &subSegments))
      {
...
# 1114 "../../../../external/BSW/FblUpd/upd_main.c"
static void FblUpdCopyFlashDriver(void)
{
   vuint16 index;
   ...
   if ( (flashCode == (IO_U8 *)0x70000000) )

   {

      for (index = 0u; index < 0x800; index++)
      {
         { if (((index) & (0x20u - 1u)) == 0x00u) { (void)FblLookForWatchdog(); } };
         flashCode[index] = (vuint8)((vuint8)(flashDrvBlk0[index]) ^ (vuint8)0xCC);
      }
   }
}
...
static void FblUpdInit( void )
{
   ...
   FblLbtInitPowerOn();
# 1173 "../../../../external/BSW/FblUpd/upd_main.c"
   EcuM_StartupTwo();
}
# 1184 "../../../../external/BSW/FblUpd/upd_main.c"
static tFblResult FblUpdMioInit( void )
{
   tFblResult result;
   ...
   if (0x00u != MemDriver_InitSync((void *)0))
   {
      result = 0x01u;
   }
...
# 1217 "../../../../external/BSW/FblUpd/upd_main.c"
static tFblResult FblUpdErase( void )
{
   tFblResult result;
   ...
   while (0x00u == FblUpdGetSegment(segmentIndex, fblUpdSegmentList))
   {
      ...
      if (!((firstBlock <= lastBlock))) ApplFblFatalError((0x02u));
         ...
         if (lastBlock > prevBlock)
         {
            ...
            for (loopSegment = firstBlock; loopSegment <= lastBlock; loopSegment++)
            {
               ...
               if (0x00u == 0x00u)
               {
                  ...
                  if (0x00u != MemDriver_REraseSync((FlashBlock[memSegment].end - FlashBlock[memSegment].begin) + 1u,
...
# 1295 "../../../../external/BSW/FblUpd/upd_main.c"
static tFblResult FblUpdProgram( void )
{
   return FblUpdIterateSegments(FblUpdSegmentOpProgram, FblUpdAdjustSegmentDummy, 4096u);
}
# 1309 "../../../../external/BSW/FblUpd/upd_main.c"
static tFblResult FblUpdVerify( void )
{
   return FblUpdIterateSegments(FblUpdSegmentOpCompare, FblUpdAdjustSegmentDummy, (4096u / 2u));
}
# 1323 "../../../../external/BSW/FblUpd/upd_main.c"
static tFblResult FblUpdReset( void )
{
...
# 1496 "../../../../external/BSW/FblUpd/upd_main.c"
void FblMemSetInteger( vuint32 count, vuint32 input, tFblMemRamData buffer )
{
   vuint32 localCount = count;
...
# 1519 "../../../../external/BSW/FblUpd/upd_main.c"
vuint32 FblMemGetInteger( vuint32 count, tFblMemConstRamData buffer )
{
   vuint32 output;
   vuint32 idx;
...
# 1549 "../../../../external/BSW/FblUpd/upd_main.c"
void FblMain( void )
{
   vuint32 updateCount;
   vuint32 funcIndex;
   ...
   while (updateCount < 3u)
   {
      updateState = 0x00u;


      for (funcIndex = 0u; funcIndex < (sizeof(fblUpdFunctionWalk) / sizeof((fblUpdFunctionWalk)[0u])); funcIndex++)
      {
         ...
         if ((tFblUpdFunc)0 != updateFct)
         {
            updateState = updateFct();
         }


         if (0x00u != updateState)
         {
            break;
         }
      }
      ...
      if (!((0x00u == updateState))) ApplFblFatalError((0x03u));
   ...
   if (!((0x00u == updateState))) ApplFblFatalError((0x04u));
}


# 1 "Include/MemMap.h" 1
# 1600 "../../../../external/BSW/FblUpd/upd_main.c" 2
