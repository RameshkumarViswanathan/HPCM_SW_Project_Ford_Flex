...
call ..\..\ScriptHelper.bat
:: Configuration section :::::::::::::::::::::::::::::::::::::::::::::::::::::::

:: Path to HexView binary
set HEXVIEW=%HexViewExecutable%
...
set SIG_PARAM=..\..\..\Demo\DemoKeys\key.txt
...
set B1_ADDRESS=0xA0080000
set B1_LENGTH=0x80000
set B1_SIG_ADDR=0xA00FFC00
set B1_VS_ADDR=0xA00FFD00
set B1_SEG_SIZE=0x20
set B1_IV=0x00


:: Parameters of 2nd logical block :: CAL0
set B2_ADDRESS=0xA0100000
set B2_LENGTH=0x80000
set B2_SIG_ADDR=0xA017FC00
set B2_VS_ADDR=0xA017FD00
set B2_SEG_SIZE=0x20
set B2_IV=0x00
set B2_PUBLICKEYHASH=0x0

:: Parameters of 3rd logical block :: CAL1
set B3_ADDRESS=0xA0180000
set B3_LENGTH=0x80000
set B3_SIG_ADDR=0xA01FFC00
set B3_VS_ADDR=0xA01FFD00
set B3_SEG_SIZE=0x20
set B3_IV=0x00

:: Parameters of FlashDrv :: SBL
set B4_ADDRESS=0x70000000
set B4_SIG_ADDR=0x70000900
set B4_VS_ADDR=0x70000A00
...
if not defined B2_ADDRESS goto :ParamError
if not defined B2_LENGTH goto :ParamError
if not defined B2_SIG_ADDR goto :ParamError
if not defined B2_VS_ADDR goto :ParamError
if not defined B2_SEG_SIZE goto :ParamError
if not defined B3_ADDRESS goto :ParamError
if not defined B3_LENGTH goto :ParamError
if not defined B3_SIG_ADDR goto :ParamError
if not defined B3_VS_ADDR goto :ParamError
if not defined B3_SEG_SIZE goto :ParamError
...
echo %~n1 | findstr "Cal0" > nul && set BLOCK=B2
echo %~n1 | findstr "Cal1" > nul && set BLOCK=B3
