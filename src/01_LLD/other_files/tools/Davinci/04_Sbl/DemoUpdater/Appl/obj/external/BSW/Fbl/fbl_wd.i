...
# 40 "../../../../external/BSW/Fbl/fbl_wd.c" 2
# 86 "../../../../external/BSW/Fbl/fbl_wd.c"
# 1 "Include/MemMap.h" 1
# 87 "../../../../external/BSW/Fbl/fbl_wd.c" 2
 ...
 tWdTime WDTimer;
# 108 "../../../../external/BSW/Fbl/fbl_wd.c"
# 1 "Include/MemMap.h" 1
# 109 "../../../../external/BSW/Fbl/fbl_wd.c" 2
...
# 1 "Include/MemMap.h" 1
# 116 "../../../../external/BSW/Fbl/fbl_wd.c" 2
...
# 1 "Include/MemMap.h" 1
# 135 "../../../../external/BSW/Fbl/fbl_wd.c" 2


# 1 "Include/MemMap.h" 1
# 4026 "Include/MemMap.h"
#pragma section ".RamCodeCoreSection" ax
# 138 "../../../../external/BSW/Fbl/fbl_wd.c" 2
# 148 "../../../../external/BSW/Fbl/fbl_wd.c"
void FblLookForWatchdogVoid( void )
{
...
# 4033 "Include/MemMap.h"
#pragma section
# 154 "../../../../external/BSW/Fbl/fbl_wd.c" 2


# 1 "Include/MemMap.h" 1
# 4026 "Include/MemMap.h"
#pragma section ".RamCodeCoreSection" ax
# 157 "../../../../external/BSW/Fbl/fbl_wd.c" 2
# 167 "../../../../external/BSW/Fbl/fbl_wd.c"
vuint8 FblLookForWatchdog( void )
{
   ...
   if ((WDInitFlag == 0x01u))
   {
      if (((vuint8)(((*((volatile vuint32 *)((0xF0001000u) + (0x3Cu + ((0u) * 0x100u))))) & 0x00000002u) & 0xFFu)) != 0x00u)
      {
         ...
         if (P2Timer > 0x00u)
         {
            ...
            {
               { if (((vuint8)0x00u)) { ; (P2Timer = ((5000u / 1u))); } };
            }
         }
...
# 4033 "Include/MemMap.h"
#pragma section
# 237 "../../../../external/BSW/Fbl/fbl_wd.c" 2
