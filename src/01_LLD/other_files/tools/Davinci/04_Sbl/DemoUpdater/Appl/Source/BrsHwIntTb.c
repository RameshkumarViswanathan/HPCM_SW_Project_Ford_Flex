...
# define Brs_ExceptionHandler(core, class) \
  ...
  __asm ("movh.a %a14, hi:BrsHw_CoreExceptionHandler");             /* load address of BrsHw_CoreExceptionHandler */ \
  __asm ("lea %a14,[%a14]lo:BrsHw_CoreExceptionHandler");           /* load address of BrsHw_CoreExceptionHandler */ \
...
# define Brs_ExceptionHandlerRam(core, class) \
  __asm (".align 5"); \
  __asm (".globl brsTrap_Ram_" #class "_Core" #core); \
  __asm ("brsTrap_Ram_" #class "_Core" #core ": svlcx");       /* save lower context */\
  __asm ("movh %d4, " #class);                                 /* prepare parameters for C-Function; D4 = Exception class */\
  __asm ("or %d4, %d15");                                      /* prepare parameters for C-Function; D4 |= TIN (D15) */\
  __asm ("movh.a %a14, hi:BrsHw_CoreExceptionHandler_Ram");    /* load address of BrsHw_CoreExceptionHandler_Ram */ \
  __asm ("lea %a14,[%a14]lo:BrsHw_CoreExceptionHandler_Ram");  /* load address of BrsHw_CoreExceptionHandler_Ram */ \
  __asm ("ji %a14 ");                                          /* jump to the handler */
#endif
