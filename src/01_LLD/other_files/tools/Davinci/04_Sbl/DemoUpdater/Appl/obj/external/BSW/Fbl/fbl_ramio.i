# 1 "../../../../external/BSW/Fbl/fbl_ramio.c"
...
# 1 "<command-line>" 2
# 1 "../../../../external/BSW/Fbl/fbl_ramio.c"
# 40 "../../../../external/BSW/Fbl/fbl_ramio.c"
# 1 "../../../../external/BSW/Fbl/fbl_ramio_inc.h" 1
# 41 "../../../../external/BSW/Fbl/fbl_ramio_inc.h"
# 1 "../../../../external/BSW/Fbl/iotypes.h" 1
# 43 "../../../../external/BSW/Fbl/iotypes.h"
# 1 "../../../../external/BSW/Fbl/fbl_def.h" 1
# 70 "../../../../external/BSW/Fbl/fbl_def.h"
...
# 71 "../../../../external/BSW/Fbl/fbl_def.h" 2
# 81 "../../../../external/BSW/Fbl/fbl_def.h"
# 1 "GenData/FblBm_Cfg.h" 1
# 82 "../../../../external/BSW/Fbl/fbl_def.h" 2
...
# 86 "../../../../external/BSW/Fbl/fbl_def.h" 2
# 98 "../../../../external/BSW/Fbl/fbl_def.h"
...
# 99 "../../../../external/BSW/Fbl/fbl_def.h" 2
...
# 1 "../../../../external/BSW/Fbl/fbl_assert.h" 1
# 96 "../../../../external/BSW/Fbl/fbl_assert.h"
# 1 "../../../../external/BSW/Fbl/fbl_assert_oem.h" 1
# 97 "../../../../external/BSW/Fbl/fbl_assert.h" 2
# 106 "../../../../external/BSW/Fbl/fbl_def.h" 2
# 304 "../../../../external/BSW/Fbl/fbl_def.h"
typedef vuint32 tFblStateBitmap;
# 328 "../../../../external/BSW/Fbl/fbl_def.h"
...
# 346 "../../../../external/BSW/Fbl/fbl_def.h"
...
# 374 "../../../../external/BSW/Fbl/fbl_def.h"
...
# 44 "../../../../external/BSW/Fbl/iotypes.h" 2
# 57 "../../../../external/BSW/Fbl/iotypes.h"
...
# 42 "../../../../external/BSW/Fbl/fbl_ramio_inc.h" 2
...
# 43 "../../../../external/BSW/Fbl/fbl_ramio_inc.h" 2
# 1 "../../../../external/BSW/Fbl/fbl_ramio.h" 1
# 77 "../../../../external/BSW/Fbl/fbl_ramio.h"
# 1 "Include/MemMap.h" 1
# 78 "../../../../external/BSW/Fbl/fbl_ramio.h" 2
...
# 1 "Include/MemMap.h" 1
# 87 "../../../../external/BSW/Fbl/fbl_ramio.h" 2
# 44 "../../../../external/BSW/Fbl/fbl_ramio_inc.h" 2
# 41 "../../../../external/BSW/Fbl/fbl_ramio.c" 2
# 128 "../../../../external/BSW/Fbl/fbl_ramio.c"
# 1 "Include/MemMap.h" 1
# 129 "../../../../external/BSW/Fbl/fbl_ramio.c" 2



static IO_ErrorType RamDriver_GetOffset( IO_SizeType length, IO_PositionType address,
   IO_SizeType * pOffset );
# 148 "../../../../external/BSW/Fbl/fbl_ramio.c"
static IO_ErrorType RamDriver_GetOffset( IO_SizeType length, IO_PositionType address,
   IO_SizeType * pOffset )
{
   IO_ErrorType result;
...
# 188 "../../../../external/BSW/Fbl/fbl_ramio.c"
IO_ErrorType RamDriver_InitSync( void * address )
{
   IO_ErrorType result;
...
# 236 "../../../../external/BSW/Fbl/fbl_ramio.c"
   return result;
}
# 246 "../../../../external/BSW/Fbl/fbl_ramio.c"
IO_ErrorType RamDriver_DeinitSync( void * address )
{
   IO_ErrorType result;
...
# 266 "../../../../external/BSW/Fbl/fbl_ramio.c"
IO_ErrorType RamDriver_RWriteSync( IO_MemPtrType writeBuffer, IO_SizeType writeLength, IO_PositionType writeAddress )
{
   IO_ErrorType result;
   IO_SizeType offset;
...
# 303 "../../../../external/BSW/Fbl/fbl_ramio.c"
IO_ErrorType RamDriver_REraseSync( IO_SizeType eraseLength, IO_PositionType eraseAddress )
{
   ...
   return result;
# 338 "../../../../external/BSW/Fbl/fbl_ramio.c"
}
# 350 "../../../../external/BSW/Fbl/fbl_ramio.c"
IO_ErrorType RamDriver_RReadSync( IO_MemPtrType readBuffer, IO_SizeType readLength, IO_PositionType readAddress )
{
   IO_ErrorType result;
   IO_SizeType offset;
...
# 1 "Include/MemMap.h" 1
# 381 "../../../../external/BSW/Fbl/fbl_ramio.c" 2
