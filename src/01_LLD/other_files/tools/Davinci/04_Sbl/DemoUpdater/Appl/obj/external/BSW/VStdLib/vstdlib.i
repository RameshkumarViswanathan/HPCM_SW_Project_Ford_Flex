# 1 "../../../../external/BSW/VStdLib/vstdlib.c"
...
# 1 "<command-line>" 2
# 1 "../../../../external/BSW/VStdLib/vstdlib.c"
# 38 "../../../../external/BSW/VStdLib/vstdlib.c"
# 1 "../../../../external/BSW/VStdLib/vstdlib.h" 1
# 56 "../../../../external/BSW/VStdLib/vstdlib.h"
...
#pragma section
# 2019 "../../../../external/BSW/VStdLib/vstdlib.h" 2
...
# 7778 "Include/MemMap.h"
#pragma section ".RamCodeCoreSection" ax
# 2025 "../../../../external/BSW/VStdLib/vstdlib.h" 2
# 2037 "../../../../external/BSW/VStdLib/vstdlib.h"
  ...
  uint8 * dst)
{
  ...
  uint8 errorId = (0x00u);
# 2053 "../../../../external/BSW/VStdLib/vstdlib.h"
  {
...
# 2072 "../../../../external/BSW/VStdLib/vstdlib.h"
  (void)(errorId);

}
# 2085 "../../../../external/BSW/VStdLib/vstdlib.h"
  ...
  uint8 * dst)
{
  ...
  uint8 errorId = (0x00u);
# 2101 "../../../../external/BSW/VStdLib/vstdlib.h"
  {
...
# 2120 "../../../../external/BSW/VStdLib/vstdlib.h"
  (void)(errorId);

}
# 2133 "../../../../external/BSW/VStdLib/vstdlib.h"
  ...
  uint16 * dst)
{
  ...
  uint8 errorId = (0x00u);
# 2149 "../../../../external/BSW/VStdLib/vstdlib.h"
  {
...
# 2169 "../../../../external/BSW/VStdLib/vstdlib.h"
  (void)(errorId);

}
# 2182 "../../../../external/BSW/VStdLib/vstdlib.h"
  ...
  uint16 * dst)
{
  ...
  uint8 errorId = (0x00u);
# 2198 "../../../../external/BSW/VStdLib/vstdlib.h"
  {
...
# 2218 "../../../../external/BSW/VStdLib/vstdlib.h"
  (void)(errorId);

}
# 2235 "../../../../external/BSW/VStdLib/vstdlib.h"
  ...
  uint8 * dst)
{
  ...
  uint8 errorId = (0x00u);
# 2251 "../../../../external/BSW/VStdLib/vstdlib.h"
  {
...
# 2272 "../../../../external/BSW/VStdLib/vstdlib.h"
  (void)(errorId);

}
# 2285 "../../../../external/BSW/VStdLib/vstdlib.h"
  ...
  uint8 * dst)
{
  ...
  uint8 errorId = (0x00u);
# 2301 "../../../../external/BSW/VStdLib/vstdlib.h"
  {
...
# 2322 "../../../../external/BSW/VStdLib/vstdlib.h"
  (void)(errorId);

}
# 2335 "../../../../external/BSW/VStdLib/vstdlib.h"
  ...
  uint32 * dst)
{
  ...
  uint8 errorId = (0x00u);
# 2351 "../../../../external/BSW/VStdLib/vstdlib.h"
  {
...
# 2373 "../../../../external/BSW/VStdLib/vstdlib.h"
  (void)(errorId);

}
# 2386 "../../../../external/BSW/VStdLib/vstdlib.h"
  ...
  uint32 * dst)
{
  ...
  uint8 errorId = (0x00u);
# 2402 "../../../../external/BSW/VStdLib/vstdlib.h"
  {
...
# 2424 "../../../../external/BSW/VStdLib/vstdlib.h"
  (void)(errorId);

}
# 2441 "../../../../external/BSW/VStdLib/vstdlib.h"
  ...
  uint8 * dst)
{
  ...
  uint8 errorId = (0x00u);
# 2457 "../../../../external/BSW/VStdLib/vstdlib.h"
  {
...
# 2482 "../../../../external/BSW/VStdLib/vstdlib.h"
  (void)(errorId);

}
# 2495 "../../../../external/BSW/VStdLib/vstdlib.h"
  ...
  uint8 * dst)
{
  ...
  uint8 errorId = (0x00u);
# 2511 "../../../../external/BSW/VStdLib/vstdlib.h"
  {
...
# 2527 "../../../../external/BSW/VStdLib/vstdlib.h"
  }
# 2536 "../../../../external/BSW/VStdLib/vstdlib.h"
  (void)(errorId);

}
# 2549 "../../../../external/BSW/VStdLib/vstdlib.h"
  ...
  uint64 * dst)
{
  ...
  uint8 errorId = (0x00u);
# 2565 "../../../../external/BSW/VStdLib/vstdlib.h"
  {
...
# 2591 "../../../../external/BSW/VStdLib/vstdlib.h"
  (void)(errorId);

}
# 2604 "../../../../external/BSW/VStdLib/vstdlib.h"
  ...
  uint64 * dst)
{
  ...
  uint8 errorId = (0x00u);
# 2620 "../../../../external/BSW/VStdLib/vstdlib.h"
  {
    ...
    VStdLib_MemCpy(dst, src, 8u);
# 2637 "../../../../external/BSW/VStdLib/vstdlib.h"
  }
# 2646 "../../../../external/BSW/VStdLib/vstdlib.h"
  (void)(errorId);

}
# 2662 "../../../../external/BSW/VStdLib/vstdlib.h"
static __inline__ uint16 VStdLib_SwapEndianUint16(uint16 value)
{
...
# 2682 "../../../../external/BSW/VStdLib/vstdlib.h"
static __inline__ uint32 VStdLib_SwapEndianUint32(uint32 value)
{
...
# 2706 "../../../../external/BSW/VStdLib/vstdlib.h"
static __inline__ uint64 VStdLib_SwapEndianUint64(uint64 value)
{
...
# 7785 "Include/MemMap.h"
#pragma section
# 2726 "../../../../external/BSW/VStdLib/vstdlib.h" 2
# 39 "../../../../external/BSW/VStdLib/vstdlib.c" 2
# 319 "../../../../external/BSW/VStdLib/vstdlib.c"
# 1 "Include/MemMap.h" 1
# 7794 "Include/MemMap.h"
#pragma section ".RamConstSection" a
# 320 "../../../../external/BSW/VStdLib/vstdlib.c" 2
...
# 831 "../../../../external/BSW/VStdLib/vstdlib.c"
static __inline__ sint8 VStdLib_Loc_MemCmp_8(
  const uint8 * pBuf1_8,
  const uint8 * pBuf2_8,
  uint32_least nCnt)
...
# 869 "../../../../external/BSW/VStdLib/vstdlib.c"
static __inline__ void VStdLib_Loc_MemSet_8_3(
  uint8 * pDst8,
  uint8 nPattern,
  uint8_least nCnt)
...
# 907 "../../../../external/BSW/VStdLib/vstdlib.c"
}
# 920 "../../../../external/BSW/VStdLib/vstdlib.c"
static __inline__ void VStdLib_Loc_MemSet_8_31(
  uint8 * pDst8,
  uint8 nPattern,
  uint8_least nCnt)
...
# 1042 "../../../../external/BSW/VStdLib/vstdlib.c"
}
# 1056 "../../../../external/BSW/VStdLib/vstdlib.c"
static __inline__ void VStdLib_Loc_MemSet_32_Aligned(
  uint32 * pDst32,
  uint8 nPattern,
  uint32_least nCnt)
...
# 1128 "../../../../external/BSW/VStdLib/vstdlib.c"
}
# 1141 "../../../../external/BSW/VStdLib/vstdlib.c"
static __inline__ void VStdLib_Loc_MemCpy_8_3(
  uint8 * pDst8,
  const uint8 * pSrc8,
  uint8_least nCnt)
...
# 1179 "../../../../external/BSW/VStdLib/vstdlib.c"
}
# 1192 "../../../../external/BSW/VStdLib/vstdlib.c"
static __inline__ void VStdLib_Loc_MemCpy_8_31(
  uint8 * pDst8,
  const uint8 * pSrc8,
  uint8_least nCnt)
...
# 1314 "../../../../external/BSW/VStdLib/vstdlib.c"
}
# 1328 "../../../../external/BSW/VStdLib/vstdlib.c"
static __inline__ void VStdLib_Loc_MemCpy_32_Aligned(
  uint32 * pDst32,
  const uint32 * pSrc32,
  uint32_least nCnt)
...
# 1403 "../../../../external/BSW/VStdLib/vstdlib.c"
}
# 1422 "../../../../external/BSW/VStdLib/vstdlib.c"
static __inline__ void VStdLib_Loc_MemCpy_8_PartialWord(
  uint8 * pDst8,
  uint8_least nCnt,
  uint32 * pPrev,
...
# 1506 "../../../../external/BSW/VStdLib/vstdlib.c"
}
# 1521 "../../../../external/BSW/VStdLib/vstdlib.c"
static __inline__ void VStdLib_Loc_MemCpy_32_Unaligned(
  uint8 * pDst8,
  const uint32 * pSrc32,
  uint32_least nCnt,
...
# 1697 "../../../../external/BSW/VStdLib/vstdlib.c"
static __inline__ sint8 VStdLib_Loc_MemCmp_32_Aligned(
  const uint32 * pBuf1_32,
  const uint32 * pBuf2_32,
  uint32_least nCnt)
...
# 1753 "../../../../external/BSW/VStdLib/vstdlib.c"
static __inline__ sint8 VStdLib_Loc_MemCmp_32_Unaligned(
  const uint32 * pBuf1_32,
  const uint8 * pBuf2_8,
  uint32_least nCnt,
...
# 1866 "../../../../external/BSW/VStdLib/vstdlib.c"
static __inline__ uint8 VStdLib_Loc_GetHighestBitPosOneInByte(uint8 value)
{
...
# 1897 "../../../../external/BSW/VStdLib/vstdlib.c"
static __inline__ uint8 VStdLib_Loc_GetLowestBitPosOneInByte(uint8 value)
{
...
# 1938 "../../../../external/BSW/VStdLib/vstdlib.c"
static __inline__ uint8 VStdLib_Loc_GetHighestBitPosOneInTwoBytes(uint16 value)
{
...
# 1969 "../../../../external/BSW/VStdLib/vstdlib.c"
static __inline__ uint8 VStdLib_Loc_GetLowestBitPosOneInTwoBytes(uint16 value)
{
...
# 2010 "../../../../external/BSW/VStdLib/vstdlib.c"
static __inline__ uint8 VStdLib_Loc_GetHighestBitPosOneInFourBytes(uint32 value)
{
...
# 2041 "../../../../external/BSW/VStdLib/vstdlib.c"
static __inline__ uint8 VStdLib_Loc_GetLowestBitPosOneInFourBytes(uint32 value)
{
...
# 2080 "../../../../external/BSW/VStdLib/vstdlib.c"
static __inline__ uint8 VStdLib_Loc_GetHighestBitPosOneInEightBytes(uint64 value)
{
...
# 2111 "../../../../external/BSW/VStdLib/vstdlib.c"
static __inline__ uint8 VStdLib_Loc_GetLowestBitPosOneInEightBytes(uint64 value)
{
...
# 2162 "../../../../external/BSW/VStdLib/vstdlib.c"
void VStdLib_MemSet(void * pDst,
                                        uint8 nPattern,
                                        VStdLib_CntType nCnt)
{
  ...
  uint8 * pDst8 =
    (uint8 * ) pDst;
  uint8 errorId = (0x00u);
# 2180 "../../../../external/BSW/VStdLib/vstdlib.c"
  {
...
# 2230 "../../../../external/BSW/VStdLib/vstdlib.c"
  }
# 2239 "../../../../external/BSW/VStdLib/vstdlib.c"
  (void)(errorId);

}
# 2265 "../../../../external/BSW/VStdLib/vstdlib.c"
void VStdLib_MemCpy(void * pDst,
                                        const void * pSrc,
                                        VStdLib_CntType nCnt)
{
  ...
  const uint8 * pSrc8 =
    (const uint8 * ) pSrc;
  uint8 errorId = (0x00u);
# 2285 "../../../../external/BSW/VStdLib/vstdlib.c"
  {
...
# 2354 "../../../../external/BSW/VStdLib/vstdlib.c"
  }
# 2363 "../../../../external/BSW/VStdLib/vstdlib.c"
  (void)(errorId);

}
# 2376 "../../../../external/BSW/VStdLib/vstdlib.c"
void VStdLib_MemCpy16(uint16 * pDst,
                                          const uint16 * pSrc,
                                          VStdLib_CntType nCnt)
{
  ...
  VStdLib_CntType idx;
  uint8 errorId = (0x00u);
# 2393 "../../../../external/BSW/VStdLib/vstdlib.c"
  {
...
# 2409 "../../../../external/BSW/VStdLib/vstdlib.c"
  (void)(errorId);

}
# 2422 "../../../../external/BSW/VStdLib/vstdlib.c"
void VStdLib_MemCpy32(uint32 * pDst,
                                          const uint32 * pSrc,
                                          VStdLib_CntType nCnt)
{
  ...
  VStdLib_CntType idx;
  uint8 errorId = (0x00u);
# 2439 "../../../../external/BSW/VStdLib/vstdlib.c"
  {
...
# 2455 "../../../../external/BSW/VStdLib/vstdlib.c"
  (void)(errorId);

}
# 2470 "../../../../external/BSW/VStdLib/vstdlib.c"
void VStdLib_MemCpy_s(void * pDst,
                                          VStdLib_CntType nDstSize,
                                          const void * pSrc,
                                          VStdLib_CntType nCnt)
...
# 2497 "../../../../external/BSW/VStdLib/vstdlib.c"
  (void)(errorId);

}
# 2529 "../../../../external/BSW/VStdLib/vstdlib.c"
  ...
  VStdLib_CntType nCnt)
{
  ...
  uint8 errorId = (0x00u);
  sint8 result = (0);
# 2558 "../../../../external/BSW/VStdLib/vstdlib.c"
  {
...
# 2633 "../../../../external/BSW/VStdLib/vstdlib.c"
  (void)(errorId);


  return result;
}
# 2700 "../../../../external/BSW/VStdLib/vstdlib.c"
uint8 VStdLib_GetHighestBitPosOne8(uint8 value)
{
...
# 2725 "../../../../external/BSW/VStdLib/vstdlib.c"
uint8 VStdLib_GetHighestBitPosZero8(uint8 value)
{
...
# 2750 "../../../../external/BSW/VStdLib/vstdlib.c"
uint8 VStdLib_GetLowestBitPosOne8(uint8 value)
{
...
# 2775 "../../../../external/BSW/VStdLib/vstdlib.c"
uint8 VStdLib_GetLowestBitPosZero8(uint8 value)
{
...
# 2800 "../../../../external/BSW/VStdLib/vstdlib.c"
uint8 VStdLib_GetCountLeadingOnes8(uint8 value)
{
...
# 2825 "../../../../external/BSW/VStdLib/vstdlib.c"
uint8 VStdLib_GetCountLeadingZeros8(uint8 value)
{
...
# 2850 "../../../../external/BSW/VStdLib/vstdlib.c"
uint8 VStdLib_GetCountTrailingOnes8(uint8 value)
{
...
# 2875 "../../../../external/BSW/VStdLib/vstdlib.c"
uint8 VStdLib_GetCountTrailingZeros8(uint8 value)
{
...
# 2904 "../../../../external/BSW/VStdLib/vstdlib.c"
uint8 VStdLib_GetHighestBitPosOne16(uint16 value)
{
...
# 2929 "../../../../external/BSW/VStdLib/vstdlib.c"
uint8 VStdLib_GetHighestBitPosZero16(uint16 value)
{
...
# 2954 "../../../../external/BSW/VStdLib/vstdlib.c"
uint8 VStdLib_GetLowestBitPosOne16(uint16 value)
{
...
# 2979 "../../../../external/BSW/VStdLib/vstdlib.c"
uint8 VStdLib_GetLowestBitPosZero16(uint16 value)
{
...
# 3004 "../../../../external/BSW/VStdLib/vstdlib.c"
uint8 VStdLib_GetCountLeadingOnes16(uint16 value)
{
...
# 3029 "../../../../external/BSW/VStdLib/vstdlib.c"
uint8 VStdLib_GetCountLeadingZeros16(uint16 value)
{
...
# 3054 "../../../../external/BSW/VStdLib/vstdlib.c"
uint8 VStdLib_GetCountTrailingOnes16(uint16 value)
{
...
# 3079 "../../../../external/BSW/VStdLib/vstdlib.c"
uint8 VStdLib_GetCountTrailingZeros16(uint16 value)
{
...
# 3108 "../../../../external/BSW/VStdLib/vstdlib.c"
uint8 VStdLib_GetHighestBitPosOne32(uint32 value)
{
...
# 3133 "../../../../external/BSW/VStdLib/vstdlib.c"
uint8 VStdLib_GetHighestBitPosZero32(uint32 value)
{
...
# 3158 "../../../../external/BSW/VStdLib/vstdlib.c"
uint8 VStdLib_GetLowestBitPosOne32(uint32 value)
{
...
# 3183 "../../../../external/BSW/VStdLib/vstdlib.c"
uint8 VStdLib_GetLowestBitPosZero32(uint32 value)
{
...
# 3208 "../../../../external/BSW/VStdLib/vstdlib.c"
uint8 VStdLib_GetCountLeadingOnes32(uint32 value)
{
...
# 3233 "../../../../external/BSW/VStdLib/vstdlib.c"
uint8 VStdLib_GetCountLeadingZeros32(uint32 value)
{
...
# 3258 "../../../../external/BSW/VStdLib/vstdlib.c"
uint8 VStdLib_GetCountTrailingOnes32(uint32 value)
{
...
# 3283 "../../../../external/BSW/VStdLib/vstdlib.c"
uint8 VStdLib_GetCountTrailingZeros32(uint32 value)
{
...
# 3312 "../../../../external/BSW/VStdLib/vstdlib.c"
uint8 VStdLib_GetHighestBitPosOne64(uint64 value)
{
...
# 3337 "../../../../external/BSW/VStdLib/vstdlib.c"
uint8 VStdLib_GetHighestBitPosZero64(uint64 value)
{
...
# 3362 "../../../../external/BSW/VStdLib/vstdlib.c"
uint8 VStdLib_GetLowestBitPosOne64(uint64 value)
{
...
# 3387 "../../../../external/BSW/VStdLib/vstdlib.c"
uint8 VStdLib_GetLowestBitPosZero64(uint64 value)
{
...
# 3412 "../../../../external/BSW/VStdLib/vstdlib.c"
uint8 VStdLib_GetCountLeadingOnes64(uint64 value)
{
...
# 3437 "../../../../external/BSW/VStdLib/vstdlib.c"
uint8 VStdLib_GetCountLeadingZeros64(uint64 value)
{
...
# 3462 "../../../../external/BSW/VStdLib/vstdlib.c"
uint8 VStdLib_GetCountTrailingOnes64(uint64 value)
{
...
# 3487 "../../../../external/BSW/VStdLib/vstdlib.c"
uint8 VStdLib_GetCountTrailingZeros64(uint64 value)
{
...
# 7785 "Include/MemMap.h"
#pragma section
# 3507 "../../../../external/BSW/VStdLib/vstdlib.c" 2
