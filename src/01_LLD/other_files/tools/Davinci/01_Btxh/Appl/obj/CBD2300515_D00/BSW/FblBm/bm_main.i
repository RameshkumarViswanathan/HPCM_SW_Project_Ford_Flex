# 1 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c"
# 59 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c"
...
# 60 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c" 2
...
# 62 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c" 2
# 1 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.h" 1
# 63 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c" 2
# 1 "../../../BSW/Fbl/fbl_fsm.h" 1
# 92 "../../../BSW/Fbl/fbl_fsm.h"
...
# 64 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c" 2
...
# 70 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c" 2
# 142 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c"
typedef enum
{
   ...
   FBLBM_STATE_CHECK_FBL_SEGMENTS,
   FBLBM_STATE_FAIL
} tFblBmState;
...
# 1 "Include/MemMap.h" 1
# 189 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c" 2
...
# 1 "Include/MemMap.h" 1
# 243 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c" 2
...
# 3052 "Include/MemMap.h"
#pragma section ".BmHeaderSection" a
# 250 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c" 2

 tFblBmHeader const FblBmHeader =
{
   0x05ECB007u,
   0x0001u,
   0x0000u,
...
# 3059 "Include/MemMap.h"
#pragma section
# 272 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c" 2
...
# 1 "Include/MemMap.h" 1
# 279 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c" 2

 static tFblBmBlockInfo fblBmBlockInfo;



 static tFblHeader fblBmFblHeader;



 static tFblFsmContext g_BmFsmContext;
# 297 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c"
 static vuint32 g_BmTargetListIndex;

 static tFblBmHdrHeader g_BmTargetBmHeader;



 static tFblBmError g_BmError;


# 1 "Include/MemMap.h" 1
# 307 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c" 2




# 1 "Include/MemMap.h" 1
# 312 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c" 2


 static tFblFsmEventEntry const g_BmState_PowerOn[] = {


   { (FblBmState_PowerOn_Entry), kFblFsmDefaultEvent_Entry, ((tFblFsmState)-1) },
   { FblFsmEventHandlerDefault, (FBLBM_EVENT_CONTINUE), (FBLBM_STATE_INIT) }
};


 static tFblFsmEventEntry const g_BmState_Init[] = {



   { (FblBmState_Init_Entry), kFblFsmDefaultEvent_Entry, ((tFblFsmState)-1) },
   { FblFsmEventHandlerDefault, (FBLBM_EVENT_CONTINUE), (FBLBM_STATE_CHECK_FBL_VALIDITY) }
};


 static tFblFsmEventEntry const g_BmState_CheckFblValidity[] = {



   { (FblBmState_CheckFblValidity), (FBLBM_EVENT_CONTINUE), (FBLBM_STATE_SECURE_BOOT_ENABLED) },
   { FblFsmEventHandlerDefault, (FBLBM_EVENT_CONTINUE), (FBLBM_STATE_FAILSAFE_UPDATER_ENABLED) }
};


 static tFblFsmEventEntry const g_BmState_FailsafeUpdaterEnabled[] = {
   ...
   { FblFsmEventHandlerDefault, kFblFsmDefaultEvent_Entry, (FBLBM_STATE_FAIL) }

};


 static tFblFsmEventEntry const g_BmState_FailsafeUpdaterSearchInit[] = {



   { FblFsmEventHandlerDefault, (FBLBM_EVENT_CONTINUE), (FBLBM_STATE_FAIL) }
};


 static tFblFsmEventEntry const g_BmState_FailsafeUpdaterCheck[] = {
 ...
 static tFblFsmEventEntry const g_BmState_FailsafeUpdaterSearchNext[] = {
 ...
 static tFblFsmEventEntry const g_BmState_CallFailsafeUpdater[] = {
 ...
 static tFblFsmEventEntry const g_BmState_SecureBootEnabled[] = {
   ...
   { FblFsmEventHandlerDefault, kFblFsmDefaultEvent_Entry, (FBLBM_STATE_CHECK_FBL_SEGMENTS) }

};


 static tFblFsmEventEntry const g_BmState_CheckKeyAvailability[] = {


   { (FblBmState_CheckKeyAvailability), (FBLBM_EVENT_CONTINUE), (FBLBM_STATE_INIT_FBL_MAC_ENABLED) },
   { FblFsmEventHandlerDefault, (FBLBM_EVENT_CONTINUE), (FBLBM_STATE_CALL_FBL_INIT_KEY) }
};


 static tFblFsmEventEntry const g_BmState_CallFblInitKey[] = {
 ...
 static tFblFsmEventEntry const g_BmState_InitFblMacEnabled[] = {
 ...
 static tFblFsmEventEntry const g_BmState_CheckFblMacErased[] = {
 ...
 static tFblFsmEventEntry const g_BmState_CallFblInitCmac[] = {
 ...
 static tFblFsmEventEntry const g_BmState_StayInBootEnabled[] = {




   { FblFsmEventHandlerDefault, kFblFsmDefaultEvent_Entry, (FBLBM_STATE_CHECK_APPL_START_FLAG) }
 ...
 static tFblFsmEventEntry const g_BmState_CheckApplStartFlag[] = {



   { (FblBmState_CheckApplStartFlag), (FBLBM_EVENT_CONTINUE), (FBLBM_STATE_CHECK_FBL_LBT) },
   { FblFsmEventHandlerDefault, (FBLBM_EVENT_CONTINUE), (FBLBM_STATE_CHECK_FBL_VERIFICATION_STAY_IN_BOOT) }
 ...
 static tFblFsmEventEntry const g_BmState_CheckFblLbt[] = {




   { (FblBmState_CheckFblLbt), (FBLBM_EVENT_CONTINUE), (FBLBM_STATE_REPROG_LBT_ENABLED) },
   { FblFsmEventHandlerDefault, (FBLBM_EVENT_CONTINUE), (FBLBM_STATE_FAIL) }
};


 static tFblFsmEventEntry const g_BmState_CheckReprogFlag[] = {


   { (FblBmState_CheckReprogFlag), (FBLBM_EVENT_CONTINUE), (FBLBM_STATE_CHECK_FBL_VERIFICATION) },
   { FblFsmEventHandlerDefault, (FBLBM_EVENT_CONTINUE), (FBLBM_STATE_STAY_IN_BOOT_ENABLED) }
};


 static tFblFsmEventEntry const g_BmState_ReprogLbtEnabled[] = {





   { FblFsmEventHandlerDefault, kFblFsmDefaultEvent_Entry, (FBLBM_STATE_TARGET_LIST_INIT) }

};


 static tFblFsmEventEntry const g_BmState_CheckReprogLbt[] = {
 ...
 static tFblFsmEventEntry const g_BmState_TargetListInit[] = {



   { (FblBmState_TargetListInit), (FBLBM_EVENT_CONTINUE), (FBLBM_STATE_TARGET_CHECK) },
   { FblFsmEventHandlerDefault, (FBLBM_EVENT_CONTINUE), (FBLBM_STATE_FAIL) }
 ...
 static tFblFsmEventEntry const g_BmState_TargetCheck[] = {




   { (FblBmState_TargetCheck), (FBLBM_EVENT_CONTINUE), (FBLBM_STATE_CALL_TARGET) },
   { FblFsmEventHandlerDefault, (FBLBM_EVENT_CONTINUE), (FBLBM_STATE_TARGET_LIST_NEXT) }
 ...
 static tFblFsmEventEntry const g_BmState_TargetListNext[] = {



   { (FblBmState_TargetListNext), (FBLBM_EVENT_CONTINUE), (FBLBM_STATE_TARGET_CHECK) },
   { FblFsmEventHandlerDefault, (FBLBM_EVENT_CONTINUE), (FBLBM_STATE_CHECK_FBL_VERIFICATION) }
 ...
 static tFblFsmEventEntry const g_BmState_CallTarget[] = {



   { (FblBmState_CallTarget_Entry), kFblFsmDefaultEvent_Entry, ((tFblFsmState)-1) },

   { FblFsmEventHandlerDefault, (FBLBM_EVENT_CONTINUE), (FBLBM_STATE_FAIL) }
};


 static tFblFsmEventEntry const g_BmState_CheckFblVerification[] = {


   { (FblBmState_CheckFblVerification), (FBLBM_EVENT_CONTINUE), (FBLBM_STATE_CALL_FBL) },
   { FblFsmEventHandlerDefault, (FBLBM_EVENT_CONTINUE), (FBLBM_STATE_FAIL) }
};


 static tFblFsmEventEntry const g_BmState_CheckFblVerificationStayInBoot[] = {


   { (FblBmState_CheckFblVerification), (FBLBM_EVENT_CONTINUE), (FBLBM_STATE_CALL_FBL_STAY_IN_BOOT) },
   { FblFsmEventHandlerDefault, (FBLBM_EVENT_CONTINUE), (FBLBM_STATE_FAIL) }
};


 static tFblFsmEventEntry const g_BmState_CallFbl[] = {

   { (FblBmState_CallFbl_Entry), kFblFsmDefaultEvent_Entry, ((tFblFsmState)-1) },
   { FblFsmEventHandlerDefault, (FBLBM_EVENT_CONTINUE), (FBLBM_STATE_FAIL) }
};


 static tFblFsmEventEntry const g_BmState_CallFblStayInBoot[] = {


   { (FblBmState_CallFblStayInBoot_Entry), kFblFsmDefaultEvent_Entry, ((tFblFsmState)-1) },

   { FblFsmEventHandlerDefault, (FBLBM_EVENT_CONTINUE), (FBLBM_STATE_FAIL) }
};


 static tFblFsmEventEntry const g_BmState_CheckFblSegments[] = {
   ...
   { FblFsmEventHandlerDefault, kFblFsmDefaultEvent_Entry, (FBLBM_STATE_CHECK_REPROG_FLAG) }

};


 static tFblFsmEventEntry const g_BmState_Fail[] = {


   { (FblBmState_Fail_Entry), kFblFsmDefaultEvent_Entry, ((tFblFsmState)-1) }
};


 static tFblFsmStateDefinition const bmFsmStates[] =
{
   { ((tFblFsmState)-1), (sizeof(g_BmState_PowerOn) / sizeof((g_BmState_PowerOn)[0u])), (g_BmState_PowerOn) },
   { ((tFblFsmState)-1), (sizeof(g_BmState_Init) / sizeof((g_BmState_Init)[0u])), (g_BmState_Init) },
   { ((tFblFsmState)-1), (sizeof(g_BmState_CheckFblValidity) / sizeof((g_BmState_CheckFblValidity)[0u])), (g_BmState_CheckFblValidity) },
   { ((tFblFsmState)-1), (sizeof(g_BmState_FailsafeUpdaterEnabled) / sizeof((g_BmState_FailsafeUpdaterEnabled)[0u])), (g_BmState_FailsafeUpdaterEnabled) },
   { ((tFblFsmState)-1), (sizeof(g_BmState_FailsafeUpdaterSearchInit) / sizeof((g_BmState_FailsafeUpdaterSearchInit)[0u])), (g_BmState_FailsafeUpdaterSearchInit) },
   { ((tFblFsmState)-1), (sizeof(g_BmState_FailsafeUpdaterCheck) / sizeof((g_BmState_FailsafeUpdaterCheck)[0u])), (g_BmState_FailsafeUpdaterCheck) },
   { ((tFblFsmState)-1), (sizeof(g_BmState_FailsafeUpdaterSearchNext) / sizeof((g_BmState_FailsafeUpdaterSearchNext)[0u])), (g_BmState_FailsafeUpdaterSearchNext) },
   { ((tFblFsmState)-1), (sizeof(g_BmState_CallFailsafeUpdater) / sizeof((g_BmState_CallFailsafeUpdater)[0u])), (g_BmState_CallFailsafeUpdater) },
   { ((tFblFsmState)-1), (sizeof(g_BmState_SecureBootEnabled) / sizeof((g_BmState_SecureBootEnabled)[0u])), (g_BmState_SecureBootEnabled) },
   { ((tFblFsmState)-1), (sizeof(g_BmState_CheckKeyAvailability) / sizeof((g_BmState_CheckKeyAvailability)[0u])), (g_BmState_CheckKeyAvailability) },
   { ((tFblFsmState)-1), (sizeof(g_BmState_CallFblInitKey) / sizeof((g_BmState_CallFblInitKey)[0u])), (g_BmState_CallFblInitKey) },
   { ((tFblFsmState)-1), (sizeof(g_BmState_InitFblMacEnabled) / sizeof((g_BmState_InitFblMacEnabled)[0u])), (g_BmState_InitFblMacEnabled) },
   { ((tFblFsmState)-1), (sizeof(g_BmState_CheckFblMacErased) / sizeof((g_BmState_CheckFblMacErased)[0u])), (g_BmState_CheckFblMacErased) },
   { ((tFblFsmState)-1), (sizeof(g_BmState_CallFblInitCmac) / sizeof((g_BmState_CallFblInitCmac)[0u])), (g_BmState_CallFblInitCmac) },
   { ((tFblFsmState)-1), (sizeof(g_BmState_StayInBootEnabled) / sizeof((g_BmState_StayInBootEnabled)[0u])), (g_BmState_StayInBootEnabled) },
   { ((tFblFsmState)-1), (sizeof(g_BmState_CheckApplStartFlag) / sizeof((g_BmState_CheckApplStartFlag)[0u])), (g_BmState_CheckApplStartFlag) },
   { ((tFblFsmState)-1), (sizeof(g_BmState_CheckFblLbt) / sizeof((g_BmState_CheckFblLbt)[0u])), (g_BmState_CheckFblLbt) },
   { ((tFblFsmState)-1), (sizeof(g_BmState_CheckReprogFlag) / sizeof((g_BmState_CheckReprogFlag)[0u])), (g_BmState_CheckReprogFlag) },
   { ((tFblFsmState)-1), (sizeof(g_BmState_ReprogLbtEnabled) / sizeof((g_BmState_ReprogLbtEnabled)[0u])), (g_BmState_ReprogLbtEnabled) },
   { ((tFblFsmState)-1), (sizeof(g_BmState_CheckReprogLbt) / sizeof((g_BmState_CheckReprogLbt)[0u])), (g_BmState_CheckReprogLbt) },
   { ((tFblFsmState)-1), (sizeof(g_BmState_TargetListInit) / sizeof((g_BmState_TargetListInit)[0u])), (g_BmState_TargetListInit) },
   { ((tFblFsmState)-1), (sizeof(g_BmState_TargetCheck) / sizeof((g_BmState_TargetCheck)[0u])), (g_BmState_TargetCheck) },
   { ((tFblFsmState)-1), (sizeof(g_BmState_TargetListNext) / sizeof((g_BmState_TargetListNext)[0u])), (g_BmState_TargetListNext) },
   { ((tFblFsmState)-1), (sizeof(g_BmState_CallTarget) / sizeof((g_BmState_CallTarget)[0u])), (g_BmState_CallTarget) },
   { ((tFblFsmState)-1), (sizeof(g_BmState_CheckFblVerification) / sizeof((g_BmState_CheckFblVerification)[0u])), (g_BmState_CheckFblVerification) },
   { ((tFblFsmState)-1), (sizeof(g_BmState_CheckFblVerificationStayInBoot) / sizeof((g_BmState_CheckFblVerificationStayInBoot)[0u])), (g_BmState_CheckFblVerificationStayInBoot) },
   { ((tFblFsmState)-1), (sizeof(g_BmState_CallFbl) / sizeof((g_BmState_CallFbl)[0u])), (g_BmState_CallFbl) },
   { ((tFblFsmState)-1), (sizeof(g_BmState_CallFblStayInBoot) / sizeof((g_BmState_CallFblStayInBoot)[0u])), (g_BmState_CallFblStayInBoot) },
   { ((tFblFsmState)-1), (sizeof(g_BmState_CheckFblSegments) / sizeof((g_BmState_CheckFblSegments)[0u])), (g_BmState_CheckFblSegments) },
   { ((tFblFsmState)-1), (sizeof(g_BmState_Fail) / sizeof((g_BmState_Fail)[0u])), (g_BmState_Fail) }
};

# 1 "Include/MemMap.h" 1
# 656 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c" 2
...
# 1 "Include/MemMap.h" 1
# 663 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c" 2
# 674 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c"
static tFblFsmGuard FblBmState_PowerOn_Entry(tFblFsmContextPtr const pFsmContext, tFblFsmEvent event)
{
   ...
   if (!((( tFblBmHeader const *)(&FblBmHeader)) == (( tFblBmHeader const *)(0xA001FFE0u)))) ApplFblFatalError((0x50u));
...
# 736 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c"
static tFblFsmGuard FblBmState_Init_Entry(tFblFsmContextPtr const pFsmContext, tFblFsmEvent event)
{
   ...
   EcuM_StartupTwo();
# 773 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c"
   ;
   ;
   ApplFblBmInitPost();
...
# 854 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c"
static tFblFsmGuard FblBmState_CallTarget_Entry(tFblFsmContextPtr const pFsmContext, tFblFsmEvent event)
{
   ...
   ApplFblBmStartSoftware(&g_BmTargetBmHeader);


   return kFblFsmGuard_True;
}
# 916 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c"
static tFblFsmGuard FblBmState_CallFbl_Entry(tFblFsmContextPtr const pFsmContext, tFblFsmEvent event)
{
   ...
   ApplFblBmStartSoftware(&fblBmBlockInfo.bmHeader);


   return kFblFsmGuard_True;
}
# 945 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c"
static tFblFsmGuard FblBmState_CallFblStayInBoot_Entry(tFblFsmContextPtr const pFsmContext, tFblFsmEvent event)
{
   ...
   { fblBmMagicFlag[0u] = 0x53u; fblBmMagicFlag[1u] = 0x74u; fblBmMagicFlag[2u] = 0x61u; fblBmMagicFlag[3u] = 0x79u; fblBmMagicFlag[4u] = 0x42u; fblBmMagicFlag[5u] = 0x6Fu; fblBmMagicFlag[6u] = 0x6Fu; fblBmMagicFlag[7u] = 0x74u; };
...
# 1021 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c"
static tFblFsmGuard FblBmState_Fail_Entry(tFblFsmContextPtr const pFsmContext, tFblFsmEvent event)
{
   ...
   ApplFblBmFatalError(g_BmError);

   return kFblFsmGuard_False;
}
# 1044 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c"
static tFblFsmGuard FblBmState_CheckFblValidity(tFblFsmContextPtr const pFsmContext, tFblFsmEvent event)
{
   tFblFsmGuard result;
   ...
   {
      if (fblBmFblHeader.magicFlag != 0x58462918u)
      {
         result = kFblFsmGuard_False;
   ...
   if (kFblFsmGuard_True == result)
   {
      ...
      fblBmBlockInfo.logicalBlock.mandatoryType = 1u;
      fblBmBlockInfo.logicalBlock.blockNr = 0x00u;


      if (0x00u != ApplFblBmIsValidBlock(FBLBMHDR_TARGET_FBL, &fblBmBlockInfo.logicalBlock))
      {
         result = kFblFsmGuard_False;
         g_BmError = FBLBM_ERROR_VALIDITY_FAILED;
      }
   }
# 1104 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c"
   if (kFblFsmGuard_True == result)
   {
...
# 1312 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c"
static tFblFsmGuard FblBmState_CheckKeyAvailability(tFblFsmContextPtr const pFsmContext, tFblFsmEvent event)
{
   tFblFsmGuard result;
   ...
   (void)pFsmContext;
   (void)event;
# 1336 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c"
   result = kFblFsmGuard_True;

   return result;
}
# 1389 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c"
static tFblFsmGuard FblBmState_CheckApplStartFlag( tFblFsmContextPtr const pFsmContext, tFblFsmEvent event )
{
   tFblFsmGuard result;
   ...
   if ((( (fblBmMagicFlag[0u] == 0x41u) && (fblBmMagicFlag[1u] == 0x70u) && (fblBmMagicFlag[2u] == 0x70u) && (fblBmMagicFlag[3u] == 0x6Cu) && (fblBmMagicFlag[4u] == 0x53u) && (fblBmMagicFlag[5u] == 0x69u) && (fblBmMagicFlag[6u] == 0x67u) && (fblBmMagicFlag[7u] == 0x6Eu)) ? 1u : 0u))
   {
...
# 1424 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c"
static tFblFsmGuard FblBmState_CheckReprogFlag(tFblFsmContextPtr const pFsmContext, tFblFsmEvent event)
{
   tFblFsmGuard result;
   ...
   if (ApplFblBmCheckReprogFlag() == 0x00u)
   {
...
# 1459 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c"
static tFblFsmGuard FblBmState_CheckFblLbt(tFblFsmContextPtr const pFsmContext, tFblFsmEvent event)
{
   ...
   (void)pFsmContext;
   (void)event;
# 1480 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c"
   {

      FblLbtActivateLbtBlockByAddress((tFblAddress)fblBmFblHeader.pLogicalBlockTable);



      if (FblLbtGetBlockCount() > 4u)
      {
         result = kFblFsmGuard_False;
   ...
   return result;
# 1513 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c"
}
# 1638 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c"
static tFblFsmGuard FblBmState_TargetListInit(tFblFsmContextPtr const pFsmContext, tFblFsmEvent event)
{
   tFblFsmGuard result;
...
# 1664 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c"
static tFblFsmGuard FblBmState_TargetCheck(tFblFsmContextPtr const pFsmContext, tFblFsmEvent event)
{
   ...
   tFblBmBlockInfo blockInfoTarget = { 0 };
   ...
   if (0x00u != ApplFblBmCheckTargetValidity(targetHandle))
   {
      result = kFblFsmGuard_False;
...
# 1726 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c"
   if (kFblFsmGuard_True == result)
   {
      ...
      for (index = 0u; index < target.dependenciesSize; index++)
      {
         ...
         {
# 1756 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c"
         }
         else
         {
            ...
            else
            {
               ...
               ApplFblBmIsOptionalBlock(targetHandle, &blockInfoDep.logicalBlock);
            }
         }
   ...
   if (kFblFsmGuard_True == result)
   {
      if (blockInfoTarget.bmHeader.bmEntryAddress == 0xFFFFFFFFu)
      {
         result = kFblFsmGuard_False;
...
# 1807 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c"
static tFblFsmGuard FblBmState_TargetListNext(tFblFsmContextPtr const pFsmContext, tFblFsmEvent event)
{
   tFblFsmGuard result;
...
# 1842 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c"
static tFblFsmGuard FblBmState_CheckFblVerification(tFblFsmContextPtr const pFsmContext, tFblFsmEvent event)
{
   tFblFsmGuard result;
   ...
   (void)pFsmContext;
   (void)event;
# 1864 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c"
   {
      result = kFblFsmGuard_True;
   }
...
static void FblBmDeinit(void)
{
   ...
   { (*((volatile vuint32 *)((0xF0001000u) + (0x30u + ((0u) * 0x100u) + ((0) * 0x04u))))) = 0x00000000uL; };

   ;
   ;
   ;
}
# 1909 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c"
void FblMemSetInteger( vuint32 count, vuint32 input, tFblMemRamData buffer)
{
   vuint32 localCount;
   vuint32 localInput;
...
# 1937 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c"
vuint32 FblMemGetInteger( vuint32 count, tFblMemConstRamData buffer)
{
   vuint32 output;
   vuint32 idx;
...
# 1968 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c"
void FblMain(void)
{
   ...
   g_BmFsmContext.stateCount = (sizeof(bmFsmStates) / sizeof((bmFsmStates)[0u]));
   ...
   ApplFblBmFatalError(FBLBM_ERROR_END_OF_MAIN_REACHED);
}


# 1 "Include/MemMap.h" 1
# 1990 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c" 2



# 1 "Include/MemMap.h" 1
# 1994 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c" 2
# 2008 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c"
void FblStart( void )

{
   ...
   ;
# 2038 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c"
   { fblBmMagicFlag[0u] = 0x50u; fblBmMagicFlag[1u] = 0x72u; fblBmMagicFlag[2u] = 0x6Fu; fblBmMagicFlag[3u] = 0x67u; fblBmMagicFlag[4u] = 0x53u; fblBmMagicFlag[5u] = 0x69u; fblBmMagicFlag[6u] = 0x67u; fblBmMagicFlag[7u] = 0x6Eu; };
...
# 1 "Include/MemMap.h" 1
# 2045 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c" 2




# 1 "Include/MemMap.h" 1
# 2050 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c" 2
# 2062 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c"
void ApplStart( void )

{
   ...
   ;
# 2087 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c"
   { fblBmMagicFlag[0u] = 0x41u; fblBmMagicFlag[1u] = 0x70u; fblBmMagicFlag[2u] = 0x70u; fblBmMagicFlag[3u] = 0x6Cu; fblBmMagicFlag[4u] = 0x53u; fblBmMagicFlag[5u] = 0x69u; fblBmMagicFlag[6u] = 0x67u; fblBmMagicFlag[7u] = 0x6Eu; };
...
# 1 "Include/MemMap.h" 1
# 2094 "../../../../CBD2300515_D00/BSW/FblBm/bm_main.c" 2
