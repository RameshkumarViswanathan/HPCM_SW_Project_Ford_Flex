# 1 "../../../../CBD2300515_D00/BSW/Fbl/fbl_nvpattern.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/Fbl/fbl_nvpattern.c"
# 54 "../../../../CBD2300515_D00/BSW/Fbl/fbl_nvpattern.c"
...
# 55 "../../../../CBD2300515_D00/BSW/Fbl/fbl_nvpattern.c" 2
# 1 "../../../../CBD2300515_D00/BSW/Fbl/fbl_nvpattern.h" 1
# 56 "../../../../CBD2300515_D00/BSW/Fbl/fbl_nvpattern.c" 2
# 111 "../../../../CBD2300515_D00/BSW/Fbl/fbl_nvpattern.c"
typedef struct
{
   vuint32 alignDummy;
   vuint8 data[32u];
...
# 1 "Include/MemMap.h" 1
# 123 "../../../../CBD2300515_D00/BSW/Fbl/fbl_nvpattern.c" 2
 static tFblNvPatternAlignedBuffer pageBuffer;

# 1 "Include/MemMap.h" 1
# 126 "../../../../CBD2300515_D00/BSW/Fbl/fbl_nvpattern.c" 2
...
# 1 "Include/MemMap.h" 1
# 133 "../../../../CBD2300515_D00/BSW/Fbl/fbl_nvpattern.c" 2
...
# 150 "../../../../CBD2300515_D00/BSW/Fbl/fbl_nvpattern.c"
static tFblResult FblNvPatternWritePageAligned( const vuint8* pSrcBuffer, IO_PositionType address, IO_SizeType length )
{
   tFblResult result;
   IO_SizeType i;
   ...
   while (localLength > 0u)
   {
      ...
      if (localLength > 32u)
      {
         writeGranularity = 32u;
         actualWriteLength = 32u;
      }
      else
      {
         writeGranularity = (((localLength) + (((IO_SizeType)(memDrvLst[FlashBlock[memSegment].device].segmentSize)) - 1u)) & ~(((IO_SizeType)(memDrvLst[FlashBlock[memSegment].device].segmentSize)) - 1u));
      ...
      if (MemDriver_RWriteSync(pageBuffer.data, writeGranularity, address + offset) != 0x00u)
      {
         result = 0x01u;
         break;
      }
...
# 220 "../../../../CBD2300515_D00/BSW/Fbl/fbl_nvpattern.c"
static tFblNvPatternItemState FblNvPatternGetPatternItemState( IO_PositionType patternAddress, IO_SizeType length, const vuint8* compareValue)
{
   ...
   while (localLength > 0u)
   {
      ...
      if (itemState == FBL_NVPATTERN_STATE_ERASED)
      {
         ...
         for (i = 0u; i < currentReadLength; i++)
         {
            ...
            if ((compareValue != (vuint8*)0u) && (pageBuffer.data[i] == compareValue[readOffset + i]))
            {
               countExpectedValue++;
            }
...
# 356 "../../../../CBD2300515_D00/BSW/Fbl/fbl_nvpattern.c"
tFblNvPatternState FblNvPatternGetPatternState( const tBlockDescriptor * pBlockDescriptor,
                                                       tFblNvPatternId patternId,
                                                       IO_PositionType * pPatternAddress,
                                                       IO_SizeType * pPatternLength )
{
   ...
   vuint8 fblMarkerValue[] = {0x73u, 0x6Au, 0x29u, 0x3Eu};
   vuint8 fblMaskValue[] = {0x8Cu, 0x95u, 0xD6u, 0xC1u};


   if (!(sizeof(fblMarkerValue) == 4u)) ApplFblFatalError((0x50u));
   if (!(sizeof(fblMaskValue) == 4u)) ApplFblFatalError((0x50u));
   ...
   if ((((patternId) > kFblNvPatternId_Invalid) && ((patternId) < kFblNvPatternId_Last)))
   {
   ...
   while (multiplicity >= 1u)
   {
      ...
      patternState.markerState = FblNvPatternGetPatternItemState(patternAddress, 4u, fblMarkerValue);
      patternState.maskState = FblNvPatternGetPatternItemState((patternAddress + *pPatternLength), 4u, fblMaskValue);
...
# 439 "../../../../CBD2300515_D00/BSW/Fbl/fbl_nvpattern.c"
vsint16 FblNvPatternGetBaseAddr( vuint8 blockNr,
                                 tFblNvPatternId patternId,
                                 IO_PositionType * pPatternAddress,
                                 IO_SizeType * pPatternLength )
...
# 472 "../../../../CBD2300515_D00/BSW/Fbl/fbl_nvpattern.c"
vsint16 FblNvPatternGetBaseAddrByBlockDescriptor( const tBlockDescriptor * blockDescriptor,
                                                  tFblNvPatternId patternId,
                                                  IO_PositionType * pPatternAddress,
                                                  IO_SizeType * pPatternLength )
{
   ...
   if (memSegment >= 0)
   {
      ...
      if (!(((((memDrvLst[FlashBlock[memSegment].device].segmentSize)) & ~(((memDrvLst[FlashBlock[memSegment].device].segmentSize)) - 1u)) == ((memDrvLst[FlashBlock[memSegment].device].segmentSize))))) ApplFblFatalError((0x50u));


      patternLength = (((4u) + (((IO_SizeType)(memDrvLst[FlashBlock[memSegment].device].segmentSize)) - 1u)) & ~(((IO_SizeType)(memDrvLst[FlashBlock[memSegment].device].segmentSize)) - 1u));
      ...
      upperBound = (patternId > kFblNvPatternId_Last) ? ((vuint32)kFblNvPatternId_Last - 1u) : (vuint32)patternId;
...
# 529 "../../../../CBD2300515_D00/BSW/Fbl/fbl_nvpattern.c"
      *pPatternLength = patternLength;
      *pPatternAddress = (lastBlockAddress - offsetLength) + 1u;


      if (!(*pPatternAddress >= blockDescriptor->blockStartAddress)) ApplFblFatalError((0x50u));


      if (!(FblMemSegmentNrGet(*pPatternAddress) == memSegment)) ApplFblFatalError((0x50u));
   }
   else
   {
...
# 556 "../../../../CBD2300515_D00/BSW/Fbl/fbl_nvpattern.c"
tFblResult FblNvPatternSet( const tBlockDescriptor * blockDescriptor, tFblNvPatternId patternId )
{
...
# 580 "../../../../CBD2300515_D00/BSW/Fbl/fbl_nvpattern.c"
tFblResult FblNvPatternSetByBlockDescriptor( const tBlockDescriptor * blockDescriptor,
                                             tFblNvPatternId patternId )
{
   IO_PositionType patternAddress;
   ...
   if (patternState.markerState == FBL_NVPATTERN_STATE_ERASED)
   {
      ...
      if (0x00u == FblNvPatternWritePageAligned(fblMarkerValue, patternAddress, 4u))
      {
...
# 634 "../../../../CBD2300515_D00/BSW/Fbl/fbl_nvpattern.c"
tFblResult FblNvPatternClr( const tBlockDescriptor * blockDescriptor, tFblNvPatternId patternId )
{
   tBlockDescriptor localBlockDescriptor;
   tFblResult result;
...
# 658 "../../../../CBD2300515_D00/BSW/Fbl/fbl_nvpattern.c"
tFblResult FblNvPatternClrByBlockDescriptor( const tBlockDescriptor * blockDescriptor,
                                             tFblNvPatternId patternId )
{
   tFblResult result;
   ...
   if ((patternState.markerState == FBL_NVPATTERN_STATE_EXPECTEDVALUE) && (patternState.maskState == FBL_NVPATTERN_STATE_ERASED))
   {
      ...
      result = FblNvPatternWritePageAligned(fblMaskValue, (patternAddress + patternLength), 4u);
   }
   else
   {
...
# 698 "../../../../CBD2300515_D00/BSW/Fbl/fbl_nvpattern.c"
tFblResult FblNvPatternGet( const tBlockDescriptor * blockDescriptor, tFblNvPatternId patternId )
{
   tBlockDescriptor localBlockDescriptor;
   tFblResult result;
...
# 723 "../../../../CBD2300515_D00/BSW/Fbl/fbl_nvpattern.c"
tFblResult FblNvPatternGetByBlockDescriptor( const tBlockDescriptor * blockDescriptor,
                                             tFblNvPatternId patternId )
{
   IO_PositionType patternAddress;
...
# 905 "../../../../CBD2300515_D00/BSW/Fbl/fbl_nvpattern.c"
# 1 "Include/MemMap.h" 1
# 906 "../../../../CBD2300515_D00/BSW/Fbl/fbl_nvpattern.c" 2
