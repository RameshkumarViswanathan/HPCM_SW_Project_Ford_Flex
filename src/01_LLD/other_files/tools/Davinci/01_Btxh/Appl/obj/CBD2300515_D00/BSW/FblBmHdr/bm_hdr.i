# 1 "../../../../CBD2300515_D00/BSW/FblBmHdr/bm_hdr.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/FblBmHdr/bm_hdr.c"
# 43 "../../../../CBD2300515_D00/BSW/FblBmHdr/bm_hdr.c"
...
# 44 "../../../../CBD2300515_D00/BSW/FblBmHdr/bm_hdr.c" 2
# 68 "../../../../CBD2300515_D00/BSW/FblBmHdr/bm_hdr.c"
# 1 "Include/MemMap.h" 1
# 69 "../../../../CBD2300515_D00/BSW/FblBmHdr/bm_hdr.c" 2
# 82 "../../../../CBD2300515_D00/BSW/FblBmHdr/bm_hdr.c"
tFblBmHdrCheckBmHeaderResult FblBmHdrGetBmHeader(tFblBmHdrTargetHandle targetHandle, tFblAddress bmHeaderAddress,
   tFblBmHdrHeader * bmHeader)
{
   ...
   if (result == FBLBMHDR_CHKHDR_OK)
   {
      if (0x00u != FblBmHdrCheckConsistency(bmHeader))
      {
...
# 122 "../../../../CBD2300515_D00/BSW/FblBmHdr/bm_hdr.c"
tFblResult FblBmHdrCheckConsistency( const tFblBmHdrHeader * pBmHeader )
{
   tFblResult result;
   ...
   if (pBmHeader->bmMagicFlag != 0xECE9654Au)
   {
      result = 0x01u;
   }
# 168 "../../../../CBD2300515_D00/BSW/FblBmHdr/bm_hdr.c"
   return result;
}
# 186 "../../../../CBD2300515_D00/BSW/FblBmHdr/bm_hdr.c"
tFblBmHdrCheckBmHeaderResult FblBmHdrFindValidHeader(tFblBmHdrTargetHandle targetHandle,
   tFblBmBlockInfo * pBlockInfo)
{
   tFblBmHdrCheckBmHeaderResult result;
   ...
   while (FblLbtBlockDone() == 0u)
   {
      ...
      if (0x00u == ApplFblBmIsValidBlock(targetHandle, &pBlockInfo->logicalBlock))
      {
...
# 1 "Include/MemMap.h" 1
# 226 "../../../../CBD2300515_D00/BSW/FblBmHdr/bm_hdr.c" 2
