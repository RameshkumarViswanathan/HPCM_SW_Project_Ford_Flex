# 1 "../../../../CBD2300515_D00/BSW/Fbl/fbl_lbt_access.c"
...
# 1 "<command-line>" 2
# 1 "../../../../CBD2300515_D00/BSW/Fbl/fbl_lbt_access.c"
# 41 "../../../../CBD2300515_D00/BSW/Fbl/fbl_lbt_access.c"
...
# 42 "../../../../CBD2300515_D00/BSW/Fbl/fbl_lbt_access.c" 2
# 79 "../../../../CBD2300515_D00/BSW/Fbl/fbl_lbt_access.c"
# 1 "Include/MemMap.h" 1
# 80 "../../../../CBD2300515_D00/BSW/Fbl/fbl_lbt_access.c" 2

 static tFblLbtBlockNr fblLbtBlockIteratorNr;
 static tFblLbtBlockFilter fblLbtBlockIteratorFilter;
 static boolean fblLbtBlockIteratorDone;




 static tLogicalBlockTable const * fblLbtActive;



# 1 "Include/MemMap.h" 1
# 93 "../../../../CBD2300515_D00/BSW/Fbl/fbl_lbt_access.c" 2
...
# 1 "Include/MemMap.h" 1
# 100 "../../../../CBD2300515_D00/BSW/Fbl/fbl_lbt_access.c" 2

static boolean FblLbtBlockFilterHit(const tFblLbtBlockFilter * blockFilter,
                                    const tBlockDescriptor * blockDescriptor);
# 123 "../../../../CBD2300515_D00/BSW/Fbl/fbl_lbt_access.c"
static boolean FblLbtBlockFilterHit(const tFblLbtBlockFilter * blockFilter,
                                    const tBlockDescriptor * blockDescriptor)
{
   ...
   if (blockFilter->mandatoryType.enabled == 1u)
   {

      if (blockDescriptor->mandatoryType == 1u)
      {

         result = (blockFilter->mandatoryType.value == 1u) ? 1u : 0u;
      }
      else
      {

         result = (blockFilter->mandatoryType.value == 0u) ? 1u : 0u;
      }
   }



   if (blockFilter->blockType.enabled == 1u)
   {

      if (result == 1u)
      {
         result = (boolean)((blockDescriptor->blockType == blockFilter->blockType.value) ? 1u : 0u);
      }
   }
...
# 332 "../../../../CBD2300515_D00/BSW/Fbl/fbl_lbt_access.c"
void FblLbtInitPowerOn(void)
{
...
void FblLbtBlockFilterInit( tFblLbtBlockFilter * blockFilter)
{
   blockFilter->mandatoryType.enabled = 0u;

   blockFilter->blockType.enabled = 0u;

}
# 364 "../../../../CBD2300515_D00/BSW/Fbl/fbl_lbt_access.c"
void FblLbtBlockFilterSetMandatoryType( tFblLbtBlockFilter * blockFilter,
                                       tFblLbtMandatoryType mandatoryType)
{
   blockFilter->mandatoryType.value = mandatoryType;
   blockFilter->mandatoryType.enabled = 1u;
}
# 379 "../../../../CBD2300515_D00/BSW/Fbl/fbl_lbt_access.c"
void FblLbtBlockFilterSetBlockType( tFblLbtBlockFilter * blockFilter,
                                   tFblLbtBlockType blockType)
{
   blockFilter->blockType.value = blockType;
   blockFilter->blockType.enabled = 1u;
}
# 394 "../../../../CBD2300515_D00/BSW/Fbl/fbl_lbt_access.c"
tBlockDescriptor FblLbtBlockFirst(const tFblLbtBlockFilter * blockFilter)
{
   fblLbtBlockIteratorNr = 0u;
   fblLbtBlockIteratorFilter = *blockFilter;
   fblLbtBlockIteratorDone = 0u;
...
tBlockDescriptor FblLbtBlockNext(void)
{
   ...
   if ((fblLbtBlockIteratorNr >= fblLbtActive->noOfBlocks) && (filterResult == 0u))
   {

      fblLbtBlockIteratorDone = 1u;
   }

   return blockDescriptor;
}
# 451 "../../../../CBD2300515_D00/BSW/Fbl/fbl_lbt_access.c"
boolean FblLbtBlockDone(void)
{
...
# 489 "../../../../CBD2300515_D00/BSW/Fbl/fbl_lbt_access.c"
...
# 527 "../../../../CBD2300515_D00/BSW/Fbl/fbl_lbt_access.c"
...
# 552 "../../../../CBD2300515_D00/BSW/Fbl/fbl_lbt_access.c"
...
# 579 "../../../../CBD2300515_D00/BSW/Fbl/fbl_lbt_access.c"
...
# 617 "../../../../CBD2300515_D00/BSW/Fbl/fbl_lbt_access.c"
...
# 647 "../../../../CBD2300515_D00/BSW/Fbl/fbl_lbt_access.c"
tFblResult FblLbtGetBlockIndexByNr(tFblLbtBlockNr blockNr, tFblLbtBlockIndex * blockIndex)
{
   tFblResult result = 0x01u;
   tBlockDescriptor blockDescriptor = {0};
...
# 676 "../../../../CBD2300515_D00/BSW/Fbl/fbl_lbt_access.c"
tFblResult FblLbtGetBlockHeaderAddressByNr(tFblLbtBlockNr blockNr,
                                           tFblAddress * blockHeaderAddress)
{
   tFblResult result = 0x01u;
   tBlockDescriptor blockDescriptor = {0};
...
# 706 "../../../../CBD2300515_D00/BSW/Fbl/fbl_lbt_access.c"
...
# 856 "../../../../CBD2300515_D00/BSW/Fbl/fbl_lbt_access.c"
tFblResult FblLbtGetBlockVerifyOutputFuncByNr(tFblLbtBlockNr blockNr,
                                              tExportFct * blockVerifyFunc)
{
   tFblResult result = 0x01u;
   tBlockDescriptor blockDescriptor = {0};
...
# 886 "../../../../CBD2300515_D00/BSW/Fbl/fbl_lbt_access.c"
...
# 922 "../../../../CBD2300515_D00/BSW/Fbl/fbl_lbt_access.c"
   ...
   tFblLbtBlockNr * blockNr)
{
   ...
   if (FblLbtGetBlockDescriptorByIndex(blockIndex, &blockDescriptor) == 0x00u)
   {
...
# 951 "../../../../CBD2300515_D00/BSW/Fbl/fbl_lbt_access.c"
...
# 981 "../../../../CBD2300515_D00/BSW/Fbl/fbl_lbt_access.c"
...
# 1011 "../../../../CBD2300515_D00/BSW/Fbl/fbl_lbt_access.c"
...
# 1161 "../../../../CBD2300515_D00/BSW/Fbl/fbl_lbt_access.c"
...
# 1192 "../../../../CBD2300515_D00/BSW/Fbl/fbl_lbt_access.c"
tFblResult FblLbtCheckAddressRange(tFblAddress address, tFblAddress rangeStart, tFblLength rangeLength)
{
   tFblResult result = 0x01u;
...
# 1217 "../../../../CBD2300515_D00/BSW/Fbl/fbl_lbt_access.c"
tFblResult FblLbtCheckRangeContained(tFblAddress address, tFblLength length, tFblAddress rangeStart, tFblLength rangeLength)
{
   tFblResult result = 0x01u;

   if ((FblLbtCheckAddressRange(address, rangeStart, rangeLength) == 0x00u)
       && (length <= rangeLength)
...
# 1328 "../../../../CBD2300515_D00/BSW/Fbl/fbl_lbt_access.c"
void FblLbtActivateLbtBlockByAddress(tFblAddress address)
{
   ...
   fblLbtActive = ( tLogicalBlockTable const *)address;

}

# 1 "Include/MemMap.h" 1
# 1342 "../../../../CBD2300515_D00/BSW/Fbl/fbl_lbt_access.c" 2
