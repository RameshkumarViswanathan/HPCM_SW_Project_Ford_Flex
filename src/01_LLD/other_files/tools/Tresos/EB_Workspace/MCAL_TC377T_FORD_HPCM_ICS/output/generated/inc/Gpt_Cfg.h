...
**  VERSION   : 10.0.0                                                        **
**                                                                            **
**  DATE, TIME: 2024-01-05, 10:32:28       !!!IGNORE-LINE!!!                  **
**                                                                            **
...
#define GPT_SW_MINOR_VERSION                              (20U)
...
#define GPT_MAX_CHANNELS_CORE1                            (0U)
...
#define GPT_GTM_TOM_MODULE                                (3U)
#define GPT_GTM_TOM_CHANNELS_PER_TGC                      (8U)

#define GPT_GTM_ATOM_MODULE                               (6U)
