...
static const Ocu_ChannelConfigType Ocu_kChannelConfigCore_0[ ] =
{
  {
    /* OCU Channel 0 */
    (Ocu_NotifiPtrType)0,/*Notification-function name*/
    (uint32)123456,/*DefaultThreshold*/
    (uint32)16777215,/*MaxCounterValue*/
    {
      OCU_GTM_ATOM, /* Assigned Hw Unit */
      0x0001, /* Assigned Hw Unit Number */
      (uint8)OCU_LOW, /* Pin default state */
      OCU_FALSE, /* Pin Used */
      OCU_FALSE, /* Dma Used */
      OCU_FALSE, /* Adc Used */
      OCU_GTM_CONFIGURABLE_CLOCK_1, /* Clock Select */
