/*
 * This is Os_Compiler_Cfg.h for target platform: TriCoreHighTec/TC37x
 */
...
#define OS_VAR_CLEARED        /* not required */ /* Globals or statics which are initialized after PO reset. */
