...
/* OS Core 0 Code */
#elif defined (OS_START_SEC_CODE_LIB_CORE0)
  #undef      OS_START_SEC_CODE_LIB_CORE0
  #define DEFAULT_START_SEC_CODE_LIB
#elif defined (OS_STOP_SEC_CODE_LIB_CORE0)
  #undef      OS_STOP_SEC_CODE_LIB_CORE0
  #define DEFAULT_STOP_SEC_CODE_LIB

/* OS Core 1 Code */
#elif defined (OS_START_SEC_CODE_LIB_CORE1)
  #undef      OS_START_SEC_CODE_LIB_CORE1
  #define DEFAULT_START_SEC_CODE_LIB
#elif defined (OS_STOP_SEC_CODE_LIB_CORE1)
  #undef      OS_STOP_SEC_CODE_LIB_CORE1
  #define DEFAULT_STOP_SEC_CODE_LIB

/* OS Core 2 Code */
#elif defined (OS_START_SEC_CODE_LIB_CORE2)
  #undef      OS_START_SEC_CODE_LIB_CORE2
  #define DEFAULT_START_SEC_CODE_LIB
#elif defined (OS_STOP_SEC_CODE_LIB_CORE2)
  #undef      OS_STOP_SEC_CODE_LIB_CORE2
  #define DEFAULT_STOP_SEC_CODE_LIB

/* MemoryMappingCodeLocations */
#elif defined (OS_START_SEC_OSAPPCORE0_LIB)
  #undef      OS_START_SEC_OSAPPCORE0_LIB
#elif defined (OS_STOP_SEC_OSAPPCORE0_LIB)
  #undef      OS_STOP_SEC_OSAPPCORE0_LIB

#elif defined (OS_START_SEC_CONST_CORE0)
  #undef      OS_START_SEC_CONST_CORE0
#elif defined (OS_STOP_SEC_CONST_CORE0)
  #undef      OS_STOP_SEC_CONST_CORE0

#elif defined (OS_START_SEC_CONST_CORE1)
  #undef      OS_START_SEC_CONST_CORE1
#elif defined (OS_STOP_SEC_CONST_CORE1)
  #undef      OS_STOP_SEC_CONST_CORE1

#elif defined (OS_START_SEC_CONST_CORE2)
  #undef      OS_START_SEC_CONST_CORE2
#elif defined (OS_STOP_SEC_CONST_CORE2)
  #undef      OS_STOP_SEC_CONST_CORE2
