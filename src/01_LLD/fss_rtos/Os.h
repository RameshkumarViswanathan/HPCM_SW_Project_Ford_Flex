...
#define OS_SW_PATCH_VERSION (200U)
...
#define OS_TARGET_PATCH_VERSION (28U)
...
/* [MISRA 2012 Dir 4.9] */ /*lint -estring(9026, CAT1_ISR, CAT1_TRAP, DECLARE_CAT1_ISR, OS_MAIN, OS_MFCR, OS_MTCR, OS_DISABLE, OS_ENABLE, OS_ISYNC, OS_DSYNC, OS_SYSCALL, OS_NOP, OS_SET_PSW_S, OS_RESET_PSW_S) */
/* Function-like macros: CAT1_ISR, CAT1_TRAP, DECLARE_CAT1_ISR, OS_MAIN, OS_MFCR, OS_MTCR, OS_DISABLE, OS_ENABLE, OS_ISYNC, OS_DSYNC, OS_SYSCALL, OS_NOP */
...
#define OS_VOLATILE volatile
  ...
  extern FUNC(void, OS_CODE_CORE0) Os_ISRWrapper0(uint32 isr_index, uint32 pcxi);
#else
  extern FUNC(void, OS_CODE_CORE0) Os_ISRWrapper0(uint32 isr_index, uint32 pcxi) __attribute__((interrupt_handler));
#endif /* _lint */



#ifdef _lint /* Lint does not like attribute on an extern */
  extern FUNC(void, OS_CODE_CORE1) Os_ISRWrapper1(uint32 isr_index, uint32 pcxi);
#else
  extern FUNC(void, OS_CODE_CORE1) Os_ISRWrapper1(uint32 isr_index, uint32 pcxi) __attribute__((interrupt_handler));
#endif /* _lint */



#ifdef _lint /* Lint does not like attribute on an extern */
  extern FUNC(void, OS_CODE_CORE2) Os_ISRWrapper2(uint32 isr_index, uint32 pcxi);
#else
  extern FUNC(void, OS_CODE_CORE2) Os_ISRWrapper2(uint32 isr_index, uint32 pcxi) __attribute__((interrupt_handler));
#endif /* _lint */


#ifdef _lint /* Lint doesn't like inline assembler */
 extern uint32 dummy_lint_var[];
 #define OS_MFCR(reg) (dummy_lint_var[reg])
 #define OS_MTCR(reg, val) (dummy_lint_var[reg] = (val))
 ...
 extern uint32 OS_CLZ(uint32 val);
 #define OS_NOINLINE /* nothing */
 #define OS_MAIN() extern void main(void); void main(void)
#else
 /* [$TgtCore 188] [$TgtCore 190] [$TgtCore 189] [$TgtCore 191] */
 ...
 #ifndef __cplusplus
 extern int __builtin_clz(unsigned int reg); /* [$TargetHT_EHI 645636] */
 #define OS_CLZ(x) (uint32)__builtin_clz(x)
 #endif /* __cplusplus */
 #define OS_NOINLINE   __attribute__ ((noinline))
 #define OS_MAIN() extern void inner_main(void); int main(void) { OS_MTCR(0xfe04, OS_IS_BIT | (OS_MFCR(0xfe04))); /* Ensure PSW.IS */ Os_StartCoreGate(); inner_main(); return 0; } void inner_main(void) /* [$Satisfies $TgtCore 56] */
#endif
#define OS_SET_PSW_S() OS_MTCR(0xfe04, OS_SAFETASK_BIT | OS_MFCR(0xfe04))
#define OS_RESET_PSW_S() OS_MTCR(0xfe04, ~OS_SAFETASK_BIT & OS_MFCR(0xfe04))
...
extern OS_VOLATILE VAR(uint32, OS_VAR_NOINIT) Os_RunningCat1ISR0;
extern OS_VOLATILE VAR(uint32, OS_VAR_NOINIT) Os_RunningCat1ISR1;
extern OS_VOLATILE VAR(uint32, OS_VAR_NOINIT) Os_RunningCat1ISR2;
 ...
 /* [$TargetHT 80] */
 #define CAT1_ISR(x) __inline__ static void cat1_inline_##x(void); void x(void) {\
 uint32 prev_isr = OS_CAT1_TRACKER_##x; \
 OS_CAT1_TRACKER_##x = OS_CAT1_ID_##x; \
 cat1_inline_##x(); \
 OS_CAT1_TRACKER_##x = prev_isr; \
 } __inline__ static void cat1_inline_##x(void) /* [$TgtCore 55] */
#endif /* _lint */
...
#define OS_TRUSTED_TMASK (0x800U)
#define OS_UNTRUSTED_TMASK (0x1000U)
#define OS_TWP_TMASK (0x2800U)
#define OS_IS_BIT (0x200U)
#define OS_SUPERVISOR_BIT (0x800U)
#define OS_SAFETASK_BIT (0x4000U) /* [$UKS 2047] */
...
typedef struct Os_SpinlockInfo_s {
  uint32 LockAttempts[3U]; /* [$UKS 1827] */
  uint32 LockSucceeds[3U]; /* [$UKS 1828] */
  uint32 LockFails[3U];
  Os_StopwatchTickType MaxLockTime[3U];   /* [$UKS 1829] */
  Os_LockerRefType MaxLockTimeLocker[3U]; /* [$UKS 1830] */
  Os_StopwatchTickType MaxSpinTime[3U];   /* [$UKS 1831] */
  Os_LockerRefType MaxSpinTimeLocker[3U]; /* [$UKS 1832] */
  CoreIdType CurrentLockingCore;        /* [$UKS 1833] */
  Os_StopwatchTickType CurrentLockTime; /* [$UKS 1834] */
  Os_LockerRefType CurrentLocker;       /* [$UKS 1836] */
  Os_StopwatchTickType LockAttemptTime[3U]; /* [$EHI 586153] */
} Os_SpinlockInfo;
typedef P2VAR(Os_SpinlockInfo, TYPEDEF, OS_VAR) Os_SpinlockInfoRefType;
...
typedef struct Os_SpinlockDynType_s {
  ...
  Os_SpinlockInfo info[1]; /* Reset code needs an array */
} Os_SpinlockDynType;
...
#define OSServiceId_TerminateApplication ((OSServiceIdType)83)
...
#define OSServiceId_GetSpinlock ((OSServiceIdType)92)
#define OSServiceId_ReleaseSpinlock ((OSServiceIdType)93)
#define OSServiceId_TryToGetSpinlock ((OSServiceIdType)94)
#define OSServiceId_GetSpinlockInfo ((OSServiceIdType)95)
#define OSServiceId_ResetSpinlockInfo ((OSServiceIdType)96)
#define OSServiceId_Os_GetTrapInfo ((OSServiceIdType)97)
...
#define OSError_GetSpinlockInfo_SpinlockId() ((SpinlockIdType)(Os_ErrorInformation.service_param1)) /* [MISRA 2012 Rule 11.4/11.6] */ /*lint !e9078 !e923 !e9030 !e9087 !e931 !e826 !e571 */
#define OSError_GetSpinlockInfo_Info() ((Os_SpinlockInfoRefType)(Os_ErrorInformation.service_param2)) /* [MISRA 2012 Rule 11.4/11.6] */ /*lint !e9078 !e923 !e9030 !e9087 !e931 !e826 !e571 */
#define OSError_ResetSpinlockInfo_SpinlockId() ((SpinlockIdType)(Os_ErrorInformation.service_param1)) /* [MISRA 2012 Rule 11.4/11.6] */ /*lint !e9078 !e923 !e9030 !e9087 !e931 !e826 !e571 */
...
#define GetCoreID() ((CoreIdType)/*lint --e(9034) [MISRA 2012 Dir 10.3] Depends on CoreIdType size */OS_MFCR(0xfe1c))  /* [$UKS 1619] [$UKS 1620] [$UKS 1621] */
...
extern OS_VOLATILE VAR(Os_Lockable, OS_VAR_NOINIT) Os_lock_alarmaccess;
extern OS_VOLATILE VAR(Os_Lockable, OS_VAR_NOINIT) Os_lock_spinlockinfo;
...
extern FUNC(void, OS_CALLOUT_CODE) Os_Cbk_TaskActivated(TaskType task);
...
extern FUNC(StatusType, OS_CODE) Os_GetSpinlockInfo(SpinlockIdType SpinlockId, Os_SpinlockInfoRefType Info) /* [$UKS 1823] */;
extern FUNC(StatusType, OS_CODE) Os_ResetSpinlockInfo(SpinlockIdType SpinlockId);
