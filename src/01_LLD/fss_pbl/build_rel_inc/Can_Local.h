...
# define ShmSIDF(num)      (*((tSIFEType*) (Can_GetSIDFAOfVirtualShmAdr(canHwChannel) + GET_SIDF_OFFSET(num))))
# define ShmXIDF(num)      (*((tXIFEType*) (Can_GetXIDFAOfVirtualShmAdr(canHwChannel) + GET_XIDF_OFFSET(num))))
# define ShmRXF0(num)      (  (CanElmType*)(Can_GetRXF0AOfVirtualShmAdr(canHwChannel) + GET_RX0F_OFFSET(num)) )
# define ShmRXF1(num)      (  (CanElmType*)(Can_GetRXF1AOfVirtualShmAdr(canHwChannel) + GET_RX1F_OFFSET(num)) )
# define ShmRXB(num)       (  (CanElmType*)(Can_GetRXBAOfShmAdr(canHwChannel)  + GET_RXB_OFFSET (num)) )
# define ShmTXEF(num)      (*((tTxEventFifoElmType*)(Can_GetTXEFAOfVirtualShmAdr(canHwChannel) + GET_TXEF_OFFSET(num))))
# define ShmTXB(num)       (*((CanElmType*) (Can_GetTXBAOfVirtualShmAdr(canHwChannel)  + GET_TXB_OFFSET (num))))
# define pShmTXB(num)      ( ((CanElmType*) (Can_GetTXBAOfVirtualShmAdr(canHwChannel)  + GET_TXB_OFFSET (num))))
# else
...
# define ShmRXF0(num)      (  (CanElmType*)(Can_GetRXF0AOfShmAdr(canHwChannel) + GET_RX0F_OFFSET(num)) )
# define ShmRXF1(num)      (  (CanElmType*)(Can_GetRXF1AOfShmAdr(canHwChannel) + GET_RX1F_OFFSET(num)) )
# define ShmRXB(num)       (  (CanElmType*)(Can_GetRXBAOfShmAdr(canHwChannel)  + GET_RXB_OFFSET (num)) )
# define ShmTXEF(num)      (*((tTxEventFifoElmType*)(Can_GetTXEFAOfShmAdr(canHwChannel) + GET_TXEF_OFFSET(num))))
# define ShmTXB(num)       (*((CanElmType*) (Can_GetTXBAOfShmAdr(canHwChannel)  + GET_TXB_OFFSET (num))))
# define pShmTXB(num)      ( ((CanElmType*) (Can_GetTXBAOfShmAdr(canHwChannel)  + GET_TXB_OFFSET (num))))
# endif
...
# define Can_GetPSRValue(ch)                                Can_GetPSRValueOfControllerData(ch)
#endif
# define Can_GetCanIntEnable(ch)                            Can_GetIntEnableOfControllerData(ch)
# if defined (C_ENABLE_UPDATE_BASE_ADDRESS)
#  define Can_GetCanBasisAdr(hwch)                          Can_GetVirtualBasisAdrOfControllerData(hwch)
# else
...
#define CanRxActualExtId(rxStruct)          (vuint32) ( ((rxStruct)->pChipMsgObj->uB0.B0) & 0x1FFFFFFFUL)
#define CanRxActualStdId(rxStruct)          (vuint16) ((((rxStruct)->pChipMsgObj->uB0.B0) & 0x1FFC0000UL) >> 18u)
#define CanRxActualData(rxStruct, i)               (vuint8)  ((rxStruct)->pChipData[i])                                   /* return code has to be vuint8 */
#define CanRxActualIdType(rxStruct)         (tCanIdType) ( ((rxStruct)->pChipMsgObj->uB0.B0) & kCanIdTypeExt)           /* return code has to be tCanIdType */
#define CanRxActualFdType(rxStruct)         (tCanFdType) ((((rxStruct)->pChipMsgObj->uB1.B1) >> 16u) & kCanFdTypeFd)    /* return code has to be tCanFdType */
...
#define CanRxActualDLC(rxStruct)       (vuint8)    CAN_DLC2LEN((rxStruct)->pChipMsgObj->uB1.rb1.DLC)       /* return code has to be vuint8 */ 
...
#if defined( C_SINGLE_RECEIVE_CHANNEL )
# define CanTxActualErrorCounter()             (vuint8)((CnX(0)->ECR) & 0x000000FFUL)
# define CanRxActualErrorCounter()             (vuint8)(((((CnX(0)->ECR) & 0x00008000UL )) == 0x00008000UL) ? (128u) : (((CnX(0)->ECR) >> 8u) & 0x0000007FUL))
#else
# define CanTxActualErrorCounter(ch)           (vuint8)((CnX(ch)->ECR) & 0x000000FFUL)
# define CanRxActualErrorCounter(ch)           (vuint8)(((((CnX(ch)->ECR) & 0x00008000UL )) == 0x00008000UL) ? (128u) : (((CnX(ch)->ECR) >> 8u) & 0x0000007FUL))
#endif /* C_SINGLE_RECEIVE_CHANNEL */


#if defined(C_ENABLE_TX_HW_FIFO)
/* Macros for Tx HW FiFO */
# define CanGetTxHwFifoPutIndex(ch)  CnX(ch)->TXFQS.B.TFQPI
# define CanGetTxHwFifoGetIndex(ch)  CnX(ch)->TXFQS.B.TFGI
# define CanGetTxHwFifoFreeLevel(ch) CnX(ch)->TXFQS.B.TFFL
# define CanIsTxHwFifoFull(ch)      (CnX(ch)->TXFQS.B.TFQF == 1u)
#endif
...
#define CanTxActualDLC(txConfStruct)           (vuint8)  CAN_DLC2LEN((txConfStruct)->pChipMsgObj->uB1.tb1.DLC)
...
# endif
  ...
  #endif
  vuint32 tmpVal;
  V_DEF_P2VAR(V_NONE, CanElmType, AUTOMATIC, VAR_NOINIT) pTXB; /* pointer to TxBuffer */
...
typedef struct sCanRxBasicParaStruct
{
  ...
  /* LL specific part */
  V_DEF_P2VAR(V_NONE,   CanElmType, AUTOMATIC, VAR_NOINIT) pShm;        /* shared message RAM   */
...
***********************************************************************************************************/
/* CODE CATEGORY 4 START */
V_DEF_FUNC(CAN_LOCAL_INLINE, vuint8, STATIC_CODE) CanLL_WriteReg32(CAN_CHANNEL_CANTYPE_FIRST CanChipMsgPtr32 regPtr, vuint32 value, vuint32 readMask, CanInitParaStructPtr initPara);
/* CODE CATEGORY 4 END */
...
***********************************************************************************************************/
/* CODE CATEGORY 4 START */
V_DEF_FUNC(CAN_LOCAL_INLINE, vuint8, STATIC_CODE) CanLL_WriteProtectedReg32(CAN_CHANNEL_CANTYPE_FIRST vuint16 area, CanChipMsgPtr32 regPtr, vuint32 value, vuint32 readMask, CanInitParaStructPtr initPara);
/* CODE CATEGORY 4 END */
# endif /* User Mode */
...
************************************************************************************************************/
/* CODE CATEGORY 2 START */
V_DEF_FUNC(CAN_LOCAL_INLINE, vuint8, STATIC_CODE) CanLL_GetLastErrorCode(CAN_CHANNEL_AND_HW_CHANNEL_CANTYPE_ONLY);
/* CODE CATEGORY 2 END */
 ...
 *  \param[in]     channel   Index of the CAN channel (only if multiple channels are used)
 *  \return        kCanTrue    Transition to passive occurred
 *                 kCanFailed  Transition to passive has not occurred 
 *  \pre           -
 *  \context       ANY
 *  \reentrant     FALSE
 *  \synchronous   TRUE
...
/* CODE CATEGORY 4 START */
/************************************************************************************************************
 *  CanLL_SetRegisterMcMcan()
 ***********************************************************************************************************/
/*! \brief         Initialize McMcan specific registers
...
#if ( CAN_SAFE_BSW == STD_ON ) /* COV_CAN_HW_SPECIFIC */
/* CODE CATEGORY 4 START */
/************************************************************************************************************
 ...
 ***********************************************************************************************************/
/*! \brief         Initialize McMcan SubSystems
 ...
 *  \synchronous   TRUE
************************************************************************************************************/
V_DEF_FUNC(CAN_LOCAL_INLINE, vuint8, STATIC_CODE) Can_EccInit(void); /* PRQA S 3447 */ /* MD_Can_ExternalScope */
/* CODE CATEGORY 4 END */
#else
# define Can_EccInit() ApplCanEccInit() /* Application Callout to init the CAN Message RAM */
