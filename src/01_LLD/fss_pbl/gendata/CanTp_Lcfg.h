...
/**   \brief  type used to iterate CanTp_DynFCParameters */
/*! \spec strong type invariant () { self < CanTp_GetSizeOfDynFCParameters() } \endspec */ 
...
/**   \brief  value based type definition for CanTp_SizeOfDynFCParameters */
...
/**   \brief  type used to point to CanTp_DynFCParameters */
typedef P2VAR(CanTp_DynFCParameterType, TYPEDEF, CANTP_VAR_NOINIT) CanTp_DynFCParametersPtrType;
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern VAR(CanTp_DynFCParameterType, CANTP_VAR_NOINIT) CanTp_DynFCParameters[4];
