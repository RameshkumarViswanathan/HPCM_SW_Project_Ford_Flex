...
#if (CANIF_TYPES_MINOR_VERSION != 0x26u)
...
#if (CANIF_API_MINOR_VERSION != 0x05u)
...
# if (CANIF_TRCV_HANDLING == STD_ON) || (CANIF_J1939_DYN_ADDR_SUPPORT != CANIF_J1939_DYN_ADDR_DISABLED) || (CANIF_ENABLE_SECURITY_EVENT_REPORTING == STD_ON) || \
     (CANIF_BUS_MIRRORING_SUPPORT == STD_ON) || (CANIF_SUPPORT_CANDRV_ASR440 == STD_ON)
#  error "Invalid configuration: Multicore support is activated with at least one additional unsupported feature"
# endif
#endif
...
#if (CANIF_SUPPORT_CANDRV_ASR440 == STD_ON)
...
# define CANIF_CANDRV_BUSY    CAN_BUSY
#endif /* CANIF_SUPPORT_CANDRV_ASR440 == STD_ON */

#if ((CANIF_SUPPORT_CANDRV_ASR440 == STD_ON) || (CANIF_SUPPORT_CANDRV_AR_VERSIONS == STD_ON))
/* Returns the controller mode which corresponds to the given controller state */
...
/***********************************************************************************************************************
 *  CanIf_SetControllerModeSubStarted()
 **********************************************************************************************************************/
/*! \brief       Passes the requested controller mode transition to STARTED for the CAN controller to the corresponding
 *               CAN driver.
 *  \details     Called out of CanIf_SetControllerModeSubSwitch().
 *  \param[in]   ControllerId: Handle-Id of CAN controller. Parameter must be smaller than CANIF_CFG_MAX_CONTROLLER.
 *  \return      E_OK: Controller mode transition was accepted by the CAN driver.
 *               E_NOT_OK: Controller mode transistion was rejected by the CAN driver.
 *  \pre         Must be called in context of entered CANIF_EXCLUSIVE_AREA_0
 *  \context     ANY
 *  \reentrant   FALSE
 *  \synchronous FALSE
 *  \config      -
 **********************************************************************************************************************/
CANIF_LOCAL_INLINE FUNC(Std_ReturnType, CANIF_CODE) CanIf_SetControllerModeSubStarted(uint8 ControllerId);


/***********************************************************************************************************************
 *  CanIf_SetControllerModeSubStopped()
 **********************************************************************************************************************/
/*! \brief       Passes the requested controller mode transition to STOPPED for the CAN controller to the corresponding
 *               CAN driver.
 *  \details     Called out of CanIf_SetControllerModeSubSwitch().
 *  \param[in]   ControllerId: Handle-Id of CAN controller. Parameter must be smaller than CANIF_CFG_MAX_CONTROLLER.
 *  \return      E_OK: Controller mode transition was accepted by the CAN driver.
 ...
 *  \config      -
 **********************************************************************************************************************/
CANIF_LOCAL_INLINE FUNC(Std_ReturnType, CANIF_CODE) CanIf_SetControllerModeSubStopped(uint8 ControllerId);


/***********************************************************************************************************************
 *  CanIf_SetControllerModeSubSleep()
 **********************************************************************************************************************/
/*! \brief       Passes the requested controller mode transition to SLEEP for the CAN controller to the corresponding
 *               CAN driver.
 *  \details     Called out of CanIf_SetControllerModeSubSwitch().
 *  \param[in]   ControllerId: Handle-Id of CAN controller. Parameter must be smaller than CANIF_CFG_MAX_CONTROLLER.
 *  \return      E_OK: Controller mode transition was accepted by the CAN driver.
 ...
 *  \config      -
 **********************************************************************************************************************/
CANIF_LOCAL_INLINE FUNC(Std_ReturnType, CANIF_CODE) CanIf_SetControllerModeSubSleep(uint8 ControllerId);


/***********************************************************************************************************************
 *  CanIf_SetControllerModeSubWakeup()
 **********************************************************************************************************************/
/*! \brief       Passes the requested controller mode transition to WAKEUP for the CAN controller to the corresponding
 *               CAN driver.
 *  \details     Called out of CanIf_SetControllerModeSubSwitch().
 *  \param[in]   ControllerId: Handle-Id of CAN controller. Parameter must be smaller than CANIF_CFG_MAX_CONTROLLER.
 *  \return      E_OK: Controller mode transition was accepted by the CAN driver.
 ...
 *  \config      -
 **********************************************************************************************************************/
CANIF_LOCAL_INLINE FUNC(Std_ReturnType, CANIF_CODE) CanIf_SetControllerModeSubWakeup(uint8 ControllerId);
...
/* Lookup table to convert the states from Can_ControllerStateType to the modes from CanIf_ControllerModeType.
    The values of the states from Can_ControllerStateType are explicitly defined from AR version 4.3.1 of CAN driver specification.
...
#  if (CANIF_BITQUEUE == STD_ON)
        ...
        for( TxQueueFlagsIdx = CANIF_CFG_TXBUFFERPRIOBYCANIDBITQUEUE_QUEUESTARTIDX(txBufferCfgIdx); TxQueueFlagsIdx < CANIF_CFG_TXBUFFERPRIOBYCANIDBITQUEUE_QUEUESTOPIDX(txBufferCfgIdx); TxQueueFlagsIdx++) /* FETA_CANIF_6 */
        {
...
# else
        ...
        for (MappedTxPdusIdx = CANIF_CFG_TXBUFFERPRIOBYCANIDBYTEQUEUE_STARTIDX2MAPPEDTXPDUS(txBufferCfgIdx); MappedTxPdusIdx < CANIF_CFG_TXBUFFERPRIOBYCANIDBYTEQUEUE_STOPIDX2MAPPEDTXPDUS(txBufferCfgIdx); MappedTxPdusIdx++) /* FETA_CANIF_6 */
        {
 ...
 **********************************************************************************************************************/
/*
|<DataModelStart>| CanIf_SetControllerModeSubStarted
Relation_Context:
Relation:
CanIfMultipleDriver
CanIfSupportCanDrvAsr440
CanIfSupportCanDrvAsr440, CanIfMultipleDriver
Parameter_PreCompile:
Parameter_Data:
Constrain:
|<DataModelEnd>|
...
CANIF_LOCAL_INLINE FUNC(Std_ReturnType, CANIF_CODE) CanIf_SetControllerModeSubStarted(uint8 ControllerId)
{
...
#if ((CANIF_MULTIPLE_CANDRV_SUPPORT == STD_ON) && (CANIF_SUPPORT_CANDRV_AR_VERSIONS == STD_OFF))
  ...
  /* if(CANIF_MULTIPLE_CANDRV_SUPPORT == STD_OFF) canSetCtrlModeFct is defined to Can_SetControllerMode
     and CANIF_CFG_CTRLUPTOLOWMAP_CONTROLLER is defined to ControllerId
  */
#endif

  /* ----- Implementation ----------------------------------------------- */
  /* #100 Pass the requested controller mode transition to STARTED to the corresponding CAN driver */
#if (CANIF_SUPPORT_CANDRV_AR_VERSIONS == STD_ON)
  if(CanIf_GetCanDrvArVersionOfCanControllerIdUpToLowMap(ControllerId) == CAN_DRV_AR_403)
  {
    CanIf_Can_SetControllerModeAr403FctType canSetCtrlModeFct = CANIF_GET_CANSETCTRLMODEFCT(ControllerId).CanIf_Can_SetControllerModeAr403Fct;
    if(canSetCtrlModeFct((uint8)CANIF_CFG_CTRLUPTOLOWMAP_CONTROLLER(ControllerId), CAN_T_START) == CAN_OK)
    {
      retval = E_OK;
    }
  }
  ...
  {
    CanIf_Can_SetControllerModeAr431FctType canSetCtrlModeFct = CANIF_GET_CANSETCTRLMODEFCT(ControllerId).CanIf_Can_SetControllerModeAr431Fct;
    retval = canSetCtrlModeFct((uint8)CANIF_CFG_CTRLUPTOLOWMAP_CONTROLLER(ControllerId), CAN_CS_STARTED);
  }
#elif (CANIF_SUPPORT_CANDRV_ASR440 == STD_ON)
  retval = canSetCtrlModeFct((uint8)CANIF_CFG_CTRLUPTOLOWMAP_CONTROLLER(ControllerId), CAN_CS_STARTED); /* SBSW_CANIF_41 */
#else
 ...
 **********************************************************************************************************************/
/*
|<DataModelStart>| CanIf_SetControllerModeSubStopped
Relation_Context:
Relation:
CanIfMultipleDriver
CanIfSupportCanDrvAsr440
...
CANIF_LOCAL_INLINE FUNC(Std_ReturnType, CANIF_CODE) CanIf_SetControllerModeSubStopped(uint8 ControllerId)
{
  ...
  */
  ...
  /* ----- Implementation ----------------------------------------------- */
  /* #100 Pass the requested controller mode transition to STOPPED to the corresponding CAN driver */
#if (CANIF_SUPPORT_CANDRV_AR_VERSIONS == STD_ON)
  if(CanIf_GetCanDrvArVersionOfCanControllerIdUpToLowMap(ControllerId) == CAN_DRV_AR_403)
  {
    CanIf_Can_SetControllerModeAr403FctType canSetCtrlModeFct = CANIF_GET_CANSETCTRLMODEFCT(ControllerId).CanIf_Can_SetControllerModeAr403Fct;
    if(canSetCtrlModeFct((uint8)CANIF_CFG_CTRLUPTOLOWMAP_CONTROLLER(ControllerId), CAN_T_STOP) == CAN_OK)
    {
      retval = E_OK;
    }
  }
  ...
  {
    CanIf_Can_SetControllerModeAr431FctType canSetCtrlModeFct = CANIF_GET_CANSETCTRLMODEFCT(ControllerId).CanIf_Can_SetControllerModeAr431Fct;
    retval = canSetCtrlModeFct((uint8)CANIF_CFG_CTRLUPTOLOWMAP_CONTROLLER(ControllerId), CAN_CS_STOPPED);
  }
#elif (CANIF_SUPPORT_CANDRV_ASR440 == STD_ON)
  retval = canSetCtrlModeFct((uint8)CANIF_CFG_CTRLUPTOLOWMAP_CONTROLLER(ControllerId), CAN_CS_STOPPED); /* SBSW_CANIF_41 */
# else
 ...
 **********************************************************************************************************************/
/*
|<DataModelStart>| CanIf_SetControllerModeSubSleep
Relation_Context:
Relation:
CanIfMultipleDriver
CanIfSupportCanDrvAsr440
...
CANIF_LOCAL_INLINE FUNC(Std_ReturnType, CANIF_CODE) CanIf_SetControllerModeSubSleep(uint8 ControllerId)
{
  ...
  */
  ...
  /* ----- Implementation ----------------------------------------------- */
  /* #100 Pass the requested controller mode transition to SLEEP to the corresponding CAN driver */
#if (CANIF_SUPPORT_CANDRV_AR_VERSIONS == STD_ON)
  if(CanIf_GetCanDrvArVersionOfCanControllerIdUpToLowMap(ControllerId) == CAN_DRV_AR_403)
  {
    CanIf_Can_SetControllerModeAr403FctType canSetCtrlModeFct = CANIF_GET_CANSETCTRLMODEFCT(ControllerId).CanIf_Can_SetControllerModeAr403Fct;
    if(canSetCtrlModeFct((uint8)CANIF_CFG_CTRLUPTOLOWMAP_CONTROLLER(ControllerId), CAN_T_SLEEP) == CAN_OK)
    {
      retval = E_OK;
    }
  }
  ...
  {
    CanIf_Can_SetControllerModeAr431FctType canSetCtrlModeFct = CANIF_GET_CANSETCTRLMODEFCT(ControllerId).CanIf_Can_SetControllerModeAr431Fct;
    retval = canSetCtrlModeFct((uint8)CANIF_CFG_CTRLUPTOLOWMAP_CONTROLLER(ControllerId), CAN_CS_SLEEP);
  }
#elif (CANIF_SUPPORT_CANDRV_ASR440 == STD_ON)
  retval = canSetCtrlModeFct((uint8)CANIF_CFG_CTRLUPTOLOWMAP_CONTROLLER(ControllerId), CAN_CS_SLEEP); /* SBSW_CANIF_41 */
# else
 ...
 **********************************************************************************************************************/
/*
|<DataModelStart>| CanIf_SetControllerModeSubWakeup
Relation_Context:
Relation:
CanIfMultipleDriver
CanIfSupportCanDrvAsr440
...
CANIF_LOCAL_INLINE FUNC(Std_ReturnType, CANIF_CODE) CanIf_SetControllerModeSubWakeup(uint8 ControllerId)
{
  ...
  */
  ...
  /* ----- Implementation ----------------------------------------------- */
  /* #100 Pass the requested controller mode transition to WAKEUP to the corresponding CAN driver */
#if (CANIF_SUPPORT_CANDRV_AR_VERSIONS == STD_ON)
  if(CanIf_GetCanDrvArVersionOfCanControllerIdUpToLowMap(ControllerId) == CAN_DRV_AR_403)
  {
    CanIf_Can_SetControllerModeAr403FctType canSetCtrlModeFct = CANIF_GET_CANSETCTRLMODEFCT(ControllerId).CanIf_Can_SetControllerModeAr403Fct;
    if(canSetCtrlModeFct((uint8)CANIF_CFG_CTRLUPTOLOWMAP_CONTROLLER(ControllerId), CAN_T_WAKEUP) == CAN_OK)
    {
      retval = E_OK;
    }
  }
...
#elif (CANIF_SUPPORT_CANDRV_ASR440 == STD_ON)
  /* To wakeup a ASR4.4.0 CAN driver from a logical sleep mode a transition to STOPPED has to be executed (SWS_Can_00405) */
  retval = canSetCtrlModeFct((uint8)CANIF_CFG_CTRLUPTOLOWMAP_CONTROLLER(ControllerId), CAN_CS_STOPPED); /* SBSW_CANIF_41 */
# else
    ...
    case CANIF_CS_STOPPED:
      ...
      switch(CanIf_GetCtrlMode(ControllerId))
      {
        ...
        case CANIF_CS_STARTED:
          ...
          if (CanIf_SetControllerModeSubStopped(ControllerId) == E_OK)
          {
            /* \trace SPEC-45263 */
      ...
      break;
    case CANIF_CS_STARTED:
      /* #300 Transition to controller mode STARTED: Transition only possible from controller mode STOPPED/STARTED */
      /* \trace SPEC-3757 */
      ...
      switch(CanIf_GetCtrlMode(ControllerId))
      {
        case CANIF_CS_STOPPED:
          /* \trace SPEC-1845, SPEC-1996 */
          /* #310 Request CAN controller to controller mode STARTED if currently in controller mode STOPPED */
          retval = CanIf_SetControllerModeSubStarted(ControllerId);
          break;

        case CANIF_CS_STARTED:
          /* \trace SPEC-1845, SPEC-1996 */
          /* #320 Request CAN controller to controller mode STARTED if currently in controller mode STARTED */
          retval = CanIf_SetControllerModeSubStarted(ControllerId);
          break;
    ...
    case CANIF_CS_SLEEP:
      ...
      switch(CanIf_GetCtrlMode(ControllerId))
      {
        case CANIF_CS_STOPPED:
          ...
          if (CanIf_SetControllerModeSubSleep(ControllerId) == E_OK)
          {
#if (CANIF_WAKEUP_VALIDATION == STD_ON)
...
CanIfMultipleDriver
CanIfTxBuffer
CanIfTxBuffer, CanIfSupportCanDrvAsr440
CanIfMultipleDriver
CanIfMultipleDriver, CanIfSupportCanDrvAsr440
CanIfSupportCanDrvAsr440
CanIfTxBuffer
CanIfSupportCanDrvAsr440
CanIfTxBuffer, CanIfSupportCanDrvAsr440
...
# if (CANIF_SUPPORT_CANDRV_AR_VERSIONS == STD_ON)
    if(CanIf_GetCanDrvArVersionOfCanControllerIdUpToLowMap(CANIF_CFG_TX_CONTROLLER(localPduPtr->swPduHandle)) == CAN_DRV_AR_403)
    {
      CanIf_Can_WriteAr403FctType canWriteFct = CanIf_GetCan_WriteFctMap(CANIF_CFG_CTRLUPTOLOWMAP_DRIVERINDEX(CANIF_CFG_TX_CONTROLLER(localPduPtr->swPduHandle))).CanIf_Can_WriteAr403Fct;
      txResult = canWriteFct(canDrvHth, (P2CONST(Can_PduType, AUTOMATIC, CANIF_VAR_STACK))localPduPtr);
    }
    else
    {
      Std_ReturnType ret;
      CanIf_Can_WriteAr431FctType canWriteFct = CanIf_GetCan_WriteFctMap(CANIF_CFG_CTRLUPTOLOWMAP_DRIVERINDEX(CANIF_CFG_TX_CONTROLLER(localPduPtr->swPduHandle))).CanIf_Can_WriteAr431Fct;
      ret = canWriteFct(canDrvHth, (P2CONST(Can_PduType, AUTOMATIC, CANIF_VAR_STACK))localPduPtr);
      if(ret == E_OK)
      {
        txResult = CAN_OK;
      }
...
# else
    {
      CanIf_Can_WriteFctType canWriteFct = CanIf_GetCan_WriteFctMap(CANIF_CFG_CTRLUPTOLOWMAP_DRIVERINDEX(CANIF_CFG_TX_CONTROLLER(localPduPtr->swPduHandle)));
...
CANIF_LOCAL_INLINE FUNC(void, CANIF_CODE) CanIf_RxIndicationSubBinarySearch(P2VAR(CanIf_RxSearchParamsType, AUTOMATIC, AUTOMATIC) rxSearchParams)
{
  ...
  /* ----- Implementation ----------------------------------------------- */
  /* #100 Determine the inital search range of Rx-PDU-Ids in the Rx-PDU list */
  firstRxPduId = CANIF_CFG_MAILBOX_PDUIDFIRST(rxSearchParams->eHrh);
  lastRxPduId = rxSearchParams->eRxPduId;

  /* #110 Run through the search range of Rx-PDU-Ids in the Rx-PDU list (Rx-PDU-Ids in the list are sorted by their CAN-Id in descending order)
          (loop breaks at this point, if no matched Rx-PDU was found before and the end of the inital search range is reached) */
  while (firstRxPduId <= lastRxPduId) /* PRQA S 0771 */ /* MD_CanIf_MultipleBreak */ /* FETA_CANIF_12 */
  {
    /* #120 Calculate the middle Rx-PDU-Id of the search range of Rx-PDU-Ids*/
    midRxPduId = (PduIdType)((lastRxPduId + firstRxPduId) >> 1);

    /* #130 If CAN-Id of the middle Rx-PDU-Id matches the searched CAN-Id */
    if(CANIF_CFG_RX_CANID(midRxPduId) == rxSearchParams->eCanId)
    {
      /* #140 Set the middle Rx-PDU-Id as match and break the search
              (loop breaks at this point, because matched Rx-PDU was found) */
      resultId = midRxPduId;
      break;
    }
    /* #150 If CAN-Id of the middle Rx-PDU-Id is bigger than the searched CAN-Id */
    else if(CANIF_CFG_RX_CANID(midRxPduId) > rxSearchParams->eCanId)
    {
      /* #160 Continue the search between the middle Rx-PDU-Id and the last Rx-PDU-Id
              (the new value for firstRxPduId can lead to a break of the loop at the next iteration, if firstRxPduId is bigger than lastRxPduId
               this indicates that the end of the inital search range is reached) */
      firstRxPduId = midRxPduId + 1u;
    }
    /* #170 If CAN-Id of the middle Rx-PDU-Id is smaller than the searched CAN-Id */
    else
    {
      /* #180 If middle Rx-PDU-Id is the first Rx-PDU-Id from the inital search range */
      if(midRxPduId == CANIF_CFG_MAILBOX_PDUIDFIRST(rxSearchParams->eHrh))
      {
        /* #190 Break the search (no matched Rx-PDU found is already set)
                (loop breaks at this point, because the beginning of the inital search range is reached)
        */
        break;
      }
      /* #200 If middle Rx-PDU-Id is within the inital search range */
      else
      { /* #210 Continue search between middle Rx-PDU-Id and first Rx-PDU-Id */
  ...
  {
    /* #220 If matched Rx-PDU found verify the message type regarding FD format (only if configured) */
# if (CANIF_RX_SEARCH_CONSIDER_MSG_TYPE == STD_ON)
...
# if (CANIF_EXTENDEDID_SUPPORT == STD_ON)
              {
                ...
                for (j = 0; j < CANIF_CFG_RX_RXMETADATALENGTH(PduId); j++) /* FETA_CANIF_8 */
                {
...
#  if (CANIF_SUPPORT_CANDRV_AR_VERSIONS == STD_ON)
    if(CanIf_GetCanDrvArVersionOfCanControllerIdUpToLowMap(CANIF_CFG_TX_CONTROLLER(PduId)) == CAN_DRV_AR_403)
    {
      CanIf_Can_WriteAr403FctType canWriteFct = CanIf_GetCan_WriteFctMap(CANIF_CFG_CTRLUPTOLOWMAP_DRIVERINDEX(CANIF_CFG_TX_CONTROLLER(PduId))).CanIf_Can_WriteAr403Fct;
      txResult = canWriteFct(canDrvHth, &localPdu);
    }
    else
    {
      Std_ReturnType ret;
      CanIf_Can_WriteAr431FctType canWriteFct = CanIf_GetCan_WriteFctMap(CANIF_CFG_CTRLUPTOLOWMAP_DRIVERINDEX(CANIF_CFG_TX_CONTROLLER(PduId))).CanIf_Can_WriteAr431Fct;
      ret = canWriteFct(canDrvHth, &localPdu);
      if(ret == E_OK)
      {
        txResult = CAN_OK;
      }
...
#  else
    {
      CanIf_Can_WriteFctType canWriteFct = CanIf_GetCan_WriteFctMap(CANIF_CFG_CTRLUPTOLOWMAP_DRIVERINDEX(CANIF_CFG_TX_CONTROLLER(PduId)));
...
#  if (CANIF_BITQUEUE == STD_ON)
      ...
      if (CanIf_GetTxQueueCounter(txBufferPrioByCanIdBaseIdx) != 0u)
      {
        ...
        for(queueElementIdx = (((sint16_least)CANIF_CFG_TXBUFFERPRIOBYCANIDBITQUEUE_QUEUESTOPIDX(txBufferCfgIdx)) - (sint16_least)1); queueElementIdx >= queueEndElementIdx; queueElementIdx--) /* FETA_CANIF_9 */
        {
...
#  else
      ...
      if (CanIf_GetTxQueueCounter(txBufferPrioByCanIdBaseIdx) != 0u)
      {
        ...
        for (idx2MappedTxPdus = ((CanIf_AnyIdxType)CANIF_CFG_TXBUFFERPRIOBYCANIDBYTEQUEUE_STOPIDX2MAPPEDTXPDUS(txBufferCfgIdx)-1u); idx2MappedTxPdus >= CANIF_CFG_TXBUFFERPRIOBYCANIDBYTEQUEUE_STARTIDX2MAPPEDTXPDUS(txBufferCfgIdx); idx2MappedTxPdus--) /* FETA_CANIF_9 */
        {
...
Relation_Context:
CanIfSupportCanDrvAsr440 # from this API #
Relation:
CanIfDevErrorDetect
CanIfDevErrorDetect, CanIfVariant
CanIfDevErrorDetect
...
#if (CANIF_SUPPORT_CANDRV_ASR440 == STD_ON)
/* PRQA S 6010, 6030, 6080 1 */ /* MD_MSR_STPTH, MD_MSR_STCYC, MD_MSR_STMIF */
FUNC(void, CANIF_CODE) CanIf_ControllerModeIndication(uint8 ControllerId, Can_ControllerStateType ControllerMode)
#elif (CANIF_SUPPORT_CANDRV_AR_VERSIONS == STD_ON)
...
# endif
...
#endif
  {
    ...
    {
#if (CANIF_SUPPORT_CANDRV_ASR440 == STD_ON)
      /* #200 Convert the given controller state to the corresponding controller mode, if ASR4.4.0 CAN driver is used */
      if((uint8)ControllerMode < CANIF_CAN_CTRL_STATES_SIZE) /* Ensures a valid coversion; values greater or equal are also not defined in CanIf_ControllerModeType (s. CanIf_Types.h)
                                                                and are handled by the default case in the below outer switch case */
      ...
      {
        /* Continue with the invalid not converted mode (ensures same behaviour as with CanIf_ControllerModeType) */
        canIfCtrlMode = (CanIf_ControllerModeType)ControllerMode; /* PRQA S 4322 */ /* MD_CanIf_CastEnumToDiffEnum */
      }
#else
      ...
      if (cbkFct != NULL_PTR)
      {
        ...
        cbkFct(ControllerId, canIfCtrlMode); /* SBSW_CANIF_13 */
      }
...
FUNC(void, CANIF_CODE) CanIf_ControllerModeIndicationAr431(uint8 ControllerId, Can_ControllerStateType ControllerMode)
{
  ...
  /* #100 Convert the given controller state to the corresponding controller mode */
  if((uint8)ControllerMode < CANIF_CAN_CTRL_STATES_SIZE) /* Ensures a valid coversion; values greater or equal are also not defined in CanIf_ControllerModeType (s. CanIf_Types.h)
  ...
  /* #110 Call CanIf_ControllerModeIndicationAr403 with the corresponding controller mode */
  CanIf_ControllerModeIndicationAr403(ControllerId, canIfCtrlMode);
}
#endif /* (CANIF_SUPPORT_CANDRV_AR_VERSIONS == STD_ON) */
...
\ID FETA_CANIF_4
\DESCRIPTION The while loop has external termination condition computation (calls to CanIf_RxIndicationSubReceptionPduMode).
             The termination conditions are determined by parameterized GenData access.
...
\ID FETA_CANIF_6
\DESCRIPTION The for loop iterates over the Tx-Buffer to clear the queue states/flags.
             The constant start and stop index are determined by parameterized GenData access.
             ...
             -> CanIf_GetMailBoxConfigIdxOfMappedTxBuffersConfig -> CanIf_GetTxBufferCfgIdxOfMailBoxConfig
             Bit: -> CanIf_GetTxQueueFlagsStartIdxOfTxBufferPrioByCanIdBitQueueConfig/CanIf_GetTxQueueFlagsEndIdxOfTxBufferPrioByCanIdBitQueueConfig
             Byte: -> CanIf_GetTxBufferPrioByCanIdByteQueueMappedTxPdusStartIdxOfTxBufferPrioByCanIdByteQueueConfig/CanIf_GetTxBufferPrioByCanIdByteQueueMappedTxPdusEndIdxOfTxBufferPrioByCanIdByteQueueConfig
...
\DESCRIPTION The for loop iterates over the Tx-Buffer to find the next queued Tx-PDU with the highest priority.
             ...
             Bit: -> CanIf_GetTxBufferPrioByCanIdBaseIdxOfTxBufferPrioByCanIdBitQueueConfig -> CanIf_GetTxBufferPrioByCanIdBase).eQueueCounter
             Byte: -> CanIf_GetTxBufferPrioByCanIdBaseIdxOfTxBufferPrioByCanIdByteQueueConfig -> CanIf_GetTxBufferPrioByCanIdBase.eQueueCounter
...
\COUNTERMEASURE \N CanTxPduId/PduInfoPtr->swPduHandle/PduId is checked against CanIf_GetSizeOfTxPduConfig by the caller function.
                   The following indirections are ensured via qualified use-case CSL03 of ComStackLib.
                   Each time a new Tx-PDU is buffered the eQueueCounter is incremented and the corresponding queue flag/state is set.
...
\DESCRIPTION The while loop has complex termination conditions.
             The termination conditions are determined by parameterized GenData access.
\COUNTERMEASURE \D CanIf_RxIndicationSubBinarySearch
                \S SMI-246328
