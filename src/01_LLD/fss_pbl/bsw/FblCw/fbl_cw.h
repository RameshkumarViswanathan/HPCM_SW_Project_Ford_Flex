 ...
 *  06.04.02   2023-02-01  vistbe  ESCAN00112194    SetPduMode to online missing after baudrate switch
 *  06.05.00   2023-03-01  vismix  FBL-6468         Allow handling of non Dcm related bus systems
 *                                 ESCAN00113570    Compiler error: undeclared identifier "CanNmConf_CanNmRxPdu_*"
 *  06.06.00   2023-03-17  vismix  FBL-6586         Add feature for identifying the active connection bus type
 *  06.06.01   2023-03-24  visrie  ESCAN00114266    APIs related to change parameter always fail
 *  06.06.02   2023-04-03  visjns  ESCAN00112676    PduR routing path blocked and FrNm ready-sleep counter handling
 *                                                   delayed if FlexRay bus lost sychronization
 *                                 ESCAN00112677    No FrNm PDUs are transmitted on the FrNmChannel for the second
 *                                                   FrIfCluster
 * 06.06.03    2023-05-11  vismix  ESCAN00114095    Queued request feature does not work for DoIPInt
 *********************************************************************************************************************/
 ...
 *  VERSION
 *********************************************************************************************************************/
# define FBLWRAPPERCOM_PDUR_VERSION           0x0606u
...
/** Set flag to indicate reception of start message */
#  define FblCwSetStartMsgReceived()       (fblCwStateStartMsg |= kFblCwStartMsgReceived)
/** Clear flag which indicates reception of start message */
...
/*! \brief    This service initializes internal and external interfaces and variables of the MICROSAR FBLCW layer
    ...
    \details  -
    \param[in] config  NULL_PTR if FBLCW_USE_INIT_POINTER is STD_OFF
...
*********************************************************************************************************************/
/*! \brief      Get Bus type of active connection
*  \return      Bus type of active connection
*********************************************************************************************************************/
