...
#  define FBL_ISYNC()               _isync()
#  define FBL_DSYNC()               _dsync()
#  define FBL_NOP()                 _nop()
#  define FBL_MFCR(regaddr)         _mfcr(regaddr)
#  define FBL_MTCR(regaddr, val)    _mtcr((regaddr), (val))
...
#  define FblInterruptDisable()            _disable()      /**< Disable global interrupt operation */
#  define FblInterruptEnable()             _enable()       /**< Enable global interrupt operation  */
