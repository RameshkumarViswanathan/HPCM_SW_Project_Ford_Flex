...
#==================================================================================================
    ...
    S_BLACKLIST_SDC += $(notdir $(wildcard mcal/Mcal_Safety/*.c))
...
#==================================================================================================
    ...
    S_BLACKLIST_SDC += $(notdir $(wildcard bsw/Com/*.c))
    S_BLACKLIST_SDC += $(notdir $(wildcard bsw/ComM/*.c))
    ...
    S_BLACKLIST_SDC += $(notdir $(wildcard bsw/Os/*.c))
    ...
    S_BLACKLIST_SDC += $(notdir $(wildcard bsw/WdgM/*.c))
    S_BLACKLIST_SDC += $(notdir $(wildcard bsw/Wdg_30_Sbc/*.c))
    S_BLACKLIST_SDC += $(notdir $(wildcard bsw/vDem42/*.c))
...
#   S_BLACKLIST_SDC += $(notdir $(wildcard bsw/FblSwap/fbl_swap.c))
...
#   S_BLACKLIST_SDC += $(notdir $(wildcard bsw/Xcp/*.c))
#   S_BLACKLIST_SDC += $(notdir $(wildcard bsw/vLinkGen/*.c))
#   S_BLACKLIST_SDC += $(notdir $(wildcard bsw/vOtaM/*.c))
#   S_BLACKLIST_SDC += $(notdir $(wildcard bsw/vSecPrim/*.c))

#==================================================================================================
#                To avoid to compile file in specified directories -  bsw_startup
#==================================================================================================
    S_BLACKLIST_SDC += $(notdir $(wildcard pbl_appl_src/BMHD_ToFbl.c))
    S_BLACKLIST_SDC += $(notdir $(wildcard pbl_appl_src/BMHD_ToUpdater.c))
    S_BLACKLIST_SDC += $(notdir $(wildcard pbl_appl_src/Spi_Fbl_Cfg.c))
    S_BLACKLIST_SDC += $(notdir $(wildcard pbl_appl_src/bm_ap.c))
    S_BLACKLIST_SDC += $(notdir $(wildcard pbl_appl_src/fbl_spi_infineon_qspi_cfg.c))
    S_BLACKLIST_SDC += $(notdir $(wildcard pbl_appl_src/flashdrv_xd2_cfg.c))
    S_BLACKLIST_SDC += $(notdir $(wildcard pbl_appl_src/upd_ap.c))
    S_BLACKLIST_SDC += $(notdir $(wildcard pbl_appl_src/upd_hw_ap.c))
    S_BLACKLIST_SDC += $(notdir $(wildcard pbl_appl_src/upd_hw_ap.c))
    S_BLACKLIST_SDC += $(notdir $(wildcard pbl_appl_src/upd_oem_ap.c))
    S_BLACKLIST_SDC += $(notdir $(wildcard product_config/*.c))
#   S_BLACKLIST_SDC += $(notdir $(wildcard pbl_appl_src/BrsHw.c))
#   S_BLACKLIST_SDC += $(notdir $(wildcard pbl_appl_src/BrsHwIntTb.c))
#   S_BLACKLIST_SDC += $(notdir $(wildcard pbl_appl_src/BrsHwStartup.c))
#   S_BLACKLIST_SDC += $(notdir $(wildcard pbl_appl_src/BrsMain.c))
#   S_BLACKLIST_SDC += $(notdir $(wildcard pbl_appl_src/BrsMainStartup.c))
#   S_BLACKLIST_SDC += $(notdir $(wildcard pbl_appl_src/BrsMain_Appl.c))
#   S_BLACKLIST_SDC += $(notdir $(wildcard pbl_appl_src/BrsMain_Callout_Stubs.c))
#   S_BLACKLIST_SDC += $(notdir $(wildcard pbl_appl_src/EcuM.c))
#   S_BLACKLIST_SDC += $(notdir $(wildcard pbl_appl_src/fbl_ap.c))
#   S_BLACKLIST_SDC += $(notdir $(wildcard pbl_appl_src/fbl_apdi.c))
#   S_BLACKLIST_SDC += $(notdir $(wildcard pbl_appl_src/fbl_apnv.c))
#   S_BLACKLIST_SDC += $(notdir $(wildcard pbl_appl_src/fbl_apwd.c))
...
#==================================================================================================
#
OBJS_sdc = BrsHwStartup.o BrsMainStartup.o software_version.o
#
#==================================================================================================
#				Layers list
#==================================================================================================
