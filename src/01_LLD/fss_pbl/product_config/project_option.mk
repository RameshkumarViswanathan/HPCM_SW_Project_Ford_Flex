...
SOFTWARE_VERSION := "dz110B1CBL210_3"

 #COMPILATION_DATA = $(date '+%d/%m/%y-%H:%M')
...
CPPFLAGS += $(CPPFLAGS_dev) -DBRS_TIMEBASE_CLOCK=300 -DBRS_EVA_BOARD_CUSTOMER_HARDWARE -DBRS_COMP_GCCHIGHTEC -DAUTOSAR_IS_PRESENT -DNO_BOOT_IS_PRESENT -DDemoFbl \
...
hightec_main.ld:  pbl_appl_src/vLinkGen_Template_DemoFbl.ld product_config/project_option.mk
	$(CC) -E -P -C -xc $(CPPFLAGS) pbl_appl_src/vLinkGen_Template_DemoFbl.ld -o product_config/hightec_main.ld -I gendata
