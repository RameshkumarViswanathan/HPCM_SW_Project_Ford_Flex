 ...
 *  02.12.00  2023-02-16  visjhr  Removed unused IdleTask{_CoreX},removed filtering ifdefs for
 *                                C_BRSASR_USECASE_STARTAPPLICATION_COMMENT and C_BSWMODULE_ASR_* (HALBE-8511)
 ...
 */
#define BRSMAIN_VERSION        0x0214u
...
//RTAOS Inclusions
  ...
  extern uint32 __INTTAB_CPU0[];
  extern uint32 __INTTAB_CPU1[];
  extern uint32 __INTTAB_CPU2[];
  #define BRS_INTVECTTAB_CORE0  &__INTTAB_CPU0
  #define BRS_INTVECTTAB_CORE1  &__INTTAB_CPU1
  #define BRS_INTVECTTAB_CORE2  &__INTTAB_CPU2
...
#define BRS_INIT_BIV(x) BIVAddressInit = (uint32)(x)  
#endif /*_BRSMAIN_H_*/
