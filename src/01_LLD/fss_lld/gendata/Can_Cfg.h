...
#define CAN_USE_DUMMY_STATEMENT STD_OFF /* /MICROSAR/vSet/vSetGeneral/vSetDummyStatementKind */
#endif
...
#endif
#ifndef CAN_PROCESSOR_TC377T
#define CAN_PROCESSOR_TC377T
#endif
#ifndef CAN_COMP_GCCHIGHTEC
#define CAN_COMP_GCCHIGHTEC
#endif
...
#if !defined( C_PROCESSOR_TC3XX_TT )
# define C_PROCESSOR_TC3XX_TT
#endif
#if !defined( V_PROCESSOR_TC3XX_TT )
# define V_PROCESSOR_TC3XX_TT
#endif

#if !defined( C_COMP_GNU_TC3XX_MCAN )
#define C_COMP_GNU_TC3XX_MCAN
#endif
#if !defined( V_COMP_GNU )
# define V_COMP_GNU
#endif
#if !defined( V_COMP_GNU_TC3XX )
# define V_COMP_GNU_TC3XX
#endif
...
#define CAN_GEN_Mpc5700McanAsr_VERSION              0x0504u
...
#define CAN_OS_TICK2MS(tick)     OS_TICKS2MS_OsCounter((tick))     /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
...
#define CAN_GENERIC_PRECOPY                  STD_ON
...
#define CanConf_CanController_CT_DemoFBL_Ford_CANFD_b8e23c38          0u
#define CanConf_CanController_CT_DemoFBL_Ford_CANFD_b8e23c38_MCAN0    1u
#define CanConf_CanController_CT_DemoFBL_Ford_CANFD_b8e23c38_MCAN01   2u
/**\} */
#define CanConf_CN_DemoFBL_Ford_CANFD_0f313723_Tx 0u
#define CanConf_CN_DemoFBL_Ford_CANFD_0f313723_Tx_MCAN0 2u
#define CanConf_CN_DemoFBL_Ford_CANFD_0f313723_Tx_MCAN01 4u
#define CanConf_CN_DemoFBL_Ford_CANFD_3332f69a_Rx 1u
#define CanConf_CN_DemoFBL_Ford_CANFD_3332f69a_Rx_MCAN0 3u
#define CanConf_CN_DemoFBL_Ford_CANFD_3332f69a_Rx_MCAN01 5u

#define CanConf_ControllerBaudrateConfig_CT_DemoFBL_Ford_CANFD_b8e23c38_CanControllerBaudrateConfig 0u
#define CanConf_ControllerBaudrateConfig_CT_DemoFBL_Ford_CANFD_b8e23c38_MCAN0_CanControllerBaudrateConfig 0u
#define CanConf_ControllerBaudrateConfig_CT_DemoFBL_Ford_CANFD_b8e23c38_MCAN01_CanControllerBaudrateConfig 0u

#define CanConf_MemorySection_RxBuffer_CT_DemoFBL_Ford_CANFD_b8e23c38 0u
#define CanConf_MemorySection_RxBuffer_CT_DemoFBL_Ford_CANFD_b8e23c38_MCAN0 3u
#define CanConf_MemorySection_RxBuffer_CT_DemoFBL_Ford_CANFD_b8e23c38_MCAN01 6u
#define CanConf_MemorySection_RxFifo_CT_DemoFBL_Ford_CANFD_b8e23c38 1u
#define CanConf_MemorySection_RxFifo_CT_DemoFBL_Ford_CANFD_b8e23c38_MCAN0 4u
#define CanConf_MemorySection_RxFifo_CT_DemoFBL_Ford_CANFD_b8e23c38_MCAN01 7u
#define CanConf_MemorySection_TxBuffer_CT_DemoFBL_Ford_CANFD_b8e23c38 2u
#define CanConf_MemorySection_TxBuffer_CT_DemoFBL_Ford_CANFD_b8e23c38_MCAN0 5u
#define CanConf_MemorySection_TxBuffer_CT_DemoFBL_Ford_CANFD_b8e23c38_MCAN01 8u
...
#define CAN_REGEXT_MCMCAN                  STD_ON
#define CAN_REGEXT_MCANSS                  STD_OFF
#define CAN_REGEXT_SICANFD                 STD_OFF
#define CAN_REGEXT_TTCANFD                 STD_OFF
#define CAN_REGEXT_MCANAS1                 STD_OFF
#define CAN_REGEXT_STMFDCAN                STD_OFF
#define CAN_REGEXT_TCC                     STD_OFF
#define CAN_REGEXT_TCC_PWD                 STD_OFF
#define CAN_SHM_DATAQOS                    STD_OFF
#define CAN_TRICORE_ERRATUM_AI_H001        STD_ON
#define CAN_PARITY_INTERRUPT               STD_OFF
...
#define CAN_ECC_INIT_SHM          STD_ON
#define CAN_UPDATE_BASE_ADDRESS   STD_OFF
...
#define kCanISRPrio_0                     0x00000000u
#define kCanISRPrio_1                     0x00000000u
#define kCanISRPrio_4                     0x00000000u
...
typedef TickType Can_ExternalTickType; /* PRQA S 1507 */ /* MD_Can_HL_MultipleTypeDeclaration */
#else
typedef uint32 Can_ExternalTickType; /* PRQA S 1507 */ /* MD_Can_HL_MultipleTypeDeclaration */
#endif
...
#define CAN_CANSUBSYSTEMBASEADR                                                                     STD_ON
...
#define CAN_SIZEOFCANSUBSYSTEMBASEADR                                                               STD_ON
...
#define CAN_CANSUBSYSTEMBASEADROFPCCONFIG                                                           STD_ON
...
#define CAN_SIZEOFCANSUBSYSTEMBASEADROFPCCONFIG                                                     STD_ON
...
#define CAN_MIN_NONFDOBJECTSPENDINGFLAGOFCONTROLLERDATA                                             0u
...
#define CAN_MAX_NONFDOBJECTSPENDINGFLAGOFCONTROLLERDATA                                             4294967295u
...
#define CAN_ISDEF_CANSUBSYSTEMBASEADR                                                               STD_OFF
...
#define CAN_ISDEF_CANSUBSYSTEMBASEADROFPCCONFIG                                                     STD_ON
...
#define CAN_EQ2_CANSUBSYSTEMBASEADR                                                                 
...
#define CAN_EQ2_CANSUBSYSTEMBASEADROFPCCONFIG                                                       Can_CanSubSystemBaseAdr
...
#define Can_GetCanSubSystemBaseAdrOfPCConfig()                                                      Can_CanSubSystemBaseAdr  /**< the pointer to Can_CanSubSystemBaseAdr */
...
#define Can_GetPlatformDll_GeneratorVersionOfPCConfig()                                             0x0504u
...
#define Can_GetSizeOfMailboxOfPCConfig()                                                            6u  /**< the number of accomplishable value elements in Can_Mailbox */
...
#define Can_GetSizeOfSIDFEOfPCConfig()                                                              3u  /**< the number of accomplishable value elements in Can_SIDFE */
...
#define Can_GetSizeOfShmElementSizeOfPCConfig()                                                     3u  /**< the number of accomplishable value elements in Can_ShmElementSize */
...
#define Can_GetCanSubSystemBaseAdr(Index)                                                           (Can_GetCanSubSystemBaseAdrOfPCConfig()[(Index)])
...
#define Can_GetSizeOfCanSubSystemBaseAdr()                                                          Can_GetSizeOfCanSubSystemBaseAdrOfPCConfig()
...
#define Can_HasCanSubSystemBaseAdr()                                                                (TRUE != FALSE)
...
#define Can_HasSizeOfCanSubSystemBaseAdr()                                                          (TRUE != FALSE)
...
#define Can_HasCanSubSystemBaseAdrOfPCConfig()                                                      (TRUE != FALSE)
...
#define Can_HasSizeOfCanSubSystemBaseAdrOfPCConfig()                                                (TRUE != FALSE)
...
/** 
  \defgroup  CanPCAddDataMacros  Can Add Data Macros (PRE_COMPILE)
  \brief  These macros can be used to add VAR data with numerical nature.
  \{
*/ 
#define Can_AddPduOfActiveSendObject(Index, Value)                                                  Can_SetPduOfActiveSendObject(Index, (Can_GetPduOfActiveSendObject(Index) + Value))
#define Can_AddStateOfActiveSendObject(Index, Value)                                                Can_SetStateOfActiveSendObject(Index, (Can_GetStateOfActiveSendObject(Index) + Value))
#define Can_AddBusOffNotificationOfControllerData(Index, Value)                                     Can_SetBusOffNotificationOfControllerData(Index, (Can_GetBusOffNotificationOfControllerData(Index) + Value))
#define Can_AddBusOffTransitionRequestOfControllerData(Index, Value)                                Can_SetBusOffTransitionRequestOfControllerData(Index, (Can_GetBusOffTransitionRequestOfControllerData(Index) + Value))
#define Can_AddCanInterruptCounterOfControllerData(Index, Value)                                    Can_SetCanInterruptCounterOfControllerData(Index, (Can_GetCanInterruptCounterOfControllerData(Index) + Value))
#define Can_AddCanInterruptOldStatusOfControllerData(Index, Value)                                  Can_SetCanInterruptOldStatusOfControllerData(Index, (Can_GetCanInterruptOldStatusOfControllerData(Index) + Value))
#define Can_AddIntEnableOfControllerData(Index, Value)                                              Can_SetIntEnableOfControllerData(Index, (Can_GetIntEnableOfControllerData(Index) + Value))
#define Can_AddLastInitObjectOfControllerData(Index, Value)                                         Can_SetLastInitObjectOfControllerData(Index, (Can_GetLastInitObjectOfControllerData(Index) + Value))
#define Can_AddLastStateOfControllerData(Index, Value)                                              Can_SetLastStateOfControllerData(Index, (Can_GetLastStateOfControllerData(Index) + Value))
#define Can_AddLogStatusOfControllerData(Index, Value)                                              Can_SetLogStatusOfControllerData(Index, (Can_GetLogStatusOfControllerData(Index) + Value))
#define Can_AddLoopTimeoutOfControllerData(Index, Value)                                            Can_SetLoopTimeoutOfControllerData(Index, (Can_GetLoopTimeoutOfControllerData(Index) + Value))
#define Can_AddModeTransitionRequestOfControllerData(Index, Value)                                  Can_SetModeTransitionRequestOfControllerData(Index, (Can_GetModeTransitionRequestOfControllerData(Index) + Value))
#define Can_AddNonFdObjectsPendingFlagOfControllerData(Index, Value)                                Can_SetNonFdObjectsPendingFlagOfControllerData(Index, (Can_GetNonFdObjectsPendingFlagOfControllerData(Index) + Value))
...
/** 
  \defgroup  CanPCSubstractDataMacros  Can Substract Data Macros (PRE_COMPILE)
  \brief  These macros can be used to substract VAR data with numerical nature.
  \{
*/ 
#define Can_SubPduOfActiveSendObject(Index, Value)                                                  Can_SetPduOfActiveSendObject(Index, (Can_GetPduOfActiveSendObject(Index) - Value))
#define Can_SubStateOfActiveSendObject(Index, Value)                                                Can_SetStateOfActiveSendObject(Index, (Can_GetStateOfActiveSendObject(Index) - Value))
#define Can_SubBusOffNotificationOfControllerData(Index, Value)                                     Can_SetBusOffNotificationOfControllerData(Index, (Can_GetBusOffNotificationOfControllerData(Index) - Value))
#define Can_SubBusOffTransitionRequestOfControllerData(Index, Value)                                Can_SetBusOffTransitionRequestOfControllerData(Index, (Can_GetBusOffTransitionRequestOfControllerData(Index) - Value))
#define Can_SubCanInterruptCounterOfControllerData(Index, Value)                                    Can_SetCanInterruptCounterOfControllerData(Index, (Can_GetCanInterruptCounterOfControllerData(Index) - Value))
#define Can_SubCanInterruptOldStatusOfControllerData(Index, Value)                                  Can_SetCanInterruptOldStatusOfControllerData(Index, (Can_GetCanInterruptOldStatusOfControllerData(Index) - Value))
#define Can_SubIntEnableOfControllerData(Index, Value)                                              Can_SetIntEnableOfControllerData(Index, (Can_GetIntEnableOfControllerData(Index) - Value))
#define Can_SubLastInitObjectOfControllerData(Index, Value)                                         Can_SetLastInitObjectOfControllerData(Index, (Can_GetLastInitObjectOfControllerData(Index) - Value))
#define Can_SubLastStateOfControllerData(Index, Value)                                              Can_SetLastStateOfControllerData(Index, (Can_GetLastStateOfControllerData(Index) - Value))
#define Can_SubLogStatusOfControllerData(Index, Value)                                              Can_SetLogStatusOfControllerData(Index, (Can_GetLogStatusOfControllerData(Index) - Value))
#define Can_SubLoopTimeoutOfControllerData(Index, Value)                                            Can_SetLoopTimeoutOfControllerData(Index, (Can_GetLoopTimeoutOfControllerData(Index) - Value))
#define Can_SubModeTransitionRequestOfControllerData(Index, Value)                                  Can_SetModeTransitionRequestOfControllerData(Index, (Can_GetModeTransitionRequestOfControllerData(Index) - Value))
#define Can_SubNonFdObjectsPendingFlagOfControllerData(Index, Value)                                Can_SetNonFdObjectsPendingFlagOfControllerData(Index, (Can_GetNonFdObjectsPendingFlagOfControllerData(Index) - Value))
...
/**   \brief  type used to iterate Can_CanSubSystemBaseAdr */
...
/**   \brief  value based type definition for Can_CanSubSystemBaseAdr */
...
typedef uint32 Can_INT_RoutingGroupType;
...
/**   \brief  value based type definition for Can_SizeOfCanSubSystemBaseAdr */
 ...
 * (!((self.MailboxTxBasicLengthOfControllerConfig != 0u)) || (self.MailboxTxBasicStartIdxOfControllerConfig < Can_GetSizeOfMailbox())) &&
 * (!((self.MailboxTxBasicLengthOfControllerConfig != 0u)) || (self.MailboxTxBasicEndIdxOfControllerConfig < Can_GetSizeOfMailbox())) &&
 * (!((self.MailboxRxBasicLengthOfControllerConfig != 0u)) || (self.MailboxRxBasicStartIdxOfControllerConfig < Can_GetSizeOfMailbox())) &&
 * (!((self.MailboxRxBasicLengthOfControllerConfig != 0u)) || (self.MailboxRxBasicEndIdxOfControllerConfig < Can_GetSizeOfMailbox()))
 * } */
...
/*! \spec weak type invariant () { 
 * (self.ControllerConfigIdxOfMailbox < Can_GetSizeOfControllerConfig())
 * } */
...
/*! \spec weak type invariant () { 
 * (!((self.SIDFEStartIdxOfSIDFC != CAN_NO_SIDFESTARTIDXOFSIDFC)) || (self.SIDFEStartIdxOfSIDFC < Can_GetSizeOfSIDFE())) &&
 * (!((self.SIDFEStartIdxOfSIDFC != CAN_NO_SIDFESTARTIDXOFSIDFC)) || (self.SIDFEEndIdxOfSIDFC < Can_GetSizeOfSIDFE()))
 * } */
...
/**   \brief  type used to point to Can_CanSubSystemBaseAdr */
typedef P2CONST(Can_CanSubSystemBaseAdrType, TYPEDEF, CAN_CONST) Can_CanSubSystemBaseAdrPtrType;
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(Can_MailboxType, CAN_CONST) Can_Mailbox[6];
#define CAN_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(Can_SIDFEType, CAN_CONST) Can_SIDFE[3];
#define CAN_STOP_SEC_CONST_32BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(Can_ShmElementSizeType, CAN_CONST) Can_ShmElementSize[3];
#define CAN_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
