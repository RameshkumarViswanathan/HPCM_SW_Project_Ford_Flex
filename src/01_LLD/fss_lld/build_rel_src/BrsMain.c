...
#  if defined (BRS_ENABLE_OS_INTERRUPT_ONLY)
  /* OS is configured for UseCase Interrupt Only (/MICROSAR/Os/OsOS/OsUseCase) */
  //Os_InitInterruptOnly();  /*TODO: Techm :Commented for RTOS */
#  else
  //Os_InitMemory();   /*TODO: Techm :Commented for RTOS */
  //Os_Init();         /*TODO: Techm :Commented for RTOS */
#  endif
# endif
