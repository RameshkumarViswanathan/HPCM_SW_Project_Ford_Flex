...
FUNC(PduR_PBConfigIdType, PDUR_CODE) PduR_GetConfigurationId(void)
{
  ...
  else if(!PduR_IsInitializedRam(0u, PduR_GetMemIdx()))
  {
    errorId = PDUR_E_INVALID_REQUEST;
  }
  else
...
#  endif
  ...
  else if(!PduR_IsInitializedRam(PduR_GetInitializedIdxOfDestApplicationManagerRom(PduR_GetDestApplicationManagerRomIdxOfRmSrcRom(PduR_GetRmSrcRomIdxOfTx2Lo(id))), PduR_GetInitializedPartitionIdxOfDestApplicationManagerRom(PduR_GetDestApplicationManagerRomIdxOfRmSrcRom(PduR_GetRmSrcRomIdxOfTx2Lo(id)))))
  {
    errorId = PDUR_E_INVALID_REQUEST;
  }
  else
...
#  endif
  ...
  else if(!PduR_IsInitializedRam(PduR_GetInitializedIdxOfDestApplicationManagerRom(PduR_GetDestApplicationManagerRomIdxOfRmSrcRom(PduR_GetRmSrcRomIdxOfRxIf2Dest(RxPduId))), PduR_GetInitializedPartitionIdxOfDestApplicationManagerRom(PduR_GetDestApplicationManagerRomIdxOfRmSrcRom(PduR_GetRmSrcRomIdxOfRxIf2Dest(RxPduId)))))
  {
    errorId = PDUR_E_INVALID_REQUEST;
  }
  else
...
#  endif
  ...
  else if(!PduR_IsInitializedRam(PduR_GetInitializedIdxOfDestApplicationManagerRom(PduR_GetDestApplicationManagerRomIdxOfRmGDestRom(PduR_GetRmGDestRomIdxOfTxIf2Up(TxPduId))), PduR_GetInitializedPartitionIdxOfDestApplicationManagerRom(PduR_GetDestApplicationManagerRomIdxOfRmGDestRom(PduR_GetRmGDestRomIdxOfTxIf2Up(TxPduId)))))
  {
    errorId = PDUR_E_INVALID_REQUEST;
  }
  else
 ...
 *
 *********************************************************************************************************************/
/* PRQA S 6080, 6010, 6030 1 */ /* MD_MSR_STMIF, MD_MSR_STPTH, MD_MSR_STCYC */
...
#  endif
  ...
  else if(!PduR_IsInitializedRam(PduR_GetInitializedIdxOfDestApplicationManagerRom(PduR_GetDestApplicationManagerRomIdxOfRmSrcRom(PduR_GetRmSrcRomIdxOfRxTp2Dest(id))), PduR_GetInitializedPartitionIdxOfDestApplicationManagerRom(PduR_GetDestApplicationManagerRomIdxOfRmSrcRom(PduR_GetRmSrcRomIdxOfRxTp2Dest(id)))))
  {
    errorId = PDUR_E_INVALID_REQUEST;
  }
  else
...
#  if (PDUR_EXISTS_TP_BUFFERED_ROUTINGTYPEOFRMDESTROM == STD_ON)      
      for(; rmDestRomIdx < PduR_GetRmDestRomEndIdxOfRmSrcRom(rmSrcRomIdx); rmDestRomIdx++)  /* FETA_PDUR_01 */
      {
...
#  endif
  ...
  else if(!PduR_IsInitializedRam(PduR_GetInitializedIdxOfDestApplicationManagerRom(PduR_GetDestApplicationManagerRomIdxOfRmGDestRom(PduR_GetRmGDestRomIdxOfTxTp2Src(id))), PduR_GetInitializedPartitionIdxOfDestApplicationManagerRom(PduR_GetDestApplicationManagerRomIdxOfRmGDestRom(PduR_GetRmGDestRomIdxOfTxTp2Src(id)))))
  {
    errorId = PDUR_E_INVALID_REQUEST;
  }
  else
...
#  endif
  ...
  else if(!PduR_IsInitializedRam(PduR_GetInitializedIdxOfDestApplicationManagerRom(PduR_GetDestApplicationManagerRomIdxOfRmGDestRom(PduR_GetRmGDestRomIdxOfRmDestRom(PduR_GetRmDestRomIdxOfRxTp2Src(id)))), PduR_GetInitializedPartitionIdxOfDestApplicationManagerRom(PduR_GetDestApplicationManagerRomIdxOfRmGDestRom(PduR_GetRmGDestRomIdxOfRmDestRom(PduR_GetRmDestRomIdxOfRxTp2Src(id))))))
  {
    errorId = PDUR_E_INVALID_REQUEST;
  }
  else
...
PDUR_LOCAL_INLINE FUNC(Std_ReturnType, PDUR_CODE) PduR_Rm_CancelTransmit_MultiDest(PduR_RmSrcRomIterType rmSrcIdx)
{
  ...
  for(rmDestIdx = PduR_GetRmDestRomStartIdxOfRmSrcRom(rmSrcIdx); rmDestIdx < PduR_GetRmDestRomEndIdxOfRmSrcRom(rmSrcIdx); rmDestIdx++)  /* FETA_PDUR_01 */
  {
# if (PDUR_RPGROM == STD_ON)
...
PDUR_LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_CreatePartitionLookupTable(void)
{
  ...
  for (osApplicationId = 0u; osApplicationId < PduR_GetSizeOfPartitionLookupTableRam(); osApplicationId++)
  {
    ...
    for (partitionIdentifiersIdx = 0u; partitionIdentifiersIdx < PduR_GetSizeOfPartitionIdentifiers(); partitionIdentifiersIdx++)  /* COV_PDUR_RUNS_ON_ALL_APPLICATIONS */
    {
      if (((PduR_PartitionLookupTableRamIterType) PduR_GetPartitionSNVOfPartitionIdentifiers(partitionIdentifiersIdx)) == osApplicationId)
      {
        PduR_SetOsApplicationToPduROfPartitionLookupTableRam(osApplicationId, PduR_GetPCPartitionConfigIdxOfPartitionIdentifiers(partitionIdentifiersIdx)); /* SBSW_PDUR_CSL01 */
        break;
      }
    }
  }
...
#else
  return PduR_PartitionIndexOfCSLForCommonSharedMemory;
#endif
}
...
# endif
...
#endif
  {
    ...
    for (partitionIdentifiersIdx = 0u; partitionIdentifiersIdx < PduR_GetSizeOfPartitionIdentifiers(); partitionIdentifiersIdx++)
    {
      PduR_SetInitializedRam(0u, FALSE, PduR_GetPCPartitionConfigIdxOfPartitionIdentifiers(partitionIdentifiersIdx)); /* SBSW_PDUR_CSL03 */
    }
...
PDUR_LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_InitMemorySection(PduR_MemIdxType memIdx)
{
  ...
  PduR_SetInitializedRam(0u, TRUE, memIdx);        /* SBSW_PDUR_CSL_VAR_ACCESS */
...
# endif
  {
    if(PduR_IsPreInitialized() && PduR_IsInitializedRam(0u, PduR_GetMemIdx())) /* PRQA S 3415 */ /* MD_PduR_3415 */
    {
...
#if(PDUR_RMGDESTNTO1INFORAMIDXOFRMGDESTROM == STD_ON)
  PduR_RmGDestNto1InfoRamPartitionIdxOfRmGDestRomType memIdx = PduR_GetRmGDestNto1InfoRamPartitionIdxOfRmGDestRom(rmGDestRomIdx);
  PDUR_DUMMY_STATEMENT(memIdx);       /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */ /* lint -e{438} */
...
# endif
  {
    PduR_RpgRomPartitionIdxOfRpgExtIdRomType memIdx = PduR_GetRpgRomPartitionIdxOfRpgExtIdRom(id);
...
# endif
# if ((PDUR_EXISTS_IF_UNBUFFERED_TX_API_FWD_ROUTINGTYPEOFRMDESTROM == STD_ON) && (PDUR_RMGDESTNTO1INFORAMIDXOFRMGDESTROM == STD_ON))
          if(PDUR_IF_UNBUFFERED_TX_API_FWD_ROUTINGTYPEOFRMDESTROM == PduR_GetRoutingTypeOfRmDestRom(rmDestRomIdx))
          {
            PduR_Rm_MultipleSourceHandler_Reset(PduR_GetRmGDestRomIdxOfRmDestRom(rmDestRomIdx));
          }
# endif
# if (PDUR_EXISTS_TP_BUFFERED_ROUTINGTYPEOFRMDESTROM == STD_ON)
...
FUNC(void, PDUR_CODE) PduR_EvC_WriteDeferredEventCache(PduR_RmDestRomIterType rmDest, PduR_RmGDestRomIdxOfRmDestRomType rmGDest)
{
  ...
  (void) PduR_EvC_Put(PduR_GetDeferredEventCacheRomIdxOfSrcApplicationRom(dest2srcApplicationRomIdx), rmGDest, PduR_GetDeferredEventCacheRomPartitionIdxOfSrcApplicationRom(dest2srcApplicationRomIdx));
}
#endif
...
PDUR_LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_EvC_ReadAndProcessEvCOfDestApplication(PduR_DestApplicationManagerRomIterType destApplicationManagerRomIdx)
{
  ...
  for(srcApplicationRomIdx = PduR_GetSrcApplicationRomStartIdxOfDestApplicationManagerRom(destApplicationManagerRomIdx); srcApplicationRomIdx < PduR_GetSrcApplicationRomEndIdxOfDestApplicationManagerRom(destApplicationManagerRomIdx); srcApplicationRomIdx++)  /* FETA_PDUR_01 */
  {
    ...
    while(PduR_EvC_Get(deferredEventCacheRomIdx, &rmGDestRomIdx, memIdx) == E_OK)       /* SBSW_PDUR_STACK_VARIABLE */ /* FETA_PDUR_02 */
    {
...
/* COV_JUSTIFICATION_BEGIN
  ...
  \ID COV_PDUR_ROBUSTNESS_FLUSH_INVALID_QUEUE
    \ACCEPT X
    \REASON This check increases robustness. Under normal circumstances functions regarding this functionality are never executed. Function behaviour was validated by review. 
