...
#if ( WDG_17_SCU_SW_MINOR_VERSION != 20U )
...
**                                                                            **
** Return value:     None                                                     **
** Description :    Function to report DEMs                                   **
**                                                                            **
**[/cover]                                                                    **
*******************************************************************************/
...
const Dem_EventStatusType EventStatus)
{
  ...
  /* Report DEM for AS422 by calling Dem_ReportErrorStatus */
  Dem_ReportErrorStatus(EventId,EventStatus);
  #endif
  #if (MCAL_AR_VERSION == MCAL_AR_440)  
  /*Report DEM for AS440 by calling Dem_SetEventStatus */
