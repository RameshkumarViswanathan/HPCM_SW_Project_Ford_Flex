...
**  VERSION   : 14.0.0                                                        **
**                                                                            **
**  DATE, TIME: 2023-11-22, 11:35:49          !!!IGNORE-LINE!!!               **
**                                                                            **
...
static const Port_n_ConfigType Port_kConfiguration[] =
{
  /*                              Port0                       */
  {
    ...
    Portx_lPdrConfig1(
      (PORT_INPUT_LEVEL_TTL_5_0V|PORT_PIN_PAD_STRENGTH_DEFAULT),/*Pin0*/
      (PORT_PIN_PAD_LEVEL_DEFAULT|SLOW_PORT_PIN_DEFAULT_DRIVER),/*Pin1*/
      (PORT_INPUT_LEVEL_TTL_5_0V|PORT_PIN_PAD_STRENGTH_DEFAULT),/*Pin2*/
      (PORT_PIN_PAD_LEVEL_DEFAULT|SLOW_PORT_PIN_DEFAULT_DRIVER),/*Pin3*/
      (PORT_INPUT_LEVEL_TTL_5_0V|PORT_PIN_PAD_STRENGTH_DEFAULT),/*Pin4*/
      (PORT_PIN_PAD_LEVEL_DEFAULT|SLOW_PORT_PIN_DEFAULT_DRIVER),/*Pin5*/
      (PORT_INPUT_LEVEL_TTL_5_0V|PORT_PIN_PAD_STRENGTH_DEFAULT),/*Pin6*/
      (PORT_INPUT_LEVEL_TTL_5_0V|PORT_PIN_PAD_STRENGTH_DEFAULT)/*Pin7*/
                  ),
    /* Port pins drive strength2 configuration */
    Portx_lPdrConfig2(
      (PORT_INPUT_LEVEL_TTL_5_0V|PORT_PIN_PAD_STRENGTH_DEFAULT),/*Pin8*/
      (PORT_INPUT_LEVEL_TTL_5_0V|PORT_PIN_PAD_STRENGTH_DEFAULT),/*Pin9*/
      (PORT_INPUT_LEVEL_TTL_5_0V|PORT_PIN_PAD_STRENGTH_DEFAULT),/*Pin10*/
      (PORT_INPUT_LEVEL_TTL_5_0V|PORT_PIN_PAD_STRENGTH_DEFAULT),/*Pin11*/
      (PORT_INPUT_LEVEL_TTL_5_0V|PORT_PIN_PAD_STRENGTH_DEFAULT),/*Pin12*/
  ...
  /*                              Port1                       */
  {
    ...
    Portx_lPdrConfig1(
      ...
      (PORT_INPUT_LEVEL_TTL_5_0V|PORT_PIN_PAD_STRENGTH_DEFAULT),/*Pin5*/
  ...
  /*                              Port10                       */
  {
    ...
    /* Port pins drive strength1 configuration */
    Portx_lPdrConfig1(
      (PORT_PIN_PAD_LEVEL_DEFAULT|SLOW_PORT_PIN_MEDIUM_DRIVER_SHARP_EDGE),/*Pin0*/
      (PORT_INPUT_LEVEL_CMOS_AUTOMOTIVE|PORT_PIN_PAD_STRENGTH_DEFAULT),/*Pin1*/
      (PORT_PIN_PAD_LEVEL_DEFAULT|FAST_PORT_PIN_STRONG_DRIVER_SHARP_EDGE),/*Pin2*/
      (PORT_PIN_PAD_LEVEL_DEFAULT|FAST_PORT_PIN_STRONG_DRIVER_SHARP_EDGE),/*Pin3*/
      (PORT_PIN_PAD_LEVEL_DEFAULT|FAST_PORT_PIN_DEFAULT_DRIVER),/*Pin4*/
      (PORT_PIN_PAD_LEVEL_DEFAULT|SLOW_PORT_PIN_DEFAULT_DRIVER),/*Pin5*/
      (PORT_PIN_PAD_LEVEL_DEFAULT|SLOW_PORT_PIN_MEDIUM_DRIVER_SHARP_EDGE),/*Pin6*/
      (PORT_INPUT_LEVEL_CMOS_AUTOMOTIVE|PORT_PIN_PAD_STRENGTH_DEFAULT)/*Pin7*/
                  ),
    /* Port pins drive strength2 configuration */
    Portx_lPdrConfig2(
      (PORT_PIN_PAD_LEVEL_DEFAULT|SLOW_PORT_PIN_MEDIUM_DRIVER_SHARP_EDGE),/*Pin8*/
      (PORT_PIN_PAD_DEFAULT),/*Pin9*/
      (PORT_PIN_PAD_DEFAULT),/*Pin10*/
      (PORT_PIN_PAD_DEFAULT),/*Pin11*/
      (PORT_PIN_PAD_DEFAULT),/*Pin12*/
  ...
  /*                              Port11                       */
  {
    ...
    control bit field for each port pin located  as register bytes. Hence
    typecasting is done for each port pin to uint8*/
    ((uint8)PORT_PIN_IN | PORT_PIN_IN_NO_PULL | PORT_PIN_MODE_GPIO),/*Pin 14*/
    /* MISRA2012_RULE_10_3_JUSTIFICATION: The port IOCR registers has the
    control bit field for each port pin located  as register bytes. Hence
    typecasting is done for each port pin to uint8*/
    ...
    Portx_lPdrConfig1(
      (PORT_INPUT_LEVEL_TTL_5_0V|PORT_PIN_PAD_STRENGTH_DEFAULT),/*Pin0*/
      (PORT_INPUT_LEVEL_TTL_5_0V|PORT_PIN_PAD_STRENGTH_DEFAULT),/*Pin1*/
      (PORT_INPUT_LEVEL_TTL_5_0V|PORT_PIN_PAD_STRENGTH_DEFAULT),/*Pin2*/
      (PORT_INPUT_LEVEL_TTL_5_0V|PORT_PIN_PAD_STRENGTH_DEFAULT),/*Pin3*/
      (PORT_INPUT_LEVEL_TTL_5_0V|PORT_PIN_PAD_STRENGTH_DEFAULT),/*Pin4*/
      (PORT_INPUT_LEVEL_TTL_5_0V|PORT_PIN_PAD_STRENGTH_DEFAULT),/*Pin5*/
      (PORT_INPUT_LEVEL_TTL_5_0V|PORT_PIN_PAD_STRENGTH_DEFAULT),/*Pin6*/
      (PORT_INPUT_LEVEL_TTL_5_0V|PORT_PIN_PAD_STRENGTH_DEFAULT)/*Pin7*/
    ...
    Portx_lPdrConfig2(
      (PORT_INPUT_LEVEL_TTL_5_0V|PORT_PIN_PAD_STRENGTH_DEFAULT),/*Pin8*/
      (PORT_PIN_PAD_LEVEL_DEFAULT|FAST_PORT_PIN_STRONG_DRIVER_SHARP_EDGE),/*Pin9*/
      (PORT_PIN_PAD_LEVEL_DEFAULT|FAST_PORT_PIN_STRONG_DRIVER_SHARP_EDGE),/*Pin10*/
      (PORT_PIN_PAD_LEVEL_DEFAULT|FAST_PORT_PIN_STRONG_DRIVER_SHARP_EDGE),/*Pin11*/
      (PORT_INPUT_LEVEL_TTL_5_0V|PORT_PIN_PAD_STRENGTH_DEFAULT),/*Pin12*/
      (PORT_INPUT_LEVEL_TTL_5_0V|PORT_PIN_PAD_STRENGTH_DEFAULT),/*Pin13*/
      (PORT_INPUT_LEVEL_TTL_5_0V|PORT_PIN_PAD_STRENGTH_DEFAULT),/*Pin14*/
      (PORT_INPUT_LEVEL_TTL_5_0V|PORT_PIN_PAD_STRENGTH_DEFAULT)/*Pin15*/
                  ),
    {/* Port pin run time mode changeable or not configuration */
    PORT_PIN_MODE_NOT_CHANGEABLE,/* Pin 0 */
    PORT_PIN_MODE_NOT_CHANGEABLE,/* Pin 1 */
  ...
  /*                              Port14                       */
  {
    ...
    Portx_lPdrConfig1(
      (PORT_PIN_PAD_LEVEL_DEFAULT|FAST_PORT_PIN_DEFAULT_DRIVER),/*Pin0*/
      (PORT_INPUT_LEVEL_TTL_5_0V|PORT_PIN_PAD_STRENGTH_DEFAULT),/*Pin1*/
      (PORT_PIN_PAD_LEVEL_DEFAULT|SLOW_PORT_PIN_MEDIUM_DRIVER_SHARP_EDGE),/*Pin2*/
      (PORT_PIN_PAD_LEVEL_DEFAULT|SLOW_PORT_PIN_DEFAULT_DRIVER),/*Pin3*/
      (PORT_INPUT_LEVEL_TTL_5_0V|PORT_PIN_PAD_STRENGTH_DEFAULT),/*Pin4*/
      (PORT_INPUT_LEVEL_TTL_5_0V|PORT_PIN_PAD_STRENGTH_DEFAULT),/*Pin5*/
      (PORT_INPUT_LEVEL_TTL_5_0V|PORT_PIN_PAD_STRENGTH_DEFAULT),/*Pin6*/
  ...
  /*                              Port15                       */
  {
    ...
    Portx_lPdrConfig1(
      ...
      (PORT_INPUT_LEVEL_TTL_5_0V|PORT_PIN_PAD_STRENGTH_DEFAULT),/*Pin4*/
      (PORT_INPUT_LEVEL_TTL_5_0V|PORT_PIN_PAD_STRENGTH_DEFAULT),/*Pin5*/
      (PORT_PIN_PAD_LEVEL_DEFAULT|FAST_PORT_PIN_STRONG_DRIVER_SHARP_EDGE),/*Pin6*/
      (PORT_INPUT_LEVEL_CMOS_AUTOMOTIVE|PORT_PIN_PAD_STRENGTH_DEFAULT)/*Pin7*/
                  ),
    /* Port pins drive strength2 configuration */
    Portx_lPdrConfig2(
      (PORT_PIN_PAD_LEVEL_DEFAULT|FAST_PORT_PIN_STRONG_DRIVER_SHARP_EDGE),/*Pin8*/
      (PORT_PIN_PAD_DEFAULT),/*Pin9*/
      (PORT_PIN_PAD_DEFAULT),/*Pin10*/
      (PORT_PIN_PAD_DEFAULT),/*Pin11*/
      (PORT_PIN_PAD_DEFAULT),/*Pin12*/
  ...
  /*                              Port20                       */
  {
    ...
    control bit field for each port pin located  as register bytes. Hence
    typecasting is done for each port pin to uint8*/
    ((uint8)PORT_PIN_OUT | PORT_PIN_OUT_OPENDRAIN | PORT_PIN_MODE_ALT3),/*Pin 10*/
    /* MISRA2012_RULE_10_3_JUSTIFICATION: The port IOCR registers has the
    control bit field for each port pin located  as register bytes. Hence
    typecasting is done for each port pin to uint8*/
  ...
  /*                              Port33                       */
  {
    ...
    control bit field for each port pin located  as register bytes. Hence
    typecasting is done for each port pin to uint8*/
    ((uint8)PORT_PIN_OUT | PORT_PIN_OUT_PUSHPULL | PORT_PIN_MODE_ALT3),/*Pin 12*/
    /* MISRA2012_RULE_10_3_JUSTIFICATION: The port IOCR registers has the
    control bit field for each port pin located  as register bytes. Hence
    typecasting is done for each port pin to uint8*/
    ...
    Portx_lPdrConfig1(
      ...
      (PORT_PIN_PAD_LEVEL_DEFAULT|SLOW_PORT_PIN_MEDIUM_DRIVER_SHARP_EDGE),/*Pin1*/
      (PORT_PIN_PAD_LEVEL_DEFAULT|SLOW_PORT_PIN_DEFAULT_DRIVER),/*Pin2*/
      (PORT_PIN_PAD_LEVEL_DEFAULT|SLOW_PORT_PIN_MEDIUM_DRIVER_SHARP_EDGE),/*Pin3*/
      (PORT_PIN_PAD_LEVEL_DEFAULT|SLOW_PORT_PIN_DEFAULT_DRIVER),/*Pin4*/
      (PORT_PIN_PAD_LEVEL_DEFAULT|SLOW_PORT_PIN_MEDIUM_DRIVER_SHARP_EDGE),/*Pin5*/
      (PORT_PIN_PAD_LEVEL_DEFAULT|SLOW_PORT_PIN_DEFAULT_DRIVER),/*Pin6*/
      (PORT_INPUT_LEVEL_TTL_5_0V|PORT_PIN_PAD_STRENGTH_DEFAULT)/*Pin7*/
                  ),
    /* Port pins drive strength2 configuration */
    Portx_lPdrConfig2(
      ...
      (PORT_INPUT_LEVEL_TTL_5_0V|PORT_PIN_PAD_STRENGTH_DEFAULT),/*Pin10*/
      (PORT_PIN_PAD_LEVEL_DEFAULT|FAST_PORT_PIN_STRONG_DRIVER_SHARP_EDGE),/*Pin11*/
      (PORT_PIN_PAD_LEVEL_DEFAULT|FAST_PORT_PIN_STRONG_DRIVER_SHARP_EDGE),/*Pin12*/
      (PORT_INPUT_LEVEL_TTL_5_0V|PORT_PIN_PAD_STRENGTH_DEFAULT),/*Pin13*/
      (PORT_INPUT_LEVEL_TTL_5_0V|PORT_PIN_PAD_STRENGTH_DEFAULT),/*Pin14*/
      (PORT_INPUT_LEVEL_TTL_5_0V|PORT_PIN_PAD_STRENGTH_DEFAULT)/*Pin15*/
                  ),
...
static const uint32 Port_DiscSet[] =
{
  ...
  Port_lDiscSet(
    ...
    PORT_PIN_ANALOG_INPUT_ENABLE,/* Pin 12 */
