...
#define BRS_FBL_INSTANCE_LLD //TechM: remove this if don't want presence pattern in hex file 

#if defined (BRS_FBL_INSTANCE_LLD)
#pragma section ".rodata.Appl_RomFblPP1_Section" a // TechM to have presence pattern in ROM
const uint8 FblPresencePatternArray[4] = {0x73u, 0x6Au, 0x29u, 0x3Eu};
#pragma section 

#pragma section ".rodata.Appl_RomFblPP2_Section" a // TechM to have presence pattern in ROM
