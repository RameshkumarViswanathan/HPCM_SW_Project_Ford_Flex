...
#include "Dem.h"
#endif
#if ((ADC_DEV_ERROR_DETECT == STD_ON) || (ADC_RUNTIME_ERROR_DETECT == STD_ON))
#include "Det.h"
#endif
...
#if ((ADC_CLC_FAILURE_DEM_NOTIF == ADC_ENABLE_DEM_REPORT)||\
   (ADC_CONV_STOP_TIME_DEM_NOTIF == ADC_ENABLE_DEM_REPORT))
/*[cover parentID={D9C75887-D938-4689-BDD4-B8BD24AB1711}] Version Check for DEM
[/cover]*/
  #ifndef DEM_AR_RELEASE_MAJOR_VERSION
    #error "DEM_AR_RELEASE_MAJOR_VERSION is not defined."
  #endif

  #if ( DEM_AR_RELEASE_MAJOR_VERSION != MCAL_AR_RELEASE_MAJOR_VERSION)
    ...
    if (MCAL_MASTER_COREID == lCoreId)
    {
          ...
          (uint32)0U)
      {
        /* [cover parentID={9AE22EA1-E7A0-4bf4-8070-4463F89E2F22}]
           DEM NOTIFY is ON or SAFETY is ON [/cover] */
        #if (ADC_CLC_FAILURE_DEM_NOTIF == ADC_ENABLE_DEM_REPORT)
        /* [cover parentID={3ED1D538-A90C-47be-937A-E329380EACC9}]
        Report DEM PASS when CLC enabling is successful [/cover] */
      ...
      else
      {
        ...
        Report DEM FAIL when CLC enabling fails [/cover] */
...
static void Adc_lReportRuntimeDetError(const uint8 ApiId, const uint8 ErrorId)
{
  ...
  (void)Det_ReportRuntimeError(ADC_MODULE_ID, ADC_MODULE_INSTANCE,
                               ApiId, ErrorId);
...
**                    )                                                       **
**                                                                            **
** Description      : This function reports the DEM status                    **
**                                                                            **
** Service ID       : None                                                    **
**                                                                            **
** Sync/Async       : Asynchronous                                            **
