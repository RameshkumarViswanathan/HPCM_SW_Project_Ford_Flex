...
**  VERSION   : 9.0.0                                                         **
**                                                                            **
**  DATE, TIME: 2023-10-16, 19:37:39              !!!IGNORE-LINE!!!           **
**                                                                            **
...
#define SMU_SW_MINOR_VERSION             (0U)
#define SMU_SW_PATCH_VERSION             (2U)
...
#define SMU_ALARMEXECSTATUS_VALID        (0xa3f0a3fU)
...
#define SMU_E_ACTIVATE_RUN_STATE_FAILURE          (SMU_DISABLE_DEM_REPORT)
...
#define SMU_E_CLEAR_ALARM_STATUS_FAILURE          (SMU_DISABLE_DEM_REPORT)
...
#define SMU_E_RELEASE_FSP_FAILURE                 (SMU_DISABLE_DEM_REPORT)
...
#define SMU_E_CORE_ALIVE_FAILURE                  (SMU_DISABLE_DEM_REPORT)
...
#define SMU_E_RT_STOP_FAILURE                     (SMU_DISABLE_DEM_REPORT)
...
#define SMU_E_ACTIVATE_PES_FAILURE                (SMU_DISABLE_DEM_REPORT)
...
#define SMU_E_ACTIVATE_FSP_FAILURE                (SMU_DISABLE_DEM_REPORT)
...
#define SMU_E_SET_ALARM_STATUS_FAILURE            (SMU_DISABLE_DEM_REPORT)
...
#define SMU_E_SFF_TEST_FAILURE                    (SMU_DISABLE_DEM_REPORT)
