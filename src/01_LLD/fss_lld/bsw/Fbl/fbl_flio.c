 ...
 *  02.12.02   2023-06-16  vismix  ESCAN00113927      Wrong swap address used
 *  02.12.03   2023-06-29  vismix  ESCAN00114766      Compiler error: Missing functions in case ECC safe read is disabled
 **********************************************************************************************************************/
 ...
 **********************************************************************************************************************/
    ...
    ( FBLWRAPPERFLASH_TRICOREAURIXHIS_RELEASE_VERSION != 0x03u )
...
static V_MEMROM0 V_MEMROM1 tFlashSwapDevLookUpTbl V_MEMROM2 flashDevLookUpTbl[] =
{
   ...
   {0x0F00F0C0uL, 0x07006080uL, &flashSwap4MBCfg},    /* FSIZE = 0x7 =  4MB, CHID = 0x6 = TC36xx, CHTEC = 0x2 = SAx-TC3xx */
   {0x0F00F0C0uL, 0x07005080uL, &flashSwap4MBCfg},    /* FSIZE = 0x7 =  4MB, CHID = 0x5 = TC35xx, CHTEC = 0x2 = SAx-TC3xx */
};
# endif /* FLASH_ENABLE_TRICORE_SWAP */
