...
# include "Os.h" //fix rtos conflict
#endif
...
#if (CAN_COREVERSION           != 0x1002u) /* \trace SPEC-1699, SPEC-3837 */
 ...
 *
 */
ISR( CanIsr_12 )    /* PRQA S 3408 */ /* ISR prototypes must be provided by OSEK header file */
#   else
#    if defined( C_ENABLE_OSEK_OS ) && defined (osdIsrCanIsr_12Cat) /* COV_CAN_OSCAT_CONFIG_CHECK */
 ...
 *
 */
V_DEF_FUNC(V_NONE, void __interrupt(kCanISRPrio_12) __vector_table(Can_GetkCanUsedCore()), CODE) CanIsr_12( void ) /* PRQA S 3408 */ /* MD_Can_ExternalScope */
#     else
#      if defined(V_COMP_GHS) && !defined(MISRA_CHECK) /* COV_CAN_COMPILER_SWITCH */
#       pragma ghs interrupt
#      endif
...
#   else
    CanInterrupt(kCanPhysToLogChannelIndex_12);                      /* call Interrupthandling with logical channel */
#   endif
 ...
 *
 */
ISR( CanIsr_13 )    /* PRQA S 3408 */ /* ISR prototypes must be provided by OSEK header file */
#   else
#    if defined( C_ENABLE_OSEK_OS ) && defined (osdIsrCanIsr_13Cat) /* COV_CAN_OSCAT_CONFIG_CHECK */
 ...
 *
 */
V_DEF_FUNC(V_NONE, void __interrupt(kCanISRPrio_13) __vector_table(Can_GetkCanUsedCore()), CODE) CanIsr_13( void ) /* PRQA S 3408 */ /* MD_Can_ExternalScope */
#     else
#      if defined(V_COMP_GHS) && !defined(MISRA_CHECK) /* COV_CAN_COMPILER_SWITCH */
#       pragma ghs interrupt
#      endif
...
#   else
    CanInterrupt(kCanPhysToLogChannelIndex_13);                      /* call Interrupthandling with logical channel */
#   endif
 ...
 *
 */
ISR( CanIsr_14 )    /* PRQA S 3408 */ /* ISR prototypes must be provided by OSEK header file */
#   else
#    if defined( C_ENABLE_OSEK_OS ) && defined (osdIsrCanIsr_14Cat) /* COV_CAN_OSCAT_CONFIG_CHECK */
 ...
 *
 */
V_DEF_FUNC(V_NONE, void __interrupt(kCanISRPrio_14) __vector_table(Can_GetkCanUsedCore()), CODE) CanIsr_14( void ) /* PRQA S 3408 */ /* MD_Can_ExternalScope */
#     else
#      if defined(V_COMP_GHS) && !defined(MISRA_CHECK) /* COV_CAN_COMPILER_SWITCH */
#       pragma ghs interrupt
#      endif
...
#   else
    CanInterrupt(kCanPhysToLogChannelIndex_14);                      /* call Interrupthandling with logical channel */
#   endif
 ...
 *
 */
ISR( CanIsr_15 )    /* PRQA S 3408 */ /* ISR prototypes must be provided by OSEK header file */
#   else
#    if defined( C_ENABLE_OSEK_OS ) && defined (osdIsrCanIsr_15Cat) /* COV_CAN_OSCAT_CONFIG_CHECK */
 ...
 *
 */
V_DEF_FUNC(V_NONE, void __interrupt(kCanISRPrio_15) __vector_table(Can_GetkCanUsedCore()), CODE) CanIsr_15( void ) /* PRQA S 3408 */ /* MD_Can_ExternalScope */
#     else
#      if defined(V_COMP_GHS) && !defined(MISRA_CHECK) /* COV_CAN_COMPILER_SWITCH */
#       pragma ghs interrupt
#      endif
...
#   else
    CanInterrupt(kCanPhysToLogChannelIndex_15);                      /* call Interrupthandling with logical channel */
#   endif
 ...
 *
 */
ISR( CanIsr_16 )    /* PRQA S 3408 */ /* ISR prototypes must be provided by OSEK header file */
#   else
#    if defined( C_ENABLE_OSEK_OS ) && defined (osdIsrCanIsr_16Cat) /* COV_CAN_OSCAT_CONFIG_CHECK */
 ...
 *
 */
V_DEF_FUNC(V_NONE, void __interrupt(kCanISRPrio_16) __vector_table(Can_GetkCanUsedCore()), CODE) CanIsr_16( void ) /* PRQA S 3408 */ /* MD_Can_ExternalScope */
#     else
#      if defined(V_COMP_GHS) && !defined(MISRA_CHECK) /* COV_CAN_COMPILER_SWITCH */
#       pragma ghs interrupt
#      endif
...
#   else
    CanInterrupt(kCanPhysToLogChannelIndex_16);                      /* call Interrupthandling with logical channel */
#   endif
 ...
 *
 */
ISR( CanIsr_17 )    /* PRQA S 3408 */ /* ISR prototypes must be provided by OSEK header file */
#   else
#    if defined( C_ENABLE_OSEK_OS ) && defined (osdIsrCanIsr_17Cat) /* COV_CAN_OSCAT_CONFIG_CHECK */
 ...
 *
 */
V_DEF_FUNC(V_NONE, void __interrupt(kCanISRPrio_17) __vector_table(Can_GetkCanUsedCore()), CODE) CanIsr_17( void ) /* PRQA S 3408 */ /* MD_Can_ExternalScope */
#     else
#      if defined(V_COMP_GHS) && !defined(MISRA_CHECK) /* COV_CAN_COMPILER_SWITCH */
#       pragma ghs interrupt
#      endif
...
#   else
    CanInterrupt(kCanPhysToLogChannelIndex_17);                      /* call Interrupthandling with logical channel */
#   endif
 ...
 *
 */
ISR( CanIsr_18 )    /* PRQA S 3408 */ /* ISR prototypes must be provided by OSEK header file */
#   else
#    if defined( C_ENABLE_OSEK_OS ) && defined (osdIsrCanIsr_18Cat) /* COV_CAN_OSCAT_CONFIG_CHECK */
 ...
 *
 */
V_DEF_FUNC(V_NONE, void __interrupt(kCanISRPrio_18) __vector_table(Can_GetkCanUsedCore()), CODE) CanIsr_18( void ) /* PRQA S 3408 */ /* MD_Can_ExternalScope */
#     else
#      if defined(V_COMP_GHS) && !defined(MISRA_CHECK) /* COV_CAN_COMPILER_SWITCH */
#       pragma ghs interrupt
#      endif
...
#   else
    CanInterrupt(kCanPhysToLogChannelIndex_18);                      /* call Interrupthandling with logical channel */
#   endif
 ...
 *
 */
ISR( CanIsr_19 )    /* PRQA S 3408 */ /* ISR prototypes must be provided by OSEK header file */
#   else
#    if defined( C_ENABLE_OSEK_OS ) && defined (osdIsrCanIsr_19Cat) /* COV_CAN_OSCAT_CONFIG_CHECK */
 ...
 *
 */
V_DEF_FUNC(V_NONE, void __interrupt(kCanISRPrio_19) __vector_table(Can_GetkCanUsedCore()), CODE) CanIsr_19( void ) /* PRQA S 3408 */ /* MD_Can_ExternalScope */
#     else
#      if defined(V_COMP_GHS) && !defined(MISRA_CHECK) /* COV_CAN_COMPILER_SWITCH */
#       pragma ghs interrupt
#      endif
...
#   else
    CanInterrupt(kCanPhysToLogChannelIndex_19);                      /* call Interrupthandling with logical channel */
#   endif
