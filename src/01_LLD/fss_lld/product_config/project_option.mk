...
#Create Meged .a file Run only during Release ./build.sh made_merge_ar
# to check the .a file content run command in terminal "ar -t lldio.a"
# Please install sudo apt install binutils to make ar working
made_merge_ar:
	@ar -M < product_config/libmerge.mri
...
SOFTWARE_VERSION := "dz110B0CBM100_0"
...
CPPFLAGS += $(CPPFLAGS_dev) -DBRS_TIMEBASE_CLOCK=300 -DBRS_EVA_BOARD_CUSTOMER_HARDWARE -DBRS_COMP_GCCHIGHTEC -DAUTOSAR_IS_PRESENT -DNO_BOOT_IS_PRESENT -DDemoAppl \
                            -D__HIGHTEC__ -D_GNU_C_TRICORE_=1 -D_HIGHTEC_C_TRICORE_ -D_HIGHTEC_COMPILER 
 
 
# Optimization Options of compiler (tricore-gcc):
# CFLAGS_FILE = other_files/product_config/CFLAGS_tricore_gcc_b.txt
# CFLAGS = @$(CFLAGS_FILE)
CFLAGS = \
 -mtc162 \
 -g3 \
...
LDLIBS = \
  -lgcc \
   $(shell find ../../01_LLD/fss_rtos/ -type f -iname "RTAOS.a")
...
hightec_main.ld:  ../other_files/memory.ld  product_config/project_option.mk
	$(CC) -E -P -C -xc $(CPPFLAGS) ../other_files/memory.ld -o product_config/hightec_main.ld -I ./gendata
