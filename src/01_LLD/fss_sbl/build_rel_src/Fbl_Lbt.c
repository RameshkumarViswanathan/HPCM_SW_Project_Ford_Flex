 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: Fbl_Lbt.c
 *   Generation Time: 2024-01-08 20:07:56
  ...
  {
    {
      ...
      0x70000000u /*  Block Start Address  */ , 
      0x00000C00u /*  Block Length (End Address = 0x70000BFFu)  */ , 
      0x70000A00u /*  Header Address  */ , 
      0x70000000u /*  BM Header Address  */ , 
    ...
    {  
      ...
      kBlockTypeApplication /*  Block Type  */ , 
	    0x805A0000u /*  Block Start Address  */ ,
      /*TechM: Do not exceed this as BOOT Manager also in this segment*/ 
      0x00050000u /*  Block Length (End Address = 0x805EFFFFu)  */ ,
      0x805A0000u /*  Header Address  */ , 
      0x805A0020u /*  BM Header Address  */ , 
      (tExportFct)SecM_Default /*  Output Verification  */ 
    } /*  Name 'Fbl'  */ , 
    {
      2u, 
      ...
      kBlockTypeApplication /*  Block Type  */ , 
      0x80290000u /*  Block Start Address  */ , 
      0x00070000u /*  Block Length (End Address = 0x802FFFFFu)  */ , 
      0x802FFD00u /*  Header Address  */ , 
      0x802E4820u /*  BM Header Address  */ , 
      (tExportFct)SecM_Default /*  Output Verification  */ 
    } /*  Name 'Updater'  */ 
  }
};
