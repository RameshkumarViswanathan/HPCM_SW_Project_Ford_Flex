...
/**********************************************************************************************************************/
/* TODO: TechM: BM Integration to have presences pattern in lld 
for all btxh, pbl and lld flash thru TRACE32 every time
*/

/***********************************************************************************************************************
 * LLD Instance Presence Pattern
 *   This presence pattern is only required when downloading the LLD with debugger. When using an updater (or an EOL
 *   programmer), this presence pattern is not required as part of the .hex file and should be removed.
 *   LLD specific section to store the FBL instance presence pattern into a
 *   dedicated section
 **********************************************************************************************************************/

#define BRS_FBL_INSTANCE_LLD //TODO: TechM: remove this if don't want presence pattern in hex file 

#if defined (BRS_FBL_INSTANCE_LLD)
#pragma section ".rodata.FblPresencePatternSection" a //TODO: TechM to have presence pattern in ROM
const uint8 FblPresencePatternArray[4] = {0x73u, 0x6Au, 0x29u, 0x3Eu};
#pragma section 

#pragma section ".rodata.FblPresencePatternSection2" a //TODO: TechM to have presence pattern in ROM
const uint8 FblPresencePatternArray2[4] = {0x73u, 0x6Au, 0x29u, 0x3Eu};
#pragma section 
#endif /*BRS_FBL_INSTANCE_LLD*/
