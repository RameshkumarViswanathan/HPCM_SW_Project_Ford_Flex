...
/* CAN */
#if ( FBLCW_MODULE_CANIF == STD_ON)
# include "CanIf_CanTrcv.h"
#endif /* FBLCW_MODULE_CANIF == STD_ON */
#if ( FBLCW_MODULE_CAN == STD_ON)
# include FBLCW_CANDRV_HEADER_NAME /* PRQA S 0832 */ /* MD_FblCw_0832 */
#endif /* FBLCW_MODULE_CAN == STD_ON */
#if ( FBLCW_MODULE_CANIF == STD_ON)
# include "CanIf.h"
#endif /* FBLCW_MODULE_CANIF == STD_ON */
#if ( FBLCW_MODULE_CANTP == STD_ON)
# include "CanTp.h"
#endif /* FBLCW_MODULE_CANTP == STD_ON */
...
#if ( FBLCW_MODULE_ETHIF == STD_ON )
# include "EthIf.h"
#endif /* FBLCW_MODULE_ETHIF == STD_ON */
...
# include "TcpIp.h"
#endif /* FBLCW_MODULE_TCPIP == STD_ON */

#if ( FBLCW_MODULE_SOAD == STD_ON )
# include "SoAd.h"
#endif /* FBLCW_MODULE_SOAD == STD_ON */
...
#if ( FBLCW_MODULE_FR == STD_ON )
# include "Fr.h"
#endif
#if ( FBLCW_MODULE_FRIF == STD_ON )
# include "FrIf.h"
# include "FrIf_Priv.h"
# include "FrIf_Ext.h"
#endif
...
#if ( FBLCW_MODULE_LIN == STD_ON )
# include FBLCW_LINDRV_HEADER_NAME
#endif
#if ( FBLCW_MODULE_LINIF == STD_ON )
# include "LinIf.h"
 ...
 *  VERSION
 *********************************************************************************************************************/
#if ( FBLWRAPPERCOM_PDUR_VERSION != 0x0606u ) || ( FBLWRAPPERCOM_PDUR_RELEASE_VERSION != 0x03u )
...
#  elif defined( FBLCW_CAN_BUSTYPEOFDCMDSLCONNECTIONINFO ) || defined( FBLCW_CANFD_BUSTYPEOFDCMDSLCONNECTIONINFO )
...
V_MEMRAM0 V_MEMRAM1 vuint8 V_MEMRAM2 fblCwStateStartMsg;    /**< State of start message reception */
...
# endif
#endif /* FBLCW_MODULE_LINIF == STD_ON */
#if ( FBLCW_MODULE_LINSM == STD_ON )
...
#if ( FBLCW_MODULE_FRIF == STD_ON )          && \
    ( FRIF_CUSTOM_JLE_SCHEDULING == STD_ON )
/**********************************************************************************************************************
...
# endif
    ...
    ( FRIF_CUSTOM_JLE_SCHEDULING == STD_ON )
# if ( FBLCW_MODULE_FRNM == STD_ON )   || \
     ( FBLCW_MODULE_FRTP == STD_ON )   || \
     ( FBLCW_MODULE_FRARTP == STD_ON )
  Std_ReturnType frMainFunctionSyncStatus = E_NOT_OK;
  vuint8         frCycle = 0u;
  vuint16        frMacroTicks = 0u;
# endif /* FBLCW_MODULE_FRNM == STD_ON || FBLCW_MODULE_FRTP == STD_ON || FBLCW_MODULE_FRARTP == STD_ON */
#endif /* FBLCW_MODULE_FRIF == STD_ON && FRIF_CUSTOM_JLE_SCHEDULING == STD_ON */
...
# if ( FBLCW_MODULE_FRNM == STD_ON )   || \
     ( FBLCW_MODULE_FRTP == STD_ON )   || \
     ( FBLCW_MODULE_FRARTP == STD_ON )
  frMainFunctionSyncStatus = FrIf_GetGlobalTime(0u, &frCycle, &frMacroTicks);
# endif /* FBLCW_MODULE_FRNM == STD_ON || FBLCW_MODULE_FRTP == STD_ON || FBLCW_MODULE_FRARTP == STD_ON */
#endif /* FBLCW_MODULE_FRIF == STD_ON && FRIF_CUSTOM_JLE_SCHEDULING == STD_ON */
...
# if ( FBLCW_MODULE_FRTP == STD_ON )
    /* FlexRay TP task */
    if ( frMainFunctionSyncStatus != E_OK )
    {
      FrTp_MainFunction();
    }
# endif /* FBLCW_MODULE_FRTP == STD_ON */
# if ( FBLCW_MODULE_FRARTP == STD_ON )
    /* FlexRay ARTP task */
    if ( frMainFunctionSyncStatus != E_OK )
    {
...
# endif /* FBLCW_MODULE_FRARTP == STD_ON */
#endif /* FBLCW_MODULE_FRIF == STD_ON && FRIF_CUSTOM_JLE_SCHEDULING == STD_ON */
...
# if ( FBLCW_MODULE_FRNM == STD_ON )
  ...
  {
    FrNm_MainFunction_0();
#  if ( FrIf_CommonMaxNumberOfClusters > 1u )
    FrNm_MainFunction_1();
#  endif /* FrIf_CommonMaxNumberOfClusters > 1u */
  }
# endif /* FBLCW_MODULE_FRNM == STD_ON */
#endif /* FBLCW_MODULE_FRIF == STD_ON && FRIF_CUSTOM_JLE_SCHEDULING == STD_ON */
...
#endif /* (FBLCW_MODULE_DOIP == STD_ON) || (FBLCW_MODULE_SOAD == STD_ON)  */
...
static void FblCheckOwnStartMsg(SduDataPtrType data, PduLengthType length)
{
  /* Start message only supported for messages with length smaller eight */
  if((length < 8u) && (data != NULL))
  {
    vuint8 messageBuffer[8u];     /**< Start message buffer - 8 Bytes max. on CAN */
    /* Copy length in front of actual data to get TP message */
    ...
    /* Check whether this is an actual start message */
    if (kFblOk == FblDiagCheckStartMsg(messageBuffer, 8u))
    {
      /* Start message received, change state */
...
# if ( FRIF_CUSTOM_JLE_SCHEDULING == STD_ON )
      ...
      FrIf_CustomJLEHandling();
# endif
#endif /* FBLCW_MODULE_FRIF == STD_ON */
...
#endif
#if ( FBLCW_MODULE_LINIF == STD_ON )
  /* Initialize linIfCycleCounter variable */
# if ( LINIF_SW_MAJOR_VERSION < 10u )
  linIfCycleCounter = 0u;
# else
...
#endif
#if ( FBLCW_MODULE_LINSM == STD_ON )
  /* Initialize linSmCycleCounter variable */
  linSmCycleCounter = 0u;
#endif
  cwTxTimer = 0u;
  cwTxState = kFblCwTxStateIdle;
...
#if defined( FBLCW_CAN_BUSTYPEOFDCMDSLCONNECTIONINFO ) || defined( FBLCW_CANFD_BUSTYPEOFDCMDSLCONNECTIONINFO )
...
#endif /* FBLCW_CAN_BUSTYPEOFDCMDSLCONNECTIONINFO || FBLCW_CANFD_BUSTYPEOFDCMDSLCONNECTIONINFO */
...
tFblResult FblCwCheckStartMessage(void)
{
   ...
   else
   {
      ...
      /* No correct boot message received. Release buffers for next message */
      if (FblDiagGetBufferLocked())
      {
...
# if defined( FBLCW_CAN_BUSTYPEOFDCMDSLCONNECTIONINFO ) || defined( FBLCW_CANFD_BUSTYPEOFDCMDSLCONNECTIONINFO )
  ...
  /* Baud rate switch only supported for CAN */ /* PRQA S 2996 2 */ /* MD_FblCw_2991_2995_2996 */
...
# if defined( FBLCW_CAN_BUSTYPEOFDCMDSLCONNECTIONINFO ) || defined( FBLCW_CANFD_BUSTYPEOFDCMDSLCONNECTIONINFO )
      ...
      || (connectionBusType == FBLCW_CONNECTIONBUSTYPE_CANFD))
  {
    ...
    (void) CanIf_SetPduMode((uint8)(FblCw_GetControllerOfDcmDslConnectionInfo(activeConnection[FBL_CW_MAIN_REQUEST_INDEX])), CANIF_SET_ONLINE);

  }
# endif /* FBLCW_CAN_BUSTYPEOFDCMDSLCONNECTIONINFO == STD_ON || FBLCW_CANFD_BUSTYPEOFDCMDSLCONNECTIONINFO */
...
tFblCw_ConnectionBusType FblCwGetBusTypeOfActiveConnection(void)
{
  ...
  if (activeConnection[FBL_CW_MAIN_REQUEST_INDEX] != FBLCW_CONNECTION_UNASSIGNED)
  {
    FblCw_BusTypeOfDcmDslConnectionInfoType connectionInfo = FblCw_GetBusTypeOfDcmDslConnectionInfo(activeConnection[FBL_CW_MAIN_REQUEST_INDEX]);

    switch (connectionInfo)
    {
#if defined( FBLCW_ETH_BUSTYPEOFDCMDSLCONNECTIONINFO )
      case FBLCW_ETH_BUSTYPEOFDCMDSLCONNECTIONINFO:
      {
        busTypeActiveConnection = FBLCW_CONNECTIONBUSTYPE_ETH;
        break;
      }
#endif
#if defined( FBLCW_CAN_BUSTYPEOFDCMDSLCONNECTIONINFO )
      case FBLCW_CAN_BUSTYPEOFDCMDSLCONNECTIONINFO:
      {
        busTypeActiveConnection = FBLCW_CONNECTIONBUSTYPE_CAN;
        break;
      }
#endif
#if defined( FBLCW_CANFD_BUSTYPEOFDCMDSLCONNECTIONINFO )
      case FBLCW_CANFD_BUSTYPEOFDCMDSLCONNECTIONINFO:
      {
        busTypeActiveConnection = FBLCW_CONNECTIONBUSTYPE_CANFD;
        break;
      }
#endif
#if defined( FBLCW_LIN_BUSTYPEOFDCMDSLCONNECTIONINFO )
      case FBLCW_LIN_BUSTYPEOFDCMDSLCONNECTIONINFO:
      {
        busTypeActiveConnection = FBLCW_CONNECTIONBUSTYPE_LIN;
        break;
      }
#endif
#if defined( FBLCW_FR_BUSTYPEOFDCMDSLCONNECTIONINFO )
      case FBLCW_FR_BUSTYPEOFDCMDSLCONNECTIONINFO:
      {
        busTypeActiveConnection = FBLCW_CONNECTIONBUSTYPE_FR;
        break;
      }
#endif
#if defined( FBLCW_CDD_BUSTYPEOFDCMDSLCONNECTIONINFO )
      case FBLCW_CDD_BUSTYPEOFDCMDSLCONNECTIONINFO:
      {
        busTypeActiveConnection = FBLCW_CONNECTIONBUSTYPE_CDD;
        break;
      }
#endif
      default:
      {
        /* Current Connection Bus Type not supported */
...
# endif
  ...
  else
  {
    ...
    {
      /* Invoke diagnostic function to check whether this is the (OEM specific) start message */
      FblCheckOwnStartMsg(info->SduDataPtr, info->SduLength);

      if (!FblCwGetStartMsgReceived())
      {
        /* Ignore all other messages during stay-in-boot */
        result = BUFREQ_OK;
      }
    }

    /* If the start message is received it should be processed afterwards */
    if ( (!FblCwGetCheckForStartMsg()) || FblCwGetStartMsgReceived() )
#endif /* FBL_ENABLE_STAY_IN_BOOT */
    {
      if (FblCw_CheckRxPduAllowedInConnection(id, FBL_CW_MAIN_REQUEST_INDEX))
      {
...
FUNC(tFblResult, FBLCW_CODE) FblCw_ChangeParameter(TPParameterType parameter, uint16 value)
{
  ...
  if (activeConnection[FBL_CW_MAIN_REQUEST_INDEX] != FBLCW_CONNECTION_UNASSIGNED)
  {
    FblCw_ParameterInfoIterType parameterInfoIdx = FblCw_GetParameterInfoIdxOfDcmDslConnectionInfo(activeConnection[FBL_CW_MAIN_REQUEST_INDEX]);

# if defined( FBLCW_CAN_BUSTYPEOFDCMDSLCONNECTIONINFO ) || defined( FBLCW_CANFD_BUSTYPEOFDCMDSLCONNECTIONINFO ) || defined( FBLCW_FR_BUSTYPEOFDCMDSLCONNECTIONINFO )
    tFblCw_ConnectionBusType connectionBusType = FblCwGetBusTypeOfActiveConnection();

#  if defined( FBLCW_CAN_BUSTYPEOFDCMDSLCONNECTIONINFO ) || defined( FBLCW_CANFD_BUSTYPEOFDCMDSLCONNECTIONINFO )
    /* PRQA S 2996 2 */ /* MD_FblCw_2991_2995_2996 */
    if (   (connectionBusType == FBLCW_CONNECTIONBUSTYPE_CAN)
        || (connectionBusType == FBLCW_CONNECTIONBUSTYPE_CANFD))
    {
...
#  if defined( FBLCW_FR_BUSTYPEOFDCMDSLCONNECTIONINFO )
    if (connectionBusType == FBLCW_CONNECTIONBUSTYPE_FR)
    {
#   if ( FBLCW_MODULE_FRTP == STD_ON )
      if (parameter == TP_BC)
#   endif
...
# else /* FBLCW_CAN_BUSTYPEOFDCMDSLCONNECTIONINFO || FBLCW_CANFD_BUSTYPEOFDCMDSLCONNECTIONINFO || FBLCW_FR_BUSTYPEOFDCMDSLCONNECTIONINFO */
    if (PduR_DcmChangeParameter(FblCw_GetPduRIdOfParameterInfo(parameterInfoIdx), parameter, value) == E_OK)
    {
      result = kFblOk;
    }
...
# if defined( FBLCW_CAN_BUSTYPEOFDCMDSLCONNECTIONINFO ) || defined( FBLCW_CANFD_BUSTYPEOFDCMDSLCONNECTIONINFO ) || defined( FBLCW_FR_BUSTYPEOFDCMDSLCONNECTIONINFO )
  ...
  for (dcmDslConnectionInfoIdx = 0u; dcmDslConnectionInfoIdx < FblCw_GetSizeOfDcmDslConnectionInfo(); dcmDslConnectionInfoIdx++)
  {
    if (FblCw_IsParameterInfoUsedOfDcmDslConnectionInfo(dcmDslConnectionInfoIdx)) /* PRQA S 4304 */ /* MD_FblCw_4304_BooleanCast */
    {
      FblCw_ParameterInfoIterType parameterInfoIdx = FblCw_GetParameterInfoIdxOfDcmDslConnectionInfo(dcmDslConnectionInfoIdx);
      tFblCw_ConnectionBusType connectionBusType = FblCwGetBusTypeOfActiveConnection();
...
# endif /* FBLCW_CAN_BUSTYPEOFDCMDSLCONNECTIONINFO || FBLCW_CANFD_BUSTYPEOFDCMDSLCONNECTIONINFO || FBLCW_FR_BUSTYPEOFDCMDSLCONNECTIONINFO */
...
{
  uint8 ClusterIdx = 0u;
  boolean isLastFrIfRxTaskForTp[FrIf_CommonMaxNumberOfClusters] = {FALSE};
...
# if ( FBLCW_MODULE_FRNM == STD_ON )
          ...
          {
            if (ClusterIdx == 0u) /* PRQA S 2991, 2995 */ /* MD_FblCw_2991_2995_2996 */
            {
              FrNm_MainFunction_0();
            }
#  if ( FrIf_CommonMaxNumberOfClusters > 1u )
...
#  endif /* FrIf_CommonMaxNumberOfClusters == 2u */
          }
# endif /* FBLCW_MODULE_FRNM == STD_ON */
        }
      }
...
# if ( FBLCW_MODULE_FRSM == STD_OFF )
#  define FBLCW_FR_STOP_SEC_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_MemMap */
#  define FBLCW_START_SEC_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_MemMap */
# endif /* FBLCW_MODULE_FRSM == STD_OFF */
#else /* FBLCW_MODULE_FRIF == STD_ON && FRIF_CUSTOM_JLE_SCHEDULING == STD_ON */
# if ( FBLCW_MODULE_FRSM == STD_ON )
#  define FBLCW_STOP_SEC_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_MemMap */
#  define FBLCW_FR_START_SEC_CODE
...
# endif /* LINSM_MASTERNODE_POSSIBLE == STD_ON && FBLCW_MODULE_LINTP == STD_ON */
