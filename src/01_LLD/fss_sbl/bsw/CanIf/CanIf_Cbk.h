 ...
 *  06.01.00  2021-03-11  visgaz  CAN-2553      [CAN-IF] Support ASR4.4.0 CAN driver
 *  06.02.00  2022-08-15  visgaz  CANCORE-1372  [CAN-IF] [Beta] Support CAN driver combination 3rd party AR version 4.4.0 with CMSR
 *********************************************************************************************************************/
 ...
 *  \details       CANIF_SUPPORT_CANDRV_ASR440: Signature according to AR version 4.3.1 is used. But the CanIf
 *                 ensures AR version 4.0.3 behavior to the upper layer.
 *                 CANIF_SUPPORT_CANDRV_AR_VERSIONS: A macro is generated to CanIf_Cfg.h for the CAN driver
 *                 according to AR version 4.0.3 to call this callback.
 ...
 ***********************************************************************************************************/
/*! \brief         Called by the CAN Driver AR version 4.3.1 to notify CAN Interface about a successful
 *                 controller mode transition at the specified CAN controller.
 *  \details       A macro is generated to CanIf_Cfg.h for the CAN driver according to AR version 4.3.1 to
 *                 call this callback. Internally the state is converted to the mode type and is forwared to
 *                 the CanIf_ControllerModeIndicationAr403 (ensures AR version 4.0.3 behavior to the upper layer).
 *  \param[in]     ControllerId: Abstracted CanIf ControllerId which is assigned to a CAN controller,
 *                               which controller mode has been transitioned.
 *  \param[in]     ControllerMode: Controller mode to which the CAN controller transitioned.
 *  \pre           -
 ...
 *  \reentrant     TRUE only for different ControllerId
 *  \synchronous   TRUE
 *  \config        CANIF_SUPPORT_CANDRV_AR_VERSIONS == STD_ON
***********************************************************************************************************/
