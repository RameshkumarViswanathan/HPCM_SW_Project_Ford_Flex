 ...
 *  02.04.00  2020-11-18  visbwa                Removed AUTHOR IDENTITY, changed filter mechanism (Product instead of
 *                                              AutosarVersion)
*********************************************************************************************************************/
...
/* TechM Added for FORD Inverter */
typedef signed char           I8;            /* At least 7 bit + 1 bit sign    */
typedef unsigned char         U8;            /* At least 8 bit                 */
typedef signed short          I16;           /* At least 15 bit + 1 bit sign   */
typedef unsigned short        U16;           /* At least 16 bit                */
typedef signed long           I32;           /* At least 31 bit + 1 bit sign   */
typedef unsigned long         U32;           /* At least 32 bit                */
...
typedef unsigned char         FLAG;          /*        TRUE .. FALSE           */
typedef float                 F32;
typedef double                F64;
