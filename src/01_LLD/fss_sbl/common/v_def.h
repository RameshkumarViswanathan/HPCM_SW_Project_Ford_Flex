...
| 2021-07-07 3.91.00 Ht     Added V_COMP_IAR_TAYRONA
|                    Ht     Added V_COMP_IAR_KW4
|                    Ht     Added V_COMP_LLVMDIAB_AWRGEN2
|                    Ht     Added V_COMP_GHS_JACINTO7
|                    Ht     Replace C_COMP_TI_TMS320ARM_DCAN with V_COMP_TI_TMS320ARM
| 2021-10-06 3.92.00 Ht     Added V_COMP_ARM6_BCM8910X
|                    Ht     Added V_COMP_LLVMTI_JACINTO7
| 2022-03-11 3.93.00 Ht     CANCORE-1117: Added V_COMP_LLVMTI_AWRGEN2
|                    Ht     Added V_COMP_GNU_LINUXFORARM32
|                    Ht     CANCORE-1125: Added V_COMP_ARM_ACCORDO2, V_COMP_ARM_ACCORDO2
| 2022-07-06 3.94.00 Ht     CANCORE-1377: Added V_COMP_GNU_LPC54
|                    Ht     CANCORE-1375: Added V_COMP_GHS_SAF85
| 2022-10-13 3.95.00 Ap     CANCORE-1555: Added V_COMP_ARM6_S32
| 2022-11-17 3.96.00 Bmo    Added V_COMP_IAR_MSPM0
| 2023-02-14 3.97.00 Ht     CANCORE-1818: Added V_COMP_GHS_TCC70XX
| 2023-03-03 3.98.00 Ap     Added V_COMP_LLVMTI_MSPM0
| 2023-03-31 4.00.00 Ht     CANCORE-1848: Added V_COMP_IAR_ASX
|                    Ht     Added V_COMP_TI_MSPM0
|                    Ht     Improvements related to compiler for ARM platforms
|                    Ht     Removed: C_COMP_IAR_78K0_AFCAN, C_COMP_IAR_78K0
|****************************************************************************/
...
/***************************************************************************/
# define COMMON_VDEF_VERSION            0x0400
...
/* compatibility define due to older implementations */



/* ARM32 with ARM6 compiler */

/* ARM32 with GHS compiler */

/* ARM32 with GNU compiler */

/* ARM32 with IAR compiler */

/* ARM32 with LLVMDIAB compiler */

/* ARM32 with LLVMTI compiler */

/* ARM32 with TI compiler */


/* all other supported plattform compiler combination */
...
#  error "Plattform unknown or V_COMP_xxx_yyy not defined"
# endif
...
/***************************************************************************/
/***************************************************************************/
/****  General and platform dependent type definitions  ********************/
/***************************************************************************/
/***************************************************************************/
...
#if defined( V_DEF_COMP_GHS_ARM )               || \
    defined( V_DEF_COMP_IAR_ARM )
...
#endif
#if defined( V_COMP_GNU_TRICORE )          || \
    defined( V_DEF_COMP_GNU_ARM )          || \
    defined( V_DEF_COMP_LLVMDIAB_ARM )     || \
    defined( V_DEF_COMP_LLVMTI_ARM )
# if !defined(V_ENABLE_CAN_ASR_ABSTRACTION) && !defined(V_ENABLE_VSTDLIB_ASR_ABSTRACTION)
#  if !defined(LOCAL_INLINE)
...
/* ARM32 with ARM6 compiler */
#if defined( V_DEF_COMP_ARM6_ARM )
# if !defined(V_ENABLE_CAN_ASR_ABSTRACTION) && !defined(V_ENABLE_VSTDLIB_ASR_ABSTRACTION)
#  if !defined(LOCAL_INLINE)
#   define LOCAL_INLINE       static __inline
#  endif
