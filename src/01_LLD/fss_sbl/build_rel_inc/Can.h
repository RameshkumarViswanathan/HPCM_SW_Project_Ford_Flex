...
| 2022-03-08 10.01.00 Bir - call CanIf_ControllerErrorStatePassive and CanIf_ErrorNotification with infix
|                     Pip - CANCORE-1575 Update for allowing Pretransmit function to change DLC
| 2023-01-30 10.02.00 Jan - CANCORE-1779 FETA Analysis
|                           Add missing SBSW comment
|****************************************************************************/
...
#define DRVCAN_MPC5700MCANASR_VERSION         0x0511u
#define DRVCAN_MPC5700MCANASR_RELEASE_VERSION 0x04u

/* internal Core Version */
#define CAN_COREVERSION           0x1002u
...
#define CAN_E_MRAF               (uint8)0x13u   /* extension - Mcan specific Det to signal a Message RAM access failure */
...
# define CAN_ENABLE_SECURITY_EVENT_REPORTING
#endif
...
# if (CAN_SHM_DATAQOS == STD_ON)              /* COV_CAN_HW_SPECIFIC */
#  define C_ENABLE_SHM_DATAQOS
# else
#  define C_DISABLE_SHM_DATAQOS
# endif

#  if (CAN_TRICORE_ERRATUM_AI_H001 == STD_ON) /* COV_CAN_HW_SPECIFIC */
#   define C_ENABLE_TRICORE_ERRATUM_AI_H001
#  else
#   define C_DISABLE_TRICORE_ERRATUM_AI_H001
#  endif

# if (CAN_REGEXT_MCANAS1 == STD_ON)           /* COV_CAN_HW_SPECIFIC */
#  define C_ENABLE_REGEXT_MCANAS1
# else
#  define C_DISABLE_REGEXT_MCANAS1
# endif


# if (CAN_REGEXT_STMFDCAN == STD_ON)          /* COV_CAN_HW_SPECIFIC */
#  define C_ENABLE_REGEXT_STMFDCAN
# else
#  define C_DISABLE_REGEXT_STMFDCAN
# endif

# if (CAN_REGEXT_TCC == STD_ON)               /* COV_CAN_HW_SPECIFIC */
#  define C_ENABLE_REGEXT_TCC
# else
#  define C_DISABLE_REGEXT_TCC
# endif

# if (CAN_REGEXT_TCC_PWD == STD_ON)           /* COV_CAN_HW_SPECIFIC */
#  define C_ENABLE_REGEXT_TCC_PWD
# else
#  define C_DISABLE_REGEXT_TCC_PWD
# endif


# if (CAN_PARITY_INTERRUPT == STD_ON)         /* COV_CAN_HW_SPECIFIC */
#  define C_ENABLE_PARITY_INTERRUPT
# else
#  define C_DISABLE_PARITY_INTERRUPT
# endif

# if ( CAN_ECC_INIT_SHM == STD_ON )           /* COV_CAN_COMPATIBILITY */
#  define C_ENABLE_CAN_ECC_INIT_SHM
# else
#  define C_DISABLE_CAN_ECC_INIT_SHM
# endif

# if defined (CAN_CANSUBSYSTEMBASEADR)                /* COV_CAN_HW_SPECIFIC */
#  if ( CAN_CANSUBSYSTEMBASEADR == STD_ON )           /* COV_CAN_COMPATIBILITY */
#   define C_ENABLE_CANSUBSYSTEMBASEADR
#  else
#   define C_DISABLE_CANSUBSYSTEMBASEADR
#  endif
# else 
#  define C_DISABLE_CANSUBSYSTEMBASEADR
# endif

# if defined (CAN_CANGLOBALBASEADR)                /* COV_CAN_HW_SPECIFIC */
#  if ( CAN_CANGLOBALBASEADR == STD_ON )           /* COV_CAN_COMPATIBILITY */
#   define C_ENABLE_CANGLOBALBASEADR
#  else
#   define C_DISABLE_CANGLOBALBASEADR
#  endif
# else 
#  define C_DISABLE_CANGLOBALBASEADR
# endif

# if ( CAN_UPDATE_BASE_ADDRESS == STD_ON )           /* COV_CAN_COMPATIBILITY */
#  define C_ENABLE_UPDATE_BASE_ADDRESS
# else
#  define C_DISABLE_UPDATE_BASE_ADDRESS
# endif
...
#  define kCanLoopRamInit      ((vuint8)0x06u)
# endif
...
V_DEF_VAR_TYPE(V_NONE, tElmType) CanElmType;
...
#  define MCMCAN(sub)   ((V_DEF_P2SFR_CAN(V_NONE, tCanGlobalObjType, AUTOMATIC))Can_GetCanVirtualSubSystemBaseAdr(sub) ) /* MCMCAN SFR */
# else
# define MCMCAN(sub)   ((V_DEF_P2SFR_CAN(V_NONE, tCanGlobalObjType, AUTOMATIC))(Can_GetCanSubSystemBaseAdr(sub))) /* MCMCAN SFR */
# endif
...
V_DEF_P2SFR_CAN_TYPE(V_NONE, tCanChipMsgPtr) CanChipMsgPtr;
...
{ /*! Can module structure */
  ...
  volatile tTXFQS TXFQS;     /*! 0x00C4         Tx FIFO/Queue Status               */
 ...
 *  \trace         CREQ-979
***********************************************************************************************************/
V_DEF_FUNC(extern, void, CODE) Can_MainFunction_Write( void ); /* PRQA S 3449, 3451 */ /* MD_Can_HL_ExternalDeclaration */
 ...
 *  \trace         CREQ-979
***********************************************************************************************************/
V_DEF_FUNC(extern, void, CODE) Can_MainFunction_Read( void ); /* PRQA S 3449, 3451 */ /* MD_Can_HL_ExternalDeclaration */
 ...
 *  \trace         CREQ-979
***********************************************************************************************************/
V_DEF_FUNC(extern, void, CODE) Can_MainFunction_BusOff( void ); /* PRQA S 3449, 3451 */ /* MD_Can_HL_ExternalDeclaration */
 ...
 *  \trace         CREQ-979
***********************************************************************************************************/
V_DEF_FUNC(extern, void, CODE) Can_MainFunction_Wakeup( void ); /* PRQA S 3449, 3451 */ /* MD_Can_HL_ExternalDeclaration */
 ...
 *  \trace         CREQ-978
***********************************************************************************************************/
V_DEF_FUNC(extern, void, CODE) Can_MainFunction_Mode( void ); /* PRQA S 3449, 3451 */ /* MD_Can_HL_ExternalDeclaration */
...
V_DEF_FUNC(V_NONE, void, CODE) CanIsr_16( void );
#    endif
/************************************************************************************************************
 *  CanIsr_17
 ***********************************************************************************************************/
...
V_DEF_FUNC(V_NONE, void, CODE) CanIsr_17( void );
#    endif
/************************************************************************************************************
 *  CanIsr_18
 ***********************************************************************************************************/
...
V_DEF_FUNC(V_NONE, void, CODE) CanIsr_18( void );
#    endif
/************************************************************************************************************
 *  CanIsr_19
 ***********************************************************************************************************/
...
V_DEF_FUNC(V_NONE, void, CODE) CanIsr_19( void );
#    endif
 ...
 *                 Do not extend DataPtr->length beyond the maximum length for the given DataPtr->swPduHandle (see related CanHardwareObject\CanMaxDataLen). 
 *                 Do not write beyond the DataPtr->length to the DataPtr->sdu. 
***********************************************************************************************************/
 ...
 *  \param[in]     void
 *  \return        kCanOk      Initialization of the CAN Message RAM was successful
 *  \return        kCanFailed  Initialization of the CAN Mesaage RAM failed
 *  \pre           -
 *  \context       TASK
 *  \reentrant     FALSE
 *  \synchronous   TRUE
***********************************************************************************************************/
V_DEF_FUNC(V_NONE, vuint8, CODE) ApplCanEccInit(void);  /* PRQA S 3408 */ /* MD_Can_ExternalScope */
/* CODE CATEGORY 4 END */
#endif
 ...
 *  \synchronous   TRUE
***********************************************************************************************************/
V_DEF_FUNC(extern, uint32, CODE) ApplCanPowerOnGetBaseAddress(uint32 physAddr, vuint16 size);  /* PRQA S 3408 */ /* MD_Can_ExternalScope */
/* CODE CATEGORY 4 END */
#endif


# if defined( C_ENABLE_INIT_POST_PROCESS )
# define CanBtpReg(ch)               (((V_DEF_P2SFR_CAN(V_NONE, tCanObjType, AUTOMATIC))(Can_GetBasisAdrOfControllerConfig(ch)))->BTP)     /* PRQA S 3453  */ /* MD_MSR_FctLikeMacro */
# define CanRxBCReg(ch)              (((V_DEF_P2SFR_CAN(V_NONE, tCanObjType, AUTOMATIC))(Can_GetBasisAdrOfControllerConfig(ch)))->RXBC)    /* PRQA S 3453  */ /* MD_MSR_FctLikeMacro */
# define CanRxESCReg(ch)             (((V_DEF_P2SFR_CAN(V_NONE, tCanObjType, AUTOMATIC))(Can_GetBasisAdrOfControllerConfig(ch)))->RXESC.R) /* PRQA S 3453  */ /* MD_MSR_FctLikeMacro */
# define CanTxESCReg(ch)             (((V_DEF_P2SFR_CAN(V_NONE, tCanObjType, AUTOMATIC))(Can_GetBasisAdrOfControllerConfig(ch)))->TXESC)   /* PRQA S 3453  */ /* MD_MSR_FctLikeMacro */
# endif
 ...
 * \protects Canif_CancelTxConfirmation processing against Can_Write call inbetween to secure the send order.
